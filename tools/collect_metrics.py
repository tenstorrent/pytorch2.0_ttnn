...
if __name__ == "__main__":
    ...
    # Combine README.in and append the Results section to create the README.md
    with open("README.in", "r") as text_file:
        readme_in = text_file.read()

    readme_md = f"""\
<!--- This README.md was generated by tools/collect_metrics.py. Please modify README.in and/or collect_metris.py to make permanent changes. --->
{readme_in}
