...
|   3 | Tensor<[1, 10, 2048]> self = ?      | Done     | Done       | 1.0   | 0      |
|   4 | Tensor<[1, 10, 3072]> self = ?      | Done     | Done       | 1.0   | 0      |
|   5 | Tensor<[1, 10, 4096]> self = ?      | Done     | Done       | 1.0   | 0      |
...
| 423 | Tensor<[59, 4096]> self = ?         | Done     | Done       | 1.0   | 0      |
