...
|  2 | Tensor<[1, 24, 64, 1]> self = ?,<br>number min = 1e-12 | Removed  | Done       | 0.9999999999999983 | 0      |
...
|  7 | Tensor<[4, 12, 64, 1]> self = ?,<br>number min = 1e-12 | Removed  | Done       | 0.9999999999999996 | 0      |
...
| 10 | Tensor<[64, 4, 64, 1]> self = ?,<br>number min = 1e-12 | Removed  | Done       | 0.9999999999999971 | 0      |
