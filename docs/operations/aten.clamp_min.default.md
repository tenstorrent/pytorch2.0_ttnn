...
|  2 | Tensor<[1, 24, 64, 1]> self = ?,<br>number min = 1e-12 | Removed  | Done       | 0.9999999999999987 | 0      |
...
|  7 | Tensor<[4, 12, 64, 1]> self = ?,<br>number min = 1e-12 | Removed  | Done       | 0.9999999999999979 | 0      |
|  8 | Tensor<[4, 16, 64, 1]> self = ?,<br>number min = 1e-12 | Removed  | Done       | 1.0                | 0      |
|  9 | Tensor<[64, 3, 64, 1]> self = ?,<br>number min = 1e-12 | Removed  | Done       | 0.9999999999999986 | 0      |
