...
|  2 | Tensor<[1, 144, 150, 150]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0     | Done     | Done       | 1.0   | 0      |
|  3 | Tensor<[1, 144, 151, 151]> self = ?,<br>List[int] pad = [0, -1, 0, -1]                          | None     | Fallback   | 1.0   | -1     |
|  4 | Tensor<[1, 144, 190, 190]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0     | Done     | Done       | 1.0   | 0      |
|  5 | Tensor<[1, 144, 191, 191]> self = ?,<br>List[int] pad = [0, -1, 0, -1]                          | None     | Fallback   | 1.0   | -1     |
...
| 16 | Tensor<[1, 192, 95, 95]> self = ?,<br>List[int] pad = [2, 2, 2, 2],<br>number value = 0.0       | Done     | Done       | 1.0   | 0      |
| 17 | Tensor<[1, 192, 99, 99]> self = ?,<br>List[int] pad = [-2, -2, -2, -2]                          | None     | Fallback   | 1.0   | -1     |
...
| 26 | Tensor<[1, 288, 38, 38]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0       | Done     | Done       | 1.0   | 0      |
| 27 | Tensor<[1, 288, 39, 39]> self = ?,<br>List[int] pad = [0, -1, 0, -1]                            | None     | Fallback   | 1.0   | -1     |
| 28 | Tensor<[1, 3, 224, 224]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0       | Done     | Done       | 1.0   | 0      |
| 29 | Tensor<[1, 3, 225, 225]> self = ?,<br>List[int] pad = [0, -1, 0, -1]                            | None     | Fallback   | 1.0   | -1     |
| 30 | Tensor<[1, 3, 240, 240]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0       | Done     | Done       | 1.0   | 0      |
| 31 | Tensor<[1, 3, 241, 241]> self = ?,<br>List[int] pad = [0, -1, 0, -1]                            | None     | Fallback   | 1.0   | -1     |
| 32 | Tensor<[1, 3, 260, 260]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0       | Done     | Done       | 1.0   | 0      |
...
| 36 | Tensor<[1, 3, 380, 380]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0       | Done     | Done       | 1.0   | 0      |
| 37 | Tensor<[1, 3, 381, 381]> self = ?,<br>List[int] pad = [0, -1, 0, -1]                            | None     | Fallback   | 1.0   | -1     |
...
| 40 | Tensor<[1, 336, 48, 48]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0       | Done     | Done       | 1.0   | 0      |
| 41 | Tensor<[1, 336, 49, 49]> self = ?,<br>List[int] pad = [0, -1, 0, -1]                            | None     | Fallback   | 1.0   | -1     |
...
| 58 | Tensor<[1, 96, 112, 112]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0      | Done     | Done       | 1.0   | 0      |
...
| 62 | Tensor<[1, 96, 130, 130]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0      | Done     | Done       | 1.0   | 0      |
| 63 | Tensor<[1, 96, 131, 131]> self = ?,<br>List[int] pad = [0, -1, 0, -1]                           | None     | Fallback   | 1.0   | -1     |
| 64 | Tensor<[1, 960, 24, 24]> self = ?,<br>List[int] pad = [1, 2, 1, 2],<br>number value = 0.0       | Done     | Done       | 1.0   | 0      |
| 65 | Tensor<[1, 960, 27, 27]> self = ?,<br>List[int] pad = [-1, -2, -1, -2]                          | None     | Fallback   | 1.0   | -1     |
| 66 | Tensor<[22]> self = ?,<br>List[int] pad = [0, 0],<br>number value = 50257.0                     | Unknown  | Unknown    | N/A   | N/A    |
