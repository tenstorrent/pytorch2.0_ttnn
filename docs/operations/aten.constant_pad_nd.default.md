...
|  2 | Tensor<[1, 144, 150, 150]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0     | None     | Fallback   | 1.0   | -1     |
|  3 | Tensor<[1, 144, 151, 151]> self = ?,<br>List[int] pad = [0, -1, 0, -1]                          | None     | Fallback   | 1.0   | -1     |
|  4 | Tensor<[1, 144, 190, 190]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0     | None     | Fallback   | 1.0   | -1     |
|  5 | Tensor<[1, 144, 191, 191]> self = ?,<br>List[int] pad = [0, -1, 0, -1]                          | Unknown  | Unknown    | N/A   | N/A    |
|  6 | Tensor<[1, 144, 56, 56]> self = ?,<br>List[int] pad = [1, 2, 1, 2],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
|  7 | Tensor<[1, 144, 59, 59]> self = ?,<br>List[int] pad = [-1, -2, -1, -2]                          | None     | Fallback   | 1.0   | -1     |
|  8 | Tensor<[1, 144, 60, 60]> self = ?,<br>List[int] pad = [1, 2, 1, 2],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
|  9 | Tensor<[1, 144, 63, 63]> self = ?,<br>List[int] pad = [-1, -2, -1, -2]                          | None     | Fallback   | 1.0   | -1     |
| 10 | Tensor<[1, 144, 65, 65]> self = ?,<br>List[int] pad = [2, 2, 2, 2],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
...
| 14 | Tensor<[1, 192, 75, 75]> self = ?,<br>List[int] pad = [2, 2, 2, 2],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
| 15 | Tensor<[1, 192, 79, 79]> self = ?,<br>List[int] pad = [-2, -2, -2, -2]                          | None     | Fallback   | 1.0   | -1     |
| 16 | Tensor<[1, 192, 95, 95]> self = ?,<br>List[int] pad = [2, 2, 2, 2],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
| 17 | Tensor<[1, 192, 99, 99]> self = ?,<br>List[int] pad = [-2, -2, -2, -2]                          | Unknown  | Unknown    | N/A   | N/A    |
| 18 | Tensor<[1, 240, 28, 28]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
| 19 | Tensor<[1, 240, 29, 29]> self = ?,<br>List[int] pad = [0, -1, 0, -1]                            | None     | Fallback   | 1.0   | -1     |
| 20 | Tensor<[1, 240, 30, 30]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
...
| 24 | Tensor<[1, 288, 33, 33]> self = ?,<br>List[int] pad = [1, 1, 1, 1],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
| 25 | Tensor<[1, 288, 35, 35]> self = ?,<br>List[int] pad = [-1, -1, -1, -1]                          | None     | Fallback   | 1.0   | -1     |
| 26 | Tensor<[1, 288, 38, 38]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
| 27 | Tensor<[1, 288, 39, 39]> self = ?,<br>List[int] pad = [0, -1, 0, -1]                            | None     | Fallback   | 1.0   | -1     |
| 28 | Tensor<[1, 3, 224, 224]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
| 29 | Tensor<[1, 3, 225, 225]> self = ?,<br>List[int] pad = [0, -1, 0, -1]                            | None     | Fallback   | 1.0   | -1     |
| 30 | Tensor<[1, 3, 240, 240]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
| 31 | Tensor<[1, 3, 241, 241]> self = ?,<br>List[int] pad = [0, -1, 0, -1]                            | None     | Fallback   | 1.0   | -1     |
| 32 | Tensor<[1, 3, 260, 260]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
| 33 | Tensor<[1, 3, 261, 261]> self = ?,<br>List[int] pad = [0, -1, 0, -1]                            | None     | Fallback   | 1.0   | -1     |
| 34 | Tensor<[1, 3, 300, 300]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
| 35 | Tensor<[1, 3, 301, 301]> self = ?,<br>List[int] pad = [0, -1, 0, -1]                            | None     | Fallback   | 1.0   | -1     |
| 36 | Tensor<[1, 3, 380, 380]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
...
| 40 | Tensor<[1, 336, 48, 48]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
...
| 46 | Tensor<[1, 672, 14, 14]> self = ?,<br>List[int] pad = [1, 2, 1, 2],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
| 47 | Tensor<[1, 672, 15, 15]> self = ?,<br>List[int] pad = [2, 2, 2, 2],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
...
| 52 | Tensor<[1, 720, 17, 17]> self = ?,<br>List[int] pad = [2, 2, 2, 2],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
...
| 56 | Tensor<[1, 816, 19, 19]> self = ?,<br>List[int] pad = [2, 2, 2, 2],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
| 57 | Tensor<[1, 816, 23, 23]> self = ?,<br>List[int] pad = [-2, -2, -2, -2]                          | None     | Fallback   | 1.0   | -1     |
| 58 | Tensor<[1, 96, 112, 112]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0      | None     | Fallback   | 1.0   | -1     |
| 59 | Tensor<[1, 96, 113, 113]> self = ?,<br>List[int] pad = [0, -1, 0, -1]                           | None     | Fallback   | 1.0   | -1     |
| 60 | Tensor<[1, 96, 120, 120]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0      | None     | Fallback   | 1.0   | -1     |
| 61 | Tensor<[1, 96, 121, 121]> self = ?,<br>List[int] pad = [0, -1, 0, -1]                           | None     | Fallback   | 1.0   | -1     |
| 62 | Tensor<[1, 96, 130, 130]> self = ?,<br>List[int] pad = [0, 1, 0, 1],<br>number value = 0.0      | None     | Fallback   | 1.0   | -1     |
| 63 | Tensor<[1, 96, 131, 131]> self = ?,<br>List[int] pad = [0, -1, 0, -1]                           | None     | Fallback   | 1.0   | -1     |
| 64 | Tensor<[1, 960, 24, 24]> self = ?,<br>List[int] pad = [1, 2, 1, 2],<br>number value = 0.0       | None     | Fallback   | 1.0   | -1     |
