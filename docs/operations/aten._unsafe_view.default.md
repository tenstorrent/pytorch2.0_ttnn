...
|   6 | Tensor<[1, 16, 16, 16, 16, 3]> self = ?,<br>List[int] size = [1, 256, 768]    | Done     | Done       | 1.0   | 0      |
|   7 | Tensor<[1, 19, 19, 6, 4]> self = ?,<br>List[int] size = [1, 2166, 4]          | Done     | Done       | 1.0   | 0      |
|   8 | Tensor<[1, 19, 19, 6, 91]> self = ?,<br>List[int] size = [1, 2166, 91]        | Done     | Done       | 1.0   | 0      |
|   9 | Tensor<[1, 197, 12, 64]> self = ?,<br>List[int] size = [1, 197, 768]          | Done     | Done       | 1.0   | 0      |
|  10 | Tensor<[1, 2, 2, 6, 4]> self = ?,<br>List[int] size = [1, 24, 4]              | Done     | Done       | 1.0   | 0      |
|  11 | Tensor<[1, 2, 2, 6, 91]> self = ?,<br>List[int] size = [1, 24, 91]            | Done     | Done       | 1.0   | 0      |
|  12 | Tensor<[1, 2, 2, 7, 7, 384]> self = ?,<br>List[int] size = [4, 49, 384]       | Done     | Done       | 1.0   | 0      |
|  13 | Tensor<[1, 2, 2, 7, 7, 512]> self = ?,<br>List[int] size = [4, 49, 512]       | Done     | Done       | 1.0   | 0      |
|  14 | Tensor<[1, 2, 2, 8, 8, 384]> self = ?,<br>List[int] size = [4, 64, 384]       | Done     | Done       | 1.0   | 0      |
|  15 | Tensor<[1, 2, 2, 8, 8, 512]> self = ?,<br>List[int] size = [4, 64, 512]       | Done     | Done       | 1.0   | 0      |
|  16 | Tensor<[1, 2, 7, 2, 7, 384]> self = ?,<br>List[int] size = [1, 14, 14, 384]   | Done     | Done       | 1.0   | 0      |
|  17 | Tensor<[1, 2, 7, 2, 7, 512]> self = ?,<br>List[int] size = [1, 14, 14, 512]   | Done     | Done       | 1.0   | 0      |
|  18 | Tensor<[1, 2, 8, 2, 8, 384]> self = ?,<br>List[int] size = [1, 16, 16, 384]   | Done     | Done       | 1.0   | 0      |
|  19 | Tensor<[1, 2, 8, 2, 8, 512]> self = ?,<br>List[int] size = [1, 16, 16, 512]   | Done     | Done       | 1.0   | 0      |
|  20 | Tensor<[1, 20, 20, 6, 4]> self = ?,<br>List[int] size = [1, 2400, 4]          | Done     | Done       | 1.0   | 0      |
|  21 | Tensor<[1, 20, 20, 6, 91]> self = ?,<br>List[int] size = [1, 2400, 91]        | Done     | Done       | 1.0   | 0      |
...
|  25 | Tensor<[1, 3, 16, 16, 16, 16]> self = ?,<br>List[int] size = [1, 3, 256, 256] | Done     | Done       | 1.0   | 0      |
|  26 | Tensor<[1, 3, 3, 4, 4]> self = ?,<br>List[int] size = [1, 36, 4]              | Done     | Done       | 1.0   | 0      |
|  27 | Tensor<[1, 3, 3, 4, 91]> self = ?,<br>List[int] size = [1, 36, 91]            | Done     | Done       | 1.0   | 0      |
|  28 | Tensor<[1, 3, 3, 6, 4]> self = ?,<br>List[int] size = [1, 54, 4]              | Done     | Done       | 1.0   | 0      |
|  29 | Tensor<[1, 3, 3, 6, 91]> self = ?,<br>List[int] size = [1, 54, 91]            | Done     | Done       | 1.0   | 0      |
|  30 | Tensor<[1, 32, 16, 96]> self = ?,<br>List[int] size = [1, 32, 1536]           | Done     | Done       | 1.0   | 0      |
|  31 | Tensor<[1, 38, 38, 4, 4]> self = ?,<br>List[int] size = [1, 5776, 4]          | Done     | Done       | 1.0   | 0      |
|  32 | Tensor<[1, 38, 38, 4, 91]> self = ?,<br>List[int] size = [1, 5776, 91]        | Done     | Done       | 1.0   | 0      |
|  33 | Tensor<[1, 4, 4, 7, 7, 192]> self = ?,<br>List[int] size = [16, 49, 192]      | Done     | Done       | 1.0   | 0      |
|  34 | Tensor<[1, 4, 4, 7, 7, 256]> self = ?,<br>List[int] size = [16, 49, 256]      | Done     | Done       | 1.0   | 0      |
|  35 | Tensor<[1, 4, 4, 8, 8, 192]> self = ?,<br>List[int] size = [16, 64, 192]      | Done     | Done       | 1.0   | 0      |
|  36 | Tensor<[1, 4, 4, 8, 8, 256]> self = ?,<br>List[int] size = [16, 64, 256]      | Done     | Done       | 1.0   | 0      |
|  37 | Tensor<[1, 4, 7, 4, 7, 192]> self = ?,<br>List[int] size = [1, 28, 28, 192]   | Done     | Done       | 1.0   | 0      |
|  38 | Tensor<[1, 4, 7, 4, 7, 256]> self = ?,<br>List[int] size = [1, 28, 28, 256]   | Done     | Done       | 1.0   | 0      |
|  39 | Tensor<[1, 4, 8, 4, 8, 192]> self = ?,<br>List[int] size = [1, 32, 32, 192]   | Done     | Done       | 1.0   | 0      |
|  40 | Tensor<[1, 4, 8, 4, 8, 256]> self = ?,<br>List[int] size = [1, 32, 32, 256]   | Done     | Done       | 1.0   | 0      |
|  41 | Tensor<[1, 4096, 2, 32]> self = ?,<br>List[int] size = [1, 4096, 64]          | Done     | Done       | 1.0   | 0      |
|  42 | Tensor<[1, 49, 24, 32]> self = ?,<br>List[int] size = [1, 49, 768]            | Done     | Done       | 1.0   | 0      |
|  43 | Tensor<[1, 49, 32, 32]> self = ?,<br>List[int] size = [1, 49, 1024]           | Done     | Done       | 1.0   | 0      |
|  44 | Tensor<[1, 5, 4, 4, 64]> self = ?,<br>List[int] size = [1, 5, 16, 64]         | Unknown  | Done       | 1.0   | 0      |
|  45 | Tensor<[1, 5, 5, 6, 4]> self = ?,<br>List[int] size = [1, 150, 4]             | Done     | Done       | 1.0   | 0      |
|  46 | Tensor<[1, 5, 5, 6, 91]> self = ?,<br>List[int] size = [1, 150, 91]           | Done     | Done       | 1.0   | 0      |
|  47 | Tensor<[1, 50, 12, 64]> self = ?,<br>List[int] size = [1, 50, 768]            | Done     | Done       | 1.0   | 0      |
|  48 | Tensor<[1, 59, 16, 64]> self = ?,<br>List[int] size = [1, 59, 1024]           | Unknown  | Done       | 1.0   | 0      |
|  49 | Tensor<[1, 64, 24, 32]> self = ?,<br>List[int] size = [1, 64, 768]            | Done     | Done       | 1.0   | 0      |
|  50 | Tensor<[1, 64, 32, 32]> self = ?,<br>List[int] size = [1, 64, 1024]           | Done     | Done       | 1.0   | 0      |
|  51 | Tensor<[1, 7, 71, 64]> self = ?,<br>List[int] size = [1, 7, 4544]             | Unknown  | Unknown    | N/A   | N/A    |
...
|  72 | Tensor<[16, 64, 8, 32]> self = ?,<br>List[int] size = [16, 64, 256]           | Done     | Done       | 1.0   | 0      |
...
| 109 | Tensor<[64, 4, 64, 32]> self = ?,<br>List[int] size = [256, 64, 32]           | Done     | Done       | 1.0   | 0      |
