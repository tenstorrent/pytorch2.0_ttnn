...
|  63 | Tensor<[1, 7, 9, 9, 4]> self = ?,<br>List[int] size = [1, 567, 4]             | Fallback | Done       | True  |
|  64 | Tensor<[1, 7, 9, 9, 91]> self = ?,<br>List[int] size = [1, 567, 91]           | Fallback | Done       | True  |
|  65 | Tensor<[1, 8, 7, 8, 7, 128]> self = ?,<br>List[int] size = [1, 56, 56, 128]   | Fallback | Done       | True  |
|  66 | Tensor<[1, 8, 7, 8, 7, 96]> self = ?,<br>List[int] size = [1, 56, 56, 96]     | Fallback | Done       | True  |
|  67 | Tensor<[1, 8, 8, 7, 7, 128]> self = ?,<br>List[int] size = [64, 49, 128]      | Fallback | Done       | True  |
|  68 | Tensor<[1, 8, 8, 7, 7, 96]> self = ?,<br>List[int] size = [64, 49, 96]        | Fallback | Done       | True  |
...
|  71 | Tensor<[1, 8, 8, 8, 8, 96]> self = ?,<br>List[int] size = [1, 64, 64, 96]     | Fallback | Done       | True  |
|  72 | Tensor<[1, 8, 8, 8, 8, 96]> self = ?,<br>List[int] size = [64, 64, 96]        | Fallback | Done       | True  |
...
|  78 | Tensor<[100, 136]> self = ?,<br>List[int] size = [13600]                      | Fallback | Done       | True  |
|  79 | Tensor<[13, 17]> self = ?,<br>List[int] size = [221]                          | Fallback | Done       | True  |
...
| 100 | Tensor<[25, 34]> self = ?,<br>List[int] size = [850]                          | Fallback | Done       | True  |
...
| 118 | Tensor<[50, 68]> self = ?,<br>List[int] size = [3400]                         | Fallback | Done       | True  |
...
| 131 | Tensor<[7, 9]> self = ?,<br>List[int] size = [63]                             | Fallback | Done       | True  |
