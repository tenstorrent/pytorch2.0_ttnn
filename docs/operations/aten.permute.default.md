...
|   9 | Tensor<[1, 1, 19200, 64]> self = ?,<br>List[int] dims = [0, 2, 1, 3]            | Fallback | Unknown    | N/A   |
...
|  63 | Tensor<[1, 197, 12, 64]> self = ?,<br>List[int] dims = [0, 2, 1, 3]             | Fallback | Done       | True  |
|  64 | Tensor<[1, 197, 16, 64]> self = ?,<br>List[int] dims = [0, 2, 1, 3]             | Fallback | Done       | True  |
...
| 206 | Tensor<[12, 197, 197]> self = ?,<br>List[int] dims = [1, 2, 0]                  | None     | Fallback   | True  |
| 207 | Tensor<[15, 15, 6]> self = ?,<br>List[int] dims = [2, 0, 1]                     | Done     | Done       | True  |
| 208 | Tensor<[16, 197, 197]> self = ?,<br>List[int] dims = [1, 2, 0]                  | None     | Fallback   | True  |
...
| 220 | Tensor<[2, 7, 2, 7]> self = ?,<br>List[int] dims = [0, 2, 1, 3]                 | None     | Fallback   | True  |
...
| 226 | Tensor<[4, 7, 4, 7]> self = ?,<br>List[int] dims = [0, 2, 1, 3]                 | None     | Fallback   | True  |
...
| 232 | Tensor<[49, 49, 3]> self = ?,<br>List[int] dims = [2, 0, 1]                     | None     | Fallback   | True  |
...
| 244 | Tensor<[64, 64, 3]> self = ?,<br>List[int] dims = [2, 0, 1]                     | None     | Fallback   | True  |
...
| 248 | Tensor<[8, 7, 8, 7]> self = ?,<br>List[int] dims = [0, 2, 1, 3]                 | None     | Fallback   | True  |
