...
|  8 | Tensor<[7735]> self = ?,<br>Optional[int] dtype = torch.bool,<br>Optional[bool] pin_memory = False                                    | None     | Unknown    | N/A   | N/A    |
|  9 | Tensor<[8381]> self = ?,<br>Optional[int] dtype = torch.bool,<br>Optional[bool] pin_memory = False                                    | None     | Unknown    | N/A   | N/A    |
