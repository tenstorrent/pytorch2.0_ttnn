...
|  10 | Tensor<[1, 2, 120, 160]> self = ?,<br>int dim = 1,<br>int index = 0   | Unknown  | Done       | 1.0   | -1     |
|  11 | Tensor<[1, 2, 120, 160]> self = ?,<br>int dim = 1,<br>int index = 1   | Unknown  | Done       | 1.0   | -1     |
|  12 | Tensor<[1, 2, 30, 40]> self = ?,<br>int dim = 1,<br>int index = 0     | Unknown  | Done       | 1.0   | -1     |
|  13 | Tensor<[1, 2, 30, 40]> self = ?,<br>int dim = 1,<br>int index = 1     | Unknown  | Done       | 1.0   | -1     |
|  14 | Tensor<[1, 2, 60, 80]> self = ?,<br>int dim = 1,<br>int index = 0     | Unknown  | Done       | 1.0   | -1     |
|  15 | Tensor<[1, 2, 60, 80]> self = ?,<br>int dim = 1,<br>int index = 1     | Unknown  | Done       | 1.0   | -1     |
|  16 | Tensor<[1, 25, 768]> self = ?,<br>int dim = 1,<br>int index = 0       | Done     | Done       | 1.0   | -1     |
|  17 | Tensor<[1, 257, 768]> self = ?,<br>int dim = 1,<br>int index = 0      | Done     | Unknown    | N/A   | N/A    |
|  18 | Tensor<[1, 3, 224, 224]> self = ?,<br>int dim = 1,<br>int index = 0   | Done     | Done       | 1.0   | -1     |
|  19 | Tensor<[1, 3, 224, 224]> self = ?,<br>int dim = 1,<br>int index = 1   | Done     | Done       | 1.0   | -1     |
|  20 | Tensor<[1, 3, 224, 224]> self = ?,<br>int dim = 1,<br>int index = 2   | Done     | Done       | 1.0   | -1     |
|  21 | Tensor<[1, 3, 300, 300]> self = ?,<br>int dim = 0,<br>int index = 0   | Unknown  | Done       | 1.0   | -1     |
|  22 | Tensor<[1, 3, 320, 320]> self = ?,<br>int dim = 0,<br>int index = 0   | Done     | Done       | 1.0   | -1     |
|  23 | Tensor<[1, 3, 480, 640]> self = ?,<br>int dim = 0,<br>int index = 0   | Done     | Done       | 1.0   | -1     |
|  24 | Tensor<[1, 3, 720, 1280]> self = ?,<br>int dim = 0,<br>int index = 0  | Unknown  | Unknown    | N/A   | N/A    |
|  25 | Tensor<[1, 32, 16, 3, 96]> self = ?,<br>int dim = 3,<br>int index = 0 | Done     | Done       | 1.0   | -1     |
|  26 | Tensor<[1, 32, 16, 3, 96]> self = ?,<br>int dim = 3,<br>int index = 1 | Done     | Done       | 1.0   | -1     |
|  27 | Tensor<[1, 32, 16, 3, 96]> self = ?,<br>int dim = 3,<br>int index = 2 | Done     | Done       | 1.0   | -1     |
|  28 | Tensor<[1, 4251, 192]> self = ?,<br>int dim = 1,<br>int index = 0     | Done     | Done       | 1.0   | -1     |
|  29 | Tensor<[1, 45]> self = ?,<br>int dim = 1,<br>int index = -1           | Unknown  | Done       | 1.0   | -1     |
|  30 | Tensor<[1, 50, 1024]> self = ?,<br>int dim = 1,<br>int index = 0      | Done     | Done       | 1.0   | -1     |
|  31 | Tensor<[1, 50, 768]> self = ?,<br>int dim = 1,<br>int index = 0       | Done     | Done       | 1.0   | -1     |
|  32 | Tensor<[1, 50]> self = ?,<br>int dim = 1,<br>int index = -1           | Unknown  | Done       | 1.0   | -1     |
|  33 | Tensor<[1, 51865]> self = ?,<br>int dim = 0,<br>int index = 0         | Unknown  | Unknown    | N/A   | N/A    |
|  34 | Tensor<[1, 59]> self = ?,<br>int dim = 1,<br>int index = -1           | Unknown  | Done       | 1.0   | -1     |
|  35 | Tensor<[1, 5]> self = ?,<br>int dim = 1,<br>int index = -1            | Unknown  | Done       | 1.0   | -1     |
|  36 | Tensor<[1, 9, 768]> self = ?,<br>int dim = 1,<br>int index = 0        | Done     | Done       | 1.0   | -1     |
|  37 | Tensor<[1]> self = ?,<br>int dim = 0,<br>int index = 0                | Removed  | Done       | 1.0   | -1     |
...
| 101 | Tensor<[6, 1, 100, 4]> self = ?,<br>int dim = 0,<br>int index = -1    | Unknown  | Done       | 1.0   | -1     |
| 102 | Tensor<[6, 1, 100, 92]> self = ?,<br>int dim = 0,<br>int index = -1   | Unknown  | Done       | 1.0   | -1     |
| 103 | Tensor<[8732, 4]> self = ?,<br>int dim = 1,<br>int index = 0          | Unknown  | Unknown    | N/A   | N/A    |
| 104 | Tensor<[8732, 4]> self = ?,<br>int dim = 1,<br>int index = 1          | Unknown  | Unknown    | N/A   | N/A    |
| 105 | Tensor<[8732, 4]> self = ?,<br>int dim = 1,<br>int index = 2          | Unknown  | Unknown    | N/A   | N/A    |
| 106 | Tensor<[8732, 4]> self = ?,<br>int dim = 1,<br>int index = 3          | Unknown  | Unknown    | N/A   | N/A    |
