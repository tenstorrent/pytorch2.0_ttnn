...
|  7 | Tensor<[1, 120, 14, 14]> self = ? | Removed  | Done       | True  |
...
| 24 | Tensor<[1, 240, 14, 14]> self = ? | Removed  | Done       | True  |
...
| 36 | Tensor<[1, 480, 7, 7]> self = ?   | Removed  | Done       | True  |
...
| 42 | Tensor<[1, 672, 7, 7]> self = ?   | Removed  | Done       | True  |
| 43 | Tensor<[1, 696, 1, 1]> self = ?   | Done     | Done       | True  |
| 44 | Tensor<[1, 72, 1, 1]> self = ?    | Done     | Done       | True  |
| 45 | Tensor<[1, 72, 28, 28]> self = ?  | Removed  | Done       | True  |
...
| 51 | Tensor<[1, 960, 3, 3]> self = ?   | Removed  | Done       | True  |
