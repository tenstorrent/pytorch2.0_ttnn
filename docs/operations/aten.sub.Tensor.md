...
|  7 | Tensor<[1, 1, 1, 42]> self = ?,<br>Tensor<[1, 1, 1, 42]> other = ?     | Done     | Done       | True  |
...
| 13 | Tensor<[1, 1, 32, 1]> self = ?,<br>Tensor<[1, 1, 32, 1]> other = ?     | Done     | Done       | True  |
...
| 38 | Tensor<[128]> self = ?,<br>Tensor other = 0.5                          | Unknown  | Done       | True  |
| 39 | Tensor<[128]> self = ?,<br>Tensor<[128]> other = ?                     | Done     | Done       | True  |
...
| 43 | Tensor<[160]> self = ?,<br>Tensor<[160]> other = ?                     | Done     | Done       | True  |
| 44 | Tensor<[1]> self = ?,<br>Tensor other = 1                              | Unknown  | Done       | True  |
...
| 64 | Tensor<[40]> self = ?,<br>Tensor<[40]> other = ?                       | Done     | Done       | True  |
| 65 | Tensor<[480, 1]> self = ?,<br>Tensor<[480, 1]> other = ?               | Done     | Done       | True  |
| 66 | Tensor<[480]> self = ?,<br>Tensor other = 0.5                          | Unknown  | Done       | True  |
| 67 | Tensor<[60, 1]> self = ?,<br>Tensor<[60, 1]> other = ?                 | Done     | Done       | True  |
