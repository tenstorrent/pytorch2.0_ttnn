...
|  7 | Tensor<[1, 1, 1, 42]> self = ?,<br>Tensor<[1, 1, 1, 42]> other = ?     | Removed  | Done       | True  |
...
| 13 | Tensor<[1, 1, 32, 1]> self = ?,<br>Tensor<[1, 1, 32, 1]> other = ?     | Removed  | Done       | True  |
...
| 19 | Tensor<[1, 1]> self = ?,<br>Tensor<[1, 1]> other = ?                   | Unknown  | Done       | True  |
...
| 35 | Tensor<[120, 1]> self = ?,<br>Tensor<[120, 1]> other = ?               | Unknown  | Done       | True  |
| 36 | Tensor<[120]> self = ?,<br>Tensor other = 0.5                          | Unknown  | Done       | True  |
| 37 | Tensor<[128, 1]> self = ?,<br>Tensor<[128, 1]> other = ?               | Removed  | Done       | True  |
| 38 | Tensor<[128]> self = ?,<br>Tensor other = 0.5                          | Removed  | Done       | True  |
| 39 | Tensor<[128]> self = ?,<br>Tensor<[128]> other = ?                     | Removed  | Done       | True  |
| 40 | Tensor<[16, 1, 49]> self = ?,<br>Tensor<[16, 49, 1]> other = ?         | None     | Fallback   | True  |
| 41 | Tensor<[16, 1, 64]> self = ?,<br>Tensor<[16, 64, 1]> other = ?         | None     | Fallback   | True  |
| 42 | Tensor<[160]> self = ?,<br>Tensor other = 0.5                          | Unknown  | Done       | True  |
| 43 | Tensor<[160]> self = ?,<br>Tensor<[160]> other = ?                     | Unknown  | Done       | True  |
| 44 | Tensor<[1]> self = ?,<br>Tensor other = 1                              | None     | Done       | True  |
| 45 | Tensor<[24, 1]> self = ?,<br>Tensor<[1, 24]> other = ?                 | None     | Fallback   | True  |
| 46 | Tensor<[240, 1]> self = ?,<br>Tensor<[240, 1]> other = ?               | Unknown  | Done       | True  |
| 47 | Tensor<[240]> self = ?,<br>Tensor other = 0.5                          | Unknown  | Done       | True  |
...
| 50 | Tensor<[30, 1]> self = ?,<br>Tensor<[30, 1]> other = ?                 | Unknown  | Done       | True  |
...
| 54 | Tensor<[30]> self = ?,<br>Tensor other = 0.5                           | Unknown  | Done       | True  |
| 55 | Tensor<[320, 1]> self = ?,<br>Tensor<[320, 1]> other = ?               | Unknown  | Done       | True  |
| 56 | Tensor<[320]> self = ?,<br>Tensor other = 0.5                          | Unknown  | Done       | True  |
| 57 | Tensor<[320]> self = ?,<br>Tensor<[320]> other = ?                     | Unknown  | Done       | True  |
...
| 63 | Tensor<[40]> self = ?,<br>Tensor other = 0.5                           | Unknown  | Done       | True  |
| 64 | Tensor<[40]> self = ?,<br>Tensor<[40]> other = ?                       | Unknown  | Done       | True  |
| 65 | Tensor<[480, 1]> self = ?,<br>Tensor<[480, 1]> other = ?               | Unknown  | Done       | True  |
| 66 | Tensor<[480]> self = ?,<br>Tensor other = 0.5                          | Unknown  | Done       | True  |
| 67 | Tensor<[60, 1]> self = ?,<br>Tensor<[60, 1]> other = ?                 | Unknown  | Done       | True  |
| 68 | Tensor<[60]> self = ?,<br>Tensor other = 0.5                           | Unknown  | Done       | True  |
| 69 | Tensor<[64, 1, 49]> self = ?,<br>Tensor<[64, 49, 1]> other = ?         | None     | Fallback   | True  |
| 70 | Tensor<[64, 1, 64]> self = ?,<br>Tensor<[64, 64, 1]> other = ?         | None     | Fallback   | True  |
| 71 | Tensor<[640]> self = ?,<br>Tensor other = 0.5                          | Unknown  | Done       | True  |
| 72 | Tensor<[640]> self = ?,<br>Tensor<[640]> other = ?                     | Unknown  | Done       | True  |
| 73 | Tensor<[800, 1]> self = ?,<br>Tensor<[800, 1]> other = ?               | Unknown  | Done       | True  |
| 74 | Tensor<[800]> self = ?,<br>Tensor other = 0.5                          | Unknown  | Done       | True  |
| 75 | Tensor<[80]> self = ?,<br>Tensor other = 0.5                           | Unknown  | Done       | True  |
| 76 | Tensor<[80]> self = ?,<br>Tensor<[80]> other = ?                       | Unknown  | Done       | True  |
