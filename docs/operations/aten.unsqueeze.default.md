...
|   1 | Tensor<[1, 1, 1, 16]> self = ?,<br>int dim = 4        | Unknown  |
|   2 | Tensor<[1, 1, 10]> self = ?,<br>int dim = 2           | Done     |
|   3 | Tensor<[1, 1, 12]> self = ?,<br>int dim = 2           | Done     |
|   4 | Tensor<[1, 1, 14]> self = ?,<br>int dim = 2           | Done     |
|   5 | Tensor<[1, 1, 15]> self = ?,<br>int dim = 2           | Done     |
|   6 | Tensor<[1, 1, 16]> self = ?,<br>int dim = 2           | Unknown  |
|   7 | Tensor<[1, 1, 17]> self = ?,<br>int dim = 1           | Unknown  |
|   8 | Tensor<[1, 1, 17]> self = ?,<br>int dim = 2           | Unknown  |
|   9 | Tensor<[1, 1, 19]> self = ?,<br>int dim = 2           | Done     |
|  10 | Tensor<[1, 1, 1]> self = ?,<br>int dim = 1            | Unknown  |
|  11 | Tensor<[1, 1, 1]> self = ?,<br>int dim = 2            | Unknown  |
|  12 | Tensor<[1, 1, 201]> self = ?,<br>int dim = 2          | Unknown  |
|  13 | Tensor<[1, 1, 2048]> self = ?,<br>int dim = 2         | Unknown  |
|  14 | Tensor<[1, 1, 24]> self = ?,<br>int dim = 2           | Done     |
|  15 | Tensor<[1, 1, 256]> self = ?,<br>int dim = 2          | Done     |
|  16 | Tensor<[1, 1, 25]> self = ?,<br>int dim = 2           | Done     |
|  17 | Tensor<[1, 1, 2]> self = ?,<br>int dim = 1            | Unknown  |
|  18 | Tensor<[1, 1, 2]> self = ?,<br>int dim = 2            | Unknown  |
|  19 | Tensor<[1, 1, 32]> self = ?,<br>int dim = 2           | Done     |
|  20 | Tensor<[1, 1, 45]> self = ?,<br>int dim = 2           | Unknown  |
|  21 | Tensor<[1, 1, 46]> self = ?,<br>int dim = 2           | Unknown  |
|  22 | Tensor<[1, 1, 59]> self = ?,<br>int dim = 2           | Done     |
|  23 | Tensor<[1, 1, 5]> self = ?,<br>int dim = 2            | Unknown  |
|  24 | Tensor<[1, 1, 60]> self = ?,<br>int dim = 2           | Unknown  |
|  25 | Tensor<[1, 1, 6]> self = ?,<br>int dim = 2            | Unknown  |
|  26 | Tensor<[1, 1, 7]> self = ?,<br>int dim = 2            | Unknown  |
|  27 | Tensor<[1, 1, 8]> self = ?,<br>int dim = 2            | Done     |
|  28 | Tensor<[1, 1, 9]> self = ?,<br>int dim = 2            | Done     |
|  29 | Tensor<[1, 1, s0 + 1]> self = ?,<br>int dim = 1       | Unknown  |
|  30 | Tensor<[1, 1, s0 + 1]> self = ?,<br>int dim = 2       | Unknown  |
|  31 | Tensor<[1, 1, s0]> self = ?,<br>int dim = 1           | Unknown  |
|  32 | Tensor<[1, 1, s0]> self = ?,<br>int dim = 2           | Unknown  |
|  33 | Tensor<[1, 1, s10 + 1]> self = ?,<br>int dim = 2      | Unknown  |
|  34 | Tensor<[1, 10]> self = ?,<br>int dim = 1              | Done     |
|  35 | Tensor<[1, 12, 16, 2]> self = ?,<br>int dim = 1       | Unknown  |
|  36 | Tensor<[1, 120, 160]> self = ?,<br>int dim = 1        | Done     |
|  37 | Tensor<[1, 1280, 1]> self = ?,<br>int dim = 3         | Done     |
|  38 | Tensor<[1, 1280]> self = ?,<br>int dim = 2            | None     |
|  39 | Tensor<[1, 12]> self = ?,<br>int dim = 1              | Done     |
|  40 | Tensor<[1, 14]> self = ?,<br>int dim = 1              | Done     |
|  41 | Tensor<[1, 15]> self = ?,<br>int dim = 1              | Done     |
...
|  90 | Tensor<[10]> self = ?,<br>int dim = 0                 | Done     |
|  91 | Tensor<[10]> self = ?,<br>int dim = 1                 | None     |
|  92 | Tensor<[12, 1, 1]> self = ?,<br>int dim = 0           | Unknown  |
|  93 | Tensor<[12, 10, 10]> self = ?,<br>int dim = 0         | Done     |
...
|  98 | Tensor<[12, 64, 64]> self = ?,<br>int dim = 0         | Done     |
...
| 106 | Tensor<[15]> self = ?,<br>int dim = 1                 | None     |
| 107 | Tensor<[16, 1, 1]> self = ?,<br>int dim = 0           | Unknown  |
| 108 | Tensor<[16, 1, 49, 49]> self = ?,<br>int dim = 0      | Done     |
| 109 | Tensor<[16, 1, 64, 64]> self = ?,<br>int dim = 0      | Done     |
| 110 | Tensor<[16, 10, 10]> self = ?,<br>int dim = 0         | Done     |
...
| 116 | Tensor<[16, 49]> self = ?,<br>int dim = 2             | None     |
| 117 | Tensor<[16, 64, 64]> self = ?,<br>int dim = 0         | Done     |
| 118 | Tensor<[16, 64, 64]> self = ?,<br>int dim = 1         | Done     |
| 119 | Tensor<[16, 64]> self = ?,<br>int dim = 1             | Done     |
| 120 | Tensor<[16, 64]> self = ?,<br>int dim = 2             | None     |
| 121 | Tensor<[16, s0 + 1, s0 + 1]> self = ?,<br>int dim = 0 | Unknown  |
| 122 | Tensor<[160]> self = ?,<br>int dim = 0                | Done     |
| 123 | Tensor<[16]> self = ?,<br>int dim = -1                | None     |
| 124 | Tensor<[16]> self = ?,<br>int dim = 1                 | None     |
...
| 132 | Tensor<[1]> self = ?,<br>int dim = 1                  | Done     |
...
| 138 | Tensor<[24, 64, 64]> self = ?,<br>int dim = 0         | Done     |
| 139 | Tensor<[240]> self = ?,<br>int dim = 1                | None     |
| 140 | Tensor<[24]> self = ?,<br>int dim = 0                 | Done     |
| 141 | Tensor<[24]> self = ?,<br>int dim = 1                 | None     |
| 142 | Tensor<[25]> self = ?,<br>int dim = 1                 | Unknown  |
| 143 | Tensor<[28]> self = ?,<br>int dim = -1                | None     |
| 144 | Tensor<[2]> self = ?,<br>int dim = 0                  | Unknown  |
| 145 | Tensor<[2]> self = ?,<br>int dim = 1                  | Unknown  |
| 146 | Tensor<[3, 1]> self = ?,<br>int dim = 2               | Done     |
...
| 150 | Tensor<[3, 64, 64]> self = ?,<br>int dim = 0          | Done     |
| 151 | Tensor<[300]> self = ?,<br>int dim = 1                | None     |
| 152 | Tensor<[30]> self = ?,<br>int dim = 1                 | None     |
| 153 | Tensor<[32, 32]> self = ?,<br>int dim = 0             | Done     |
| 154 | Tensor<[32, 49, 49]> self = ?,<br>int dim = 0         | Done     |
| 155 | Tensor<[32, 64, 64]> self = ?,<br>int dim = 0         | Done     |
| 156 | Tensor<[320]> self = ?,<br>int dim = 1                | None     |
| 157 | Tensor<[3234]> self = ?,<br>int dim = 1               | Unknown  |
| 158 | Tensor<[32]> self = ?,<br>int dim = -1                | None     |
| 159 | Tensor<[32]> self = ?,<br>int dim = 0                 | Done     |
| 160 | Tensor<[3]> self = ?,<br>int dim = 1                  | None     |
| 161 | Tensor<[4, 1, 49, 49]> self = ?,<br>int dim = 0       | Done     |
| 162 | Tensor<[4, 1, 64, 64]> self = ?,<br>int dim = 0       | Done     |
| 163 | Tensor<[4, 49, 49]> self = ?,<br>int dim = 0          | Done     |
| 164 | Tensor<[4, 49, 49]> self = ?,<br>int dim = 1          | Done     |
| 165 | Tensor<[4, 49]> self = ?,<br>int dim = 1              | Done     |
| 166 | Tensor<[4, 49]> self = ?,<br>int dim = 2              | None     |
| 167 | Tensor<[4, 64, 64]> self = ?,<br>int dim = 0          | Done     |
| 168 | Tensor<[4, 64, 64]> self = ?,<br>int dim = 1          | Done     |
| 169 | Tensor<[4, 64]> self = ?,<br>int dim = 1              | Done     |
| 170 | Tensor<[4, 64]> self = ?,<br>int dim = 2              | None     |
| 171 | Tensor<[45, 45]> self = ?,<br>int dim = 0             | Unknown  |
| 172 | Tensor<[480]> self = ?,<br>int dim = 1                | None     |
...
| 183 | Tensor<[6, 64, 64]> self = ?,<br>int dim = 0          | Done     |
| 184 | Tensor<[6, s0 + 1, s0 + 1]> self = ?,<br>int dim = 0  | Unknown  |
| 185 | Tensor<[60]> self = ?,<br>int dim = 1                 | None     |
| 186 | Tensor<[64, 1, 49, 49]> self = ?,<br>int dim = 0      | Done     |
| 187 | Tensor<[64, 1, 64, 64]> self = ?,<br>int dim = 0      | Done     |
| 188 | Tensor<[64, 49, 49]> self = ?,<br>int dim = 1         | Done     |
| 189 | Tensor<[64, 49]> self = ?,<br>int dim = 1             | Done     |
| 190 | Tensor<[64, 49]> self = ?,<br>int dim = 2             | None     |
| 191 | Tensor<[64, 64, 64]> self = ?,<br>int dim = 1         | Done     |
| 192 | Tensor<[64, 64]> self = ?,<br>int dim = 1             | Done     |
| 193 | Tensor<[64, 64]> self = ?,<br>int dim = 2             | None     |
| 194 | Tensor<[64]> self = ?,<br>int dim = -1                | None     |
| 195 | Tensor<[64]> self = ?,<br>int dim = 0                 | Done     |
| 196 | Tensor<[7, 7]> self = ?,<br>int dim = 0               | Done     |
| 197 | Tensor<[7]> self = ?,<br>int dim = -1                 | None     |
| 198 | Tensor<[7]> self = ?,<br>int dim = 0                  | Done     |
| 199 | Tensor<[8, 1, 1]> self = ?,<br>int dim = 0            | Unknown  |
| 200 | Tensor<[8, 10, 10]> self = ?,<br>int dim = 0          | Done     |
| 201 | Tensor<[8, 2, 2]> self = ?,<br>int dim = 0            | Unknown  |
| 202 | Tensor<[8, 49, 49]> self = ?,<br>int dim = 0          | Done     |
| 203 | Tensor<[8, 64, 64]> self = ?,<br>int dim = 0          | Done     |
