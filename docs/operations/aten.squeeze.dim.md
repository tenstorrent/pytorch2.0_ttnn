...
|  3 | Tensor<[1, 14, 1]> self = ?,<br>int dim = -1            | Removed  | Done       | True  |
...
| 10 | Tensor<[1, 256, 1]> self = ?,<br>int dim = -1           | Removed  | Done       | True  |
| 11 | Tensor<[1, 40, 28, 28]> self = ?,<br>int dim = 0        | Removed  | Done       | True  |
| 12 | Tensor<[1, 80, 14, 14]> self = ?,<br>int dim = 0        | Removed  | Done       | True  |
| 13 | Tensor<[3, 1370, 1, 1, 1280]> self = ?,<br>int dim = -2 | None     | Fallback   | True  |
| 14 | Tensor<[3, 197, 1, 1, 1024]> self = ?,<br>int dim = -2  | None     | Fallback   | True  |
| 15 | Tensor<[3, 197, 1, 1, 768]> self = ?,<br>int dim = -2   | None     | Fallback   | True  |
| 16 | Tensor<[3, 50, 1, 1, 1024]> self = ?,<br>int dim = -2   | None     | Fallback   | True  |
| 17 | Tensor<[3, 50, 1, 1, 768]> self = ?,<br>int dim = -2    | None     | Fallback   | True  |
