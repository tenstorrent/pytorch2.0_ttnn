...
|   9 | Tensor<[1, 12, 197, 197]> self = ?,<br>Tensor other = 8.0                | Done     | Done       | True  |
...
|  59 | Tensor<[1, 1]> self = ?,<br>Tensor other = 16                            | Unknown  | Failed     | N/A   |
...
|  69 | Tensor<[1, 3, 1445, 1445]> self = ?,<br>Tensor other = 8.0               | Done     | Done       | True  |
...
|  79 | Tensor<[1, 512, 38, 38]> self = ?,<br>Tensor<[1, 512, 38, 38]> other = ? | Done     | Done       | True  |
...
|  95 | Tensor<[10]> self = ?,<br>Tensor other = 10                              | Done     | Failed     | N/A   |
|  96 | Tensor<[10]> self = ?,<br>Tensor other = 9.375                           | Done     | Done       | True  |
|  97 | Tensor<[128]> self = ?,<br>Tensor other = 128                            | Unknown  | Failed     | N/A   |
...
| 102 | Tensor<[160]> self = ?,<br>Tensor other = 160                            | Unknown  | Failed     | N/A   |
...
| 105 | Tensor<[19]> self = ?,<br>Tensor other = 18.75                           | Done     | Done       | True  |
| 106 | Tensor<[1]> self = ?,<br>Tensor other = 1                                | Done     | Failed     | N/A   |
| 107 | Tensor<[1]> self = ?,<br>Tensor other = 1.0                              | Done     | Done       | True  |
...
| 111 | Tensor<[20]> self = ?,<br>Tensor other = 20                              | Done     | Failed     | N/A   |
| 112 | Tensor<[2]> self = ?,<br>Tensor other = 2                                | Done     | Failed     | N/A   |
...
| 115 | Tensor<[3234, 1]> self = ?,<br>Tensor other = 10.0                       | Unknown  | Done       | True  |
| 116 | Tensor<[3234, 1]> self = ?,<br>Tensor other = 5.0                        | Unknown  | Done       | True  |
| 117 | Tensor<[38]> self = ?,<br>Tensor other = 37.5                            | Done     | Done       | True  |
| 118 | Tensor<[3]> self = ?,<br>Tensor other = 3                                | Done     | Failed     | N/A   |
| 119 | Tensor<[3]> self = ?,<br>Tensor other = 3.0                              | Done     | Done       | True  |
...
| 122 | Tensor<[5]> self = ?,<br>Tensor other = 4.6875                           | Done     | Done       | True  |
| 123 | Tensor<[5]> self = ?,<br>Tensor other = 5                                | Done     | Failed     | N/A   |
...
| 128 | Tensor<[8732, 1]> self = ?,<br>Tensor other = 10.0                       | Unknown  | Done       | True  |
| 129 | Tensor<[8732, 1]> self = ?,<br>Tensor other = 5.0                        | Unknown  | Done       | True  |
