...
|  12 | Tensor<[1, 12, 7, 7]> self = ?,<br>Tensor<[]> other = ?                  | Unknown  | Fallback   | True  |
...
|  70 | Tensor<[1, 3, 1445, 1445]> self = ?,<br>Tensor other = 8.0               | None     | Fallback   | True  |
...
|  90 | Tensor<[10]> self = ?,<br>Tensor other = 10                              | None     | Fallback   | True  |
|  91 | Tensor<[10]> self = ?,<br>Tensor other = 9.375                           | None     | Fallback   | True  |
|  92 | Tensor<[128]> self = ?,<br>Tensor other = 128                            | None     | Fallback   | True  |
...
|  96 | Tensor<[16, 8, 64, 32]> self = ?,<br>Tensor<[16, 8, 64, 32]> other = ?   | Done     | Done       | True  |
|  97 | Tensor<[160]> self = ?,<br>Tensor other = 160                            | Unknown  | Fallback   | True  |
...
| 100 | Tensor<[19]> self = ?,<br>Tensor other = 18.75                           | None     | Fallback   | True  |
| 101 | Tensor<[1]> self = ?,<br>Tensor other = 1                                | None     | Fallback   | True  |
| 102 | Tensor<[1]> self = ?,<br>Tensor other = 1.0                              | None     | Fallback   | True  |
...
| 105 | Tensor<[2, 512]> self = ?,<br>Tensor<[2, 1]> other = ?                   | Fallback | Done       | True  |
| 106 | Tensor<[20]> self = ?,<br>Tensor other = 20                              | None     | Fallback   | True  |
| 107 | Tensor<[2]> self = ?,<br>Tensor other = 2                                | None     | Fallback   | True  |
| 108 | Tensor<[3, 320, 320]> self = ?,<br>Tensor<[3, 1, 1]> other = ?           | Done     | Done       | True  |
| 109 | Tensor<[3, 480, 640]> self = ?,<br>Tensor<[3, 1, 1]> other = ?           | Done     | Done       | True  |
| 110 | Tensor<[3234, 1]> self = ?,<br>Tensor other = 10.0                       | Unknown  | Fallback   | True  |
| 111 | Tensor<[3234, 1]> self = ?,<br>Tensor other = 5.0                        | Unknown  | Fallback   | True  |
| 112 | Tensor<[38]> self = ?,<br>Tensor other = 37.5                            | None     | Fallback   | True  |
| 113 | Tensor<[3]> self = ?,<br>Tensor other = 3                                | None     | Fallback   | True  |
| 114 | Tensor<[3]> self = ?,<br>Tensor other = 3.0                              | None     | Fallback   | True  |
...
| 117 | Tensor<[5]> self = ?,<br>Tensor other = 4.6875                           | None     | Fallback   | True  |
| 118 | Tensor<[5]> self = ?,<br>Tensor other = 5                                | None     | Fallback   | True  |
...
| 123 | Tensor<[8732, 1]> self = ?,<br>Tensor other = 10.0                       | Unknown  | Fallback   | True  |
| 124 | Tensor<[8732, 1]> self = ?,<br>Tensor other = 5.0                        | Unknown  | Fallback   | True  |
