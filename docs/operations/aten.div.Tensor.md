...
| 19 | Tensor<[1, 16, 1, 6]> self = ?,<br>Tensor<[]> other = ?                  | Unknown  |
| 20 | Tensor<[1, 16, 1, s10 + 1]> self = ?,<br>Tensor<[]> other = ?            | Unknown  |
| 21 | Tensor<[1, 16, 197, 197]> self = ?,<br>Tensor other = 8.0                | None     |
| 22 | Tensor<[1, 16, 256, 256]> self = ?,<br>Tensor other = 8.0                | Done     |
| 23 | Tensor<[1, 16, 5, 5]> self = ?,<br>Tensor<[]> other = ?                  | Unknown  |
| 24 | Tensor<[1, 16, 9, 9]> self = ?,<br>Tensor other = 11.313708498984761     | Done     |
| 25 | Tensor<[1, 16, 9, 9]> self = ?,<br>Tensor other = 8.0                    | Done     |
| 26 | Tensor<[1, 1]> self = ?,<br>Tensor other = 16                            | Unknown  |
| 27 | Tensor<[1, 1]> self = ?,<br>Tensor other = 2.0794415416798357            | Unknown  |
| 28 | Tensor<[1, 2, 4096, 256]> self = ?,<br>Tensor other = 5.656854249492381  | Done     |
| 29 | Tensor<[1, 2, 4800, 300]> self = ?,<br>Tensor other = 8.0                | None     |
| 30 | Tensor<[1, 23, 40, 1]> self = ?,<br>Tensor<[128]> other = ?              | Unknown  |
| 31 | Tensor<[1, 23, 40]> self = ?,<br>Tensor<[1, 1, 40]> other = ?            | Unknown  |
...
| 42 | Tensor<[1, 5, 1200, 300]> self = ?,<br>Tensor other = 8.0                | None     |
| 43 | Tensor<[1, 50257]> self = ?,<br>Tensor other = 0.9                       | Unknown  |
| 44 | Tensor<[1, 512, 38, 38]> self = ?,<br>Tensor<[1, 512, 38, 38]> other = ? | None     |
...
| 54 | Tensor<[1, 8, 300, 300]> self = ?,<br>Tensor other = 8.0                 | None     |
| 55 | Tensor<[1, s0, 256]> self = ?,<br>Tensor other = 0.5                     | Unknown  |
| 56 | Tensor<[10, 10]> self = ?,<br>Tensor other = 2.772588722239781           | Done     |
| 57 | Tensor<[10, 10]> self = ?,<br>Tensor other = 8                           | Done     |
| 58 | Tensor<[10]> self = ?,<br>Tensor other = 10                              | None     |
| 59 | Tensor<[10]> self = ?,<br>Tensor other = 9.375                           | None     |
| 60 | Tensor<[128]> self = ?,<br>Tensor other = 128                            | Unknown  |
| 61 | Tensor<[15, 15]> self = ?,<br>Tensor other = 2.772588722239781           | Done     |
| 62 | Tensor<[15, 15]> self = ?,<br>Tensor other = 8                           | Done     |
| 63 | Tensor<[16, 6, 64, 32]> self = ?,<br>Tensor<[16, 6, 64, 32]> other = ?   | Done     |
| 64 | Tensor<[16, 8, 64, 32]> self = ?,<br>Tensor<[16, 8, 64, 32]> other = ?   | Done     |
| 65 | Tensor<[160]> self = ?,<br>Tensor other = 160                            | None     |
| 66 | Tensor<[17, 17]> self = ?,<br>Tensor other = 16                          | Unknown  |
| 67 | Tensor<[17, 17]> self = ?,<br>Tensor other = 2.0794415416798357          | Unknown  |
| 68 | Tensor<[19]> self = ?,<br>Tensor other = 18.75                           | None     |
| 69 | Tensor<[1]> self = ?,<br>Tensor other = 1                                | None     |
| 70 | Tensor<[1]> self = ?,<br>Tensor other = 1.0                              | None     |
| 71 | Tensor<[2, 2]> self = ?,<br>Tensor other = 16                            | Unknown  |
| 72 | Tensor<[2, 2]> self = ?,<br>Tensor other = 2.0794415416798357            | Unknown  |
| 73 | Tensor<[2, 512]> self = ?,<br>Tensor<[2, 1]> other = ?                   | Done     |
| 74 | Tensor<[20]> self = ?,<br>Tensor other = 20                              | None     |
| 75 | Tensor<[2]> self = ?,<br>Tensor other = 2                                | None     |
...
| 80 | Tensor<[38]> self = ?,<br>Tensor other = 37.5                            | None     |
| 81 | Tensor<[3]> self = ?,<br>Tensor other = 3                                | None     |
| 82 | Tensor<[3]> self = ?,<br>Tensor other = 3.0                              | None     |
| 83 | Tensor<[4, 12, 64, 32]> self = ?,<br>Tensor<[4, 12, 64, 32]> other = ?   | Done     |
| 84 | Tensor<[4, 16, 64, 32]> self = ?,<br>Tensor<[4, 16, 64, 32]> other = ?   | Done     |
| 85 | Tensor<[5]> self = ?,<br>Tensor other = 4.6875                           | None     |
| 86 | Tensor<[5]> self = ?,<br>Tensor other = 5                                | None     |
| 87 | Tensor<[64, 3, 64, 32]> self = ?,<br>Tensor<[64, 3, 64, 32]> other = ?   | Done     |
| 88 | Tensor<[64, 4, 64, 32]> self = ?,<br>Tensor<[64, 4, 64, 32]> other = ?   | Done     |
