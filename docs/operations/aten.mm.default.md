...
|   1 | Tensor<[1, 1000]> self = ?,<br>Tensor<[1000, 1280]> mat2 = ?    | Done     | Done       | 0.999967 |      0 |
...
|   4 | Tensor<[1, 1000]> self = ?,<br>Tensor<[1000, 512]> mat2 = ?     | Done     | Done       | 0.999968 |      0 |
|   5 | Tensor<[1, 1000]> self = ?,<br>Tensor<[1000, 768]> mat2 = ?     | Done     | Done       | 0.999969 |      0 |
|   6 | Tensor<[1, 1024]> self = ?,<br>Tensor<[1024, 1024]> mat2 = ?    | Unknown  | Done       | 0.999965 |      0 |
...
|  10 | Tensor<[1, 1024]> self = ?,<br>Tensor<[1024, 512]> mat2 = ?     | Unknown  | Done       | 0.999972 |      0 |
|  11 | Tensor<[1, 10]> self = ?,<br>Tensor<[10, 128]> mat2 = ?         | Done     | Done       | 0.999992 |      0 |
|  12 | Tensor<[1, 128]> self = ?,<br>Tensor<[128, 64]> mat2 = ?        | Done     | Done       | 0.999981 |      0 |
...
|  15 | Tensor<[1, 12]> self = ?,<br>Tensor<[12, 3]> mat2 = ?           | Done     | Done       | 0.999999 |      0 |
|  16 | Tensor<[1, 12]> self = ?,<br>Tensor<[12, 64]> mat2 = ?          | Done     | Done       | 0.999994 |      0 |
|  17 | Tensor<[1, 2048]> self = ?,<br>Tensor<[2048, 512]> mat2 = ?     | Unknown  | Done       | 0.999957 |      0 |
|  18 | Tensor<[1, 21843]> self = ?,<br>Tensor<[21843, 768]> mat2 = ?   | Done     | Done       | 0.999538 |      0 |
|  19 | Tensor<[1, 2]> self = ?,<br>Tensor<[2, 512]> mat2 = ?           | Done     | Done       | 0.999996 |      0 |
|  20 | Tensor<[1, 3072]> self = ?,<br>Tensor<[3072, 768]> mat2 = ?     | Unknown  | Done       | 0.999946 |      0 |
...
|  23 | Tensor<[1, 4096]> self = ?,<br>Tensor<[4096, 1024]> mat2 = ?    | Unknown  | Done       | 0.999934 |      0 |
...
|  27 | Tensor<[1, 512]> self = ?,<br>Tensor<[512, 384]> mat2 = ?       | Unknown  | Done       | 0.999972 |      0 |
|  28 | Tensor<[1, 512]> self = ?,<br>Tensor<[512, 50272]> mat2 = ?     | Unknown  | Done       | 0.999972 |      0 |
|  29 | Tensor<[1, 512]> self = ?,<br>Tensor<[512, 512]> mat2 = ?       | Unknown  | Done       | 0.999969 |      0 |
|  30 | Tensor<[1, 512]> self = ?,<br>Tensor<[512, 768]> mat2 = ?       | Done     | Done       | 0.999967 |      0 |
|  31 | Tensor<[1, 64]> self = ?,<br>Tensor<[64, 128]> mat2 = ?         | Done     | Done       | 0.999982 |      0 |
|  32 | Tensor<[1, 64]> self = ?,<br>Tensor<[64, 12]> mat2 = ?          | Done     | Done       | 0.99999  |      0 |
|  33 | Tensor<[1, 768]> self = ?,<br>Tensor<[768, 3072]> mat2 = ?      | Unknown  | Done       | 0.999966 |      0 |
...
|  36 | Tensor<[1, 768]> self = ?,<br>Tensor<[768, 512]> mat2 = ?       | Done     | Done       | 0.99997  |      0 |
...
|  39 | Tensor<[1, 784]> self = ?,<br>Tensor<[784, 128]> mat2 = ?       | Done     | Done       | 0.999977 |      0 |
...
|  45 | Tensor<[10, 4096]> self = ?,<br>Tensor<[4096, 1024]> mat2 = ?   | Unknown  | Done       | 0.99993  |      0 |
...
|  65 | Tensor<[128, 16384]> self = ?,<br>Tensor<[16384, 32]> mat2 = ?  | Done     | Done       | 0.999799 |      0 |
...
|  79 | Tensor<[160, 256]> self = ?,<br>Tensor<[256, 1024]> mat2 = ?    | Done     | Done       | 0.999976 |      0 |
...
|  91 | Tensor<[197, 768]> self = ?,<br>Tensor<[768, 3072]> mat2 = ?    | Done     | Done       | 0.999969 |      0 |
|  92 | Tensor<[197, 768]> self = ?,<br>Tensor<[768, 768]> mat2 = ?     | Done     | Done       | 0.999969 |      0 |
|  93 | Tensor<[2, 1]> self = ?,<br>Tensor<[1, 512]> mat2 = ?           | Done     | Done       | 0.999994 |      0 |
...
|  97 | Tensor<[2048, 768]> self = ?,<br>Tensor<[768, 262]> mat2 = ?    | Removed  | Done       | 0.999969 |      0 |
|  98 | Tensor<[21843, 1]> self = ?,<br>Tensor<[1, 768]> mat2 = ?       | Done     | Done       | 0.999992 |      0 |
|  99 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 12]> mat2 = ?      | Done     | Done       | 0.999971 |      0 |
| 100 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 16]> mat2 = ?      | Done     | Done       | 0.999973 |      0 |
| 101 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 24]> mat2 = ?      | Done     | Done       | 0.999972 |      0 |
| 102 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 32]> mat2 = ?      | Done     | Done       | 0.999972 |      0 |
| 103 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 3]> mat2 = ?       | Done     | Done       | 0.99997  |      0 |
| 104 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 4]> mat2 = ?       | Done     | Done       | 0.999973 |      0 |
| 105 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 6]> mat2 = ?       | Done     | Done       | 0.99997  |      0 |
| 106 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 8]> mat2 = ?       | Done     | Done       | 0.999972 |      0 |
...
| 111 | Tensor<[256, 16384]> self = ?,<br>Tensor<[16384, 32]> mat2 = ?  | Done     | Done       | 0.999799 |      0 |
| 112 | Tensor<[256, 256]> self = ?,<br>Tensor<[256, 1024]> mat2 = ?    | Done     | Done       | 0.999976 |      0 |
...
| 116 | Tensor<[256, 4096]> self = ?,<br>Tensor<[4096, 64]> mat2 = ?    | Done     | Done       | 0.999844 |      0 |
...
| 121 | Tensor<[3, 1]> self = ?,<br>Tensor<[1, 12]> mat2 = ?            | Done     | Done       | 0.999998 |      0 |
...
| 126 | Tensor<[32, 16384]> self = ?,<br>Tensor<[16384, 128]> mat2 = ?  | Done     | Done       | 0.99981  |      0 |
| 127 | Tensor<[32, 16384]> self = ?,<br>Tensor<[16384, 32]> mat2 = ?   | Done     | Done       | 0.999824 |      0 |
...
| 138 | Tensor<[49, 1536]> self = ?,<br>Tensor<[1536, 768]> mat2 = ?    | Done     | Done       | 0.99996  |      0 |
| 139 | Tensor<[49, 2048]> self = ?,<br>Tensor<[2048, 1024]> mat2 = ?   | Done     | Done       | 0.999955 |      0 |
| 140 | Tensor<[5, 1024]> self = ?,<br>Tensor<[1024, 1024]> mat2 = ?    | Unknown  | Done       | 0.999963 |      0 |
...
| 151 | Tensor<[59, 1024]> self = ?,<br>Tensor<[1024, 512]> mat2 = ?    | Unknown  | Done       | 0.999956 |      0 |
...
| 156 | Tensor<[64, 1]> self = ?,<br>Tensor<[1, 12]> mat2 = ?           | Done     | Done       | 0.999994 |      0 |
| 157 | Tensor<[64, 2048]> self = ?,<br>Tensor<[2048, 1024]> mat2 = ?   | Done     | Done       | 0.999954 |      0 |
| 158 | Tensor<[64, 256]> self = ?,<br>Tensor<[256, 4096]> mat2 = ?     | Done     | Done       | 0.999975 |      0 |
| 159 | Tensor<[64, 256]> self = ?,<br>Tensor<[256, 64]> mat2 = ?       | Done     | Done       | 0.999979 |      0 |
| 160 | Tensor<[64, 4096]> self = ?,<br>Tensor<[4096, 256]> mat2 = ?    | Done     | Done       | 0.999851 |      0 |
| 161 | Tensor<[64, 4096]> self = ?,<br>Tensor<[4096, 64]> mat2 = ?     | Done     | Done       | 0.999848 |      0 |
| 162 | Tensor<[640, 1024]> self = ?,<br>Tensor<[1024, 160]> mat2 = ?   | Done     | Done       | 0.999965 |      0 |
| 163 | Tensor<[7, 768]> self = ?,<br>Tensor<[768, 2]> mat2 = ?         | Done     | Done       | 0.99994  |      0 |
