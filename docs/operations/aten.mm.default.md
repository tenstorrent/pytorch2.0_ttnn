...
|----:|:----------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|   0 | Tensor<[1, 1000]> self = ?,<br>Tensor<[1000, 1024]> mat2 = ?    | Done     | Done       | 0.999972 |      0 |
...
|   9 | Tensor<[1, 1024]> self = ?,<br>Tensor<[1024, 4096]> mat2 = ?    | Unknown  | Done       | 0.999963 |      0 |
|  10 | Tensor<[1, 1024]> self = ?,<br>Tensor<[1024, 512]> mat2 = ?     | Unknown  | Done       | 0.999968 |      0 |
|  11 | Tensor<[1, 10]> self = ?,<br>Tensor<[10, 128]> mat2 = ?         | Done     | Done       | 0.99999  |      0 |
|  12 | Tensor<[1, 128]> self = ?,<br>Tensor<[128, 64]> mat2 = ?        | Done     | Done       | 0.999985 |      0 |
|  13 | Tensor<[1, 128]> self = ?,<br>Tensor<[128, 784]> mat2 = ?       | Done     | Done       | 0.999984 |      0 |
|  14 | Tensor<[1, 128]> self = ?,<br>Tensor<[128, 9216]> mat2 = ?      | Done     | Done       | 0.99998  |      0 |
|  15 | Tensor<[1, 12]> self = ?,<br>Tensor<[12, 3]> mat2 = ?           | Done     | Done       | 0.999997 |      0 |
...
|  18 | Tensor<[1, 21843]> self = ?,<br>Tensor<[21843, 768]> mat2 = ?   | Done     | Done       | 0.999552 |      0 |
...
|  22 | Tensor<[1, 3]> self = ?,<br>Tensor<[3, 12]> mat2 = ?            | Done     | Done       | 0.999991 |      0 |
...
|  25 | Tensor<[1, 512]> self = ?,<br>Tensor<[512, 2048]> mat2 = ?      | Unknown  | Done       | 0.999968 |      0 |
...
|  32 | Tensor<[1, 64]> self = ?,<br>Tensor<[64, 12]> mat2 = ?          | Done     | Done       | 0.999985 |      0 |
...
|  39 | Tensor<[1, 784]> self = ?,<br>Tensor<[784, 128]> mat2 = ?       | Done     | Done       | 0.999969 |      0 |
...
|  65 | Tensor<[128, 16384]> self = ?,<br>Tensor<[16384, 32]> mat2 = ?  | Done     | Done       | 0.999809 |      0 |
|  66 | Tensor<[128, 1]> self = ?,<br>Tensor<[1, 64]> mat2 = ?          | Done     | Done       | 0.999991 |      0 |
...
|  72 | Tensor<[15, 1024]> self = ?,<br>Tensor<[1024, 512]> mat2 = ?    | Unknown  | Done       | 0.999967 |      0 |
...
|  75 | Tensor<[15, 512]> self = ?,<br>Tensor<[512, 384]> mat2 = ?      | Unknown  | Done       | 0.99997  |      0 |
...
| 104 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 4]> mat2 = ?       | Done     | Done       | 0.999972 |      0 |
| 105 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 6]> mat2 = ?       | Done     | Done       | 0.999971 |      0 |
| 106 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 8]> mat2 = ?       | Done     | Done       | 0.999973 |      0 |
...
| 111 | Tensor<[256, 16384]> self = ?,<br>Tensor<[16384, 32]> mat2 = ?  | Done     | Done       | 0.999809 |      0 |
...
| 126 | Tensor<[32, 16384]> self = ?,<br>Tensor<[16384, 128]> mat2 = ?  | Done     | Done       | 0.999799 |      0 |
| 127 | Tensor<[32, 16384]> self = ?,<br>Tensor<[16384, 32]> mat2 = ?   | Done     | Done       | 0.999807 |      0 |
...
| 159 | Tensor<[64, 256]> self = ?,<br>Tensor<[256, 64]> mat2 = ?       | Done     | Done       | 0.99998  |      0 |
| 160 | Tensor<[64, 4096]> self = ?,<br>Tensor<[4096, 256]> mat2 = ?    | Done     | Done       | 0.999846 |      0 |
| 161 | Tensor<[64, 4096]> self = ?,<br>Tensor<[4096, 64]> mat2 = ?     | Done     | Done       | 0.999852 |      0 |
