...
|   4 | Tensor<[1, 1000]> self = ?,<br>Tensor<[1000, 512]> mat2 = ?     | Done     | Done       | 0.999973 |      0 |
|   5 | Tensor<[1, 1000]> self = ?,<br>Tensor<[1000, 768]> mat2 = ?     | Done     | Done       | 0.999964 |      0 |
...
|  10 | Tensor<[1, 1024]> self = ?,<br>Tensor<[1024, 512]> mat2 = ?     | Unknown  | Done       | 0.999964 |      0 |
|  11 | Tensor<[1, 10]> self = ?,<br>Tensor<[10, 128]> mat2 = ?         | Done     | Done       | 0.999994 |      0 |
|  12 | Tensor<[1, 128]> self = ?,<br>Tensor<[128, 64]> mat2 = ?        | Done     | Done       | 0.999974 |      0 |
|  13 | Tensor<[1, 128]> self = ?,<br>Tensor<[128, 784]> mat2 = ?       | Done     | Done       | 0.999979 |      0 |
...
|  17 | Tensor<[1, 2048]> self = ?,<br>Tensor<[2048, 512]> mat2 = ?     | Unknown  | Done       | 0.999958 |      0 |
|  18 | Tensor<[1, 21843]> self = ?,<br>Tensor<[21843, 768]> mat2 = ?   | Done     | Done       | 0.999462 |      0 |
|  19 | Tensor<[1, 2]> self = ?,<br>Tensor<[2, 512]> mat2 = ?           | Done     | Done       | 0.999994 |      0 |
|  20 | Tensor<[1, 3072]> self = ?,<br>Tensor<[3072, 768]> mat2 = ?     | Unknown  | Done       | 0.999945 |      0 |
|  21 | Tensor<[1, 384]> self = ?,<br>Tensor<[384, 512]> mat2 = ?       | Unknown  | Done       | 0.999976 |      0 |
|  22 | Tensor<[1, 3]> self = ?,<br>Tensor<[3, 12]> mat2 = ?            | Done     | Done       | 0.999997 |      0 |
|  23 | Tensor<[1, 4096]> self = ?,<br>Tensor<[4096, 1024]> mat2 = ?    | Unknown  | Done       | 0.999931 |      0 |
...
|  27 | Tensor<[1, 512]> self = ?,<br>Tensor<[512, 384]> mat2 = ?       | Unknown  | Done       | 0.999968 |      0 |
|  28 | Tensor<[1, 512]> self = ?,<br>Tensor<[512, 50272]> mat2 = ?     | Unknown  | Done       | 0.999972 |      0 |
|  29 | Tensor<[1, 512]> self = ?,<br>Tensor<[512, 512]> mat2 = ?       | Unknown  | Done       | 0.999971 |      0 |
...
|  32 | Tensor<[1, 64]> self = ?,<br>Tensor<[64, 12]> mat2 = ?          | Done     | Done       | 0.999982 |      0 |
...
|  39 | Tensor<[1, 784]> self = ?,<br>Tensor<[784, 128]> mat2 = ?       | Done     | Done       | 0.999981 |      0 |
...
|  42 | Tensor<[10, 1]> self = ?,<br>Tensor<[1, 128]> mat2 = ?          | Done     | Done       | 0.99999  |      0 |
...
|  63 | Tensor<[12, 1]> self = ?,<br>Tensor<[1, 3]> mat2 = ?            | Done     | Done       | 0.999997 |      0 |
...
|  95 | Tensor<[2, 512]> self = ?,<br>Tensor<[512, 512]> mat2 = ?       | Done     | Done       | 0.999968 |      0 |
...
|  99 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 12]> mat2 = ?      | Done     | Done       | 0.999973 |      0 |
| 100 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 16]> mat2 = ?      | Done     | Done       | 0.99997  |      0 |
...
| 103 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 3]> mat2 = ?       | Done     | Done       | 0.999971 |      0 |
| 104 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 4]> mat2 = ?       | Done     | Done       | 0.999974 |      0 |
...
| 111 | Tensor<[256, 16384]> self = ?,<br>Tensor<[16384, 32]> mat2 = ?  | Done     | Done       | 0.999801 |      0 |
...
| 116 | Tensor<[256, 4096]> self = ?,<br>Tensor<[4096, 64]> mat2 = ?    | Done     | Done       | 0.999849 |      0 |
...
| 126 | Tensor<[32, 16384]> self = ?,<br>Tensor<[16384, 128]> mat2 = ?  | Done     | Done       | 0.999803 |      0 |
| 127 | Tensor<[32, 16384]> self = ?,<br>Tensor<[16384, 32]> mat2 = ?   | Done     | Done       | 0.999794 |      0 |
| 128 | Tensor<[32, 256]> self = ?,<br>Tensor<[256, 16384]> mat2 = ?    | Done     | Done       | 0.999975 |      0 |
| 129 | Tensor<[32, 256]> self = ?,<br>Tensor<[256, 32]> mat2 = ?       | Done     | Done       | 0.999973 |      0 |
| 130 | Tensor<[384, 768]> self = ?,<br>Tensor<[768, 196]> mat2 = ?     | Done     | Done       | 0.999963 |      0 |
| 131 | Tensor<[4, 768]> self = ?,<br>Tensor<[768, 51865]> mat2 = ?     | Unknown  | Done       | 0.999969 |      0 |
...
| 134 | Tensor<[4096, 64]> self = ?,<br>Tensor<[64, 256]> mat2 = ?      | Done     | Done       | 0.999987 |      0 |
...
| 163 | Tensor<[7, 768]> self = ?,<br>Tensor<[768, 2]> mat2 = ?         | Done     | Done       | 0.999958 |      0 |
