...
|   2 | Tensor<[1, 1000]> self = ?,<br>Tensor<[1000, 1536]> mat2 = ?    | Done     | Done       | 0.999968 |      0 |
...
|  12 | Tensor<[1, 128]> self = ?,<br>Tensor<[128, 64]> mat2 = ?        | Done     | Done       | 0.999984 |      0 |
...
|  15 | Tensor<[1, 12]> self = ?,<br>Tensor<[12, 3]> mat2 = ?           | Done     | Done       | 0.999998 |      0 |
...
|  18 | Tensor<[1, 21843]> self = ?,<br>Tensor<[21843, 768]> mat2 = ?   | Done     | Done       | 0.999472 |      0 |
...
|  36 | Tensor<[1, 768]> self = ?,<br>Tensor<[768, 512]> mat2 = ?       | Done     | Done       | 0.999963 |      0 |
...
| 103 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 3]> mat2 = ?       | Removed  | Done       | 0.999971 |      0 |
| 104 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 4]> mat2 = ?       | Removed  | Done       | 0.99997  |      0 |
| 105 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 6]> mat2 = ?       | Removed  | Done       | 0.999971 |      0 |
...
| 111 | Tensor<[256, 16384]> self = ?,<br>Tensor<[16384, 32]> mat2 = ?  | Done     | Done       | 0.999804 |      0 |
...
| 116 | Tensor<[256, 4096]> self = ?,<br>Tensor<[4096, 64]> mat2 = ?    | Done     | Done       | 0.999848 |      0 |
...
| 121 | Tensor<[3, 1]> self = ?,<br>Tensor<[1, 12]> mat2 = ?            | Done     | Done       | 0.999994 |      0 |
...
| 127 | Tensor<[32, 16384]> self = ?,<br>Tensor<[16384, 32]> mat2 = ?   | Done     | Done       | 0.999778 |      0 |
...
| 140 | Tensor<[5, 1024]> self = ?,<br>Tensor<[1024, 1024]> mat2 = ?    | Unknown  | Done       | 0.999968 |      0 |
...
| 156 | Tensor<[64, 1]> self = ?,<br>Tensor<[1, 12]> mat2 = ?           | Done     | Done       | 0.999991 |      0 |
...
| 163 | Tensor<[7, 768]> self = ?,<br>Tensor<[768, 2]> mat2 = ?         | Done     | Done       | 0.999972 |      0 |
