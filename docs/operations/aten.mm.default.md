...
|----:|:----------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|   0 | Tensor<[1, 1000]> self = ?,<br>Tensor<[1000, 1024]> mat2 = ?    | Done     | Done       | 0.999964 |      0 |
...
|   4 | Tensor<[1, 1000]> self = ?,<br>Tensor<[1000, 512]> mat2 = ?     | Done     | Done       | 0.99997  |      0 |
|   5 | Tensor<[1, 1000]> self = ?,<br>Tensor<[1000, 768]> mat2 = ?     | Done     | Done       | 0.999967 |      0 |
|   6 | Tensor<[1, 1024]> self = ?,<br>Tensor<[1024, 1024]> mat2 = ?    | Unknown  | Done       | 0.999968 |      0 |
|   7 | Tensor<[1, 1024]> self = ?,<br>Tensor<[1024, 3072]> mat2 = ?    | Unknown  | Done       | 0.999968 |      0 |
...
|  12 | Tensor<[1, 128]> self = ?,<br>Tensor<[128, 64]> mat2 = ?        | Done     | Done       | 0.999975 |      0 |
|  13 | Tensor<[1, 128]> self = ?,<br>Tensor<[128, 784]> mat2 = ?       | Done     | Done       | 0.99998  |      0 |
|  14 | Tensor<[1, 128]> self = ?,<br>Tensor<[128, 9216]> mat2 = ?      | Done     | Done       | 0.999979 |      0 |
|  15 | Tensor<[1, 12]> self = ?,<br>Tensor<[12, 3]> mat2 = ?           | Done     | Done       | 1        |      0 |
|  16 | Tensor<[1, 12]> self = ?,<br>Tensor<[12, 64]> mat2 = ?          | Done     | Done       | 0.999991 |      0 |
|  17 | Tensor<[1, 2048]> self = ?,<br>Tensor<[2048, 512]> mat2 = ?     | Unknown  | Done       | 0.999953 |      0 |
|  18 | Tensor<[1, 21843]> self = ?,<br>Tensor<[21843, 768]> mat2 = ?   | Done     | Done       | 0.999497 |      0 |
|  19 | Tensor<[1, 2]> self = ?,<br>Tensor<[2, 512]> mat2 = ?           | Done     | Done       | 0.99999  |      0 |
|  20 | Tensor<[1, 3072]> self = ?,<br>Tensor<[3072, 768]> mat2 = ?     | Unknown  | Done       | 0.999949 |      0 |
...
|  23 | Tensor<[1, 4096]> self = ?,<br>Tensor<[4096, 1024]> mat2 = ?    | Unknown  | Done       | 0.999929 |      0 |
|  24 | Tensor<[1, 512]> self = ?,<br>Tensor<[512, 1024]> mat2 = ?      | Unknown  | Done       | 0.999973 |      0 |
|  25 | Tensor<[1, 512]> self = ?,<br>Tensor<[512, 2048]> mat2 = ?      | Unknown  | Done       | 0.999972 |      0 |
...
|  30 | Tensor<[1, 512]> self = ?,<br>Tensor<[512, 768]> mat2 = ?       | Done     | Done       | 0.999969 |      0 |
|  31 | Tensor<[1, 64]> self = ?,<br>Tensor<[64, 128]> mat2 = ?         | Done     | Done       | 0.999991 |      0 |
|  32 | Tensor<[1, 64]> self = ?,<br>Tensor<[64, 12]> mat2 = ?          | Done     | Done       | 0.999999 |      0 |
...
|  36 | Tensor<[1, 768]> self = ?,<br>Tensor<[768, 512]> mat2 = ?       | Done     | Done       | 0.999973 |      0 |
|  37 | Tensor<[1, 768]> self = ?,<br>Tensor<[768, 51865]> mat2 = ?     | Unknown  | Done       | 0.999968 |      0 |
|  38 | Tensor<[1, 768]> self = ?,<br>Tensor<[768, 768]> mat2 = ?       | Unknown  | Done       | 0.999966 |      0 |
|  39 | Tensor<[1, 784]> self = ?,<br>Tensor<[784, 128]> mat2 = ?       | Done     | Done       | 0.99996  |      0 |
...
|  43 | Tensor<[10, 2048]> self = ?,<br>Tensor<[2048, 512]> mat2 = ?    | Unknown  | Done       | 0.999957 |      0 |
...
|  48 | Tensor<[10, 768]> self = ?,<br>Tensor<[768, 3072]> mat2 = ?     | Unknown  | Done       | 0.999969 |      0 |
|  49 | Tensor<[10, 768]> self = ?,<br>Tensor<[768, 768]> mat2 = ?      | Unknown  | Done       | 0.999967 |      0 |
...
|  63 | Tensor<[12, 1]> self = ?,<br>Tensor<[1, 3]> mat2 = ?            | Done     | Done       | 0.999981 |      0 |
|  64 | Tensor<[12, 1]> self = ?,<br>Tensor<[1, 64]> mat2 = ?           | Done     | Done       | 0.999993 |      0 |
|  65 | Tensor<[128, 16384]> self = ?,<br>Tensor<[16384, 32]> mat2 = ?  | Done     | Done       | 0.99981  |      0 |
...
|  75 | Tensor<[15, 512]> self = ?,<br>Tensor<[512, 384]> mat2 = ?      | Unknown  | Done       | 0.999971 |      0 |
...
|  93 | Tensor<[2, 1]> self = ?,<br>Tensor<[1, 512]> mat2 = ?           | Done     | Done       | 0.999998 |      0 |
|  94 | Tensor<[2, 512]> self = ?,<br>Tensor<[512, 1]> mat2 = ?         | Done     | Done       | 1        |      0 |
|  95 | Tensor<[2, 512]> self = ?,<br>Tensor<[512, 512]> mat2 = ?       | Done     | Done       | 0.999973 |      0 |
...
| 100 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 16]> mat2 = ?      | Removed  | Done       | 0.999972 |      0 |
| 101 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 24]> mat2 = ?      | Removed  | Done       | 0.999971 |      0 |
...
| 105 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 6]> mat2 = ?       | Removed  | Done       | 0.999972 |      0 |
| 106 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 8]> mat2 = ?       | Removed  | Done       | 0.999972 |      0 |
| 107 | Tensor<[256, 1024]> self = ?,<br>Tensor<[1024, 160]> mat2 = ?   | Done     | Done       | 0.999956 |      0 |
| 108 | Tensor<[256, 1024]> self = ?,<br>Tensor<[1024, 256]> mat2 = ?   | Done     | Done       | 0.999956 |      0 |
...
| 111 | Tensor<[256, 16384]> self = ?,<br>Tensor<[16384, 32]> mat2 = ?  | Done     | Done       | 0.999796 |      0 |
...
| 115 | Tensor<[256, 32]> self = ?,<br>Tensor<[32, 32]> mat2 = ?        | Done     | Done       | 0.999989 |      0 |
...
| 121 | Tensor<[3, 1]> self = ?,<br>Tensor<[1, 12]> mat2 = ?            | Done     | Done       | 0.999997 |      0 |
...
| 126 | Tensor<[32, 16384]> self = ?,<br>Tensor<[16384, 128]> mat2 = ?  | Done     | Done       | 0.999812 |      0 |
| 127 | Tensor<[32, 16384]> self = ?,<br>Tensor<[16384, 32]> mat2 = ?   | Done     | Done       | 0.999817 |      0 |
...
| 160 | Tensor<[64, 4096]> self = ?,<br>Tensor<[4096, 256]> mat2 = ?    | Done     | Done       | 0.999847 |      0 |
...
| 163 | Tensor<[7, 768]> self = ?,<br>Tensor<[768, 2]> mat2 = ?         | Unknown  | Done       | 0.999951 |      0 |
...
| 173 | Tensor<[920, 256]> self = ?,<br>Tensor<[256, 256]> mat2 = ?     | Unknown  | Done       | 0.999976 |      0 |
