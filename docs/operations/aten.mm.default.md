...
|   4 | Tensor<[1, 1000]> self = ?,<br>Tensor<[1000, 512]> mat2 = ?     | Done     | Done       | 0.999971 |      0 |
|   5 | Tensor<[1, 1000]> self = ?,<br>Tensor<[1000, 768]> mat2 = ?     | Done     | Done       | 0.99997  |      0 |
|   6 | Tensor<[1, 1024]> self = ?,<br>Tensor<[1024, 1024]> mat2 = ?    | Unknown  | Done       | 0.999967 |      0 |
|   7 | Tensor<[1, 1024]> self = ?,<br>Tensor<[1024, 3072]> mat2 = ?    | Unknown  | Done       | 0.999964 |      0 |
...
|  10 | Tensor<[1, 1024]> self = ?,<br>Tensor<[1024, 512]> mat2 = ?     | Unknown  | Done       | 0.999965 |      0 |
...
|  13 | Tensor<[1, 128]> self = ?,<br>Tensor<[128, 784]> mat2 = ?       | Done     | Done       | 0.999978 |      0 |
|  14 | Tensor<[1, 128]> self = ?,<br>Tensor<[128, 9216]> mat2 = ?      | Done     | Done       | 0.999982 |      0 |
|  15 | Tensor<[1, 12]> self = ?,<br>Tensor<[12, 3]> mat2 = ?           | Done     | Done       | 0.999985 |      0 |
|  16 | Tensor<[1, 12]> self = ?,<br>Tensor<[12, 64]> mat2 = ?          | Done     | Done       | 0.999991 |      0 |
|  17 | Tensor<[1, 2048]> self = ?,<br>Tensor<[2048, 512]> mat2 = ?     | Unknown  | Done       | 0.999955 |      0 |
|  18 | Tensor<[1, 21843]> self = ?,<br>Tensor<[21843, 768]> mat2 = ?   | Done     | Done       | 0.999553 |      0 |
|  19 | Tensor<[1, 2]> self = ?,<br>Tensor<[2, 512]> mat2 = ?           | Done     | Done       | 0.999992 |      0 |
|  20 | Tensor<[1, 3072]> self = ?,<br>Tensor<[3072, 768]> mat2 = ?     | Unknown  | Done       | 0.99995  |      0 |
|  21 | Tensor<[1, 384]> self = ?,<br>Tensor<[384, 512]> mat2 = ?       | Unknown  | Done       | 0.999974 |      0 |
|  22 | Tensor<[1, 3]> self = ?,<br>Tensor<[3, 12]> mat2 = ?            | Done     | Done       | 0.999998 |      0 |
|  23 | Tensor<[1, 4096]> self = ?,<br>Tensor<[4096, 1024]> mat2 = ?    | Unknown  | Done       | 0.999934 |      0 |
|  24 | Tensor<[1, 512]> self = ?,<br>Tensor<[512, 1024]> mat2 = ?      | Unknown  | Done       | 0.999969 |      0 |
...
|  32 | Tensor<[1, 64]> self = ?,<br>Tensor<[64, 12]> mat2 = ?          | Done     | Done       | 0.999989 |      0 |
...
|  38 | Tensor<[1, 768]> self = ?,<br>Tensor<[768, 768]> mat2 = ?       | Unknown  | Done       | 0.999969 |      0 |
|  39 | Tensor<[1, 784]> self = ?,<br>Tensor<[784, 128]> mat2 = ?       | Done     | Done       | 0.999972 |      0 |
...
|  43 | Tensor<[10, 2048]> self = ?,<br>Tensor<[2048, 512]> mat2 = ?    | Unknown  | Done       | 0.999955 |      0 |
|  44 | Tensor<[10, 3072]> self = ?,<br>Tensor<[3072, 768]> mat2 = ?    | Unknown  | Done       | 0.999943 |      0 |
...
|  65 | Tensor<[128, 16384]> self = ?,<br>Tensor<[16384, 32]> mat2 = ?  | Done     | Done       | 0.999808 |      0 |
...
|  88 | Tensor<[196, 768]> self = ?,<br>Tensor<[768, 3072]> mat2 = ?    | Done     | Done       | 0.999969 |      0 |
|  89 | Tensor<[196, 768]> self = ?,<br>Tensor<[768, 384]> mat2 = ?     | Done     | Done       | 0.999963 |      0 |
|  90 | Tensor<[197, 3072]> self = ?,<br>Tensor<[3072, 768]> mat2 = ?   | Done     | Done       | 0.999945 |      0 |
...
|  93 | Tensor<[2, 1]> self = ?,<br>Tensor<[1, 512]> mat2 = ?           | Done     | Done       | 0.999995 |      0 |
...
|  99 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 12]> mat2 = ?      | Removed  | Done       | 0.999971 |      0 |
...
| 103 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 3]> mat2 = ?       | Removed  | Done       | 0.999969 |      0 |
| 104 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 4]> mat2 = ?       | Removed  | Done       | 0.999973 |      0 |
| 105 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 6]> mat2 = ?       | Removed  | Done       | 0.999974 |      0 |
| 106 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 8]> mat2 = ?       | Removed  | Done       | 0.999974 |      0 |
| 107 | Tensor<[256, 1024]> self = ?,<br>Tensor<[1024, 160]> mat2 = ?   | Done     | Done       | 0.999955 |      0 |
| 108 | Tensor<[256, 1024]> self = ?,<br>Tensor<[1024, 256]> mat2 = ?   | Done     | Done       | 0.999954 |      0 |
...
| 111 | Tensor<[256, 16384]> self = ?,<br>Tensor<[16384, 32]> mat2 = ?  | Done     | Done       | 0.999797 |      0 |
...
| 116 | Tensor<[256, 4096]> self = ?,<br>Tensor<[4096, 64]> mat2 = ?    | Done     | Done       | 0.999843 |      0 |
...
| 120 | Tensor<[256, 768]> self = ?,<br>Tensor<[768, 384]> mat2 = ?     | Done     | Done       | 0.999964 |      0 |
...
| 126 | Tensor<[32, 16384]> self = ?,<br>Tensor<[16384, 128]> mat2 = ?  | Done     | Done       | 0.999794 |      0 |
| 127 | Tensor<[32, 16384]> self = ?,<br>Tensor<[16384, 32]> mat2 = ?   | Done     | Done       | 0.999801 |      0 |
| 128 | Tensor<[32, 256]> self = ?,<br>Tensor<[256, 16384]> mat2 = ?    | Done     | Done       | 0.999975 |      0 |
| 129 | Tensor<[32, 256]> self = ?,<br>Tensor<[256, 32]> mat2 = ?       | Done     | Done       | 0.999979 |      0 |
...
| 136 | Tensor<[45, 768]> self = ?,<br>Tensor<[768, 50257]> mat2 = ?    | Unknown  | Done       | 0.999969 |      0 |
...
| 159 | Tensor<[64, 256]> self = ?,<br>Tensor<[256, 64]> mat2 = ?       | Done     | Done       | 0.999978 |      0 |
| 160 | Tensor<[64, 4096]> self = ?,<br>Tensor<[4096, 256]> mat2 = ?    | Done     | Done       | 0.999844 |      0 |
| 161 | Tensor<[64, 4096]> self = ?,<br>Tensor<[4096, 64]> mat2 = ?     | Done     | Done       | 0.999843 |      0 |
| 162 | Tensor<[640, 1024]> self = ?,<br>Tensor<[1024, 160]> mat2 = ?   | Done     | Done       | 0.999966 |      0 |
| 163 | Tensor<[7, 768]> self = ?,<br>Tensor<[768, 2]> mat2 = ?         | Done     | Done       | 0.999977 |      0 |
