...
|  18 | Tensor<[1, 21843]> self = ?,<br>Tensor<[21843, 768]> mat2 = ?   | Done     | Done       | 0.999545 |      0 |
|  19 | Tensor<[1, 2]> self = ?,<br>Tensor<[2, 512]> mat2 = ?           | Done     | Done       | 0.999996 |      0 |
|  20 | Tensor<[1, 3072]> self = ?,<br>Tensor<[3072, 768]> mat2 = ?     | Unknown  | Done       | 0.999942 |      0 |
|  21 | Tensor<[1, 384]> self = ?,<br>Tensor<[384, 512]> mat2 = ?       | Unknown  | Done       | 0.999972 |      0 |
|  22 | Tensor<[1, 3]> self = ?,<br>Tensor<[3, 12]> mat2 = ?            | Done     | Done       | 0.99997  |      0 |
...
|  32 | Tensor<[1, 64]> self = ?,<br>Tensor<[64, 12]> mat2 = ?          | Done     | Done       | 0.99998  |      0 |
...
|  39 | Tensor<[1, 784]> self = ?,<br>Tensor<[784, 128]> mat2 = ?       | Done     | Done       | 0.999975 |      0 |
...
|  69 | Tensor<[14, 2048]> self = ?,<br>Tensor<[2048, 512]> mat2 = ?    | Done     | Done       | 0.999953 |      0 |
...
|  94 | Tensor<[2, 1]> self = ?,<br>Tensor<[1, 512]> mat2 = ?           | Done     | Done       | 0.999994 |      0 |
...
| 104 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 3]> mat2 = ?       | Done     | Done       | 0.999969 |      0 |
| 105 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 4]> mat2 = ?       | Done     | Done       | 0.999971 |      0 |
| 106 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 6]> mat2 = ?       | Done     | Done       | 0.999972 |      0 |
| 107 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 8]> mat2 = ?       | Done     | Done       | 0.999972 |      0 |
...
| 112 | Tensor<[256, 16384]> self = ?,<br>Tensor<[16384, 32]> mat2 = ?  | Done     | Done       | 0.999799 |      0 |
...
| 122 | Tensor<[3, 1]> self = ?,<br>Tensor<[1, 12]> mat2 = ?            | Done     | Done       | 0.999999 |      0 |
...
| 128 | Tensor<[32, 16384]> self = ?,<br>Tensor<[16384, 32]> mat2 = ?   | Done     | Done       | 0.999796 |      0 |
| 129 | Tensor<[32, 256]> self = ?,<br>Tensor<[256, 16384]> mat2 = ?    | Done     | Done       | 0.999975 |      0 |
| 130 | Tensor<[32, 256]> self = ?,<br>Tensor<[256, 32]> mat2 = ?       | Done     | Done       | 0.999976 |      0 |
...
| 133 | Tensor<[4, 768]> self = ?,<br>Tensor<[768, 768]> mat2 = ?       | Unknown  | Done       | 0.999969 |      0 |
...
| 144 | Tensor<[50, 768]> self = ?,<br>Tensor<[768, 3072]> mat2 = ?     | Done     | Done       | 0.999968 |      0 |
...
| 153 | Tensor<[59, 512]> self = ?,<br>Tensor<[512, 1024]> mat2 = ?     | Unknown  | Done       | 0.999972 |      0 |
...
| 157 | Tensor<[64, 1]> self = ?,<br>Tensor<[1, 12]> mat2 = ?           | Done     | Done       | 0.999995 |      0 |
| 158 | Tensor<[64, 2048]> self = ?,<br>Tensor<[2048, 1024]> mat2 = ?   | Done     | Done       | 0.999956 |      0 |
...
| 161 | Tensor<[64, 4096]> self = ?,<br>Tensor<[4096, 256]> mat2 = ?    | Done     | Done       | 0.999841 |      0 |
| 162 | Tensor<[64, 4096]> self = ?,<br>Tensor<[4096, 64]> mat2 = ?     | Done     | Done       | 0.999838 |      0 |
| 163 | Tensor<[640, 1024]> self = ?,<br>Tensor<[1024, 160]> mat2 = ?   | Done     | Done       | 0.999966 |      0 |
| 164 | Tensor<[7, 768]> self = ?,<br>Tensor<[768, 2]> mat2 = ?         | Done     | Done       | 0.999963 |      0 |
