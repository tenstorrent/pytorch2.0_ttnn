...
|  42 | Tensor<[1, 12, 16, 16]> self = ?                                                                  | Done     |
...
|  72 | Tensor<[1, 14, 14, 2048]> self = ?                                                                | Done     |
...
|  79 | Tensor<[1, 15, 1024]> self = ?                                                                    | Done     |
|  80 | Tensor<[1, 15, 512]> self = ?                                                                     | Done     |
|  81 | Tensor<[1, 15, 6, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format         | Done     |
...
|  91 | Tensor<[1, 16, 10, 10]> self = ?                                                                  | Done     |
|  92 | Tensor<[1, 16, 12, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
|  93 | Tensor<[1, 16, 16, 1536]> self = ?                                                                | Done     |
|  94 | Tensor<[1, 16, 16, 16, 16, 3]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Done     |
|  95 | Tensor<[1, 16, 16, 2048]> self = ?                                                                | Done     |
|  96 | Tensor<[1, 16, 16, 384]> self = ?                                                                 | Done     |
|  97 | Tensor<[1, 16, 16, 512]> self = ?                                                                 | Done     |
...
| 109 | Tensor<[1, 19, 1024]> self = ?                                                                    | Done     |
...
| 129 | Tensor<[1, 2, 2, 8, 8, 384]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format   | Done     |
| 130 | Tensor<[1, 2, 2, 8, 8, 512]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format   | Done     |
...
| 135 | Tensor<[1, 2, 8, 2, 8, 384]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format   | Done     |
| 136 | Tensor<[1, 2, 8, 2, 8, 512]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format   | Done     |
...
| 146 | Tensor<[1, 24, 64, 64]> self = ?                                                                  | Done     |
...
| 163 | Tensor<[1, 256, 98]> self = ?                                                                     | Unknown  |
...
| 183 | Tensor<[1, 32, 16, 96]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 184 | Tensor<[1, 32, 32, 1024]> self = ?                                                                | Done     |
| 185 | Tensor<[1, 32, 32, 192]> self = ?                                                                 | Done     |
| 186 | Tensor<[1, 32, 32, 256]> self = ?                                                                 | Done     |
| 187 | Tensor<[1, 32, 32, 768]> self = ?                                                                 | Done     |
| 188 | Tensor<[1, 32, 49, 49]> self = ?                                                                  | Done     |
| 189 | Tensor<[1, 32, 64, 64]> self = ?                                                                  | Done     |
...
| 198 | Tensor<[1, 4, 4, 8, 8, 192]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format   | Done     |
| 199 | Tensor<[1, 4, 4, 8, 8, 256]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format   | Done     |
...
| 203 | Tensor<[1, 4, 8, 4, 8, 192]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format   | Done     |
| 204 | Tensor<[1, 4, 8, 4, 8, 256]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format   | Done     |
...
| 220 | Tensor<[1, 5, 1, 16, 2]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format       | Unknown  |
...
| 248 | Tensor<[1, 6, 15, 15]> self = ?                                                                   | Done     |
| 249 | Tensor<[1, 64, 1024]> self = ?                                                                    | Done     |
...
| 253 | Tensor<[1, 64, 24, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 254 | Tensor<[1, 64, 32, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 255 | Tensor<[1, 64, 5120]> self = ?                                                                    | Done     |
| 256 | Tensor<[1, 64, 64, 128]> self = ?                                                                 | Done     |
| 257 | Tensor<[1, 64, 64, 384]> self = ?                                                                 | Done     |
| 258 | Tensor<[1, 64, 64, 512]> self = ?                                                                 | Done     |
| 259 | Tensor<[1, 64, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 260 | Tensor<[1, 64, 64, 96]> self = ?                                                                  | Done     |
| 261 | Tensor<[1, 64, 768]> self = ?                                                                     | Done     |
...
| 283 | Tensor<[1, 8, 10, 10]> self = ?                                                                   | Done     |
...
| 291 | Tensor<[1, 8, 8, 1024]> self = ?                                                                  | Done     |
| 292 | Tensor<[1, 8, 8, 3072]> self = ?                                                                  | Done     |
| 293 | Tensor<[1, 8, 8, 4096]> self = ?                                                                  | Done     |
| 294 | Tensor<[1, 8, 8, 7, 7, 128]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format   | Done     |
| 295 | Tensor<[1, 8, 8, 7, 7, 96]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format    | Done     |
| 296 | Tensor<[1, 8, 8, 768]> self = ?                                                                   | Done     |
| 297 | Tensor<[1, 8, 8, 8, 8, 128]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format   | Done     |
| 298 | Tensor<[1, 8, 8, 8, 8, 96]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format    | Done     |
| 299 | Tensor<[1, 80, 98]> self = ?                                                                      | Unknown  |
...
| 327 | Tensor<[12, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format           | Done     |
...
| 340 | Tensor<[16, 6, 32, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 341 | Tensor<[16, 6, 49, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 342 | Tensor<[16, 6, 49, 49]> self = ?                                                                  | Done     |
| 343 | Tensor<[16, 6, 64, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 344 | Tensor<[16, 6, 64, 64]> self = ?                                                                  | Done     |
| 345 | Tensor<[16, 64, 192]> self = ?                                                                    | Done     |
| 346 | Tensor<[16, 64, 256]> self = ?                                                                    | Done     |
| 347 | Tensor<[16, 64, 6, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 348 | Tensor<[16, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format           | Done     |
| 349 | Tensor<[16, 64, 8, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 350 | Tensor<[16, 7, 7]> self = ?                                                                       | Done     |
| 351 | Tensor<[16, 8, 32, 49]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 352 | Tensor<[16, 8, 32, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 353 | Tensor<[16, 8, 49, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 354 | Tensor<[16, 8, 49, 49]> self = ?                                                                  | Done     |
| 355 | Tensor<[16, 8, 64, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 356 | Tensor<[16, 8, 64, 64]> self = ?                                                                  | Done     |
...
| 359 | Tensor<[2, 2, 8, 8]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format           | Done     |
...
| 365 | Tensor<[24, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format           | Done     |
...
| 368 | Tensor<[3, 197, 1, 1024]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Done     |
...
| 374 | Tensor<[3, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format            | Done     |
| 375 | Tensor<[32, 49, 49]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format           | Done     |
| 376 | Tensor<[32, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format           | Done     |
...
| 379 | Tensor<[4, 12, 32, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 380 | Tensor<[4, 12, 49, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 381 | Tensor<[4, 12, 49, 49]> self = ?                                                                  | Done     |
| 382 | Tensor<[4, 12, 64, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 383 | Tensor<[4, 12, 64, 64]> self = ?                                                                  | Done     |
| 384 | Tensor<[4, 16, 32, 49]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 385 | Tensor<[4, 16, 32, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 386 | Tensor<[4, 16, 49, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 387 | Tensor<[4, 16, 49, 49]> self = ?                                                                  | Done     |
| 388 | Tensor<[4, 16, 64, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 389 | Tensor<[4, 16, 64, 64]> self = ?                                                                  | Done     |
| 390 | Tensor<[4, 4, 7, 7]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format           | Done     |
| 391 | Tensor<[4, 4, 8, 8]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format           | Done     |
...
| 397 | Tensor<[4, 64, 12, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 398 | Tensor<[4, 64, 16, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 399 | Tensor<[4, 64, 384]> self = ?                                                                     | Done     |
| 400 | Tensor<[4, 64, 512]> self = ?                                                                     | Done     |
| 401 | Tensor<[4, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format            | Done     |
...
| 405 | Tensor<[6, 49, 49]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format            | Done     |
| 406 | Tensor<[6, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format            | Done     |
| 407 | Tensor<[64, 3, 32, 49]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 408 | Tensor<[64, 3, 32, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 409 | Tensor<[64, 3, 49, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 410 | Tensor<[64, 3, 49, 49]> self = ?                                                                  | Done     |
| 411 | Tensor<[64, 3, 64, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 412 | Tensor<[64, 3, 64, 64]> self = ?                                                                  | Done     |
| 413 | Tensor<[64, 4, 32, 49]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 414 | Tensor<[64, 4, 32, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 415 | Tensor<[64, 4, 49, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 416 | Tensor<[64, 4, 49, 49]> self = ?                                                                  | Done     |
| 417 | Tensor<[64, 4, 64, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 418 | Tensor<[64, 4, 64, 64]> self = ?                                                                  | Done     |
...
| 423 | Tensor<[64, 64, 128]> self = ?                                                                    | Done     |
| 424 | Tensor<[64, 64, 3, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 425 | Tensor<[64, 64, 4, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     |
| 426 | Tensor<[64, 64, 96]> self = ?                                                                     | Done     |
...
| 429 | Tensor<[8, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format            | Done     |
| 430 | Tensor<[8, 8, 7, 7]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format           | Done     |
| 431 | Tensor<[8, 8, 8, 8]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format           | Done     |
