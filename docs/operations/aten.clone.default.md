...
|  27 | Tensor<[1, 1024, 512]> self = ?                                                                   | Fallback | Done       | True  |
|  28 | Tensor<[1, 1024, 640]> self = ?                                                                   | Done     | Done       | True  |
|  29 | Tensor<[1, 1024]> self = ?                                                                        | Done     | Done       | True  |
|  30 | Tensor<[1, 112, 14, 14]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format       | Fallback | Done       | True  |
...
|  42 | Tensor<[1, 12, 1500, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Fallback | Done       | True  |
|  43 | Tensor<[1, 12, 16, 16]> self = ?                                                                  | Done     | Done       | True  |
|  44 | Tensor<[1, 12, 197, 197]> self = ?                                                                | Fallback | Done       | True  |
...
|  49 | Tensor<[1, 12, 50, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Fallback | Done       | True  |
|  50 | Tensor<[1, 12, 7, 7]> self = ?                                                                    | Unknown  | Done       | True  |
...
|  56 | Tensor<[1, 128, 60, 80]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format       | Fallback | Done       | True  |
...
| 155 | Tensor<[1, 256, 16, 16]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format       | Fallback | Done       | True  |
| 156 | Tensor<[1, 256, 16, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format       | Done     | Done       | True  |
| 157 | Tensor<[1, 256, 2, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Unknown  | Done       | True  |
| 158 | Tensor<[1, 256, 256]> self = ?                                                                    | Done     | Done       | True  |
| 159 | Tensor<[1, 256, 5, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Unknown  | Done       | True  |
...
| 164 | Tensor<[1, 256]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format               | Fallback | Done       | True  |
...
| 171 | Tensor<[1, 3, 16, 16, 16, 16]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Unknown  | Done       | True  |
| 172 | Tensor<[1, 3, 3, 4, 4]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     | Done       | True  |
| 173 | Tensor<[1, 3, 3, 4, 91]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format       | Done     | Done       | True  |
| 174 | Tensor<[1, 3, 3, 6, 4]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Done     | Done       | True  |
| 175 | Tensor<[1, 3, 3, 6, 91]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format       | Done     | Done       | True  |
...
| 179 | Tensor<[1, 32, 128, 128]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Fallback | Done       | True  |
...
| 188 | Tensor<[1, 320, 30, 40]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format       | Fallback | Done       | True  |
...
| 258 | Tensor<[1, 64, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Fallback | Done       | True  |
...
| 306 | Tensor<[10, 10]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format               | Done     | Done       | True  |
| 307 | Tensor<[100, 1, 2048]> self = ?                                                                   | Done     | Done       | True  |
| 308 | Tensor<[100, 1, 256]> self = ?                                                                    | Done     | Done       | True  |
| 309 | Tensor<[100, 136]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format             | None     | Done       | True  |
...
| 316 | Tensor<[13, 17]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format               | None     | Done       | True  |
...
| 326 | Tensor<[16, 59, 59]> self = ?                                                                     | Done     | Done       | True  |
...
| 345 | Tensor<[19, 19]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format               | Done     | Done       | True  |
...
| 348 | Tensor<[2, 2]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format                 | Done     | Done       | True  |
| 349 | Tensor<[2, 7, 512]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format            | Done     | Done       | True  |
| 350 | Tensor<[2, 7, 8, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format          | Done     | Done       | True  |
| 351 | Tensor<[2, 8, 7, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format          | Fallback | Done       | True  |
| 352 | Tensor<[20, 20]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format               | Done     | Done       | True  |
...
| 355 | Tensor<[25, 34]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format               | None     | Done       | True  |
| 356 | Tensor<[3, 1370, 1, 1280]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format     | Fallback | Done       | True  |
| 357 | Tensor<[3, 197, 1, 1024]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Fallback | Done       | True  |
| 358 | Tensor<[3, 197, 1, 768]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format       | Fallback | Done       | True  |
| 359 | Tensor<[3, 3]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format                 | Done     | Done       | True  |
| 360 | Tensor<[3, 49, 49]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format            | Done     | Done       | True  |
| 361 | Tensor<[3, 50, 1, 1024]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format       | Fallback | Done       | True  |
| 362 | Tensor<[3, 50, 1, 768]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format        | Fallback | Done       | True  |
...
| 366 | Tensor<[38, 38]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format               | Done     | Done       | True  |
...
| 391 | Tensor<[5, 5]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format                 | Done     | Done       | True  |
| 392 | Tensor<[50, 68]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format               | None     | Done       | True  |
| 393 | Tensor<[59, 1024]> self = ?                                                                       | Done     | Done       | True  |
...
| 416 | Tensor<[7, 9]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format                 | None     | Done       | True  |
