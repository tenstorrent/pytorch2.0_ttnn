...
|  83 | Tensor<[1, 1280, 1, 1]> self = ?,<br>List[int] size = [1, 1280, 12, 12]           | None     | Fallback   | 1.0   | -1     |
...
|  87 | Tensor<[1, 136]> self = ?,<br>List[int] size = [100, 136]                         | Done     | Done       | 1.0   | 0      |
...
| 122 | Tensor<[1, 17]> self = ?,<br>List[int] size = [13, 17]                            | Done     | Done       | 1.0   | 0      |
...
| 156 | Tensor<[1, 34]> self = ?,<br>List[int] size = [25, 34]                            | Done     | Done       | 1.0   | 0      |
| 157 | Tensor<[1, 38]> self = ?,<br>List[int] size = [38, 38]                            | Done     | Done       | 1.0   | 0      |
| 158 | Tensor<[1, 3]> self = ?,<br>List[int] size = [3, 3]                               | Done     | Done       | 1.0   | 0      |
...
| 172 | Tensor<[1, 5]> self = ?,<br>List[int] size = [5, 5]                               | Done     | Done       | 1.0   | 0      |
...
| 196 | Tensor<[1, 68]> self = ?,<br>List[int] size = [50, 68]                            | Done     | Done       | 1.0   | 0      |
...
| 226 | Tensor<[1, 9]> self = ?,<br>List[int] size = [7, 9]                               | Done     | Done       | 1.0   | 0      |
| 227 | Tensor<[10, 1]> self = ?,<br>List[int] size = [10, 10]                            | None     | Fallback   | 1.0   | -1     |
| 228 | Tensor<[100, 1]> self = ?,<br>List[int] size = [100, 136]                         | None     | Fallback   | 1.0   | -1     |
| 229 | Tensor<[12, 1]> self = ?,<br>List[int] size = [12, 16]                            | None     | Fallback   | 1.0   | -1     |
| 230 | Tensor<[13, 1]> self = ?,<br>List[int] size = [13, 17]                            | None     | Fallback   | 1.0   | -1     |
...
| 245 | Tensor<[19, 1]> self = ?,<br>List[int] size = [19, 19]                            | None     | Fallback   | 1.0   | -1     |
| 246 | Tensor<[2, 1, 1, 7]> self = ?,<br>List[int] size = [2, 1, 7, 7]                   | Done     | Done       | 1.0   | 0      |
| 247 | Tensor<[2, 1]> self = ?,<br>List[int] size = [2, 2]                               | None     | Fallback   | 1.0   | -1     |
| 248 | Tensor<[20, 1]> self = ?,<br>List[int] size = [20, 20]                            | None     | Fallback   | 1.0   | -1     |
...
| 252 | Tensor<[25, 1]> self = ?,<br>List[int] size = [25, 34]                            | None     | Fallback   | 1.0   | -1     |
| 253 | Tensor<[256, 1280]> self = ?,<br>List[int] size = [1, -1, -1]                     | Done     | Done       | 1.0   | -1     |
| 254 | Tensor<[3, 1]> self = ?,<br>List[int] size = [3, 3]                               | None     | Fallback   | 1.0   | -1     |
| 255 | Tensor<[38, 1]> self = ?,<br>List[int] size = [38, 38]                            | None     | Fallback   | 1.0   | -1     |
...
| 270 | Tensor<[5, 1]> self = ?,<br>List[int] size = [5, 5]                               | None     | Fallback   | 1.0   | -1     |
| 271 | Tensor<[50, 1]> self = ?,<br>List[int] size = [50, 68]                            | None     | Fallback   | 1.0   | -1     |
...
| 286 | Tensor<[7, 1]> self = ?,<br>List[int] size = [7, 9]                               | None     | Fallback   | 1.0   | -1     |
