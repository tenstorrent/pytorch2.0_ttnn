...
|   2 | Tensor<[1, 1, 1, 19]> self = ?,<br>List[int] size = [1, 1, 19, 19]                | Done     | Done       | 1.0   | -1     |
|   3 | Tensor<[1, 1, 1, 24]> self = ?,<br>List[int] size = [1, 1, 1, 24]                 | Removed  | Done       | 1.0   | -1     |
|   4 | Tensor<[1, 1, 1, 24]> self = ?,<br>List[int] size = [1, 1, 24, 24]                | Done     | Done       | 1.0   | -1     |
|   5 | Tensor<[1, 1, 1, 32]> self = ?,<br>List[int] size = [1, 1, 32, 32]                | Done     | Done       | 1.0   | -1     |
...
|  11 | Tensor<[1, 1, 1, 920]> self = ?,<br>List[int] size = [-1, 8, -1, -1]              | Unknown  | Done       | 1.0   | -1     |
...
|  18 | Tensor<[1, 1, 19200, 300]> self = ?,<br>List[int] size = [1, 1, 19200, 300]       | Unknown  | Done       | 1.0   | -1     |
|  19 | Tensor<[1, 1, 19200, 64]> self = ?,<br>List[int] size = [1, 1, 19200, 64]         | Unknown  | Done       | 1.0   | -1     |
...
|  22 | Tensor<[1, 1, 300, 64]> self = ?,<br>List[int] size = [1, 1, 300, 64]             | Unknown  | Done       | 1.0   | -1     |
...
|  26 | Tensor<[1, 1, 38, 38]> self = ?,<br>List[int] size = [1, 512, 38, 38]             | Unknown  | Done       | 1.0   | -1     |
...
|  32 | Tensor<[1, 1, 7, 7]> self = ?,<br>List[int] size = [2, 1, 7, 7]                   | Done     | Done       | 1.0   | -1     |
|  33 | Tensor<[1, 1, 768]> self = ?,<br>List[int] size = [1, -1, -1]                     | Removed  | Done       | 1.0   | -1     |
|  34 | Tensor<[1, 1, 768]> self = ?,<br>List[int] size = [1, 196, 768]                   | Done     | Done       | 1.0   | -1     |
|  35 | Tensor<[1, 100, 192]> self = ?,<br>List[int] size = [1, -1, -1]                   | Removed  | Done       | 1.0   | -1     |
|  36 | Tensor<[1, 1024, 1, 1]> self = ?,<br>List[int] size = [1, 1024, 7, 7]             | Done     | Done       | 1.0   | -1     |
|  37 | Tensor<[1, 10]> self = ?,<br>List[int] size = [1, 10]                             | Removed  | Done       | 1.0   | -1     |
|  38 | Tensor<[1, 10]> self = ?,<br>List[int] size = [10, 10]                            | Done     | Done       | 1.0   | -1     |
...
|  85 | Tensor<[1, 120, 1, 1]> self = ?,<br>List[int] size = [1, 120, 28, 28]             | Done     | Done       | 1.0   | -1     |
|  86 | Tensor<[1, 1280, 1, 1]> self = ?,<br>List[int] size = [1, 1280, 10, 10]           | Done     | Done       | 1.0   | -1     |
|  87 | Tensor<[1, 1280, 1, 1]> self = ?,<br>List[int] size = [1, 1280, 12, 12]           | Unknown  | Done       | 1.0   | -1     |
|  88 | Tensor<[1, 1280, 1, 1]> self = ?,<br>List[int] size = [1, 1280, 7, 7]             | Done     | Done       | 1.0   | -1     |
|  89 | Tensor<[1, 1280, 1, 1]> self = ?,<br>List[int] size = [1, 1280, 8, 8]             | Done     | Done       | 1.0   | -1     |
|  90 | Tensor<[1, 1280, 1, 1]> self = ?,<br>List[int] size = [1, 1280, 9, 9]             | Done     | Done       | 1.0   | -1     |
|  91 | Tensor<[1, 1536, 1, 1]> self = ?,<br>List[int] size = [1, 1536, 8, 8]             | Unknown  | Done       | 1.0   | -1     |
...
| 103 | Tensor<[1, 16, 256, 256]> self = ?,<br>List[int] size = [1, 16, 256, 256]         | Removed  | Done       | 1.0   | -1     |
| 104 | Tensor<[1, 16, 256, 64]> self = ?,<br>List[int] size = [1, 16, 256, 64]           | Removed  | Done       | 1.0   | -1     |
...
| 122 | Tensor<[1, 19]> self = ?,<br>List[int] size = [19, 19]                            | Unknown  | Done       | 1.0   | -1     |
| 123 | Tensor<[1, 1]> self = ?,<br>List[int] size = [1, 1]                               | Removed  | Done       | 1.0   | -1     |
| 124 | Tensor<[1, 2, 256, 32]> self = ?,<br>List[int] size = [1, 2, 256, 32]             | Removed  | Done       | 1.0   | -1     |
| 125 | Tensor<[1, 2, 300, 64]> self = ?,<br>List[int] size = [1, 2, 300, 64]             | Unknown  | Done       | 1.0   | -1     |
| 126 | Tensor<[1, 2, 32, 256]> self = ?,<br>List[int] size = [1, 2, 32, 256]             | Removed  | Done       | 1.0   | -1     |
| 127 | Tensor<[1, 2, 4096, 256]> self = ?,<br>List[int] size = [1, 2, 4096, 256]         | Removed  | Done       | 1.0   | -1     |
| 128 | Tensor<[1, 2, 4096, 32]> self = ?,<br>List[int] size = [1, 2, 4096, 32]           | Removed  | Done       | 1.0   | -1     |
| 129 | Tensor<[1, 2, 4800, 300]> self = ?,<br>List[int] size = [1, 2, 4800, 300]         | Unknown  | Done       | 1.0   | -1     |
| 130 | Tensor<[1, 2, 4800, 64]> self = ?,<br>List[int] size = [1, 2, 4800, 64]           | Unknown  | Done       | 1.0   | -1     |
| 131 | Tensor<[1, 2, 64, 300]> self = ?,<br>List[int] size = [1, 2, 64, 300]             | Unknown  | Done       | 1.0   | -1     |
| 132 | Tensor<[1, 2048, 1, 1]> self = ?,<br>List[int] size = [1, 2048, 10, 10]           | Unknown  | Done       | 1.0   | -1     |
| 133 | Tensor<[1, 2048, 1, 1]> self = ?,<br>List[int] size = [1, 2048, 7, 7]             | Done     | Done       | 1.0   | -1     |
| 134 | Tensor<[1, 20]> self = ?,<br>List[int] size = [20, 20]                            | Done     | Done       | 1.0   | -1     |
| 135 | Tensor<[1, 24, 32, 49]> self = ?,<br>List[int] size = [1, 24, 32, 49]             | Removed  | Done       | 1.0   | -1     |
| 136 | Tensor<[1, 24, 32, 64]> self = ?,<br>List[int] size = [1, 24, 32, 64]             | Removed  | Done       | 1.0   | -1     |
| 137 | Tensor<[1, 24, 49, 32]> self = ?,<br>List[int] size = [1, 24, 49, 32]             | Removed  | Done       | 1.0   | -1     |
| 138 | Tensor<[1, 24, 49, 49]> self = ?,<br>List[int] size = [1, 24, 49, 49]             | Removed  | Done       | 1.0   | -1     |
| 139 | Tensor<[1, 24, 64, 1]> self = ?,<br>List[int] size = [1, 24, 64, 32]              | Done     | Done       | 1.0   | -1     |
| 140 | Tensor<[1, 24, 64, 32]> self = ?,<br>List[int] size = [1, 24, 64, 32]             | Removed  | Done       | 1.0   | -1     |
| 141 | Tensor<[1, 24, 64, 64]> self = ?,<br>List[int] size = [1, 24, 64, 64]             | Removed  | Done       | 1.0   | -1     |
| 142 | Tensor<[1, 256, 1, 1]> self = ?,<br>List[int] size = [1, 256, 56, 56]             | Done     | Done       | 1.0   | -1     |
| 143 | Tensor<[1, 25]> self = ?,<br>List[int] size = [1, 25]                             | Removed  | Done       | 1.0   | -1     |
| 144 | Tensor<[1, 2]> self = ?,<br>List[int] size = [2, 2]                               | Done     | Done       | 1.0   | -1     |
| 145 | Tensor<[1, 3, 1445, 1445]> self = ?,<br>List[int] size = [1, 3, 1445, 1445]       | Removed  | Done       | 1.0   | -1     |
| 146 | Tensor<[1, 3, 1445, 64]> self = ?,<br>List[int] size = [1, 3, 1445, 64]           | Removed  | Done       | 1.0   | -1     |
| 147 | Tensor<[1, 3, 64, 1445]> self = ?,<br>List[int] size = [1, 3, 64, 1445]           | Removed  | Done       | 1.0   | -1     |
...
| 152 | Tensor<[1, 32, 64, 1]> self = ?,<br>List[int] size = [1, 32, 64, 32]              | Done     | Done       | 1.0   | -1     |
...
| 155 | Tensor<[1, 38]> self = ?,<br>List[int] size = [38, 38]                            | Unknown  | Done       | 1.0   | -1     |
| 156 | Tensor<[1, 3]> self = ?,<br>List[int] size = [3, 3]                               | Done     | Done       | 1.0   | -1     |
| 157 | Tensor<[1, 480, 1, 1]> self = ?,<br>List[int] size = [1, 480, 14, 14]             | Done     | Done       | 1.0   | -1     |
| 158 | Tensor<[1, 5, 1, 16, 1]> self = ?,<br>List[int] size = [1, 5, 1, 16, 2]           | Unknown  | Done       | 1.0   | -1     |
...
| 161 | Tensor<[1, 5, 1200, 300]> self = ?,<br>List[int] size = [1, 5, 1200, 300]         | Unknown  | Done       | 1.0   | -1     |
| 162 | Tensor<[1, 5, 1200, 64]> self = ?,<br>List[int] size = [1, 5, 1200, 64]           | Unknown  | Done       | 1.0   | -1     |
| 163 | Tensor<[1, 5, 256, 32]> self = ?,<br>List[int] size = [1, 5, 256, 32]             | Removed  | Done       | 1.0   | -1     |
| 164 | Tensor<[1, 5, 300, 64]> self = ?,<br>List[int] size = [1, 5, 300, 64]             | Unknown  | Done       | 1.0   | -1     |
| 165 | Tensor<[1, 5, 32, 256]> self = ?,<br>List[int] size = [1, 5, 32, 256]             | Removed  | Done       | 1.0   | -1     |
| 166 | Tensor<[1, 5, 64, 300]> self = ?,<br>List[int] size = [1, 5, 64, 300]             | Unknown  | Done       | 1.0   | -1     |
| 167 | Tensor<[1, 512, 1, 1]> self = ?,<br>List[int] size = [1, 512, 28, 28]             | Done     | Done       | 1.0   | -1     |
| 168 | Tensor<[1, 512, 1, 1]> self = ?,<br>List[int] size = [1, 512, 7, 7]               | Done     | Done       | 1.0   | -1     |
| 169 | Tensor<[1, 512, 1]> self = ?,<br>List[int] size = [1, 512, 256]                   | Done     | Done       | 1.0   | -1     |
| 170 | Tensor<[1, 5]> self = ?,<br>List[int] size = [5, 5]                               | Done     | Done       | 1.0   | -1     |
...
| 192 | Tensor<[1, 672, 1, 1]> self = ?,<br>List[int] size = [1, 672, 14, 14]             | Done     | Done       | 1.0   | -1     |
| 193 | Tensor<[1, 672, 1, 1]> self = ?,<br>List[int] size = [1, 672, 7, 7]               | Done     | Done       | 1.0   | -1     |
| 194 | Tensor<[1, 72, 1, 1]> self = ?,<br>List[int] size = [1, 72, 28, 28]               | Done     | Done       | 1.0   | -1     |
| 195 | Tensor<[1, 768, 1, 1]> self = ?,<br>List[int] size = [1, 768, 14, 14]             | Done     | Done       | 1.0   | -1     |
...
| 212 | Tensor<[1, 8, 300, 300]> self = ?,<br>List[int] size = [1, 8, 300, 300]           | Unknown  | Done       | 1.0   | -1     |
| 213 | Tensor<[1, 8, 300, 64]> self = ?,<br>List[int] size = [1, 8, 300, 64]             | Unknown  | Done       | 1.0   | -1     |
...
| 219 | Tensor<[1, 8, 64, 300]> self = ?,<br>List[int] size = [1, 8, 64, 300]             | Unknown  | Done       | 1.0   | -1     |
...
| 222 | Tensor<[1, 960, 1, 1]> self = ?,<br>List[int] size = [1, 960, 7, 7]               | Done     | Done       | 1.0   | -1     |
| 223 | Tensor<[10, 1]> self = ?,<br>List[int] size = [10, 10]                            | Done     | Done       | 1.0   | -1     |
| 224 | Tensor<[12, 1]> self = ?,<br>List[int] size = [12, 16]                            | Done     | Done       | 1.0   | -1     |
...
| 229 | Tensor<[16, 6, 64, 1]> self = ?,<br>List[int] size = [16, 6, 64, 32]              | Done     | Done       | 1.0   | -1     |
...
| 236 | Tensor<[16, 8, 64, 1]> self = ?,<br>List[int] size = [16, 8, 64, 32]              | Done     | Done       | 1.0   | -1     |
...
| 239 | Tensor<[19, 1]> self = ?,<br>List[int] size = [19, 19]                            | Unknown  | Done       | 1.0   | -1     |
| 240 | Tensor<[2, 1, 1, 7]> self = ?,<br>List[int] size = [2, 1, 7, 7]                   | Done     | Done       | 1.0   | -1     |
| 241 | Tensor<[2, 1]> self = ?,<br>List[int] size = [2, 2]                               | Done     | Done       | 1.0   | -1     |
| 242 | Tensor<[20, 1]> self = ?,<br>List[int] size = [20, 20]                            | Done     | Done       | 1.0   | -1     |
| 243 | Tensor<[2048, 768]> self = ?,<br>List[int] size = [1, -1, -1]                     | Done     | Done       | 1.0   | -1     |
...
| 246 | Tensor<[256, 1280]> self = ?,<br>List[int] size = [1, -1, -1]                     | Done     | Done       | 1.0   | -1     |
| 247 | Tensor<[3, 1]> self = ?,<br>List[int] size = [3, 3]                               | Done     | Done       | 1.0   | -1     |
| 248 | Tensor<[38, 1]> self = ?,<br>List[int] size = [38, 38]                            | Unknown  | Done       | 1.0   | -1     |
...
| 253 | Tensor<[4, 12, 64, 1]> self = ?,<br>List[int] size = [4, 12, 64, 32]              | Done     | Done       | 1.0   | -1     |
...
| 260 | Tensor<[4, 16, 64, 1]> self = ?,<br>List[int] size = [4, 16, 64, 32]              | Done     | Done       | 1.0   | -1     |
...
| 263 | Tensor<[5, 1]> self = ?,<br>List[int] size = [5, 5]                               | Done     | Done       | 1.0   | -1     |
...
| 268 | Tensor<[64, 3, 64, 1]> self = ?,<br>List[int] size = [64, 3, 64, 32]              | Done     | Done       | 1.0   | -1     |
...
| 275 | Tensor<[64, 4, 64, 1]> self = ?,<br>List[int] size = [64, 4, 64, 32]              | Done     | Done       | 1.0   | -1     |
...
| 278 | Tensor<[768]> self = ?,<br>List[int] size = [1, 1, -1]                            | Done     | Done       | 1.0   | -1     |
