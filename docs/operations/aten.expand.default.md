...
|  20 | Tensor<[1, 1, 192]> self = ?,<br>List[int]<> size = [1, -1, -1]                                 | Unknown  |
...
|  24 | Tensor<[1, 1, 32, 32]> self = ?,<br>List[int]<> size = [1, 1, 32, 32]                           | Unknown  |
...
|  34 | Tensor<[1, 1, 7, 7]> self = ?,<br>List[int]<> size = [2, 1, 7, 7]                               | Unknown  |
|  35 | Tensor<[1, 1, 768]> self = ?,<br>List[int]<> size = [1, -1, -1]                                 | Unknown  |
|  36 | Tensor<[1, 100, 192]> self = ?,<br>List[int]<> size = [1, -1, -1]                               | Unknown  |
|  37 | Tensor<[1, 10]> self = ?,<br>List[int]<> size = [1, 10]                                         | Unknown  |
|  38 | Tensor<[1, 10]> self = ?,<br>List[int]<> size = [10, 10]                                        | Unknown  |
...
| 124 | Tensor<[1, 19]> self = ?,<br>List[int]<> size = [19, 19]                                        | Unknown  |
| 125 | Tensor<[1, 1]> self = ?,<br>List[int]<> size = [1, 1]                                           | Unknown  |
...
| 135 | Tensor<[1, 20]> self = ?,<br>List[int]<> size = [20, 20]                                        | Unknown  |
...
| 144 | Tensor<[1, 2]> self = ?,<br>List[int]<> size = [2, 2]                                           | Unknown  |
| 145 | Tensor<[1, 3, 1445, 1445]> self = ?,<br>List[int]<> size = [1, 3, 1445, 1445]                   | Unknown  |
| 146 | Tensor<[1, 3, 1445, 64]> self = ?,<br>List[int]<> size = [1, 3, 1445, 64]                       | Unknown  |
...
| 156 | Tensor<[1, 38]> self = ?,<br>List[int]<> size = [38, 38]                                        | Unknown  |
| 157 | Tensor<[1, 3]> self = ?,<br>List[int]<> size = [3, 3]                                           | Unknown  |
...
| 167 | Tensor<[1, 5]> self = ?,<br>List[int]<> size = [5, 5]                                           | Unknown  |
...
| 217 | Tensor<[10, 1]> self = ?,<br>List[int]<> size = [10, 10]                                        | Unknown  |
...
| 235 | Tensor<[19, 1]> self = ?,<br>List[int]<> size = [19, 19]                                        | Unknown  |
| 236 | Tensor<[1]> self = ?,<br>List[int]<> size = [1]                                                 | Unknown  |
| 237 | Tensor<[2, 1, 1, 7]> self = ?,<br>List[int]<> size = [2, 1, 7, 7]                               | Done     |
| 238 | Tensor<[2, 1]> self = ?,<br>List[int]<> size = [2, 2]                                           | Unknown  |
| 239 | Tensor<[20, 1]> self = ?,<br>List[int]<> size = [20, 20]                                        | Unknown  |
...
| 245 | Tensor<[3, 1]> self = ?,<br>List[int]<> size = [3, 3]                                           | Unknown  |
| 246 | Tensor<[38, 1]> self = ?,<br>List[int]<> size = [38, 38]                                        | Unknown  |
...
| 261 | Tensor<[5, 1]> self = ?,<br>List[int]<> size = [5, 5]                                           | Unknown  |
