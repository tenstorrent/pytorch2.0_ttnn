...
|  26 | Tensor<[1, 1, 38, 38]> self = ?,<br>List[int] size = [1, 512, 38, 38]             | Done     | Done       | 0.8396097561969695 | 2      |
...
|  31 | Tensor<[1, 1, 7, 7]> self = ?,<br>List[int] size = [2, 1, 7, 7]                   | Done     | Done       | 1.0                | 1      |
...
| 122 | Tensor<[1, 16]> self = ?,<br>List[int] size = [12, 16]                            | Done     | Done       | 1.0                | 2      |
...
| 127 | Tensor<[1, 2, 300, 64]> self = ?,<br>List[int] size = [1, 2, 300, 64]             | Unknown  | Done       | 1.0                | -1     |
...
| 131 | Tensor<[1, 2, 4800, 300]> self = ?,<br>List[int] size = [1, 2, 4800, 300]         | Unknown  | Done       | 1.0                | -1     |
| 132 | Tensor<[1, 2, 4800, 64]> self = ?,<br>List[int] size = [1, 2, 4800, 64]           | Unknown  | Done       | 1.0                | -1     |
| 133 | Tensor<[1, 2, 64, 300]> self = ?,<br>List[int] size = [1, 2, 64, 300]             | Unknown  | Done       | 1.0                | -1     |
...
| 141 | Tensor<[1, 24, 64, 1]> self = ?,<br>List[int] size = [1, 24, 64, 32]              | None     | Fallback   | 1.0                | -1     |
...
| 150 | Tensor<[1, 32, 32, 49]> self = ?,<br>List[int] size = [1, 32, 32, 49]             | Removed  | Done       | 1.0                | -1     |
| 151 | Tensor<[1, 32, 32, 64]> self = ?,<br>List[int] size = [1, 32, 32, 64]             | Removed  | Done       | 1.0                | -1     |
| 152 | Tensor<[1, 32, 49, 32]> self = ?,<br>List[int] size = [1, 32, 49, 32]             | Removed  | Done       | 1.0                | -1     |
| 153 | Tensor<[1, 32, 49, 49]> self = ?,<br>List[int] size = [1, 32, 49, 49]             | Removed  | Done       | 1.0                | -1     |
...
| 163 | Tensor<[1, 5, 1024, 32]> self = ?,<br>List[int] size = [1, 5, 1024, 32]           | Removed  | Done       | 1.0                | -1     |
| 164 | Tensor<[1, 5, 1200, 300]> self = ?,<br>List[int] size = [1, 5, 1200, 300]         | Unknown  | Done       | 1.0                | -1     |
| 165 | Tensor<[1, 5, 1200, 64]> self = ?,<br>List[int] size = [1, 5, 1200, 64]           | Unknown  | Done       | 1.0                | -1     |
| 166 | Tensor<[1, 5, 256, 32]> self = ?,<br>List[int] size = [1, 5, 256, 32]             | Removed  | Done       | 1.0                | -1     |
| 167 | Tensor<[1, 5, 300, 64]> self = ?,<br>List[int] size = [1, 5, 300, 64]             | Unknown  | Done       | 1.0                | -1     |
| 168 | Tensor<[1, 5, 32, 256]> self = ?,<br>List[int] size = [1, 5, 32, 256]             | Removed  | Done       | 1.0                | -1     |
| 169 | Tensor<[1, 5, 64, 300]> self = ?,<br>List[int] size = [1, 5, 64, 300]             | Unknown  | Done       | 1.0                | -1     |
...
| 177 | Tensor<[1, 6, 1, 2]> self = ?,<br>List[int] size = [1, 6, 1, 2]                   | Unknown  | Done       | 1.0                | -1     |
| 178 | Tensor<[1, 6, 1, 64]> self = ?,<br>List[int] size = [1, 6, 1, 64]                 | Unknown  | Done       | 1.0                | -1     |
| 179 | Tensor<[1, 6, 1, s0 + 1]> self = ?,<br>List[int] size = [1, 6, 1, <s0 + 1>]       | Unknown  | Unknown    | N/A                | N/A    |
| 180 | Tensor<[1, 6, 15, 15]> self = ?,<br>List[int] size = [1, 6, 15, 15]               | Unknown  | Done       | 1.0                | -1     |
| 181 | Tensor<[1, 6, 15, 64]> self = ?,<br>List[int] size = [1, 6, 15, 64]               | Unknown  | Done       | 1.0                | -1     |
| 182 | Tensor<[1, 6, 17, 64]> self = ?,<br>List[int] size = [1, 6, 17, 64]               | Unknown  | Done       | 1.0                | -1     |
| 183 | Tensor<[1, 6, 2, 64]> self = ?,<br>List[int] size = [1, 6, 2, 64]                 | Unknown  | Done       | 1.0                | -1     |
| 184 | Tensor<[1, 6, 64, 15]> self = ?,<br>List[int] size = [1, 6, 64, 15]               | Unknown  | Done       | 1.0                | -1     |
| 185 | Tensor<[1, 6, 64, 17]> self = ?,<br>List[int] size = [1, 6, 64, 17]               | Unknown  | Done       | 1.0                | -1     |
| 186 | Tensor<[1, 6, 64, 1]> self = ?,<br>List[int] size = [1, 6, 64, 1]                 | Unknown  | Done       | 1.0                | -1     |
| 187 | Tensor<[1, 6, 64, 2]> self = ?,<br>List[int] size = [1, 6, 64, 2]                 | Unknown  | Done       | 1.0                | -1     |
...
| 190 | Tensor<[1, 64, 1]> self = ?,<br>List[int] size = [1, -1, 1]                       | Removed  | Done       | 1.0                | -1     |
| 191 | Tensor<[1, 64, 1]> self = ?,<br>List[int] size = [1, 64, 1]                       | Removed  | Done       | 1.0                | -1     |
| 192 | Tensor<[1, 64, 64, 9]> self = ?,<br>List[int] size = [1, 64, 64, 9]               | Removed  | Done       | 1.0                | -1     |
| 193 | Tensor<[1, 64, 9, 64]> self = ?,<br>List[int] size = [1, 64, 9, 64]               | Removed  | Done       | 1.0                | -1     |
...
| 201 | Tensor<[1, 8, 1, 1]> self = ?,<br>List[int] size = [1, 8, 1, 1]                   | Unknown  | Done       | 1.0                | -1     |
| 202 | Tensor<[1, 8, 1, 2]> self = ?,<br>List[int] size = [1, 8, 1, 2]                   | Unknown  | Done       | 1.0                | -1     |
| 203 | Tensor<[1, 8, 1, 64]> self = ?,<br>List[int] size = [1, 8, 1, 64]                 | Unknown  | Done       | 1.0                | -1     |
| 204 | Tensor<[1, 8, 1, s0 + 1]> self = ?,<br>List[int] size = [1, 8, 1, <s0 + 1>]       | Unknown  | Unknown    | N/A                | N/A    |
| 205 | Tensor<[1, 8, 10, 10]> self = ?,<br>List[int] size = [1, 8, 10, 10]               | Unknown  | Done       | 1.0                | -1     |
| 206 | Tensor<[1, 8, 10, 64]> self = ?,<br>List[int] size = [1, 8, 10, 64]               | Unknown  | Done       | 1.0                | -1     |
| 207 | Tensor<[1, 8, 2, 64]> self = ?,<br>List[int] size = [1, 8, 2, 64]                 | Unknown  | Done       | 1.0                | -1     |
| 208 | Tensor<[1, 8, 2048, 160]> self = ?,<br>List[int] size = [1, 8, 2048, 160]         | Removed  | Done       | 1.0                | -1     |
| 209 | Tensor<[1, 8, 2048, 256]> self = ?,<br>List[int] size = [1, 8, 2048, 256]         | Removed  | Done       | 1.0                | -1     |
| 210 | Tensor<[1, 8, 2048, 32]> self = ?,<br>List[int] size = [1, 8, 2048, 32]           | Removed  | Done       | 1.0                | -1     |
| 211 | Tensor<[1, 8, 256, 160]> self = ?,<br>List[int] size = [1, 8, 256, 160]           | Removed  | Done       | 1.0                | -1     |
| 212 | Tensor<[1, 8, 256, 2048]> self = ?,<br>List[int] size = [1, 8, 256, 2048]         | Removed  | Done       | 1.0                | -1     |
| 213 | Tensor<[1, 8, 256, 256]> self = ?,<br>List[int] size = [1, 8, 256, 256]           | Removed  | Done       | 1.0                | -1     |
| 214 | Tensor<[1, 8, 256, 32]> self = ?,<br>List[int] size = [1, 8, 256, 32]             | Removed  | Done       | 1.0                | -1     |
| 215 | Tensor<[1, 8, 256, 96]> self = ?,<br>List[int] size = [1, 8, 256, 96]             | Removed  | Done       | 1.0                | -1     |
| 216 | Tensor<[1, 8, 300, 300]> self = ?,<br>List[int] size = [1, 8, 300, 300]           | Unknown  | Done       | 1.0                | -1     |
| 217 | Tensor<[1, 8, 300, 64]> self = ?,<br>List[int] size = [1, 8, 300, 64]             | Unknown  | Done       | 1.0                | -1     |
| 218 | Tensor<[1, 8, 32, 2048]> self = ?,<br>List[int] size = [1, 8, 32, 2048]           | Removed  | Done       | 1.0                | -1     |
| 219 | Tensor<[1, 8, 32, 256]> self = ?,<br>List[int] size = [1, 8, 32, 256]             | Removed  | Done       | 1.0                | -1     |
| 220 | Tensor<[1, 8, 64, 10]> self = ?,<br>List[int] size = [1, 8, 64, 10]               | Unknown  | Done       | 1.0                | -1     |
| 221 | Tensor<[1, 8, 64, 1]> self = ?,<br>List[int] size = [1, 8, 64, 1]                 | Unknown  | Done       | 1.0                | -1     |
| 222 | Tensor<[1, 8, 64, 2]> self = ?,<br>List[int] size = [1, 8, 64, 2]                 | Unknown  | Done       | 1.0                | -1     |
| 223 | Tensor<[1, 8, 64, 300]> self = ?,<br>List[int] size = [1, 8, 64, 300]             | Unknown  | Done       | 1.0                | -1     |
...
| 235 | Tensor<[16, 6, 49, 49]> self = ?,<br>List[int] size = [16, 6, 49, 49]             | Removed  | Done       | 1.0                | -1     |
| 236 | Tensor<[16, 6, 64, 1]> self = ?,<br>List[int] size = [16, 6, 64, 32]              | None     | Fallback   | 1.0                | -1     |
| 237 | Tensor<[16, 6, 64, 32]> self = ?,<br>List[int] size = [16, 6, 64, 32]             | Removed  | Done       | 1.0                | -1     |
| 238 | Tensor<[16, 6, 64, 64]> self = ?,<br>List[int] size = [16, 6, 64, 64]             | Removed  | Done       | 1.0                | -1     |
| 239 | Tensor<[16, 8, 32, 49]> self = ?,<br>List[int] size = [16, 8, 32, 49]             | Removed  | Done       | 1.0                | -1     |
| 240 | Tensor<[16, 8, 32, 64]> self = ?,<br>List[int] size = [16, 8, 32, 64]             | Removed  | Done       | 1.0                | -1     |
| 241 | Tensor<[16, 8, 49, 32]> self = ?,<br>List[int] size = [16, 8, 49, 32]             | Removed  | Done       | 1.0                | -1     |
| 242 | Tensor<[16, 8, 49, 49]> self = ?,<br>List[int] size = [16, 8, 49, 49]             | Removed  | Done       | 1.0                | -1     |
