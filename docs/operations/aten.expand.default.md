...
|  26 | Tensor<[1, 1, 38, 38]> self = ?,<br>List[int] size = [1, 512, 38, 38]             | Done     | Done       | 0.3219464278724244 | 2      |
...
| 135 | Tensor<[1, 20]> self = ?,<br>List[int] size = [20, 20]                            | Done     | Done       | 1.0                | 2      |
...
| 145 | Tensor<[1, 2]> self = ?,<br>List[int] size = [2, 2]                               | Done     | Done       | 1.0                | 2      |
...
| 156 | Tensor<[1, 34]> self = ?,<br>List[int] size = [25, 34]                            | Done     | Done       | 1.0                | 2      |
| 157 | Tensor<[1, 38]> self = ?,<br>List[int] size = [38, 38]                            | Done     | Done       | 1.0                | 2      |
...
| 196 | Tensor<[1, 68]> self = ?,<br>List[int] size = [50, 68]                            | Done     | Done       | 1.0                | 2      |
