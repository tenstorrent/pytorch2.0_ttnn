...
| 164 | Tensor<[1, 5, 1200, 300]> self = ?,<br>List[int] size = [1, 5, 1200, 300]         | Removed  | Done       | 1.0                 | -1     |
| 165 | Tensor<[1, 5, 1200, 64]> self = ?,<br>List[int] size = [1, 5, 1200, 64]           | Removed  | Done       | 1.0                 | -1     |
| 166 | Tensor<[1, 5, 256, 32]> self = ?,<br>List[int] size = [1, 5, 256, 32]             | Removed  | Done       | 1.0                 | -1     |
| 167 | Tensor<[1, 5, 300, 64]> self = ?,<br>List[int] size = [1, 5, 300, 64]             | Removed  | Done       | 1.0                 | -1     |
| 168 | Tensor<[1, 5, 32, 256]> self = ?,<br>List[int] size = [1, 5, 32, 256]             | Removed  | Done       | 1.0                 | -1     |
| 169 | Tensor<[1, 5, 64, 300]> self = ?,<br>List[int] size = [1, 5, 64, 300]             | Removed  | Done       | 1.0                 | -1     |
...
| 216 | Tensor<[1, 8, 300, 300]> self = ?,<br>List[int] size = [1, 8, 300, 300]           | Removed  | Done       | 1.0                 | -1     |
| 217 | Tensor<[1, 8, 300, 64]> self = ?,<br>List[int] size = [1, 8, 300, 64]             | Removed  | Done       | 1.0                 | -1     |
...
| 223 | Tensor<[1, 8, 64, 300]> self = ?,<br>List[int] size = [1, 8, 64, 300]             | Removed  | Done       | 1.0                 | -1     |
