...
|  11 | Tensor<[1, 1, 1, 920]> self = ?,<br>List[int] size = [-1, 8, -1, -1]              | Done     | Done       | 1.0   | 0      |
...
| 125 | Tensor<[1, 2, 300, 64]> self = ?,<br>List[int] size = [1, 2, 300, 64]             | Removed  | Done       | 1.0   | -1     |
...
| 129 | Tensor<[1, 2, 4800, 300]> self = ?,<br>List[int] size = [1, 2, 4800, 300]         | Removed  | Done       | 1.0   | -1     |
| 130 | Tensor<[1, 2, 4800, 64]> self = ?,<br>List[int] size = [1, 2, 4800, 64]           | Removed  | Done       | 1.0   | -1     |
| 131 | Tensor<[1, 2, 64, 300]> self = ?,<br>List[int] size = [1, 2, 64, 300]             | Removed  | Done       | 1.0   | -1     |
| 132 | Tensor<[1, 2048, 1, 1]> self = ?,<br>List[int] size = [1, 2048, 10, 10]           | Done     | Done       | 1.0   | 0      |
| 133 | Tensor<[1, 2048, 1, 1]> self = ?,<br>List[int] size = [1, 2048, 7, 7]             | Done     | Done       | 1.0   | 0      |
| 134 | Tensor<[1, 20]> self = ?,<br>List[int] size = [20, 20]                            | Done     | Done       | 1.0   | 0      |
...
| 139 | Tensor<[1, 24, 64, 1]> self = ?,<br>List[int] size = [1, 24, 64, 32]              | Done     | Done       | 1.0   | 0      |
...
| 142 | Tensor<[1, 256, 1, 1]> self = ?,<br>List[int] size = [1, 256, 56, 56]             | Done     | Done       | 1.0   | 0      |
| 143 | Tensor<[1, 25]> self = ?,<br>List[int] size = [1, 25]                             | Removed  | Done       | 1.0   | -1     |
| 144 | Tensor<[1, 2]> self = ?,<br>List[int] size = [2, 2]                               | Done     | Done       | 1.0   | 0      |
