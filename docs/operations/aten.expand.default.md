...
|  28 | Tensor<[1, 1, 64, 300]> self = ?,<br>List[int] size = [1, 1, 64, 300]             | Removed  | Done       | 1.0   | -1     |
|  29 | Tensor<[1, 1, 7, 7]> self = ?,<br>List[int] size = [1, 1, 7, 7]                   | Removed  | Unknown    | N/A   | N/A    |
|  30 | Tensor<[1, 1, 7, 7]> self = ?,<br>List[int] size = [2, 1, 7, 7]                   | Done     | Done       | 1.0   | 0      |
|  31 | Tensor<[1, 1, 768]> self = ?,<br>List[int] size = [1, -1, -1]                     | Removed  | Done       | 1.0   | -1     |
|  32 | Tensor<[1, 1, 768]> self = ?,<br>List[int] size = [1, 196, 768]                   | Done     | Done       | 1.0   | 0      |
|  33 | Tensor<[1, 100, 192]> self = ?,<br>List[int] size = [1, -1, -1]                   | Removed  | Done       | 1.0   | -1     |
|  34 | Tensor<[1, 1024, 1, 1]> self = ?,<br>List[int] size = [1, 1024, 7, 7]             | Done     | Done       | 1.0   | 0      |
|  35 | Tensor<[1, 10]> self = ?,<br>List[int] size = [1, 10]                             | Removed  | Done       | 1.0   | -1     |
|  36 | Tensor<[1, 10]> self = ?,<br>List[int] size = [10, 10]                            | Done     | Done       | 1.0   | 0      |
...
|  83 | Tensor<[1, 120, 1, 1]> self = ?,<br>List[int] size = [1, 120, 28, 28]             | Done     | Done       | 1.0   | 0      |
|  84 | Tensor<[1, 1280, 1, 1]> self = ?,<br>List[int] size = [1, 1280, 10, 10]           | Done     | Done       | 1.0   | 0      |
|  85 | Tensor<[1, 1280, 1, 1]> self = ?,<br>List[int] size = [1, 1280, 12, 12]           | Done     | Done       | 1.0   | 0      |
|  86 | Tensor<[1, 1280, 1, 1]> self = ?,<br>List[int] size = [1, 1280, 7, 7]             | Done     | Done       | 1.0   | 0      |
|  87 | Tensor<[1, 1280, 1, 1]> self = ?,<br>List[int] size = [1, 1280, 8, 8]             | Done     | Done       | 1.0   | 0      |
|  88 | Tensor<[1, 1280, 1, 1]> self = ?,<br>List[int] size = [1, 1280, 9, 9]             | Done     | Done       | 1.0   | 0      |
|  89 | Tensor<[1, 1536, 1, 1]> self = ?,<br>List[int] size = [1, 1536, 8, 8]             | Done     | Done       | 1.0   | 0      |
...
| 120 | Tensor<[1, 19]> self = ?,<br>List[int] size = [19, 19]                            | Done     | Done       | 1.0   | 0      |
...
| 220 | Tensor<[1, 960, 1, 1]> self = ?,<br>List[int] size = [1, 960, 7, 7]               | Done     | Done       | 1.0   | 0      |
...
| 241 | Tensor<[2048, 768]> self = ?,<br>List[int] size = [1, -1, -1]                     | Done     | Done       | 1.0   | 0      |
...
| 244 | Tensor<[256, 1280]> self = ?,<br>List[int] size = [1, -1, -1]                     | Done     | Done       | 1.0   | 0      |
...
| 276 | Tensor<[768]> self = ?,<br>List[int] size = [1, 1, -1]                            | Done     | Done       | 1.0   | 0      |
