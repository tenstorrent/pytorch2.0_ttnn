...
| 10 | Tensor<[16384, 3, 3]> self = ?,<br>Tensor<[16384, 3, 3]> src = ?         | Removed  | Unknown    | N/A   | N/A    |
| 11 | Tensor<[16384]> self = ?,<br>Tensor<[16384]> src = ?                     | Removed  | Unknown    | N/A   | N/A    |
| 12 | Tensor<[24, 56, 56]> self = ?,<br>Tensor<[24, 56, 56]> src = ?           | Removed  | Done       | 1.0   | -1     |
| 13 | Tensor<[3, 300, 300]> self = ?,<br>Tensor<[3, 300, 300]> src = ?         | Removed  | Unknown    | N/A   | N/A    |
| 14 | Tensor<[3, 320, 320]> self = ?,<br>Tensor<[3, 320, 320]> src = ?         | Removed  | Unknown    | N/A   | N/A    |
| 15 | Tensor<[3, 720, 1280]> self = ?,<br>Tensor<[3, 720, 1280]> src = ?       | Removed  | Unknown    | N/A   | N/A    |
| 16 | Tensor<[40, 28, 28]> self = ?,<br>Tensor<[40, 28, 28]> src = ?           | Removed  | Done       | 1.0   | -1     |
| 17 | Tensor<[80, 14, 14]> self = ?,<br>Tensor<[80, 14, 14]> src = ?           | Removed  | Done       | 1.0   | -1     |
