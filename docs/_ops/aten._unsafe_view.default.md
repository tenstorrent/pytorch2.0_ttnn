...
|   5 | Tensor<[1, 12, 12, 64]> self = ?,<br>List[int]<> size = [1, 12, 768]          | Done     |
|   6 | Tensor<[1, 13, 17, 9, 4]> self = ?,<br>List[int]<> size = [1, 1989, 4]        | Unknown  |
|   7 | Tensor<[1, 13, 17, 9, 91]> self = ?,<br>List[int]<> size = [1, 1989, 91]      | Unknown  |
|   8 | Tensor<[1, 14, 12, 64]> self = ?,<br>List[int]<> size = [1, 14, 768]          | Done     |
|   9 | Tensor<[1, 16, 16, 16, 16, 3]> self = ?,<br>List[int]<> size = [1, 256, 768]  | Done     |
|  10 | Tensor<[1, 19, 16, 64]> self = ?,<br>List[int]<> size = [1, 19, 1024]         | Done     |
|  11 | Tensor<[1, 19, 19, 6, 4]> self = ?,<br>List[int]<> size = [1, 2166, 4]        | Done     |
|  12 | Tensor<[1, 19, 19, 6, 91]> self = ?,<br>List[int]<> size = [1, 2166, 91]      | Done     |
|  13 | Tensor<[1, 2, 2, 6, 4]> self = ?,<br>List[int]<> size = [1, 24, 4]            | Done     |
|  14 | Tensor<[1, 2, 2, 6, 91]> self = ?,<br>List[int]<> size = [1, 24, 91]          | Done     |
|  15 | Tensor<[1, 2, 2, 7, 7, 384]> self = ?,<br>List[int]<> size = [4, 49, 384]     | Done     |
|  16 | Tensor<[1, 2, 2, 7, 7, 512]> self = ?,<br>List[int]<> size = [4, 49, 512]     | Done     |
...
|  19 | Tensor<[1, 2, 7, 2, 7, 384]> self = ?,<br>List[int]<> size = [1, 14, 14, 384] | Done     |
|  20 | Tensor<[1, 2, 7, 2, 7, 512]> self = ?,<br>List[int]<> size = [1, 14, 14, 512] | Done     |
...
|  23 | Tensor<[1, 20, 20, 6, 4]> self = ?,<br>List[int]<> size = [1, 2400, 4]        | Done     |
|  24 | Tensor<[1, 20, 20, 6, 91]> self = ?,<br>List[int]<> size = [1, 2400, 91]      | Done     |
|  25 | Tensor<[1, 24, 12, 64]> self = ?,<br>List[int]<> size = [1, 24, 768]          | Done     |
...
|  28 | Tensor<[1, 3, 3, 4, 4]> self = ?,<br>List[int]<> size = [1, 36, 4]            | Done     |
|  29 | Tensor<[1, 3, 3, 4, 91]> self = ?,<br>List[int]<> size = [1, 36, 91]          | Done     |
|  30 | Tensor<[1, 3, 3, 6, 4]> self = ?,<br>List[int]<> size = [1, 54, 4]            | Done     |
|  31 | Tensor<[1, 3, 3, 6, 91]> self = ?,<br>List[int]<> size = [1, 54, 91]          | Done     |
|  32 | Tensor<[1, 32, 16, 96]> self = ?,<br>List[int]<> size = [1, 32, 1536]         | Done     |
|  33 | Tensor<[1, 38, 38, 4, 4]> self = ?,<br>List[int]<> size = [1, 5776, 4]        | Done     |
|  34 | Tensor<[1, 38, 38, 4, 91]> self = ?,<br>List[int]<> size = [1, 5776, 91]      | Done     |
|  35 | Tensor<[1, 4, 4, 7, 7, 192]> self = ?,<br>List[int]<> size = [16, 49, 192]    | Done     |
...
|  72 | Tensor<[16, 49, 6, 32]> self = ?,<br>List[int]<> size = [16, 49, 192]         | Done     |
...
| 109 | Tensor<[64, 3, 32, 49]> self = ?,<br>List[int]<> size = [192, 32, 49]         | Done     |
