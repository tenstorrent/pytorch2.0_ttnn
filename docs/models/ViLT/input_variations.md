...
|---:|:-------------------------------|-------------------:|------------:|----------:|-----------:|:------------|--------:|
|  0 | aten._to_copy.default          |                  4 |           0 |         1 |          0 | 🚧          |    0.25 |
...
|  7 | aten.expand.default            |                  2 |           0 |         1 |          0 | 🚧          |    0.5  |
|  8 | aten.mul.Tensor                |                  2 |           0 |         0 |          0 | ✘           |    0    |
|  9 | aten.native_layer_norm.default |                  1 |           0 |         1 |          0 | ✅          |    1    |
| 10 | aten.select.int                |                  4 |           0 |         3 |          1 | 🚧          |    0.75 |
| 11 | aten.slice.Tensor              |                 11 |           2 |         9 |          0 | ✅          |    1    |
| 12 | aten.stack.default             |                  1 |           0 |         0 |          0 | ✘           |    0    |
| 13 | aten.sum.dim_IntList           |                  2 |           0 |         0 |          0 | ✘           |    0    |
| 14 | aten.transpose.int             |                  2 |           1 |         1 |          0 | ✅          |    1    |
| 15 | aten.unsqueeze.default         |                  2 |           0 |         2 |          0 | ✅          |    1    |
| 16 | aten.view.default              |                  4 |           2 |         2 |          0 | ✅          |    1    |
***
### aten._to_copy.default
|    | ATen Input Variations                                                     | Status   | Isolated   | PCC   |
|---:|:--------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1, 12, 16]> self = ?,<br>Optional[int] dtype = torch.int64     | None     | Fallback   | True  |
|  1 | Tensor<[1, 1, 384, 512]> self = ?,<br>Optional[int] dtype = torch.float32 | Removed  | Fallback   | True  |
...
|    | ATen Input Variations                                  | Status   | Isolated   | PCC   |
|---:|:-------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 16]> self = ?,<br>List[int] size = [12, 16] | Removed  | Done       | True  |
...
|    | ATen Input Variations                                             | Status   | Isolated   | PCC   |
|---:|:------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1, 12, 16]> self = ?,<br>int dim = 1,<br>int index = 0 | Removed  | Done       | True  |
|  1 | Tensor<[1, 12]> self = ?,<br>int dim = 1,<br>int index = 0        | Removed  | Done       | True  |
|  2 | Tensor<[1, 16]> self = ?,<br>int dim = 1,<br>int index = 0        | Removed  | Done       | True  |
|  3 | Tensor<[1]> self = ?,<br>int dim = 0,<br>int index = 0            | Fallback | Fallback   | True  |
### aten.slice.Tensor
|    | ATen Input Variations                                                                                                     | Status   | Isolated   | PCC   |
|---:|:--------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|:------|
...
|  1 | Tensor<[1, 768, 192]> self = ?,<br>int dim0 = 1,<br>int dim1 = 2 | Removed  | Done       | True  |
### aten.unsqueeze.default
|    | ATen Input Variations                          | Status   | Isolated   | PCC   |
|---:|:-----------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 384, 512]> self = ?,<br>int dim = 1 | Removed  | Done       | True  |
|  1 | Tensor<[12]> self = ?,<br>int dim = -1         | Removed  | Done       | True  |
### aten.view.default
|    | ATen Input Variations                                                | Status   | Isolated   | PCC   |
|---:|:---------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 768, 12, 16]> self = ?,<br>List[int] size = [1, 768, 192] | Done     | Done       | True  |
|  1 | Tensor<[1, 768, 144]> self = ?,<br>List[int] size = [1, 768, 12, 12] | Removed  | Done       | True  |
|  2 | Tensor<[12]> self = ?,<br>List[int] size = [-1, 1]                   | Removed  | Done       | True  |
