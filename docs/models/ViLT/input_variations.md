...
| 11 | aten.select.int                |                  4 |           0 |         3 |          1 | 🚧          |    0.75 |
...
| 17 | aten.view.default              |                  4 |           2 |         2 |          0 | ✅          |    1    |
***
...
|    | ATen Input Variations        | Status   | Isolated   | PCC   |
|---:|:-----------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 8, 768]> self = ? | Removed  | Done       | True  |
...
|    | ATen Input Variations                          | Status   | Isolated   | PCC   |
|---:|:-----------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 384, 512]> self = ?,<br>int dim = 1 | Done     | Done       | True  |
