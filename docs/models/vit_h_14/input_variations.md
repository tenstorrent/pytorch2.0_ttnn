...
|  2 | Tensor<[1280]> self = ?,<br>Tensor<[1370, 5120]> mat1 = ?,<br>Tensor<[5120, 1280]> mat2 = ? | Removed  | Done       | 0.999801 |      0 |
|  3 | Tensor<[3840]> self = ?,<br>Tensor<[1370, 1280]> mat1 = ?,<br>Tensor<[1280, 3840]> mat2 = ? | Done     | Done       | 0.999945 |      0 |
|  4 | Tensor<[5120]> self = ?,<br>Tensor<[1370, 1280]> mat1 = ?,<br>Tensor<[1280, 5120]> mat2 = ? | Removed  | Done       | 0.999946 |      0 |
### aten.cat.default
|    | ATen Input Variations                                                      | Status   | Isolated   |   PCC |   Host |
|---:|:---------------------------------------------------------------------------|:---------|:-----------|------:|-------:|
...
|  2 | Tensor<[3, 1370, 1, 1280]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Removed  | Done       |     1 |      0 |
...
|    | ATen Input Variations                                                                                                                                                         | Status   | Isolated   |      PCC |   Host |
|---:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 1370, 1280]> input = ?,<br>List[int] normalized_shape = [1280],<br>Optional[Tensor]<[1280]> weight = ?,<br>Optional[Tensor]<[1280]> bias = ?,<br>float eps = 1e-06 | Done     | Done       | 0.995475 |      3 |
...
|  2 | Tensor<[1280, 5120]> self = ? | Removed  | Done       |     1 |      0 |
|  3 | Tensor<[3840, 1280]> self = ? | Removed  | Done       |     1 |      0 |
|  4 | Tensor<[5120, 1280]> self = ? | Removed  | Done       |     1 |      0 |
### aten.transpose.int
|    | ATen Input Variations                                                     | Status   | Isolated   |   PCC |   Host |
|---:|:--------------------------------------------------------------------------|:---------|:-----------|------:|-------:|
|  0 | Tensor<[1, 1370, 1, 3, 1280]> self = ?,<br>int dim0 = 0,<br>int dim1 = -2 | Done     | Done       |     1 |      0 |
...
| 10 | Tensor<[1370, 5120]> self = ?,<br>List[int] size = [1, 1370, 5120]       | Removed  | Done       |     1 |      0 |
