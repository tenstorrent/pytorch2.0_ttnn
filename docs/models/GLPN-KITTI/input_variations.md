...
| 16 | aten.mul.Tensor                                   |                 29 |          19 |        10 |          0 | ✅          |    1    |
...
|---:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 32, 120, 160]> input = ?,<br>Optional[Tensor]<[32]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>Tensor<[32]> running_mean = ?,<br>Tensor<[32]> running_var = ?,<br>float momentum = 0.1,<br>float eps = 1e-05 | Done     | Done       | 0.999989 |      8 |
|  1 | Tensor<[1, 32, 30, 40]> input = ?,<br>Optional[Tensor]<[32]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>Tensor<[32]> running_mean = ?,<br>Tensor<[32]> running_var = ?,<br>float momentum = 0.1,<br>float eps = 1e-05   | Done     | Done       | 0.99999  |      8 |
|  2 | Tensor<[1, 32, 60, 80]> input = ?,<br>Optional[Tensor]<[32]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>Tensor<[32]> running_mean = ?,<br>Tensor<[32]> running_var = ?,<br>float momentum = 0.1,<br>float eps = 1e-05   | Done     | Done       | 0.999987 |      8 |
|  3 | Tensor<[1, 64, 120, 160]> input = ?,<br>Optional[Tensor]<[64]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>Tensor<[64]> running_mean = ?,<br>Tensor<[64]> running_var = ?,<br>float momentum = 0.1,<br>float eps = 1e-05 | Done     | Done       | 0.999989 |      8 |
...
|  5 | Tensor<[1, 64, 60, 80]> input = ?,<br>Optional[Tensor]<[64]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>Tensor<[64]> running_mean = ?,<br>Tensor<[64]> running_var = ?,<br>float momentum = 0.1,<br>float eps = 1e-05   | Done     | Done       | 0.999993 |      8 |
### aten._softmax.default
|    | ATen Input Variations                                                               | Status   | Isolated   |      PCC |   Host |
|---:|:------------------------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 1, 19200, 300]> self = ?,<br>int dim = -1,<br>bool half_to_float = False | Done     | Done       | 0.999596 |      0 |
|  1 | Tensor<[1, 2, 4800, 300]> self = ?,<br>int dim = -1,<br>bool half_to_float = False  | Done     | Done       | 0.999594 |      0 |
|  2 | Tensor<[1, 5, 1200, 300]> self = ?,<br>int dim = -1,<br>bool half_to_float = False  | Done     | Done       | 0.999597 |      0 |
|  3 | Tensor<[1, 8, 300, 300]> self = ?,<br>int dim = -1,<br>bool half_to_float = False   | Done     | Done       | 0.999591 |      0 |
...
|  9 | Tensor<[120]> self = ?,<br>Tensor other = 0.5                              | Removed  | Done       | 0.999998 |      0 |
| 10 | Tensor<[160]> self = ?,<br>Tensor other = 0.5                              | Removed  | Done       | 0.999999 |      0 |
| 11 | Tensor<[240]> self = ?,<br>Tensor other = 0.5                              | Removed  | Done       | 0.999998 |      0 |
| 12 | Tensor<[30]> self = ?,<br>Tensor other = 0.5                               | Removed  | Done       | 0.999996 |      0 |
| 13 | Tensor<[320]> self = ?,<br>Tensor other = 0.5                              | Removed  | Fallback   | 1        |     -1 |
| 14 | Tensor<[40]> self = ?,<br>Tensor other = 0.5                               | Removed  | Done       | 0.999997 |      0 |
| 15 | Tensor<[480]> self = ?,<br>Tensor other = 0.5                              | Removed  | Done       | 0.999998 |      0 |
| 16 | Tensor<[60]> self = ?,<br>Tensor other = 0.5                               | Removed  | Done       | 0.999995 |      0 |
| 17 | Tensor<[640]> self = ?,<br>Tensor other = 0.5                              | Removed  | Done       | 0.999997 |      0 |
...
|    | ATen Input Variations                                                                                                                                                                                                                                                                                 | Status   | Isolated   |      PCC |   Host |
|---:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 128, 120, 160]> input = ?,<br>Tensor<[64, 128, 3, 3]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1     | Done     | Done       | 0.999813 |      8 |
|  1 | Tensor<[1, 128, 30, 40]> input = ?,<br>Tensor<[64, 128, 3, 3]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1       | Done     | Done       | 0.999817 |      8 |
|  2 | Tensor<[1, 128, 60, 80]> input = ?,<br>Tensor<[128, 128, 4, 4]> weight = ?,<br>Optional[Tensor]<[128]> bias = ?,<br>List[int] stride = [4, 4],<br>List[int] padding = [0, 0],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1     | Done     | Done       | 0.999608 |      8 |
...
|  5 | Tensor<[1, 128, 60, 80]> input = ?,<br>Tensor<[64, 128, 3, 3]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1       | Done     | Done       | 0.999816 |      8 |
...
|  9 | Tensor<[1, 3, 480, 640]> input = ?,<br>Tensor<[64, 3, 7, 7]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int] stride = [4, 4],<br>List[int] padding = [3, 3],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1         | Done     | Done       | 0.999897 |      8 |
| 10 | Tensor<[1, 32, 120, 160]> input = ?,<br>Tensor<[2, 32, 3, 3]> weight = ?,<br>Optional[Tensor]<[2]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1         | Done     | Done       | 0.99996  |      8 |
| 11 | Tensor<[1, 32, 30, 40]> input = ?,<br>Tensor<[2, 32, 3, 3]> weight = ?,<br>Optional[Tensor]<[2]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1           | Done     | Done       | 0.999961 |      8 |
...
| 14 | Tensor<[1, 320, 30, 40]> input = ?,<br>Tensor<[512, 320, 3, 3]> weight = ?,<br>Optional[Tensor]<[512]> bias = ?,<br>List[int] stride = [2, 2],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1     | Done     | Done       | 0.999399 |      8 |
| 15 | Tensor<[1, 320, 30, 40]> input = ?,<br>Tensor<[64, 320, 1, 1]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [0, 0],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1       | Done     | Done       | 0.999973 |      8 |
| 16 | Tensor<[1, 512, 15, 20]> input = ?,<br>Tensor<[64, 512, 1, 1]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [0, 0],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1       | Done     | Done       | 0.999926 |      8 |
...
| 18 | Tensor<[1, 64, 120, 160]> input = ?,<br>Tensor<[128, 64, 3, 3]> weight = ?,<br>Optional[Tensor]<[128]> bias = ?,<br>List[int] stride = [2, 2],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1     | Done     | Done       | 0.999918 |      8 |
| 19 | Tensor<[1, 64, 120, 160]> input = ?,<br>Tensor<[32, 64, 3, 3]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1       | Done     | Done       | 0.999917 |      8 |
| 20 | Tensor<[1, 64, 120, 160]> input = ?,<br>Tensor<[64, 64, 8, 8]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int] stride = [8, 8],<br>List[int] padding = [0, 0],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1       | Done     | Done       | 0.998989 |      8 |
...
| 24 | Tensor<[1, 64, 60, 80]> input = ?,<br>Tensor<[32, 64, 3, 3]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1         | Done     | Done       | 0.999918 |      8 |
### aten.div.Tensor
|    | ATen Input Variations                                      | Status   | Isolated   |   PCC |   Host |
|---:|:-----------------------------------------------------------|:---------|:-----------|------:|-------:|
...
|    | ATen Input Variations                                                     | Status   | Isolated   | PCC                | Host   |
|---:|:--------------------------------------------------------------------------|:---------|:-----------|:-------------------|:-------|
|  0 | Tensor<[1, 1, 480, 640]> self = ?,<br>Tensor other = 10                   | Done     | Done       | 0.9999985630445217 | 0      |
|  1 | Tensor<[1, 64, 120, 160]> self = ?,<br>Tensor other = ?                   | Done     | Unknown    | N/A                | N/A    |
|  2 | Tensor<[1, 64, 120, 160]> self = ?,<br>Tensor<[1, 1, 120, 160]> other = ? | Done     | Done       | 0.9999959465102634 | 0      |
|  3 | Tensor<[1, 64, 120, 160]> self = ?,<br>Tensor<[120, 1]> other = ?         | Done     | Done       | 0.9999961358742216 | 0      |
|  4 | Tensor<[1, 64, 120, 160]> self = ?,<br>Tensor<[160]> other = ?            | Done     | Done       | 0.9999954849336031 | 0      |
|  5 | Tensor<[1, 64, 240, 320]> self = ?,<br>Tensor other = ?                   | Done     | Unknown    | N/A                | N/A    |
|  6 | Tensor<[1, 64, 240, 320]> self = ?,<br>Tensor<[240, 1]> other = ?         | Done     | Done       | 0.999995893677354  | 0      |
|  7 | Tensor<[1, 64, 240, 320]> self = ?,<br>Tensor<[320]> other = ?            | Done     | Done       | 0.9999960866344039 | 0      |
|  8 | Tensor<[1, 64, 30, 40]> self = ?,<br>Tensor other = ?                     | Done     | Unknown    | N/A                | N/A    |
|  9 | Tensor<[1, 64, 30, 40]> self = ?,<br>Tensor<[1, 1, 30, 40]> other = ?     | Done     | Done       | 0.9999960603661565 | 0      |
| 10 | Tensor<[1, 64, 30, 40]> self = ?,<br>Tensor<[30, 1]> other = ?            | Done     | Done       | 0.9999958002779332 | 0      |
| 11 | Tensor<[1, 64, 30, 40]> self = ?,<br>Tensor<[40]> other = ?               | Done     | Done       | 0.999996370377174  | 0      |
| 12 | Tensor<[1, 64, 480, 640]> self = ?,<br>Tensor other = ?                   | Done     | Unknown    | N/A                | N/A    |
| 13 | Tensor<[1, 64, 480, 640]> self = ?,<br>Tensor<[480, 1]> other = ?         | Done     | Done       | 0.9999959841313361 | 0      |
| 14 | Tensor<[1, 64, 480, 640]> self = ?,<br>Tensor<[640]> other = ?            | Done     | Done       | 0.9999959446434442 | 0      |
| 15 | Tensor<[1, 64, 60, 80]> self = ?,<br>Tensor other = ?                     | Done     | Unknown    | N/A                | N/A    |
| 16 | Tensor<[1, 64, 60, 80]> self = ?,<br>Tensor<[1, 1, 60, 80]> other = ?     | Done     | Done       | 0.9999958379465311 | 0      |
| 17 | Tensor<[1, 64, 60, 80]> self = ?,<br>Tensor<[60, 1]> other = ?            | Done     | Done       | 0.9999959681057544 | 0      |
| 18 | Tensor<[1, 64, 60, 80]> self = ?,<br>Tensor<[80]> other = ?               | Done     | Done       | 0.9999956967956741 | 0      |
| 19 | Tensor<[120]> self = ?,<br>Tensor other = 0.5                             | Removed  | Done       | 1.0                | 0      |
| 20 | Tensor<[160]> self = ?,<br>Tensor other = 0.5                             | Removed  | Done       | 1.0                | 0      |
| 21 | Tensor<[240]> self = ?,<br>Tensor other = 0.5                             | Removed  | Done       | 1.0                | 0      |
| 22 | Tensor<[30]> self = ?,<br>Tensor other = 0.5                              | Removed  | Done       | 1.0                | 0      |
| 23 | Tensor<[320]> self = ?,<br>Tensor other = 0.5                             | Removed  | Done       | 1.0                | 0      |
| 24 | Tensor<[40]> self = ?,<br>Tensor other = 0.5                              | Removed  | Done       | 1.0                | 0      |
| 25 | Tensor<[480]> self = ?,<br>Tensor other = 0.5                             | Removed  | Done       | 1.0                | 0      |
| 26 | Tensor<[60]> self = ?,<br>Tensor other = 0.5                              | Removed  | Done       | 1.0                | 0      |
| 27 | Tensor<[640]> self = ?,<br>Tensor other = 0.5                             | Removed  | Done       | 1.0                | 0      |
| 28 | Tensor<[80]> self = ?,<br>Tensor other = 0.5                              | Removed  | Done       | 1.0                | 0      |
...
|  1 | Tensor<[120, 1]> self = ?,<br>number other = 1.0 | Removed  | Done       | 0.9999925113897685 | 0      |
|  2 | Tensor<[160]> self = ?,<br>number other = 1.0    | Removed  | Done       | 0.9999950943181362 | 0      |
|  3 | Tensor<[240, 1]> self = ?,<br>number other = 1.0 | Removed  | Done       | 0.9999950347655374 | 0      |
|  4 | Tensor<[30, 1]> self = ?,<br>number other = 1.0  | Removed  | Done       | 0.9999911737321435 | 0      |
|  5 | Tensor<[320]> self = ?,<br>number other = 1.0    | Removed  | Done       | 0.9999945508518637 | 0      |
|  6 | Tensor<[40]> self = ?,<br>number other = 1.0     | Removed  | Done       | 0.9999917506964872 | 0      |
|  7 | Tensor<[480, 1]> self = ?,<br>number other = 1.0 | Removed  | Done       | 0.9999925961382937 | 0      |
|  8 | Tensor<[60, 1]> self = ?,<br>number other = 1.0  | Removed  | Done       | 0.999991071076141  | 0      |
|  9 | Tensor<[640]> self = ?,<br>number other = 1.0    | Removed  | Done       | 0.9999942211331171 | 0      |
| 10 | Tensor<[80]> self = ?,<br>number other = 1.0     | Removed  | Done       | 0.9999918643671107 | 0      |
### aten.select.int
|    | ATen Input Variations                                               | Status   | Isolated   |   PCC |   Host |
|---:|:--------------------------------------------------------------------|:---------|:-----------|------:|-------:|
...
|    | ATen Input Variations             | Status   | Isolated   | PCC                | Host   |
|---:|:----------------------------------|:---------|:-----------|:-------------------|:-------|
|  0 | Tensor<[1, 1, 480, 640]> self = ? | Done     | Done       | 0.999755360563092  | 0      |
|  1 | Tensor<[1, 2, 120, 160]> self = ? | Done     | Done       | 0.9997521468947521 | 0      |
...
|    | ATen Input Variations                                    | Status   | Isolated   |      PCC |   Host |
|---:|:---------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[120, 1]> self = ?,<br>Tensor<[120, 1]> other = ? | Removed  | Done       | 0.999998 |      0 |
|  1 | Tensor<[120]> self = ?,<br>Tensor other = 0.5            | Removed  | Done       | 0.999999 |      0 |
|  2 | Tensor<[160]> self = ?,<br>Tensor other = 0.5            | Removed  | Done       | 0.999996 |      0 |
...
|  5 | Tensor<[240]> self = ?,<br>Tensor other = 0.5            | Removed  | Done       | 0.999997 |      0 |
|  6 | Tensor<[30, 1]> self = ?,<br>Tensor<[30, 1]> other = ?   | Removed  | Done       | 1        |      0 |
|  7 | Tensor<[30]> self = ?,<br>Tensor other = 0.5             | Removed  | Done       | 0.999999 |      0 |
|  8 | Tensor<[320]> self = ?,<br>Tensor other = 0.5            | Removed  | Done       | 0.999997 |      0 |
|  9 | Tensor<[320]> self = ?,<br>Tensor<[320]> other = ?       | Removed  | Done       | 0.999998 |      0 |
| 10 | Tensor<[40]> self = ?,<br>Tensor other = 0.5             | Removed  | Done       | 0.999993 |      0 |
| 11 | Tensor<[40]> self = ?,<br>Tensor<[40]> other = ?         | Removed  | Done       | 0.999999 |      0 |
| 12 | Tensor<[480, 1]> self = ?,<br>Tensor<[480, 1]> other = ? | Removed  | Done       | 0.999999 |      0 |
| 13 | Tensor<[480]> self = ?,<br>Tensor other = 0.5            | Removed  | Done       | 0.999998 |      0 |
| 14 | Tensor<[60, 1]> self = ?,<br>Tensor<[60, 1]> other = ?   | Removed  | Done       | 0.999997 |      0 |
| 15 | Tensor<[60]> self = ?,<br>Tensor other = 0.5             | Removed  | Done       | 0.999993 |      0 |
...
| 18 | Tensor<[80]> self = ?,<br>Tensor other = 0.5             | Removed  | Done       | 0.999997 |      0 |
| 19 | Tensor<[80]> self = ?,<br>Tensor<[80]> other = ?         | Removed  | Done       | 0.999997 |      0 |
### aten.t.default
|    | ATen Input Variations        | Status   | Isolated   |   PCC |   Host |
|---:|:-----------------------------|:---------|:-----------|------:|-------:|
