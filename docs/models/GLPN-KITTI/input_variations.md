...
| 11 | aten.clone.default                                |                 19 |           0 |         0 |          0 | ✘           |    0    |
...
| 18 | aten.permute.default                              |                 21 |          17 |         0 |          0 | 🚧          |    0.81 |
...
|    | ATen Input Variations                                                                        | Status   | Isolated   | PCC   |
|---:|:---------------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1, 19200, 300]> self = ?                                                          | Unknown  | Fallback   | True  |
|  1 | Tensor<[1, 1200, 1280]> self = ?                                                             | Unknown  | Fallback   | True  |
|  2 | Tensor<[1, 1200, 320]> self = ?                                                              | Unknown  | Fallback   | True  |
|  3 | Tensor<[1, 1200, 5, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format  | Unknown  | Fallback   | True  |
|  4 | Tensor<[1, 128, 60, 80]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format  | Unknown  | Fallback   | True  |
|  5 | Tensor<[1, 19200, 256]> self = ?                                                             | Unknown  | Fallback   | True  |
|  6 | Tensor<[1, 19200, 64]> self = ?                                                              | Unknown  | Fallback   | True  |
|  7 | Tensor<[1, 2, 4800, 300]> self = ?                                                           | Unknown  | Fallback   | True  |
|  8 | Tensor<[1, 300, 2048]> self = ?                                                              | Unknown  | Fallback   | True  |
|  9 | Tensor<[1, 300, 512]> self = ?                                                               | Unknown  | Fallback   | True  |
| 10 | Tensor<[1, 300, 8, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format   | Unknown  | Fallback   | True  |
| 11 | Tensor<[1, 320, 30, 40]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format  | Unknown  | Fallback   | True  |
| 12 | Tensor<[1, 4800, 128]> self = ?                                                              | Unknown  | Fallback   | True  |
| 13 | Tensor<[1, 4800, 2, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format  | Unknown  | Fallback   | True  |
| 14 | Tensor<[1, 4800, 512]> self = ?                                                              | Unknown  | Fallback   | True  |
| 15 | Tensor<[1, 5, 1200, 300]> self = ?                                                           | Unknown  | Fallback   | True  |
| 16 | Tensor<[1, 512, 15, 20]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format  | Unknown  | Fallback   | True  |
| 17 | Tensor<[1, 64, 120, 160]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Unknown  | Fallback   | True  |
| 18 | Tensor<[1, 8, 300, 300]> self = ?                                                            | Unknown  | Fallback   | True  |
...
|  1 | Tensor<[1, 120, 160, 64]> self = ?,<br>List[int] dims = [0, 3, 1, 2] | Unknown  | Unknown    | N/A   |
...
|  5 | Tensor<[1, 15, 20, 512]> self = ?,<br>List[int] dims = [0, 3, 1, 2]  | Unknown  | Unknown    | N/A   |
...
|  9 | Tensor<[1, 30, 40, 320]> self = ?,<br>List[int] dims = [0, 3, 1, 2]  | Unknown  | Unknown    | N/A   |
...
| 18 | Tensor<[1, 60, 80, 128]> self = ?,<br>List[int] dims = [0, 3, 1, 2]  | Unknown  | Unknown    | N/A   |
...
| 14 | Tensor<[1, 19200, 1, 64]> self = ?,<br>List[int] size = [1, 19200, 64]   | Done     | Done       | False |
