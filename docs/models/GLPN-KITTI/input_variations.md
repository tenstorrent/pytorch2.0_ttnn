...
|---:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 32, 120, 160]> input = ?,<br>Optional[Tensor]<[32]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>Tensor<[32]> running_mean = ?,<br>Tensor<[32]> running_var = ?,<br>float momentum = 0.1,<br>float eps = 1e-05 | Done     | Done       | 0.99999  |      8 |
...
|  2 | Tensor<[1, 32, 60, 80]> input = ?,<br>Optional[Tensor]<[32]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>Tensor<[32]> running_mean = ?,<br>Tensor<[32]> running_var = ?,<br>float momentum = 0.1,<br>float eps = 1e-05   | Done     | Done       | 0.999992 |      8 |
|  3 | Tensor<[1, 64, 120, 160]> input = ?,<br>Optional[Tensor]<[64]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>Tensor<[64]> running_mean = ?,<br>Tensor<[64]> running_var = ?,<br>float momentum = 0.1,<br>float eps = 1e-05 | Done     | Done       | 0.999992 |      8 |
|  4 | Tensor<[1, 64, 30, 40]> input = ?,<br>Optional[Tensor]<[64]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>Tensor<[64]> running_mean = ?,<br>Tensor<[64]> running_var = ?,<br>float momentum = 0.1,<br>float eps = 1e-05   | Done     | Done       | 0.99999  |      8 |
|  5 | Tensor<[1, 64, 60, 80]> input = ?,<br>Optional[Tensor]<[64]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>Tensor<[64]> running_mean = ?,<br>Tensor<[64]> running_var = ?,<br>float momentum = 0.1,<br>float eps = 1e-05   | Done     | Done       | 0.99999  |      8 |
...
|  3 | Tensor<[1, 8, 300, 300]> self = ?,<br>int dim = -1,<br>bool half_to_float = False   | Done     | Done       | 0.999595 |      0 |
...
| 10 | Tensor<[120]> self = ?,<br>Optional[int] dtype = torch.int64                | None     | Fallback   |     1 |     -1 |
| 11 | Tensor<[160]> self = ?,<br>Optional[int] dtype = torch.int64                | None     | Fallback   |     1 |     -1 |
| 12 | Tensor<[240]> self = ?,<br>Optional[int] dtype = torch.int64                | None     | Fallback   |     1 |     -1 |
| 13 | Tensor<[30]> self = ?,<br>Optional[int] dtype = torch.int64                 | None     | Fallback   |     1 |     -1 |
| 14 | Tensor<[320]> self = ?,<br>Optional[int] dtype = torch.int64                | None     | Fallback   |     1 |     -1 |
| 15 | Tensor<[40]> self = ?,<br>Optional[int] dtype = torch.int64                 | None     | Fallback   |     1 |     -1 |
| 16 | Tensor<[480]> self = ?,<br>Optional[int] dtype = torch.int64                | None     | Fallback   |     1 |     -1 |
| 17 | Tensor<[60]> self = ?,<br>Optional[int] dtype = torch.int64                 | None     | Fallback   |     1 |     -1 |
| 18 | Tensor<[640]> self = ?,<br>Optional[int] dtype = torch.int64                | None     | Fallback   |     1 |     -1 |
| 19 | Tensor<[80]> self = ?,<br>Optional[int] dtype = torch.int64                 | None     | Fallback   |     1 |     -1 |
...
|  9 | Tensor<[120]> self = ?,<br>Tensor other = 0.5                              | Done     | Done       | 0.999999 |      0 |
| 10 | Tensor<[160]> self = ?,<br>Tensor other = 0.5                              | Done     | Done       | 0.999998 |      0 |
| 11 | Tensor<[240]> self = ?,<br>Tensor other = 0.5                              | Done     | Done       | 0.999998 |      0 |
| 12 | Tensor<[30]> self = ?,<br>Tensor other = 0.5                               | Done     | Done       | 0.999999 |      0 |
| 13 | Tensor<[320]> self = ?,<br>Tensor other = 0.5                              | None     | Fallback   | 1        |     -1 |
| 14 | Tensor<[40]> self = ?,<br>Tensor other = 0.5                               | Done     | Done       | 0.999998 |      0 |
| 15 | Tensor<[480]> self = ?,<br>Tensor other = 0.5                              | Done     | Done       | 0.999998 |      0 |
| 16 | Tensor<[60]> self = ?,<br>Tensor other = 0.5                               | Done     | Done       | 0.999999 |      0 |
| 17 | Tensor<[640]> self = ?,<br>Tensor other = 0.5                              | Done     | Done       | 0.999997 |      0 |
| 18 | Tensor<[80]> self = ?,<br>Tensor other = 0.5                               | Done     | Done       | 0.999994 |      0 |
### aten.addmm.default
|    | ATen Input Variations                                                                     | Status   | Isolated   |      PCC |   Host |
|---:|:------------------------------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
...
|  9 | Tensor<[512]> self = ?,<br>Tensor<[300, 2048]> mat1 = ?,<br>Tensor<[2048, 512]> mat2 = ?  | Done     | Done       | 0.999608 |      0 |
...
|    | ATen Input Variations                                                                                                            | Status   | Isolated   |   PCC |   Host |
|---:|:---------------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|------:|-------:|
|  0 | number end = 120,<br>Optional[int] dtype = torch.float32,<br>Optional[Device] device = cpu,<br>Optional[bool] pin_memory = False | None     | Fallback   |     1 |     -1 |
|  1 | number end = 160,<br>Optional[int] dtype = torch.float32,<br>Optional[Device] device = cpu,<br>Optional[bool] pin_memory = False | None     | Fallback   |     1 |     -1 |
|  2 | number end = 240,<br>Optional[int] dtype = torch.float32,<br>Optional[Device] device = cpu,<br>Optional[bool] pin_memory = False | None     | Fallback   |     1 |     -1 |
|  3 | number end = 30,<br>Optional[int] dtype = torch.float32,<br>Optional[Device] device = cpu,<br>Optional[bool] pin_memory = False  | None     | Fallback   |     1 |     -1 |
|  4 | number end = 320,<br>Optional[int] dtype = torch.float32,<br>Optional[Device] device = cpu,<br>Optional[bool] pin_memory = False | None     | Fallback   |     1 |     -1 |
|  5 | number end = 40,<br>Optional[int] dtype = torch.float32,<br>Optional[Device] device = cpu,<br>Optional[bool] pin_memory = False  | None     | Fallback   |     1 |     -1 |
|  6 | number end = 480,<br>Optional[int] dtype = torch.float32,<br>Optional[Device] device = cpu,<br>Optional[bool] pin_memory = False | None     | Fallback   |     1 |     -1 |
|  7 | number end = 60,<br>Optional[int] dtype = torch.float32,<br>Optional[Device] device = cpu,<br>Optional[bool] pin_memory = False  | None     | Fallback   |     1 |     -1 |
|  8 | number end = 640,<br>Optional[int] dtype = torch.float32,<br>Optional[Device] device = cpu,<br>Optional[bool] pin_memory = False | None     | Fallback   |     1 |     -1 |
|  9 | number end = 80,<br>Optional[int] dtype = torch.float32,<br>Optional[Device] device = cpu,<br>Optional[bool] pin_memory = False  | None     | Fallback   |     1 |     -1 |
### aten.bmm.default
|    | ATen Input Variations                                              | Status   | Isolated   |      PCC |   Host |
|---:|:-------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
...
|    | ATen Input Variations   | Status   | Isolated   |   PCC |   Host |
|---:|:------------------------|:---------|:-----------|------:|-------:|
|  0 | Tensor<[120]> self = ?  | None     | Fallback   |     1 |     -1 |
|  1 | Tensor<[160]> self = ?  | None     | Fallback   |     1 |     -1 |
|  2 | Tensor<[240]> self = ?  | None     | Fallback   |     1 |     -1 |
|  3 | Tensor<[30]> self = ?   | None     | Fallback   |     1 |     -1 |
|  4 | Tensor<[320]> self = ?  | None     | Fallback   |     1 |     -1 |
|  5 | Tensor<[40]> self = ?   | None     | Fallback   |     1 |     -1 |
|  6 | Tensor<[480]> self = ?  | None     | Fallback   |     1 |     -1 |
|  7 | Tensor<[60]> self = ?   | None     | Fallback   |     1 |     -1 |
|  8 | Tensor<[640]> self = ?  | None     | Fallback   |     1 |     -1 |
|  9 | Tensor<[80]> self = ?   | None     | Fallback   |     1 |     -1 |
### aten.clamp.default
|    | ATen Input Variations                                                              | Status   | Isolated   |   PCC |   Host |
|---:|:-----------------------------------------------------------------------------------|:---------|:-----------|------:|-------:|
|  0 | Tensor<[120]> self = ?,<br>Optional[number] min = 0.0                              | None     | Fallback   |     1 |     -1 |
|  1 | Tensor<[120]> self = ?,<br>Optional[number] min = ?,<br>Optional[number] max = 59  | None     | Fallback   |     1 |     -1 |
|  2 | Tensor<[160]> self = ?,<br>Optional[number] min = 0.0                              | None     | Fallback   |     1 |     -1 |
|  3 | Tensor<[160]> self = ?,<br>Optional[number] min = ?,<br>Optional[number] max = 79  | None     | Fallback   |     1 |     -1 |
|  4 | Tensor<[240]> self = ?,<br>Optional[number] min = 0.0                              | None     | Fallback   |     1 |     -1 |
|  5 | Tensor<[240]> self = ?,<br>Optional[number] min = ?,<br>Optional[number] max = 119 | None     | Fallback   |     1 |     -1 |
|  6 | Tensor<[30]> self = ?,<br>Optional[number] min = 0.0                               | None     | Fallback   |     1 |     -1 |
|  7 | Tensor<[30]> self = ?,<br>Optional[number] min = ?,<br>Optional[number] max = 14   | None     | Fallback   |     1 |     -1 |
|  8 | Tensor<[320]> self = ?,<br>Optional[number] min = 0.0                              | None     | Fallback   |     1 |     -1 |
|  9 | Tensor<[320]> self = ?,<br>Optional[number] min = ?,<br>Optional[number] max = 159 | None     | Fallback   |     1 |     -1 |
| 10 | Tensor<[40]> self = ?,<br>Optional[number] min = 0.0                               | None     | Fallback   |     1 |     -1 |
| 11 | Tensor<[40]> self = ?,<br>Optional[number] min = ?,<br>Optional[number] max = 19   | None     | Fallback   |     1 |     -1 |
| 12 | Tensor<[480]> self = ?,<br>Optional[number] min = 0.0                              | None     | Fallback   |     1 |     -1 |
| 13 | Tensor<[480]> self = ?,<br>Optional[number] min = ?,<br>Optional[number] max = 239 | None     | Fallback   |     1 |     -1 |
| 14 | Tensor<[60]> self = ?,<br>Optional[number] min = 0.0                               | None     | Fallback   |     1 |     -1 |
| 15 | Tensor<[60]> self = ?,<br>Optional[number] min = ?,<br>Optional[number] max = 29   | None     | Fallback   |     1 |     -1 |
| 16 | Tensor<[640]> self = ?,<br>Optional[number] min = 0.0                              | None     | Fallback   |     1 |     -1 |
| 17 | Tensor<[640]> self = ?,<br>Optional[number] min = ?,<br>Optional[number] max = 319 | None     | Fallback   |     1 |     -1 |
| 18 | Tensor<[80]> self = ?,<br>Optional[number] min = 0.0                               | None     | Fallback   |     1 |     -1 |
| 19 | Tensor<[80]> self = ?,<br>Optional[number] min = ?,<br>Optional[number] max = 39   | None     | Fallback   |     1 |     -1 |
### aten.clone.default
|    | ATen Input Variations                                                                        | Status   | Isolated   |   PCC |   Host |
|---:|:---------------------------------------------------------------------------------------------|:---------|:-----------|------:|-------:|
...
|    | ATen Input Variations                                                                                                                                                                                                                                                                                 | Status   | Isolated   |      PCC |   Host |
|---:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 128, 120, 160]> input = ?,<br>Tensor<[64, 128, 3, 3]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1     | Done     | Done       | 0.999813 |      7 |
|  1 | Tensor<[1, 128, 30, 40]> input = ?,<br>Tensor<[64, 128, 3, 3]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1       | Done     | Done       | 0.999817 |      7 |
|  2 | Tensor<[1, 128, 60, 80]> input = ?,<br>Tensor<[128, 128, 4, 4]> weight = ?,<br>Optional[Tensor]<[128]> bias = ?,<br>List[int] stride = [4, 4],<br>List[int] padding = [0, 0],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1     | Done     | Done       | 0.999608 |      7 |
|  3 | Tensor<[1, 128, 60, 80]> input = ?,<br>Tensor<[320, 128, 3, 3]> weight = ?,<br>Optional[Tensor]<[320]> bias = ?,<br>List[int] stride = [2, 2],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1     | Done     | Done       | 0.999814 |      7 |
|  4 | Tensor<[1, 128, 60, 80]> input = ?,<br>Tensor<[64, 128, 1, 1]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [0, 0],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1       | Done     | Done       | 0.99998  |      7 |
|  5 | Tensor<[1, 128, 60, 80]> input = ?,<br>Tensor<[64, 128, 3, 3]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1       | Done     | Done       | 0.999814 |      7 |
|  6 | Tensor<[1, 1280, 30, 40]> input = ?,<br>Tensor<[1280, 1, 3, 3]> weight = ?,<br>Optional[Tensor]<[1280]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1280 | Done     | Done       | 0.999983 |      7 |
...
|  9 | Tensor<[1, 3, 480, 640]> input = ?,<br>Tensor<[64, 3, 7, 7]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int] stride = [4, 4],<br>List[int] padding = [3, 3],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1         | Done     | Done       | 0.999898 |      7 |
| 10 | Tensor<[1, 32, 120, 160]> input = ?,<br>Tensor<[2, 32, 3, 3]> weight = ?,<br>Optional[Tensor]<[2]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1         | Done     | Done       | 0.999961 |      7 |
| 11 | Tensor<[1, 32, 30, 40]> input = ?,<br>Tensor<[2, 32, 3, 3]> weight = ?,<br>Optional[Tensor]<[2]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1           | Done     | Done       | 0.999962 |      7 |
| 12 | Tensor<[1, 32, 60, 80]> input = ?,<br>Tensor<[2, 32, 3, 3]> weight = ?,<br>Optional[Tensor]<[2]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1           | Done     | Done       | 0.999961 |      7 |
| 13 | Tensor<[1, 320, 30, 40]> input = ?,<br>Tensor<[320, 320, 2, 2]> weight = ?,<br>Optional[Tensor]<[320]> bias = ?,<br>List[int] stride = [2, 2],<br>List[int] padding = [0, 0],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1     | Done     | Done       | 0.999784 |      7 |
| 14 | Tensor<[1, 320, 30, 40]> input = ?,<br>Tensor<[512, 320, 3, 3]> weight = ?,<br>Optional[Tensor]<[512]> bias = ?,<br>List[int] stride = [2, 2],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1     | Done     | Done       | 0.999394 |      7 |
| 15 | Tensor<[1, 320, 30, 40]> input = ?,<br>Tensor<[64, 320, 1, 1]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [0, 0],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1       | Done     | Done       | 0.999956 |      7 |
| 16 | Tensor<[1, 512, 15, 20]> input = ?,<br>Tensor<[64, 512, 1, 1]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [0, 0],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1       | Done     | Done       | 0.999927 |      7 |
| 17 | Tensor<[1, 512, 60, 80]> input = ?,<br>Tensor<[512, 1, 3, 3]> weight = ?,<br>Optional[Tensor]<[512]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 512     | Done     | Done       | 0.999983 |      7 |
| 18 | Tensor<[1, 64, 120, 160]> input = ?,<br>Tensor<[128, 64, 3, 3]> weight = ?,<br>Optional[Tensor]<[128]> bias = ?,<br>List[int] stride = [2, 2],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1     | Done     | Done       | 0.999918 |      7 |
| 19 | Tensor<[1, 64, 120, 160]> input = ?,<br>Tensor<[32, 64, 3, 3]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1       | Done     | Done       | 0.999918 |      7 |
| 20 | Tensor<[1, 64, 120, 160]> input = ?,<br>Tensor<[64, 64, 8, 8]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int] stride = [8, 8],<br>List[int] padding = [0, 0],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1       | Done     | Done       | 0.999    |      7 |
| 21 | Tensor<[1, 64, 30, 40]> input = ?,<br>Tensor<[32, 64, 3, 3]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1         | Done     | Done       | 0.99992  |      7 |
...
| 24 | Tensor<[1, 64, 60, 80]> input = ?,<br>Tensor<[32, 64, 3, 3]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1         | Done     | Done       | 0.99992  |      7 |
### aten.div.Tensor
|    | ATen Input Variations                                      | Status   | Isolated   |   PCC |   Host |
|---:|:-----------------------------------------------------------|:---------|:-----------|------:|-------:|
...
|  1 | Tensor<[1, 64, 120, 160]> self = ?,<br>Tensor<[1, 1, 120, 160]> other = ? | None     | Fallback   | 1        |     -1 |
...
|  6 | Tensor<[1, 64, 30, 40]> self = ?,<br>Tensor<[1, 1, 30, 40]> other = ?     | None     | Fallback   | 1        |     -1 |
|  7 | Tensor<[1, 64, 30, 40]> self = ?,<br>Tensor<[30, 1]> other = ?            | Done     | Done       | 0.999995 |      0 |
...
| 11 | Tensor<[1, 64, 60, 80]> self = ?,<br>Tensor<[1, 1, 60, 80]> other = ?     | None     | Fallback   | 1        |     -1 |
...
| 14 | Tensor<[120]> self = ?,<br>Tensor other = 0.5                             | Done     | Done       | 1        |      0 |
| 15 | Tensor<[160]> self = ?,<br>Tensor other = 0.5                             | Done     | Done       | 1        |      0 |
| 16 | Tensor<[240]> self = ?,<br>Tensor other = 0.5                             | Done     | Done       | 1        |      0 |
| 17 | Tensor<[30]> self = ?,<br>Tensor other = 0.5                              | Done     | Done       | 1        |      0 |
| 18 | Tensor<[320]> self = ?,<br>Tensor other = 0.5                             | Done     | Done       | 1        |      0 |
| 19 | Tensor<[40]> self = ?,<br>Tensor other = 0.5                              | Done     | Done       | 1        |      0 |
| 20 | Tensor<[480]> self = ?,<br>Tensor other = 0.5                             | Done     | Done       | 1        |      0 |
| 21 | Tensor<[60]> self = ?,<br>Tensor other = 0.5                              | Done     | Done       | 1        |      0 |
| 22 | Tensor<[640]> self = ?,<br>Tensor other = 0.5                             | Done     | Done       | 1        |      0 |
| 23 | Tensor<[80]> self = ?,<br>Tensor other = 0.5                              | Done     | Done       | 1        |      0 |
...
|    | ATen Input Variations                            | Status   | Isolated   |      PCC |   Host |
|---:|:-------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[120, 1]> self = ?,<br>number other = 1.0 | Done     | Done       | 0.999994 |      0 |
|  1 | Tensor<[160]> self = ?,<br>number other = 1.0    | Done     | Done       | 0.999993 |      0 |
|  2 | Tensor<[240, 1]> self = ?,<br>number other = 1.0 | Done     | Done       | 0.999993 |      0 |
|  3 | Tensor<[30, 1]> self = ?,<br>number other = 1.0  | Done     | Done       | 0.999995 |      0 |
|  4 | Tensor<[320]> self = ?,<br>number other = 1.0    | Done     | Done       | 0.999993 |      0 |
|  5 | Tensor<[40]> self = ?,<br>number other = 1.0     | Done     | Done       | 0.999989 |      0 |
|  6 | Tensor<[480, 1]> self = ?,<br>number other = 1.0 | Done     | Done       | 0.999993 |      0 |
|  7 | Tensor<[60, 1]> self = ?,<br>number other = 1.0  | Done     | Done       | 0.999993 |      0 |
|  8 | Tensor<[640]> self = ?,<br>number other = 1.0    | Done     | Done       | 0.999993 |      0 |
|  9 | Tensor<[80]> self = ?,<br>number other = 1.0     | Done     | Done       | 0.999997 |      0 |
### aten.select.int
|    | ATen Input Variations                                               | Status   | Isolated   |   PCC |   Host |
|---:|:--------------------------------------------------------------------|:---------|:-----------|------:|-------:|
...
|  2 | Tensor<[1, 2, 30, 40]> self = ?   | Done     | Done       | 0.9997484301869491 | 0      |
|  3 | Tensor<[1, 2, 60, 80]> self = ?   | Done     | Done       | 0.9997565351824358 | 0      |
### aten.slice.Tensor
|    | ATen Input Variations                                                                                                     | Status   | Isolated   |   PCC |   Host |
|---:|:--------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|------:|-------:|
...
|    | ATen Input Variations                                    | Status   | Isolated   |      PCC |   Host |
|---:|:---------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[120, 1]> self = ?,<br>Tensor<[120, 1]> other = ? | Done     | Done       | 0.999998 |      0 |
|  1 | Tensor<[120]> self = ?,<br>Tensor other = 0.5            | Done     | Done       | 0.999999 |      0 |
|  2 | Tensor<[160]> self = ?,<br>Tensor other = 0.5            | Done     | Done       | 0.999998 |      0 |
|  3 | Tensor<[160]> self = ?,<br>Tensor<[160]> other = ?       | Done     | Done       | 0.999998 |      0 |
|  4 | Tensor<[240, 1]> self = ?,<br>Tensor<[240, 1]> other = ? | Done     | Done       | 0.999998 |      0 |
|  5 | Tensor<[240]> self = ?,<br>Tensor other = 0.5            | Done     | Done       | 0.999998 |      0 |
|  6 | Tensor<[30, 1]> self = ?,<br>Tensor<[30, 1]> other = ?   | Done     | Done       | 0.999999 |      0 |
|  7 | Tensor<[30]> self = ?,<br>Tensor other = 0.5             | Done     | Done       | 0.999997 |      0 |
|  8 | Tensor<[320]> self = ?,<br>Tensor other = 0.5            | None     | Fallback   | 1        |     -1 |
|  9 | Tensor<[320]> self = ?,<br>Tensor<[320]> other = ?       | Done     | Done       | 0.999997 |      0 |
| 10 | Tensor<[40]> self = ?,<br>Tensor other = 0.5             | Done     | Done       | 0.999997 |      0 |
| 11 | Tensor<[40]> self = ?,<br>Tensor<[40]> other = ?         | Done     | Done       | 0.999998 |      0 |
| 12 | Tensor<[480, 1]> self = ?,<br>Tensor<[480, 1]> other = ? | Done     | Done       | 0.999998 |      0 |
| 13 | Tensor<[480]> self = ?,<br>Tensor other = 0.5            | Done     | Done       | 0.999997 |      0 |
| 14 | Tensor<[60, 1]> self = ?,<br>Tensor<[60, 1]> other = ?   | Done     | Done       | 0.999999 |      0 |
| 15 | Tensor<[60]> self = ?,<br>Tensor other = 0.5             | Done     | Done       | 0.999997 |      0 |
| 16 | Tensor<[640]> self = ?,<br>Tensor other = 0.5            | Done     | Done       | 0.999997 |      0 |
| 17 | Tensor<[640]> self = ?,<br>Tensor<[640]> other = ?       | Done     | Done       | 0.999998 |      0 |
| 18 | Tensor<[80]> self = ?,<br>Tensor other = 0.5             | Done     | Done       | 0.999998 |      0 |
| 19 | Tensor<[80]> self = ?,<br>Tensor<[80]> other = ?         | Done     | Done       | 0.999999 |      0 |
### aten.t.default
|    | ATen Input Variations        | Status   | Isolated   |   PCC |   Host |
|---:|:-----------------------------|:---------|:-----------|------:|-------:|
...
|  3 | Tensor<[120]> self = ?,<br>int dim = 1         | Done     | Done       |     1 |      0 |
|  4 | Tensor<[240]> self = ?,<br>int dim = 1         | None     | Fallback   |     1 |     -1 |
|  5 | Tensor<[30]> self = ?,<br>int dim = 1          | Done     | Done       |     1 |      0 |
|  6 | Tensor<[480]> self = ?,<br>int dim = 1         | Done     | Done       |     1 |      0 |
|  7 | Tensor<[60]> self = ?,<br>int dim = 1          | Done     | Done       |     1 |      0 |
### aten.view.default
|    | ATen Input Variations                                                    | Status   | Isolated   |   PCC |   Host |
|---:|:-------------------------------------------------------------------------|:---------|:-----------|------:|-------:|
