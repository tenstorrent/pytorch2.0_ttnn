...
|  1 | Tensor<[1, 1200, 1280]> self = ?                                                               | Unknown  |
...
|  5 | Tensor<[1, 19200, 256]> self = ?                                                               | Unknown  |
|  6 | Tensor<[1, 19200, 64]> self = ?                                                                | Unknown  |
|  7 | Tensor<[1, 2, 4800, 300]> self = ?                                                             | Done     |
|  8 | Tensor<[1, 300, 2048]> self = ?                                                                | Unknown  |
...
| 14 | Tensor<[1, 4800, 512]> self = ?                                                                | Unknown  |
