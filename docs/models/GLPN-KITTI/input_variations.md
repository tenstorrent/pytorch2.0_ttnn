...
| 16 | aten.mul.Tensor                                   |                 24 |          13 |        10 |          0 | 🚧          |    0.96 |
...
|---:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 32, 120, 160]> input = ?,<br>Optional[Tensor]<[32]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>Tensor<[32]> running_mean = ?,<br>Tensor<[32]> running_var = ?,<br>float momentum = 0.1,<br>float eps = 1e-05 | Done     | Done       | 0.999992 |      8 |
...
|  3 | Tensor<[1, 64, 120, 160]> input = ?,<br>Optional[Tensor]<[64]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>Tensor<[64]> running_mean = ?,<br>Tensor<[64]> running_var = ?,<br>float momentum = 0.1,<br>float eps = 1e-05 | Done     | Done       | 0.999987 |      8 |
|  4 | Tensor<[1, 64, 30, 40]> input = ?,<br>Optional[Tensor]<[64]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>Tensor<[64]> running_mean = ?,<br>Tensor<[64]> running_var = ?,<br>float momentum = 0.1,<br>float eps = 1e-05   | Done     | Done       | 0.999992 |      8 |
|  5 | Tensor<[1, 64, 60, 80]> input = ?,<br>Optional[Tensor]<[64]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>Tensor<[64]> running_mean = ?,<br>Tensor<[64]> running_var = ?,<br>float momentum = 0.1,<br>float eps = 1e-05   | Done     | Done       | 0.999989 |      8 |
...
|  9 | Tensor<[120]> self = ?,<br>Tensor other = 0.5                              | Removed  | Fallback   | 1        |     -1 |
| 10 | Tensor<[160]> self = ?,<br>Tensor other = 0.5                              | Removed  | Fallback   | 1        |     -1 |
| 11 | Tensor<[240]> self = ?,<br>Tensor other = 0.5                              | Removed  | Fallback   | 1        |     -1 |
| 12 | Tensor<[30]> self = ?,<br>Tensor other = 0.5                               | Removed  | Fallback   | 1        |     -1 |
| 13 | Tensor<[320]> self = ?,<br>Tensor other = 0.5                              | Removed  | Fallback   | 1        |     -1 |
| 14 | Tensor<[40]> self = ?,<br>Tensor other = 0.5                               | Removed  | Fallback   | 1        |     -1 |
| 15 | Tensor<[480]> self = ?,<br>Tensor other = 0.5                              | Removed  | Fallback   | 1        |     -1 |
| 16 | Tensor<[60]> self = ?,<br>Tensor other = 0.5                               | Removed  | Fallback   | 1        |     -1 |
| 17 | Tensor<[640]> self = ?,<br>Tensor other = 0.5                              | Removed  | Fallback   | 1        |     -1 |
| 18 | Tensor<[80]> self = ?,<br>Tensor other = 0.5                               | Removed  | Fallback   | 1        |     -1 |
### aten.addmm.default
|    | ATen Input Variations                                                                     | Status   | Isolated   |      PCC |   Host |
|---:|:------------------------------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
...
|  1 | Tensor<[1, 128, 30, 40]> input = ?,<br>Tensor<[64, 128, 3, 3]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1       | Done     | Done       | 0.999818 |      8 |
...
|  3 | Tensor<[1, 128, 60, 80]> input = ?,<br>Tensor<[320, 128, 3, 3]> weight = ?,<br>Optional[Tensor]<[320]> bias = ?,<br>List[int] stride = [2, 2],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1     | Done     | Done       | 0.999813 |      8 |
...
| 11 | Tensor<[1, 32, 30, 40]> input = ?,<br>Tensor<[2, 32, 3, 3]> weight = ?,<br>Optional[Tensor]<[2]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1           | Done     | Done       | 0.999963 |      8 |
| 12 | Tensor<[1, 32, 60, 80]> input = ?,<br>Tensor<[2, 32, 3, 3]> weight = ?,<br>Optional[Tensor]<[2]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1           | Done     | Done       | 0.999963 |      8 |
| 13 | Tensor<[1, 320, 30, 40]> input = ?,<br>Tensor<[320, 320, 2, 2]> weight = ?,<br>Optional[Tensor]<[320]> bias = ?,<br>List[int] stride = [2, 2],<br>List[int] padding = [0, 0],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1     | Done     | Done       | 0.999787 |      8 |
...
| 19 | Tensor<[1, 64, 120, 160]> input = ?,<br>Tensor<[32, 64, 3, 3]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1       | Done     | Done       | 0.999919 |      8 |
| 20 | Tensor<[1, 64, 120, 160]> input = ?,<br>Tensor<[64, 64, 8, 8]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int] stride = [8, 8],<br>List[int] padding = [0, 0],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1       | Done     | Done       | 0.999006 |      8 |
| 21 | Tensor<[1, 64, 30, 40]> input = ?,<br>Tensor<[32, 64, 3, 3]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1         | Done     | Done       | 0.999921 |      8 |
...
| 24 | Tensor<[1, 64, 60, 80]> input = ?,<br>Tensor<[32, 64, 3, 3]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>List[int] stride = [1, 1],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1         | Done     | Done       | 0.999919 |      8 |
### aten.div.Tensor
|    | ATen Input Variations                                      | Status   | Isolated   |   PCC |   Host |
|---:|:-----------------------------------------------------------|:---------|:-----------|------:|-------:|
...
|    | ATen Input Variations                                                     | Status   | Isolated   |      PCC |   Host |
|---:|:--------------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 1, 480, 640]> self = ?,<br>Tensor other = 10                   | None     | Fallback   | 1        |     -1 |
...
| 14 | Tensor<[120]> self = ?,<br>Tensor other = 0.5                             | Removed  | Fallback   | 1        |     -1 |
| 15 | Tensor<[160]> self = ?,<br>Tensor other = 0.5                             | Removed  | Fallback   | 1        |     -1 |
| 16 | Tensor<[240]> self = ?,<br>Tensor other = 0.5                             | Removed  | Fallback   | 1        |     -1 |
| 17 | Tensor<[30]> self = ?,<br>Tensor other = 0.5                              | Removed  | Fallback   | 1        |     -1 |
| 18 | Tensor<[320]> self = ?,<br>Tensor other = 0.5                             | Removed  | Fallback   | 1        |     -1 |
| 19 | Tensor<[40]> self = ?,<br>Tensor other = 0.5                              | Removed  | Fallback   | 1        |     -1 |
| 20 | Tensor<[480]> self = ?,<br>Tensor other = 0.5                             | Removed  | Fallback   | 1        |     -1 |
| 21 | Tensor<[60]> self = ?,<br>Tensor other = 0.5                              | Removed  | Fallback   | 1        |     -1 |
| 22 | Tensor<[640]> self = ?,<br>Tensor other = 0.5                             | Removed  | Fallback   | 1        |     -1 |
| 23 | Tensor<[80]> self = ?,<br>Tensor other = 0.5                              | Removed  | Fallback   | 1        |     -1 |
...
|  1 | Tensor<[120, 1]> self = ?,<br>number other = 1.0 | Removed  | Done       | 0.9999959147026893 | 0      |
|  2 | Tensor<[160]> self = ?,<br>number other = 1.0    | Removed  | Done       | 0.9999943430887991 | 0      |
|  3 | Tensor<[240, 1]> self = ?,<br>number other = 1.0 | Removed  | Done       | 0.9999934417354996 | 0      |
|  4 | Tensor<[30, 1]> self = ?,<br>number other = 1.0  | Removed  | Done       | 0.9999944650670421 | 0      |
|  5 | Tensor<[320]> self = ?,<br>number other = 1.0    | Removed  | Done       | 0.9999943159011164 | 0      |
|  6 | Tensor<[40]> self = ?,<br>number other = 1.0     | Removed  | Done       | 0.9999936877008094 | 0      |
|  7 | Tensor<[480, 1]> self = ?,<br>number other = 1.0 | Removed  | Done       | 0.9999928123599747 | 0      |
|  8 | Tensor<[60, 1]> self = ?,<br>number other = 1.0  | Removed  | Done       | 0.9999960657347324 | 0      |
|  9 | Tensor<[640]> self = ?,<br>number other = 1.0    | Removed  | Done       | 0.9999940898046077 | 0      |
| 10 | Tensor<[80]> self = ?,<br>number other = 1.0     | Removed  | Done       | 0.9999909623438852 | 0      |
### aten.select.int
|    | ATen Input Variations                                               | Status   | Isolated   |   PCC |   Host |
|---:|:--------------------------------------------------------------------|:---------|:-----------|------:|-------:|
...
|  2 | Tensor<[1, 2, 30, 40]> self = ?   | Done     | Done       | 0.9997543571536053 | 0      |
|  3 | Tensor<[1, 2, 60, 80]> self = ?   | Done     | Done       | 0.999744773547576  | 0      |
### aten.slice.Tensor
|    | ATen Input Variations                                                                                                     | Status   | Isolated   |   PCC |   Host |
|---:|:--------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|------:|-------:|
...
|  1 | Tensor<[120]> self = ?,<br>Tensor other = 0.5            | Removed  | Fallback   | 1        |     -1 |
|  2 | Tensor<[160]> self = ?,<br>Tensor other = 0.5            | Removed  | Fallback   | 1        |     -1 |
...
|  5 | Tensor<[240]> self = ?,<br>Tensor other = 0.5            | Removed  | Fallback   | 1        |     -1 |
|  6 | Tensor<[30, 1]> self = ?,<br>Tensor<[30, 1]> other = ?   | Removed  | Done       | 0.999998 |      0 |
|  7 | Tensor<[30]> self = ?,<br>Tensor other = 0.5             | Removed  | Fallback   | 1        |     -1 |
|  8 | Tensor<[320]> self = ?,<br>Tensor other = 0.5            | Removed  | Fallback   | 1        |     -1 |
|  9 | Tensor<[320]> self = ?,<br>Tensor<[320]> other = ?       | Removed  | Done       | 0.999998 |      0 |
| 10 | Tensor<[40]> self = ?,<br>Tensor other = 0.5             | Removed  | Fallback   | 1        |     -1 |
| 11 | Tensor<[40]> self = ?,<br>Tensor<[40]> other = ?         | Removed  | Done       | 1        |      0 |
| 12 | Tensor<[480, 1]> self = ?,<br>Tensor<[480, 1]> other = ? | Removed  | Done       | 0.999998 |      0 |
| 13 | Tensor<[480]> self = ?,<br>Tensor other = 0.5            | Removed  | Fallback   | 1        |     -1 |
| 14 | Tensor<[60, 1]> self = ?,<br>Tensor<[60, 1]> other = ?   | Removed  | Done       | 0.999999 |      0 |
| 15 | Tensor<[60]> self = ?,<br>Tensor other = 0.5             | Removed  | Fallback   | 1        |     -1 |
| 16 | Tensor<[640]> self = ?,<br>Tensor other = 0.5            | Removed  | Fallback   | 1        |     -1 |
| 17 | Tensor<[640]> self = ?,<br>Tensor<[640]> other = ?       | Removed  | Done       | 0.999998 |      0 |
| 18 | Tensor<[80]> self = ?,<br>Tensor other = 0.5             | Removed  | Fallback   | 1        |     -1 |
| 19 | Tensor<[80]> self = ?,<br>Tensor<[80]> other = ?         | Removed  | Done       | 0.999999 |      0 |
### aten.t.default
|    | ATen Input Variations        | Status   | Isolated   |   PCC |   Host |
|---:|:-----------------------------|:---------|:-----------|------:|-------:|
