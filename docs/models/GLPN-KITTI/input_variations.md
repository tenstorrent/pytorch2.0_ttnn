...
|---:|:--------------------------------------------------|-------------------:|------------:|
|  0 | aten._native_batch_norm_legit_no_training.default |                  6 |           6 |
|  1 | aten._softmax.default                             |                  4 |           4 |
|  2 | aten._to_copy.default                             |                 10 |          10 |
|  3 | aten._unsafe_index.Tensor                         |                 25 |          20 |
|  4 | aten.add.Tensor                                   |                 19 |          19 |
|  5 | aten.addmm.default                                |                 15 |          15 |
|  6 | aten.arange.default                               |                 10 |          10 |
|  7 | aten.bmm.default                                  |                  8 |           8 |
|  8 | aten.cat.default                                  |                  6 |           3 |
|  9 | aten.ceil.default                                 |                 10 |          10 |
| 10 | aten.clamp.default                                |                 20 |          20 |
| 11 | aten.clone.default                                |                 19 |          19 |
| 12 | aten.convolution.default                          |                 25 |          25 |
...
| 20 | aten.rsub.Scalar                                  |                 10 |          10 |
| 21 | aten.select.int                                   |                  6 |           6 |
| 22 | aten.sigmoid.default                              |                  4 |           4 |
| 23 | aten.slice.Tensor                                 |                  9 |           9 |
| 24 | aten.squeeze.dim                                  |                  1 |           1 |
| 25 | aten.sub.Tensor                                   |                 20 |          20 |
| 26 | aten.t.default                                    |                 12 |          12 |
| 27 | aten.transpose.int                                |                 16 |          16 |
| 28 | aten.unsqueeze.default                            |                  8 |           8 |
| 29 | aten.view.default                                 |                 78 |          78 |
***
### aten._native_batch_norm_legit_no_training.default
|    | ATen Input Variations                                                                                                                                                                                                               | Status   |
|---:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 32, 120, 160]> input = ?,<br>Optional[Tensor]<[32]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>Tensor<[32]> running_mean = ?,<br>Tensor<[32]> running_var = ?,<br>float<> momentum = 0.1,<br>float<> eps = 1e-05 | Done     |
|  1 | Tensor<[1, 32, 30, 40]> input = ?,<br>Optional[Tensor]<[32]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>Tensor<[32]> running_mean = ?,<br>Tensor<[32]> running_var = ?,<br>float<> momentum = 0.1,<br>float<> eps = 1e-05   | Done     |
|  2 | Tensor<[1, 32, 60, 80]> input = ?,<br>Optional[Tensor]<[32]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>Tensor<[32]> running_mean = ?,<br>Tensor<[32]> running_var = ?,<br>float<> momentum = 0.1,<br>float<> eps = 1e-05   | Done     |
|  3 | Tensor<[1, 64, 120, 160]> input = ?,<br>Optional[Tensor]<[64]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>Tensor<[64]> running_mean = ?,<br>Tensor<[64]> running_var = ?,<br>float<> momentum = 0.1,<br>float<> eps = 1e-05 | Done     |
|  4 | Tensor<[1, 64, 30, 40]> input = ?,<br>Optional[Tensor]<[64]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>Tensor<[64]> running_mean = ?,<br>Tensor<[64]> running_var = ?,<br>float<> momentum = 0.1,<br>float<> eps = 1e-05   | Done     |
|  5 | Tensor<[1, 64, 60, 80]> input = ?,<br>Optional[Tensor]<[64]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>Tensor<[64]> running_mean = ?,<br>Tensor<[64]> running_var = ?,<br>float<> momentum = 0.1,<br>float<> eps = 1e-05   | Done     |
...
|    | ATen Input Variations                                          | Status   |
|---:|:---------------------------------------------------------------|:---------|
|  0 | Tensor<[120]> self = ?,<br>Optional[int]<> dtype = torch.int64 | Done     |
|  1 | Tensor<[160]> self = ?,<br>Optional[int]<> dtype = torch.int64 | Done     |
|  2 | Tensor<[240]> self = ?,<br>Optional[int]<> dtype = torch.int64 | Done     |
|  3 | Tensor<[30]> self = ?,<br>Optional[int]<> dtype = torch.int64  | Done     |
|  4 | Tensor<[320]> self = ?,<br>Optional[int]<> dtype = torch.int64 | Done     |
|  5 | Tensor<[40]> self = ?,<br>Optional[int]<> dtype = torch.int64  | Done     |
|  6 | Tensor<[480]> self = ?,<br>Optional[int]<> dtype = torch.int64 | Done     |
|  7 | Tensor<[60]> self = ?,<br>Optional[int]<> dtype = torch.int64  | Done     |
|  8 | Tensor<[640]> self = ?,<br>Optional[int]<> dtype = torch.int64 | Done     |
|  9 | Tensor<[80]> self = ?,<br>Optional[int]<> dtype = torch.int64  | Done     |
### aten._unsafe_index.Tensor
|    | ATen Input Variations                                                                                                                           | Status   |
|---:|:------------------------------------------------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 64, 120, 160]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, 'torch.Size([240, 1])', 'torch.Size([320])']             | Unknown  |
|  1 | Tensor<[1, 64, 120, 160]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_16), Proxy(_to_copy_default_14)] | Done     |
|  2 | Tensor<[1, 64, 120, 160]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_16), Proxy(_to_copy_default_15)] | Done     |
|  3 | Tensor<[1, 64, 120, 160]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_17), Proxy(_to_copy_default_14)] | Done     |
|  4 | Tensor<[1, 64, 120, 160]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_17), Proxy(_to_copy_default_15)] | Done     |
|  5 | Tensor<[1, 64, 15, 20]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, 'torch.Size([30, 1])', 'torch.Size([40])']                 | Unknown  |
|  6 | Tensor<[1, 64, 15, 20]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_1), Proxy(_to_copy_default_2)]     | Done     |
|  7 | Tensor<[1, 64, 15, 20]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_1), Proxy(_to_copy_default_3)]     | Done     |
|  8 | Tensor<[1, 64, 15, 20]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_2), Proxy(_to_copy_default_2)]     | Done     |
|  9 | Tensor<[1, 64, 15, 20]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_2), Proxy(_to_copy_default_3)]     | Done     |
| 10 | Tensor<[1, 64, 240, 320]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, 'torch.Size([480, 1])', 'torch.Size([640])']             | Unknown  |
| 11 | Tensor<[1, 64, 240, 320]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_19), Proxy(_to_copy_default_18)] | Done     |
| 12 | Tensor<[1, 64, 240, 320]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_19), Proxy(_to_copy_default_19)] | Done     |
| 13 | Tensor<[1, 64, 240, 320]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_20), Proxy(_to_copy_default_18)] | Done     |
| 14 | Tensor<[1, 64, 240, 320]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_20), Proxy(_to_copy_default_19)] | Done     |
| 15 | Tensor<[1, 64, 30, 40]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, 'torch.Size([60, 1])', 'torch.Size([80])']                 | Unknown  |
| 16 | Tensor<[1, 64, 30, 40]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_6), Proxy(_to_copy_default_6)]     | Done     |
| 17 | Tensor<[1, 64, 30, 40]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_6), Proxy(_to_copy_default_7)]     | Done     |
| 18 | Tensor<[1, 64, 30, 40]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_7), Proxy(_to_copy_default_6)]     | Done     |
| 19 | Tensor<[1, 64, 30, 40]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_7), Proxy(_to_copy_default_7)]     | Done     |
| 20 | Tensor<[1, 64, 60, 80]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, 'torch.Size([120, 1])', 'torch.Size([160])']               | Unknown  |
| 21 | Tensor<[1, 64, 60, 80]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_11), Proxy(_to_copy_default_10)]   | Done     |
| 22 | Tensor<[1, 64, 60, 80]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_11), Proxy(_to_copy_default_11)]   | Done     |
| 23 | Tensor<[1, 64, 60, 80]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_12), Proxy(_to_copy_default_10)]   | Done     |
| 24 | Tensor<[1, 64, 60, 80]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, Proxy(unsqueeze_default_12), Proxy(_to_copy_default_11)]   | Done     |
### aten.add.Tensor
|    | ATen Input Variations                                                      | Status   |
|---:|:---------------------------------------------------------------------------|:---------|
...
|    | ATen Input Variations                                                                                                                    | Status   |
|---:|:-----------------------------------------------------------------------------------------------------------------------------------------|:---------|
|  0 | number<> end = 120,<br>Optional[int]<> dtype = torch.float32,<br>Optional[Device]<> device = cpu,<br>Optional[bool]<> pin_memory = False | Done     |
|  1 | number<> end = 160,<br>Optional[int]<> dtype = torch.float32,<br>Optional[Device]<> device = cpu,<br>Optional[bool]<> pin_memory = False | Done     |
|  2 | number<> end = 240,<br>Optional[int]<> dtype = torch.float32,<br>Optional[Device]<> device = cpu,<br>Optional[bool]<> pin_memory = False | Done     |
|  3 | number<> end = 30,<br>Optional[int]<> dtype = torch.float32,<br>Optional[Device]<> device = cpu,<br>Optional[bool]<> pin_memory = False  | Done     |
|  4 | number<> end = 320,<br>Optional[int]<> dtype = torch.float32,<br>Optional[Device]<> device = cpu,<br>Optional[bool]<> pin_memory = False | Done     |
|  5 | number<> end = 40,<br>Optional[int]<> dtype = torch.float32,<br>Optional[Device]<> device = cpu,<br>Optional[bool]<> pin_memory = False  | Done     |
|  6 | number<> end = 480,<br>Optional[int]<> dtype = torch.float32,<br>Optional[Device]<> device = cpu,<br>Optional[bool]<> pin_memory = False | Done     |
|  7 | number<> end = 60,<br>Optional[int]<> dtype = torch.float32,<br>Optional[Device]<> device = cpu,<br>Optional[bool]<> pin_memory = False  | Done     |
|  8 | number<> end = 640,<br>Optional[int]<> dtype = torch.float32,<br>Optional[Device]<> device = cpu,<br>Optional[bool]<> pin_memory = False | Done     |
|  9 | number<> end = 80,<br>Optional[int]<> dtype = torch.float32,<br>Optional[Device]<> device = cpu,<br>Optional[bool]<> pin_memory = False  | Done     |
### aten.bmm.default
|    | ATen Input Variations                                              | Status   |
|---:|:-------------------------------------------------------------------|:---------|
...
|  3 | List[Tensor]<> tensors = [Proxy(clone_default_12), Proxy(ttnn_add_344)],<br>int<> dim = 1                     | Done     |
|  4 | List[Tensor]<> tensors = [Proxy(convolution_default_84), Proxy(ttnn_add_332)],<br>int<> dim = 1               | Done     |
|  5 | List[Tensor]<> tensors = [Proxy(convolution_default_88), Proxy(ttnn_add_338)],<br>int<> dim = 1               | Done     |
### aten.ceil.default
|    | ATen Input Variations   | Status   |
|---:|:------------------------|:---------|
|  0 | Tensor<[120]> self = ?  | Done     |
|  1 | Tensor<[160]> self = ?  | Done     |
|  2 | Tensor<[240]> self = ?  | Done     |
|  3 | Tensor<[30]> self = ?   | Done     |
|  4 | Tensor<[320]> self = ?  | Done     |
|  5 | Tensor<[40]> self = ?   | Done     |
|  6 | Tensor<[480]> self = ?  | Done     |
|  7 | Tensor<[60]> self = ?   | Done     |
|  8 | Tensor<[640]> self = ?  | Done     |
|  9 | Tensor<[80]> self = ?   | Done     |
### aten.clamp.default
|    | ATen Input Variations                                                                  | Status   |
|---:|:---------------------------------------------------------------------------------------|:---------|
...
|    | ATen Input Variations                                                                                                                                                                                                                                                                                             | Status   |
|---:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 128, 120, 160]> input = ?,<br>Tensor<[64, 128, 3, 3]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int]<> stride = [1, 1],<br>List[int]<> padding = [1, 1],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1     | Done     |
|  1 | Tensor<[1, 128, 30, 40]> input = ?,<br>Tensor<[64, 128, 3, 3]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int]<> stride = [1, 1],<br>List[int]<> padding = [1, 1],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1       | Done     |
|  2 | Tensor<[1, 128, 60, 80]> input = ?,<br>Tensor<[128, 128, 4, 4]> weight = ?,<br>Optional[Tensor]<[128]> bias = ?,<br>List[int]<> stride = [4, 4],<br>List[int]<> padding = [0, 0],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1     | Done     |
|  3 | Tensor<[1, 128, 60, 80]> input = ?,<br>Tensor<[320, 128, 3, 3]> weight = ?,<br>Optional[Tensor]<[320]> bias = ?,<br>List[int]<> stride = [2, 2],<br>List[int]<> padding = [1, 1],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1     | Done     |
|  4 | Tensor<[1, 128, 60, 80]> input = ?,<br>Tensor<[64, 128, 1, 1]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int]<> stride = [1, 1],<br>List[int]<> padding = [0, 0],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1       | Done     |
|  5 | Tensor<[1, 128, 60, 80]> input = ?,<br>Tensor<[64, 128, 3, 3]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int]<> stride = [1, 1],<br>List[int]<> padding = [1, 1],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1       | Done     |
|  6 | Tensor<[1, 1280, 30, 40]> input = ?,<br>Tensor<[1280, 1, 3, 3]> weight = ?,<br>Optional[Tensor]<[1280]> bias = ?,<br>List[int]<> stride = [1, 1],<br>List[int]<> padding = [1, 1],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1280 | Done     |
|  7 | Tensor<[1, 2048, 15, 20]> input = ?,<br>Tensor<[2048, 1, 3, 3]> weight = ?,<br>Optional[Tensor]<[2048]> bias = ?,<br>List[int]<> stride = [1, 1],<br>List[int]<> padding = [1, 1],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 2048 | Done     |
|  8 | Tensor<[1, 256, 120, 160]> input = ?,<br>Tensor<[256, 1, 3, 3]> weight = ?,<br>Optional[Tensor]<[256]> bias = ?,<br>List[int]<> stride = [1, 1],<br>List[int]<> padding = [1, 1],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 256   | Done     |
|  9 | Tensor<[1, 3, 480, 640]> input = ?,<br>Tensor<[64, 3, 7, 7]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int]<> stride = [4, 4],<br>List[int]<> padding = [3, 3],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1         | Done     |
| 10 | Tensor<[1, 32, 120, 160]> input = ?,<br>Tensor<[2, 32, 3, 3]> weight = ?,<br>Optional[Tensor]<[2]> bias = ?,<br>List[int]<> stride = [1, 1],<br>List[int]<> padding = [1, 1],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1         | Done     |
| 11 | Tensor<[1, 32, 30, 40]> input = ?,<br>Tensor<[2, 32, 3, 3]> weight = ?,<br>Optional[Tensor]<[2]> bias = ?,<br>List[int]<> stride = [1, 1],<br>List[int]<> padding = [1, 1],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1           | Done     |
| 12 | Tensor<[1, 32, 60, 80]> input = ?,<br>Tensor<[2, 32, 3, 3]> weight = ?,<br>Optional[Tensor]<[2]> bias = ?,<br>List[int]<> stride = [1, 1],<br>List[int]<> padding = [1, 1],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1           | Done     |
| 13 | Tensor<[1, 320, 30, 40]> input = ?,<br>Tensor<[320, 320, 2, 2]> weight = ?,<br>Optional[Tensor]<[320]> bias = ?,<br>List[int]<> stride = [2, 2],<br>List[int]<> padding = [0, 0],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1     | Done     |
| 14 | Tensor<[1, 320, 30, 40]> input = ?,<br>Tensor<[512, 320, 3, 3]> weight = ?,<br>Optional[Tensor]<[512]> bias = ?,<br>List[int]<> stride = [2, 2],<br>List[int]<> padding = [1, 1],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1     | Done     |
| 15 | Tensor<[1, 320, 30, 40]> input = ?,<br>Tensor<[64, 320, 1, 1]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int]<> stride = [1, 1],<br>List[int]<> padding = [0, 0],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1       | Done     |
| 16 | Tensor<[1, 512, 15, 20]> input = ?,<br>Tensor<[64, 512, 1, 1]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int]<> stride = [1, 1],<br>List[int]<> padding = [0, 0],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1       | Done     |
| 17 | Tensor<[1, 512, 60, 80]> input = ?,<br>Tensor<[512, 1, 3, 3]> weight = ?,<br>Optional[Tensor]<[512]> bias = ?,<br>List[int]<> stride = [1, 1],<br>List[int]<> padding = [1, 1],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 512     | Done     |
| 18 | Tensor<[1, 64, 120, 160]> input = ?,<br>Tensor<[128, 64, 3, 3]> weight = ?,<br>Optional[Tensor]<[128]> bias = ?,<br>List[int]<> stride = [2, 2],<br>List[int]<> padding = [1, 1],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1     | Done     |
| 19 | Tensor<[1, 64, 120, 160]> input = ?,<br>Tensor<[32, 64, 3, 3]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>List[int]<> stride = [1, 1],<br>List[int]<> padding = [1, 1],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1       | Done     |
| 20 | Tensor<[1, 64, 120, 160]> input = ?,<br>Tensor<[64, 64, 8, 8]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int]<> stride = [8, 8],<br>List[int]<> padding = [0, 0],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1       | Done     |
| 21 | Tensor<[1, 64, 30, 40]> input = ?,<br>Tensor<[32, 64, 3, 3]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>List[int]<> stride = [1, 1],<br>List[int]<> padding = [1, 1],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1         | Done     |
| 22 | Tensor<[1, 64, 480, 640]> input = ?,<br>Tensor<[1, 64, 3, 3]> weight = ?,<br>Optional[Tensor]<[1]> bias = ?,<br>List[int]<> stride = [1, 1],<br>List[int]<> padding = [1, 1],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1         | Done     |
| 23 | Tensor<[1, 64, 480, 640]> input = ?,<br>Tensor<[64, 64, 3, 3]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>List[int]<> stride = [1, 1],<br>List[int]<> padding = [1, 1],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1       | Done     |
| 24 | Tensor<[1, 64, 60, 80]> input = ?,<br>Tensor<[32, 64, 3, 3]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>List[int]<> stride = [1, 1],<br>List[int]<> padding = [1, 1],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1         | Done     |
### aten.div.Tensor
|    | ATen Input Variations                                        | Status   |
|---:|:-------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 1, 19200, 300]> self = ?,<br>Tensor<> other = 8.0 | Done     |
|  1 | Tensor<[1, 2, 4800, 300]> self = ?,<br>Tensor<> other = 8.0  | Done     |
|  2 | Tensor<[1, 5, 1200, 300]> self = ?,<br>Tensor<> other = 8.0  | Done     |
|  3 | Tensor<[1, 8, 300, 300]> self = ?,<br>Tensor<> other = 8.0   | Done     |
### aten.expand.default
|    | ATen Input Variations                                                         | Status   |
|---:|:------------------------------------------------------------------------------|:---------|
...
|    | ATen Input Variations                              | Status   |
|---:|:---------------------------------------------------|:---------|
|  0 | Tensor<[120, 1]> self = ?,<br>number<> other = 1.0 | Done     |
|  1 | Tensor<[160]> self = ?,<br>number<> other = 1.0    | Done     |
|  2 | Tensor<[240, 1]> self = ?,<br>number<> other = 1.0 | Done     |
|  3 | Tensor<[30, 1]> self = ?,<br>number<> other = 1.0  | Done     |
|  4 | Tensor<[320]> self = ?,<br>number<> other = 1.0    | Done     |
|  5 | Tensor<[40]> self = ?,<br>number<> other = 1.0     | Done     |
|  6 | Tensor<[480, 1]> self = ?,<br>number<> other = 1.0 | Done     |
|  7 | Tensor<[60, 1]> self = ?,<br>number<> other = 1.0  | Done     |
|  8 | Tensor<[640]> self = ?,<br>number<> other = 1.0    | Done     |
|  9 | Tensor<[80]> self = ?,<br>number<> other = 1.0     | Done     |
### aten.select.int
|    | ATen Input Variations                                                   | Status   |
|---:|:------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 2, 120, 160]> self = ?,<br>int<> dim = 1,<br>int<> index = 0 | Done     |
|  1 | Tensor<[1, 2, 120, 160]> self = ?,<br>int<> dim = 1,<br>int<> index = 1 | Done     |
|  2 | Tensor<[1, 2, 30, 40]> self = ?,<br>int<> dim = 1,<br>int<> index = 0   | Done     |
|  3 | Tensor<[1, 2, 30, 40]> self = ?,<br>int<> dim = 1,<br>int<> index = 1   | Done     |
|  4 | Tensor<[1, 2, 60, 80]> self = ?,<br>int<> dim = 1,<br>int<> index = 0   | Done     |
|  5 | Tensor<[1, 2, 60, 80]> self = ?,<br>int<> dim = 1,<br>int<> index = 1   | Done     |
...
|    | ATen Input Variations                                                                                          | Status   |
|---:|:---------------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 120, 160]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1    | Done     |
|  1 | Tensor<[1, 120, 160]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1    | Done     |
|  2 | Tensor<[1, 2, 120, 160]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1 | Done     |
|  3 | Tensor<[1, 2, 30, 40]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1   | Done     |
|  4 | Tensor<[1, 2, 60, 80]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1   | Done     |
|  5 | Tensor<[1, 30, 40]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1      | Done     |
|  6 | Tensor<[1, 30, 40]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1      | Done     |
|  7 | Tensor<[1, 60, 80]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1      | Done     |
|  8 | Tensor<[1, 60, 80]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1      | Done     |
### aten.squeeze.dim
|    | ATen Input Variations                               | Status   |
|---:|:----------------------------------------------------|:---------|
...
|  3 | Tensor<[120]> self = ?,<br>int<> dim = 1         | Done     |
|  4 | Tensor<[240]> self = ?,<br>int<> dim = 1         | Done     |
|  5 | Tensor<[30]> self = ?,<br>int<> dim = 1          | Done     |
|  6 | Tensor<[480]> self = ?,<br>int<> dim = 1         | Done     |
|  7 | Tensor<[60]> self = ?,<br>int<> dim = 1          | Done     |
### aten.view.default
|    | ATen Input Variations                                                      | Status   |
|---:|:---------------------------------------------------------------------------|:---------|
