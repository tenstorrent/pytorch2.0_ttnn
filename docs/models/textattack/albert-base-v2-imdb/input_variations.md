...
|  3 | aten.addmm.default                                       |                  6 |           2 |         4 |          0 | ✅          |       1 |
...
| 13 | aten.slice.Tensor                                        |                  5 |           0 |         5 |          0 | ✅          |       1 |
| 14 | aten.sub.Tensor                                          |                  1 |           1 |         0 |          0 | ✅          |       1 |
| 15 | aten.t.default                                           |                  5 |           0 |         5 |          0 | ✅          |       1 |
| 16 | aten.tanh.default                                        |                  2 |           2 |         0 |          0 | ✅          |       1 |
| 17 | aten.transpose.int                                       |                  1 |           1 |         0 |          0 | ✅          |       1 |
| 18 | aten.unsqueeze.default                                   |                  2 |           2 |         0 |          0 | ✅          |       1 |
| 19 | aten.view.default                                        |                  7 |           7 |         0 |          0 | ✅          |       1 |
***
...
|    | ATen Input Variations                                            | Status   | Isolated   |      PCC |   Host |
|---:|:-----------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 9, 128]> self = ?,<br>Tensor<[1, 9, 128]> other = ?   | Done     | Done       | 0.999998 |      0 |
|  1 | Tensor<[1, 9, 3072]> self = ?,<br>Tensor other = 1.0             | Done     | Done       | 0.999995 |      0 |
|  2 | Tensor<[1, 9, 3072]> self = ?,<br>Tensor<[1, 9, 3072]> other = ? | Done     | Done       | 0.999998 |      0 |
|  3 | Tensor<[1, 9, 768]> self = ?,<br>Tensor<[1, 9, 768]> other = ?   | Done     | Done       | 0.999998 |      0 |
### aten.addmm.default
|    | ATen Input Variations                                                                  | Status   | Isolated   |      PCC |   Host |
|---:|:---------------------------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
...
|  2 | Tensor<[1, 9, 768]> self = ? | Removed  | Done       |     1 |      0 |
...
|    | ATen Input Variations                                               | Status   | Isolated   |      PCC |   Host |
|---:|:--------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 9, 3072]> self = ?,<br>Tensor other = 0.044715           | Done     | Done       | 0.999995 |      0 |
|  1 | Tensor<[1, 9, 3072]> self = ?,<br>Tensor other = 0.5                | Done     | Done       | 1        |      0 |
|  2 | Tensor<[1, 9, 3072]> self = ?,<br>Tensor other = 0.7978845608028654 | Done     | Done       | 0.999997 |      0 |
|  3 | Tensor<[1, 9, 3072]> self = ?,<br>Tensor<[1, 9, 3072]> other = ?    | Done     | Done       | 0.999996 |      0 |
### aten.native_layer_norm.default
|    | ATen Input Variations                                                                                                                                                  | Status   | Isolated   |      PCC |   Host |
|---:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 9, 128]> input = ?,<br>List[int] normalized_shape = [128],<br>Optional[Tensor]<[128]> weight = ?,<br>Optional[Tensor]<[128]> bias = ?,<br>float eps = 1e-12 | Done     | Done       | 0.999943 |      3 |
|  1 | Tensor<[1, 9, 768]> input = ?,<br>List[int] normalized_shape = [768],<br>Optional[Tensor]<[768]> weight = ?,<br>Optional[Tensor]<[768]> bias = ?,<br>float eps = 1e-12 | Done     | Done       | 0.996851 |      3 |
...
|  3 | Tensor<[1, 9, 768]> self = ?,<br>int dim = 0,<br>Optional[int] start = 0,<br>Optional[int] end = 9223372036854775807  | Removed  | Done       | 1.0   | -1     |
|  4 | Tensor<[1, 9]> self = ?,<br>int dim = 0,<br>Optional[int] start = 0,<br>Optional[int] end = 9223372036854775807       | Removed  | Unknown    | N/A   | N/A    |
### aten.sub.Tensor
|    | ATen Input Variations                              | Status   | Isolated   | PCC   | Host   |
|---:|:---------------------------------------------------|:---------|:-----------|:------|:-------|
...
|    | ATen Input Variations         | Status   | Isolated   |      PCC |   Host |
|---:|:------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 768]> self = ?     | Done     | Done       | 0.999993 |      0 |
...
|  5 | Tensor<[9, 3072]> self = ?,<br>List[int] size = [1, 9, 3072]     | Done     | Done       | 1.0   | 0      |
|  6 | Tensor<[9, 768]> self = ?,<br>List[int] size = [1, 9, 768]       | Done     | Done       | 1.0   | 0      |
