...
|    | ATen Input Variations                                                                      | Status   | Isolated   | PCC   |
|---:|:-------------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1, 3072]> self = ?                                                              | Unknown  | Fallback   | True  |
|  1 | Tensor<[1, 1, 768]> self = ?                                                               | Unknown  | Fallback   | True  |
|  2 | Tensor<[1, 10, 12, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Unknown  | Fallback   | True  |
|  3 | Tensor<[1, 10, 3072]> self = ?                                                             | Unknown  | Fallback   | True  |
|  4 | Tensor<[1, 10, 768]> self = ?                                                              | Unknown  | Fallback   | True  |
|  5 | Tensor<[1, 12, 1, 10]> self = ?                                                            | Unknown  | Fallback   | True  |
|  6 | Tensor<[1, 12, 1, 1]> self = ?                                                             | Unknown  | Fallback   | True  |
|  7 | Tensor<[1, 12, 1, 2]> self = ?                                                             | Unknown  | Fallback   | True  |
|  8 | Tensor<[1, 12, 1, s0 + 1]> self = ?                                                        | Unknown  | Unknown    | N/A   |
|  9 | Tensor<[1, 12, 10, 10]> self = ?                                                           | Unknown  | Fallback   | True  |
### aten.div.Tensor
|    | ATen Input Variations                                                   | Status   | Isolated   | PCC   |
|---:|:------------------------------------------------------------------------|:---------|:-----------|:------|
