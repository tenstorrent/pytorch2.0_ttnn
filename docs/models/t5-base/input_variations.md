...
|  2 | List[Tensor]<> tensors = ['torch.Size([1, 12, 1, 64])', 'torch.Size([1, 12, 1, 64])'],<br>int<> dim = 2  | Unknown  |
|  3 | List[Tensor]<> tensors = ['torch.Size([1, 12, s0, 64])', 'torch.Size([1, 12, 1, 64])'],<br>int<> dim = 2 | Unknown  |
### aten.clone.default
|    | ATen Input Variations                                                                        | Status   |
|---:|:---------------------------------------------------------------------------------------------|:---------|
...
|  4 | Tensor<[1, 12, 1, s0 + 1]> self = ?,<br>List[int]<> size = [1, 12, 1, 'torch.Size(s0 + 1)']   | Unknown  |
...
| 11 | Tensor<[1, 12, 64, s0 + 1]> self = ?,<br>List[int]<> size = [1, 12, 64, 'torch.Size(s0 + 1)'] | Unknown  |
| 12 | Tensor<[1, 12, s0 + 1, 64]> self = ?,<br>List[int]<> size = [1, 12, 'torch.Size(s0 + 1)', 64] | Unknown  |
...
| 13 | Tensor<[1, 12, 1, s0 + 1]> self = ?,<br>List[int]<> size = [12, 1, 'torch.Size(s0 + 1)']   | Unknown  |
...
| 20 | Tensor<[1, 12, 64, s0 + 1]> self = ?,<br>List[int]<> size = [12, 64, 'torch.Size(s0 + 1)'] | Unknown  |
| 21 | Tensor<[1, 12, s0 + 1, 64]> self = ?,<br>List[int]<> size = [12, 'torch.Size(s0 + 1)', 64] | Unknown  |
...
| 32 | Tensor<[12, 1, s0 + 1]> self = ?,<br>List[int]<> size = [1, 12, 1, 'torch.Size(s0 + 1)']   | Unknown  |
