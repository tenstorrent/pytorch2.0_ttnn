...
|  4 | Tensor<[1, 12, 10, 10]> self = ?,<br>int<> dim = -1,<br>bool<> half_to_float = False    | Unknown  |
...
|  3 | Tensor<[1, 10, 768]> self = ?,<br>Tensor<[1, 10, 768]> other = ?             | Unknown  |
...
| 12 | Tensor<[1, 12, 10, 10]> self = ?,<br>Tensor<[1, 1, 1, 10]> other = ?         | Unknown  |
| 13 | Tensor<[1, 12, 10, 10]> self = ?,<br>Tensor<[1, 12, 10, 10]> other = ?       | Unknown  |
...
|  8 | Tensor<[12, 10, 10]> self = ?,<br>Tensor<[12, 10, 64]> mat2 = ?        | Unknown  |
|  9 | Tensor<[12, 10, 64]> self = ?,<br>Tensor<[12, 64, 10]> mat2 = ?        | Unknown  |
### aten.cat.default
|    | ATen Input Variations                                                                                    | Status   |
|---:|:---------------------------------------------------------------------------------------------------------|:---------|
...
|  2 | Tensor<[1, 10, 12, 64]> self = ?,<br>Optional[int]<> memory_format = torch.contiguous_format | Unknown  |
|  3 | Tensor<[1, 10, 3072]> self = ?                                                               | Unknown  |
|  4 | Tensor<[1, 10, 768]> self = ?                                                                | Unknown  |
...
|  9 | Tensor<[1, 12, 10, 10]> self = ?                                                             | Unknown  |
### aten.div.Tensor
|    | ATen Input Variations                                                     | Status   |
|---:|:--------------------------------------------------------------------------|:---------|
...
|  1 | Tensor<[32, 12]> weight = ?,<br>Tensor<[10, 10]> indices = ?         | Unknown  |
|  2 | Tensor<[32, 12]> weight = ?,<br>Tensor<[2, 2]> indices = ?           | Unknown  |
|  3 | Tensor<[32, 12]> weight = ?,<br>Tensor<[s0 + 1, s0 + 1]> indices = ? | Unknown  |
|  4 | Tensor<[32128, 768]> weight = ?,<br>Tensor<[1, 10]> indices = ?      | Unknown  |
...
|  1 | Tensor<[1, 10, 768]> self = ?,<br>Optional[List[int]]<> dim = [-1],<br>bool<> keepdim = True | Unknown  |
...
|  4 | Tensor<[10, 3072]> self = ?,<br>Tensor<[3072, 768]> mat2 = ? | Unknown  |
|  5 | Tensor<[10, 768]> self = ?,<br>Tensor<[768, 3072]> mat2 = ?  | Unknown  |
|  6 | Tensor<[10, 768]> self = ?,<br>Tensor<[768, 768]> mat2 = ?   | Unknown  |
### aten.mul.Tensor
|    | ATen Input Variations                                                           | Status   |
|---:|:--------------------------------------------------------------------------------|:---------|
...
|  9 | Tensor<[1, 10, 768]> self = ?,<br>Tensor<[1, 10, 1]> other = ?                  | Unknown  |
...
| 16 | Tensor<[768]> self = ?,<br>Tensor<[1, 10, 768]> other = ?                       | Unknown  |
...
|  1 | Tensor<[10, 10, 12]> self = ?,<br>List[int]<> dims = [2, 0, 1]         | Unknown  |
...
|  1 | Tensor<[1, 10, 768]> self = ?,<br>number<> exponent = 2 | Unknown  |
### aten.relu.default
|    | ATen Input Variations          | Status   |
|---:|:-------------------------------|:---------|
|  0 | Tensor<[1, 1, 3072]> self = ?  | Unknown  |
...
| 13 | Tensor<[1, 12, 1, 10]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1           | Unknown  |
| 14 | Tensor<[1, 12, 1, 2]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1            | Unknown  |
| 15 | Tensor<[1, 12, 1, s0 + 1]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1       | Unknown  |
| 16 | Tensor<[1, 12, 2, 2]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1            | Unknown  |
| 17 | Tensor<[1, 12, 2, 2]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1            | Unknown  |
| 18 | Tensor<[1, 12, 2, 2]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = -1,<br>Optional[int]<> end = -1           | Unknown  |
| 19 | Tensor<[1, 12, 3, 10]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1           | Unknown  |
| 20 | Tensor<[1, 12, 3, 10]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1           | Unknown  |
| 21 | Tensor<[1, 12, 3, 10]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = -1,<br>Optional[int]<> end = -1          | Unknown  |
| 22 | Tensor<[1, 12, s0 + 1, s0 + 1]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1  | Unknown  |
| 23 | Tensor<[1, 12, s0 + 1, s0 + 1]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1  | Unknown  |
| 24 | Tensor<[1, 12, s0 + 1, s0 + 1]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = -1,<br>Optional[int]<> end = -1 | Unknown  |
| 25 | Tensor<[1, 12, s0 + 2, 10]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1      | Unknown  |
| 26 | Tensor<[1, 12, s0 + 2, 10]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1      | Unknown  |
| 27 | Tensor<[1, 12, s0 + 2, 10]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = -1,<br>Optional[int]<> end = -1     | Unknown  |
...
|  1 | Tensor<[1, 10, 12, 64]> self = ?,<br>int<> dim0 = 1,<br>int<> dim1 = 2     | Unknown  |
|  2 | Tensor<[1, 12, 1, 64]> self = ?,<br>int<> dim0 = 1,<br>int<> dim1 = 2      | Unknown  |
|  3 | Tensor<[1, 12, 1, 64]> self = ?,<br>int<> dim0 = 3,<br>int<> dim1 = 2      | Unknown  |
|  4 | Tensor<[1, 12, 10, 64]> self = ?,<br>int<> dim0 = 1,<br>int<> dim1 = 2     | Unknown  |
|  5 | Tensor<[1, 12, 10, 64]> self = ?,<br>int<> dim0 = 3,<br>int<> dim1 = 2     | Unknown  |
...
| 15 | Tensor<[12, 10, 10]> self = ?,<br>int<> dim = 0         | Unknown  |
...
|  4 | Tensor<[1, 10, 12, 64]> self = ?,<br>List[int]<> size = [1, -1, 768]                       | Unknown  |
|  5 | Tensor<[1, 10, 3072]> self = ?,<br>List[int]<> size = [10, 3072]                           | Unknown  |
|  6 | Tensor<[1, 10, 768]> self = ?,<br>List[int]<> size = [1, -1, 12, 64]                       | Unknown  |
|  7 | Tensor<[1, 10, 768]> self = ?,<br>List[int]<> size = [10, 768]                             | Unknown  |
...
| 14 | Tensor<[1, 12, 10, 10]> self = ?,<br>List[int]<> size = [12, 10, 10]                       | Unknown  |
| 15 | Tensor<[1, 12, 10, 64]> self = ?,<br>List[int]<> size = [12, 10, 64]                       | Unknown  |
| 16 | Tensor<[1, 12, 2, 64]> self = ?,<br>List[int]<> size = [12, 2, 64]                         | Unknown  |
| 17 | Tensor<[1, 12, 64, 10]> self = ?,<br>List[int]<> size = [12, 64, 10]                       | Unknown  |
...
| 26 | Tensor<[10, 3072]> self = ?,<br>List[int]<> size = [1, 10, 3072]                           | Unknown  |
| 27 | Tensor<[10, 768]> self = ?,<br>List[int]<> size = [1, 10, 768]                             | Unknown  |
...
| 33 | Tensor<[12, 10, 10]> self = ?,<br>List[int]<> size = [1, 12, 10, 10]                       | Unknown  |
| 34 | Tensor<[12, 10, 64]> self = ?,<br>List[int]<> size = [1, 12, 10, 64]                       | Unknown  |
### aten.where.self
|    | ATen Input Variations                                                                                               | Status   |
|---:|:--------------------------------------------------------------------------------------------------------------------|:---------|
