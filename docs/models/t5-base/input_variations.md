...
|    | ATen Input Variations                                           | Status   |
|---:|:----------------------------------------------------------------|:---------|
|  0 | Tensor<[32128, 768]> weight = ?,<br>Tensor<[1, 10]> indices = ? | Unknown  |
### aten.expand.default
|    | ATen Input Variations                                                                 | Status   |
|---:|:--------------------------------------------------------------------------------------|:---------|
...
|  4 | Tensor<[1, 12, 1, s0 + 1]> self = ?,<br>List[int] size = [1, 12, 1, sym_size_int]     | Unknown  |
...
| 11 | Tensor<[1, 12, 64, s0 + 1]> self = ?,<br>List[int] size = [1, 12, 64, sym_size_int]   | Unknown  |
| 12 | Tensor<[1, 12, s0 + 1, 64]> self = ?,<br>List[int] size = [1, 12, sym_size_int_1, 64] | Unknown  |
...
|    | ATen Input Variations                                                                    | Status   |
|---:|:-----------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 10, 768]> self = ?,<br>Optional[List[int]] dim = [-1],<br>bool keepdim = True | Unknown  |
...
|    | ATen Input Variations                                      | Status   |
|---:|:-----------------------------------------------------------|:---------|
|  0 | Tensor<[10, 768]> self = ?,<br>Tensor<[768, 768]> mat2 = ? | Unknown  |
### aten.mul.Tensor
|    | ATen Input Variations                                                     | Status   |
|---:|:--------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 1, 1, 10]> self = ?,<br>Tensor other = -3.4028234663852886e+38 | Unknown  |
|  1 | Tensor<[1, 1, 768]> self = ?,<br>Tensor other = 0.03608439182435161       | Unknown  |
|  2 | Tensor<[1, 10, 768]> self = ?,<br>Tensor<[1, 10, 1]> other = ?            | Unknown  |
...
|    | ATen Input Variations                                        | Status   |
|---:|:-------------------------------------------------------------|:---------|
|  0 | Tensor<[10, 10, 12]> self = ?,<br>List[int] dims = [2, 0, 1] | Unknown  |
### aten.pow.Tensor_Scalar
|    | ATen Input Variations                                 | Status   |
|---:|:------------------------------------------------------|:---------|
|  0 | Tensor<[1, 10, 768]> self = ?,<br>number exponent = 2 | Unknown  |
### aten.relu.default
|    | ATen Input Variations          | Status   |
|---:|:-------------------------------|:---------|
...
|  3 | Tensor<[1, 12, 2, 2]> self = ?,<br>int dim = 2,<br>Optional[int] start = -1,<br>Optional[int] end = -1 | Unknown  |
...
|    | ATen Input Variations                                              | Status   |
|---:|:-------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 10, 12, 64]> self = ?,<br>int dim0 = 1,<br>int dim1 = 2 | Unknown  |
|  1 | Tensor<[1, 12, 10, 64]> self = ?,<br>int dim0 = 3,<br>int dim1 = 2 | Unknown  |
...
|  2 | Tensor<[1, 10, 12, 64]> self = ?,<br>List[int] size = [1, -1, 768]                 | Unknown  |
|  3 | Tensor<[1, 10, 3072]> self = ?,<br>List[int] size = [10, 3072]                     | Unknown  |
|  4 | Tensor<[1, 10, 768]> self = ?,<br>List[int] size = [10, 768]                       | Unknown  |
|  5 | Tensor<[1, 10]> self = ?,<br>List[int] size = [-1, 10]                             | Unknown  |
|  6 | Tensor<[1, 12, 1, 10]> self = ?,<br>List[int] size = [12, 1, 10]                   | Unknown  |
|  7 | Tensor<[1, 12, 1, 1]> self = ?,<br>List[int] size = [12, 1, 1]                     | Unknown  |
|  8 | Tensor<[1, 12, 1, 2]> self = ?,<br>List[int] size = [12, 1, 2]                     | Unknown  |
|  9 | Tensor<[1, 12, 1, 64]> self = ?,<br>List[int] size = [12, 1, 64]                   | Unknown  |
| 10 | Tensor<[1, 12, 1, s0 + 1]> self = ?,<br>List[int] size = [12, 1, sym_size_int]     | Unknown  |
| 11 | Tensor<[1, 12, 10, 10]> self = ?,<br>List[int] size = [12, 10, 10]                 | Unknown  |
| 12 | Tensor<[1, 12, 10, 64]> self = ?,<br>List[int] size = [12, 10, 64]                 | Unknown  |
| 13 | Tensor<[1, 12, 2, 64]> self = ?,<br>List[int] size = [12, 2, 64]                   | Unknown  |
| 14 | Tensor<[1, 12, 64, 10]> self = ?,<br>List[int] size = [12, 64, 10]                 | Unknown  |
| 15 | Tensor<[1, 12, 64, 1]> self = ?,<br>List[int] size = [12, 64, 1]                   | Unknown  |
| 16 | Tensor<[1, 12, 64, 2]> self = ?,<br>List[int] size = [12, 64, 2]                   | Unknown  |
| 17 | Tensor<[1, 12, 64, s0 + 1]> self = ?,<br>List[int] size = [12, 64, sym_size_int]   | Unknown  |
| 18 | Tensor<[1, 12, s0 + 1, 64]> self = ?,<br>List[int] size = [12, sym_size_int_1, 64] | Unknown  |
...
| 22 | Tensor<[1, 768]> self = ?,<br>List[int] size = [1, 1, 768]                         | Unknown  |
| 23 | Tensor<[10, 3072]> self = ?,<br>List[int] size = [1, 10, 3072]                     | Unknown  |
| 24 | Tensor<[10, 768]> self = ?,<br>List[int] size = [1, 10, 768]                       | Unknown  |
| 25 | Tensor<[12, 1, 10]> self = ?,<br>List[int] size = [1, 12, 1, 10]                   | Unknown  |
| 26 | Tensor<[12, 1, 1]> self = ?,<br>List[int] size = [1, 12, 1, 1]                     | Unknown  |
| 27 | Tensor<[12, 1, 2]> self = ?,<br>List[int] size = [1, 12, 1, 2]                     | Unknown  |
| 28 | Tensor<[12, 1, 64]> self = ?,<br>List[int] size = [1, 12, 1, 64]                   | Unknown  |
| 29 | Tensor<[12, 1, s0 + 1]> self = ?,<br>List[int] size = [1, 12, 1, sym_size_int]     | Unknown  |
| 30 | Tensor<[12, 10, 10]> self = ?,<br>List[int] size = [1, 12, 10, 10]                 | Unknown  |
| 31 | Tensor<[12, 10, 64]> self = ?,<br>List[int] size = [1, 12, 10, 64]                 | Unknown  |
### aten.where.self
|    | ATen Input Variations                                                                       | Status   |
|---:|:--------------------------------------------------------------------------------------------|:---------|
