...
|---:|:---------------------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 32, 64, 64]> self = ?,<br>int dim = -1,<br>bool half_to_float = False | Done     | Done       | 0.999616 |     -1 |
|  1 | Tensor<[16, 8, 64, 64]> self = ?,<br>int dim = -1,<br>bool half_to_float = False | Done     | Done       | 0.999607 |     -1 |
|  2 | Tensor<[4, 16, 64, 64]> self = ?,<br>int dim = -1,<br>bool half_to_float = False | Done     | Done       | 0.999606 |     -1 |
|  3 | Tensor<[64, 4, 64, 64]> self = ?,<br>int dim = -1,<br>bool half_to_float = False | Done     | Done       | 0.999608 |     -1 |
...
|  1 | Tensor<[1024]> self = ?,<br>Tensor<[1024, 256]> mat1 = ?,<br>Tensor<[256, 1024]> mat2 = ? | Removed  | Done       | 0.999978 |     -1 |
|  2 | Tensor<[1024]> self = ?,<br>Tensor<[64, 1024]> mat1 = ?,<br>Tensor<[1024, 1024]> mat2 = ? | Removed  | Done       | 0.999964 |     -1 |
|  3 | Tensor<[1024]> self = ?,<br>Tensor<[64, 4096]> mat1 = ?,<br>Tensor<[4096, 1024]> mat2 = ? | Done     | Done       | 0.999932 |     -1 |
|  4 | Tensor<[128]> self = ?,<br>Tensor<[4096, 128]> mat1 = ?,<br>Tensor<[128, 128]> mat2 = ?   | Removed  | Done       | 0.999979 |     -1 |
|  5 | Tensor<[128]> self = ?,<br>Tensor<[4096, 512]> mat1 = ?,<br>Tensor<[512, 128]> mat2 = ?   | Removed  | Done       | 0.99997  |     -1 |
|  6 | Tensor<[1536]> self = ?,<br>Tensor<[256, 512]> mat1 = ?,<br>Tensor<[512, 1536]> mat2 = ?  | Removed  | Done       | 0.99997  |     -1 |
|  7 | Tensor<[2048]> self = ?,<br>Tensor<[256, 512]> mat1 = ?,<br>Tensor<[512, 2048]> mat2 = ?  | Done     | Done       | 0.99997  |     -1 |
|  8 | Tensor<[256]> self = ?,<br>Tensor<[1024, 1024]> mat1 = ?,<br>Tensor<[1024, 256]> mat2 = ? | Removed  | Done       | 0.999964 |     -1 |
|  9 | Tensor<[256]> self = ?,<br>Tensor<[1024, 256]> mat1 = ?,<br>Tensor<[256, 256]> mat2 = ?   | Removed  | Done       | 0.999974 |     -1 |
| 10 | Tensor<[3072]> self = ?,<br>Tensor<[64, 1024]> mat1 = ?,<br>Tensor<[1024, 3072]> mat2 = ? | Removed  | Done       | 0.999964 |     -1 |
| 11 | Tensor<[384]> self = ?,<br>Tensor<[4096, 128]> mat1 = ?,<br>Tensor<[128, 384]> mat2 = ?   | Removed  | Done       | 0.999979 |     -1 |
| 12 | Tensor<[4096]> self = ?,<br>Tensor<[64, 1024]> mat1 = ?,<br>Tensor<[1024, 4096]> mat2 = ? | Done     | Done       | 0.999964 |     -1 |
| 13 | Tensor<[512]> self = ?,<br>Tensor<[225, 2]> mat1 = ?,<br>Tensor<[2, 512]> mat2 = ?        | Done     | Done       | 0.999992 |     -1 |
| 14 | Tensor<[512]> self = ?,<br>Tensor<[256, 2048]> mat1 = ?,<br>Tensor<[2048, 512]> mat2 = ?  | Done     | Done       | 0.99992  |     -1 |
| 15 | Tensor<[512]> self = ?,<br>Tensor<[256, 512]> mat1 = ?,<br>Tensor<[512, 512]> mat2 = ?    | Removed  | Done       | 0.99997  |     -1 |
| 16 | Tensor<[512]> self = ?,<br>Tensor<[4096, 128]> mat1 = ?,<br>Tensor<[128, 512]> mat2 = ?   | Removed  | Done       | 0.999979 |     -1 |
| 17 | Tensor<[768]> self = ?,<br>Tensor<[1024, 256]> mat1 = ?,<br>Tensor<[256, 768]> mat2 = ?   | Removed  | Done       | 0.999978 |     -1 |
...
|    | ATen Input Variations                                             | Status   | Isolated   |      PCC |   Host |
|---:|:------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[128, 64, 32]> self = ?,<br>Tensor<[128, 32, 64]> mat2 = ? | Done     | Done       | 0.999989 |     -1 |
...
|  4 | Tensor<[32, 64, 32]> self = ?,<br>Tensor<[32, 32, 64]> mat2 = ?   | Done     | Done       | 0.99999  |     -1 |
...
|    | ATen Input Variations                                                                           | Status   | Isolated   | PCC   | Host   |
|---:|:------------------------------------------------------------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 16, 16, 2048]> self = ?                                                              | Removed  | Done       | 1.0   | -1     |
|  1 | Tensor<[1, 16, 16, 512]> self = ?                                                               | Removed  | Done       | 1.0   | -1     |
|  2 | Tensor<[1, 2, 2, 8, 8, 512]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Removed  | Done       | 1.0   | -1     |
|  3 | Tensor<[1, 2, 8, 2, 8, 512]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Removed  | Done       | 1.0   | -1     |
|  4 | Tensor<[1, 32, 32, 1024]> self = ?                                                              | Removed  | Done       | 1.0   | -1     |
|  5 | Tensor<[1, 32, 32, 256]> self = ?                                                               | Removed  | Done       | 1.0   | -1     |
|  6 | Tensor<[1, 32, 64, 64]> self = ?                                                                | Removed  | Done       | 1.0   | -1     |
|  7 | Tensor<[1, 4, 4, 8, 8, 256]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Removed  | Done       | 1.0   | -1     |
|  8 | Tensor<[1, 4, 8, 4, 8, 256]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Removed  | Done       | 1.0   | -1     |
|  9 | Tensor<[1, 64, 1024]> self = ?                                                                  | Removed  | Done       | 1.0   | -1     |
| 10 | Tensor<[1, 64, 32, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Removed  | Done       | 1.0   | -1     |
| 11 | Tensor<[1, 64, 64, 128]> self = ?                                                               | Removed  | Done       | 1.0   | -1     |
| 12 | Tensor<[1, 64, 64, 512]> self = ?                                                               | Removed  | Done       | 1.0   | -1     |
| 13 | Tensor<[1, 8, 8, 1024]> self = ?                                                                | Removed  | Done       | 1.0   | -1     |
| 14 | Tensor<[1, 8, 8, 4096]> self = ?                                                                | Removed  | Done       | 1.0   | -1     |
| 15 | Tensor<[1, 8, 8, 8, 8, 128]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Removed  | Unknown    | N/A   | N/A    |
| 16 | Tensor<[16, 64, 256]> self = ?                                                                  | Removed  | Done       | 1.0   | -1     |
| 17 | Tensor<[16, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format         | Removed  | Done       | 1.0   | -1     |
| 18 | Tensor<[16, 64, 8, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Removed  | Done       | 1.0   | -1     |
| 19 | Tensor<[16, 8, 32, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Removed  | Done       | 1.0   | -1     |
| 20 | Tensor<[16, 8, 64, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Removed  | Done       | 1.0   | -1     |
| 21 | Tensor<[16, 8, 64, 64]> self = ?                                                                | Removed  | Done       | 1.0   | -1     |
| 22 | Tensor<[2, 2, 8, 8]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format         | Removed  | Done       | 1.0   | -1     |
| 23 | Tensor<[32, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format         | Removed  | Done       | 1.0   | -1     |
| 24 | Tensor<[4, 16, 32, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Removed  | Done       | 1.0   | -1     |
| 25 | Tensor<[4, 16, 64, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Removed  | Done       | 1.0   | -1     |
| 26 | Tensor<[4, 16, 64, 64]> self = ?                                                                | Removed  | Done       | 1.0   | -1     |
| 27 | Tensor<[4, 4, 8, 8]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format         | Removed  | Done       | 1.0   | -1     |
| 28 | Tensor<[4, 64, 16, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Removed  | Done       | 1.0   | -1     |
| 29 | Tensor<[4, 64, 512]> self = ?                                                                   | Removed  | Done       | 1.0   | -1     |
...
| 33 | Tensor<[64, 4, 64, 64]> self = ?                                                                | Removed  | Done       | 1.0   | -1     |
| 34 | Tensor<[64, 64, 128]> self = ?                                                                  | Removed  | Done       | 1.0   | -1     |
| 35 | Tensor<[64, 64, 4, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Removed  | Done       | 1.0   | -1     |
| 36 | Tensor<[8, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format          | Removed  | Done       | 1.0   | -1     |
| 37 | Tensor<[8, 8, 8, 8]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format         | Removed  | Done       | 1.0   | -1     |
...
|    | ATen Input Variations                                                  | Status   | Isolated   |      PCC |   Host |
|---:|:-----------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 32, 64, 32]> self = ?,<br>Tensor<[1, 32, 64, 32]> other = ? | Done     | Done       | 1        |     -1 |
|  1 | Tensor<[16, 8, 64, 32]> self = ?,<br>Tensor<[16, 8, 64, 32]> other = ? | Done     | Done       | 0.999998 |     -1 |
|  2 | Tensor<[4, 16, 64, 32]> self = ?,<br>Tensor<[4, 16, 64, 32]> other = ? | Done     | Done       | 0.999996 |     -1 |
|  3 | Tensor<[64, 4, 64, 32]> self = ?,<br>Tensor<[64, 4, 64, 32]> other = ? | Done     | Done       | 1        |     -1 |
...
|    | ATen Input Variations       | Status   | Isolated   |      PCC |   Host |
|---:|:----------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[16, 1, 1]> self = ? | Done     | Done       | 0.999948 |     -1 |
|  1 | Tensor<[32, 1, 1]> self = ? | Done     | Done       | 0.999972 |     -1 |
|  2 | Tensor<[4, 1, 1]> self = ?  | Done     | Done       | 0.999995 |     -1 |
|  3 | Tensor<[8, 1, 1]> self = ?  | Done     | Done       | 0.999973 |     -1 |
### aten.expand.default
|    | ATen Input Variations                                                 | Status   | Isolated   |   PCC |   Host |
|---:|:----------------------------------------------------------------------|:---------|:-----------|------:|-------:|
...
|  1 | Tensor<[1, 32, 32, 1024]> self = ? | Removed  | Done       | 0.999991 |     -1 |
|  2 | Tensor<[1, 64, 64, 512]> self = ?  | Removed  | Done       | 0.999991 |     -1 |
...
|  1 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 16]> mat2 = ?    | Done     | Done       | 0.999972 |     -1 |
|  2 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 32]> mat2 = ?    | Done     | Done       | 0.999971 |     -1 |
|  3 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 4]> mat2 = ?     | Done     | Done       | 0.999973 |     -1 |
|  4 | Tensor<[225, 512]> self = ?,<br>Tensor<[512, 8]> mat2 = ?     | Done     | Done       | 0.999974 |     -1 |
...
|  2 | Tensor<[1, 32, 64, 64]> self = ?,<br>Tensor<[32, 1, 1]> other = ? | Done     | Done       |  0.999996  |     -1 |
|  3 | Tensor<[1, 4, 64, 64]> self = ?,<br>Tensor other = 16             | Done     | Done       |  1         |     -1 |
|  4 | Tensor<[1, 8, 64, 64]> self = ?,<br>Tensor other = 16             | Done     | Done       |  1         |     -1 |
|  5 | Tensor<[16, 8, 64, 64]> self = ?,<br>Tensor<[8, 1, 1]> other = ?  | Done     | Done       | -0.0113098 |     -1 |
|  6 | Tensor<[4, 16, 64, 64]> self = ?,<br>Tensor<[16, 1, 1]> other = ? | Done     | Done       |  0.210076  |     -1 |
|  7 | Tensor<[64, 4, 64, 64]> self = ?,<br>Tensor<[4, 1, 1]> other = ?  | Done     | Done       | -0.0631047 |     -1 |
...
|    | ATen Input Variations            | Status   | Isolated   |      PCC |   Host |
|---:|:---------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 16, 64, 64]> self = ? | Done     | Done       | 0.999752 |     -1 |
|  1 | Tensor<[1, 32, 64, 64]> self = ? | Done     | Done       | 0.999756 |     -1 |
|  2 | Tensor<[1, 4, 64, 64]> self = ?  | Done     | Done       | 0.999756 |     -1 |
|  3 | Tensor<[1, 8, 64, 64]> self = ?  | Done     | Done       | 0.999756 |     -1 |
### aten.slice.Tensor
|    | ATen Input Variations                                                                                                                      | Status   | Isolated   | PCC   | Host   |
|---:|:-------------------------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|:------|:-------|
...
|    | ATen Input Variations                                          | Status   | Isolated   |      PCC |   Host |
|---:|:---------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[16, 1, 64]> self = ?,<br>Tensor<[16, 64, 1]> other = ? | Done     | Done       | 0.467709 |     -1 |
|  1 | Tensor<[4, 1, 64]> self = ?,<br>Tensor<[4, 64, 1]> other = ?   | Done     | Done       | 0.522818 |     -1 |
|  2 | Tensor<[64, 1, 64]> self = ?,<br>Tensor<[64, 64, 1]> other = ? | Done     | Done       | 0.352301 |     -1 |
### aten.t.default
|    | ATen Input Variations         | Status   | Isolated   |   PCC |   Host |
|---:|:------------------------------|:---------|:-----------|------:|-------:|
...
|  3 | Tensor<[1024, 256]> self = ?  | Removed  | Done       |     1 |     -1 |
|  4 | Tensor<[1024, 4096]> self = ? | Done     | Done       |     1 |     -1 |
|  5 | Tensor<[128, 128]> self = ?   | Removed  | Done       |     1 |     -1 |
|  6 | Tensor<[128, 512]> self = ?   | Removed  | Done       |     1 |     -1 |
|  7 | Tensor<[1536, 512]> self = ?  | Removed  | Done       |     1 |     -1 |
|  8 | Tensor<[16, 512]> self = ?    | Done     | Done       |     1 |     -1 |
|  9 | Tensor<[2048, 512]> self = ?  | Done     | Done       |     1 |     -1 |
| 10 | Tensor<[256, 1024]> self = ?  | Removed  | Done       |     1 |     -1 |
| 11 | Tensor<[256, 256]> self = ?   | Removed  | Done       |     1 |     -1 |
| 12 | Tensor<[256, 512]> self = ?   | Done     | Done       |     1 |     -1 |
| 13 | Tensor<[3072, 1024]> self = ? | Removed  | Done       |     1 |     -1 |
| 14 | Tensor<[32, 512]> self = ?    | Done     | Done       |     1 |     -1 |
| 15 | Tensor<[384, 128]> self = ?   | Removed  | Done       |     1 |     -1 |
| 16 | Tensor<[4, 512]> self = ?     | Done     | Done       |     1 |     -1 |
| 17 | Tensor<[4096, 1024]> self = ? | Done     | Done       |     1 |     -1 |
| 18 | Tensor<[512, 1024]> self = ?  | Done     | Done       |     1 |     -1 |
| 19 | Tensor<[512, 128]> self = ?   | Removed  | Done       |     1 |     -1 |
| 20 | Tensor<[512, 2048]> self = ?  | Done     | Done       |     1 |     -1 |
| 21 | Tensor<[512, 2]> self = ?     | Done     | Done       |     1 |     -1 |
| 22 | Tensor<[512, 512]> self = ?   | Removed  | Done       |     1 |     -1 |
| 23 | Tensor<[768, 256]> self = ?   | Removed  | Done       |     1 |     -1 |
...
| 33 | Tensor<[1024, 1024]> self = ?,<br>List[int] size = [1, 32, 32, 1024]        | Removed  | Done       |     1 |     -1 |
...
| 70 | Tensor<[4096, 512]> self = ?,<br>List[int] size = [1, 64, 64, 512]          | Removed  | Done       |     1 |     -1 |
