...
|    | ATen Input Variations                                 | Status   | Isolated   | PCC   | Host   |
|---:|:------------------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 256, 512]> self = ?,<br>number other = 256 | None     | Unknown    | N/A   | N/A    |
### aten.expand.default
|    | ATen Input Variations                                           | Status   | Isolated   | PCC   | Host   |
|---:|:----------------------------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 1, 512]> self = ?,<br>List[int] size = [1, 256, 512] | Done     | Unknown    | N/A   | N/A    |
### aten.gelu.default
|    | ATen Input Variations           | Status   | Isolated   |      PCC |   Host |
|---:|:--------------------------------|:---------|:-----------|---------:|-------:|
...
|    | ATen Input Variations                                                           | Status   | Isolated   | PCC   | Host   |
|---:|:--------------------------------------------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 16, 16, 16, 16, 3]> self = ?,<br>List[int] dims = [0, 5, 1, 3, 2, 4] | Done     | Done       | 1.0   | 0      |
|  1 | Tensor<[1, 3, 16, 16, 16, 16]> self = ?,<br>List[int] dims = [0, 2, 4, 3, 5, 1] | Done     | Done       | 1.0   | 0      |
|  2 | Tensor<[1, 512]> self = ?,<br>List[int] dims = [0, 1]                           | Done     | Unknown    | N/A   | N/A    |
...
|    | ATen Input Variations                     | Status   | Isolated   | PCC   | Host   |
|---:|:------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 512]> self = ?,<br>int dim = 1 | Done     | Unknown    | N/A   | N/A    |
### aten.view.default
|    | ATen Input Variations                                                         | Status   | Isolated   | PCC   | Host   |
|---:|:------------------------------------------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 1000]> self = ?,<br>List[int] size = [1000]                        | Done     | Done       | 1.0   | 0      |
|  1 | Tensor<[1, 256, 256]> self = ?,<br>List[int] size = [256, 256]                | Done     | Done       | 1.0   | 0      |
|  2 | Tensor<[1, 256, 512]> self = ?,<br>List[int] size = [1, 256, 512]             | Done     | Unknown    | N/A   | N/A    |
|  3 | Tensor<[1, 256, 512]> self = ?,<br>List[int] size = [256, 512]                | Done     | Done       | 1.0   | 0      |
|  4 | Tensor<[1, 256, 768]> self = ?,<br>List[int] size = [1, 16, 16, 16, 16, 3]    | Done     | Done       | 1.0   | 0      |
|  5 | Tensor<[1, 256, 768]> self = ?,<br>List[int] size = [256, 768]                | Done     | Done       | 1.0   | 0      |
|  6 | Tensor<[1, 256]> self = ?,<br>List[int] size = [256]                          | Done     | Done       | 1.0   | 0      |
|  7 | Tensor<[1, 3, 256, 256]> self = ?,<br>List[int] size = [1, 3, 16, 16, 16, 16] | Done     | Done       | 1.0   | 0      |
|  8 | Tensor<[1, 512]> self = ?,<br>List[int] size = [1, 512]                       | Done     | Unknown    | N/A   | N/A    |
|  9 | Tensor<[1, 512]> self = ?,<br>List[int] size = [512]                          | Done     | Done       | 1.0   | 0      |
...
| 12 | Tensor<[256, 768]> self = ?,<br>List[int] size = [1, 256, 768]                | Done     | Done       | 1.0   | 0      |
