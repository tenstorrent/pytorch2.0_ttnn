...
|  1 | Tensor<[5120, 16]> self = ?        | Done     | Unknown    | N/A   | N/A    |
### aten.mean.dim
|    | ATen Input Variations                                                                     | Status   | Isolated   | PCC   | Host   |
|---:|:------------------------------------------------------------------------------------------|:---------|:-----------|:------|:-------|
...
|    | ATen Input Variations       | Status   | Isolated   | PCC   | Host   |
|---:|:----------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[5120, 16]> self = ? | Done     | Unknown    | N/A   | N/A    |
...
|  9 | Tensor<[5120, 16, 1, 1]> self = ?,<br>List[int] dims = [2, 3, 0, 1] | Done     | Unknown    | N/A   | N/A    |
...
|    | ATen Input Variations          | Status   | Isolated   | PCC   | Host   |
|---:|:-------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[10240, 2560]> self = ? | Done     | Unknown    | N/A   | N/A    |
|  1 | Tensor<[192, 5120]> self = ?   | Done     | Unknown    | N/A   | N/A    |
|  2 | Tensor<[2560, 5120]> self = ?  | Done     | Unknown    | N/A   | N/A    |
|  3 | Tensor<[50280, 2560]> self = ? | Done     | Unknown    | N/A   | N/A    |
|  4 | Tensor<[5120, 160]> self = ?   | Done     | Unknown    | N/A   | N/A    |
