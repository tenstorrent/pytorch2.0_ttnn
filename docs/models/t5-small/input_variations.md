...
|    | ATen Input Variations                                                                     | Status   | Isolated   | PCC   |
|---:|:------------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1, 2048]> self = ?                                                             | Unknown  | Fallback   | True  |
|  1 | Tensor<[1, 1, 512]> self = ?                                                              | Unknown  | Fallback   | True  |
|  2 | Tensor<[1, 10, 2048]> self = ?                                                            | Unknown  | Fallback   | True  |
|  3 | Tensor<[1, 10, 512]> self = ?                                                             | Unknown  | Fallback   | True  |
|  4 | Tensor<[1, 10, 8, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Unknown  | Fallback   | True  |
|  5 | Tensor<[1, 8, 1, 10]> self = ?                                                            | Unknown  | Fallback   | True  |
|  6 | Tensor<[1, 8, 1, 1]> self = ?                                                             | Unknown  | Fallback   | True  |
|  7 | Tensor<[1, 8, 1, 2]> self = ?                                                             | Unknown  | Fallback   | True  |
|  8 | Tensor<[1, 8, 1, s0 + 1]> self = ?                                                        | Unknown  | Unknown    | N/A   |
|  9 | Tensor<[1, 8, 10, 10]> self = ?                                                           | Unknown  | Fallback   | True  |
### aten.div.Tensor
|    | ATen Input Variations                                                   | Status   | Isolated   | PCC   |
|---:|:------------------------------------------------------------------------|:---------|:-----------|:------|
