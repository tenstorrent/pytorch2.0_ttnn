...
|  9 | Tensor<[1, 1]> self = ?,<br>Optional[int] dtype = torch.float32                                                                                        | Done     | Fallback   | True  |
...
|  5 | Tensor<[1, 1]> self = ?,<br>Tensor other = 16                              | Done     | Done       | True  |
...
|  2 | List[Tensor] tensors = [<[1, 8, 1, 64]>, <[1, 8, 1, 64]>],<br>int dim = 2  | Unknown  | Done       | N/A   |
...
| 18 | Tensor<[8, 1, 1]> self = ?,<br>int dim = 0           | Done     | Done       | True  |
