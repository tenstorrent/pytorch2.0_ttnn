...
|  9 | Tensor<[1, 1]> self = ?,<br>Optional[int] dtype = torch.float32                                                                                        | None     | Fallback   | True  |
...
|  4 | Tensor<[1, 1]> self = ?,<br>Tensor other = 0                               | Fallback | Done       | True  |
|  5 | Tensor<[1, 1]> self = ?,<br>Tensor other = 16                              | Fallback | Done       | True  |
...
|  3 | Tensor<[1, 10, 512]> self = ?                                                             | Fallback | Done       | True  |
...
|    | ATen Input Variations                                               | Status   | Isolated   | PCC   |
|---:|:--------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[32, 8]> weight = ?,<br>Tensor<[1, 1]> indices = ?           | None     | Fallback   | True  |
...
| 18 | Tensor<[8, 1, 1]> self = ?,<br>int dim = 0           | Fallback | Done       | True  |
