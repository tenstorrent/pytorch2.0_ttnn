...
| 11 | aten.native_layer_norm.default                   |                  3 |           1 |         0 |          1 | 🚧          |    0.33 |
| 12 | aten.ones.default                                |                  1 |           0 |         0 |          0 | ✘           |    0    |
| 13 | aten.permute.default                             |                  1 |           1 |         0 |          0 | ✅          |    1    |
| 14 | aten.select.int                                  |                  2 |           0 |         0 |          0 | ✘           |    0    |
| 15 | aten.slice.Tensor                                |                  7 |           1 |         0 |          2 | 🚧          |    0.14 |
| 16 | aten.t.default                                   |                  4 |           4 |         0 |          0 | ✅          |    1    |
| 17 | aten.transpose.int                               |                  6 |           3 |         0 |          1 | 🚧          |    0.5  |
| 18 | aten.view.default                                |                 25 |          14 |         0 |          1 | 🚧          |    0.56 |
***
...
| 16 | Tensor<[1, 12, 4, 64]> query = ?,<br>Tensor<[1, 12, 1500, 64]> key = ?,<br>Tensor<[1, 12, 1500, 64]> value = ?                                               | Unknown  | Fallback   | True  |
| 17 | Tensor<[1, 12, 4, 64]> query = ?,<br>Tensor<[1, 12, 4, 64]> key = ?,<br>Tensor<[1, 12, 4, 64]> value = ?,<br>float dropout_p = 0.0,<br>bool is_causal = True | Unknown  | Fallback   | True  |
### aten.add.Tensor
|    | ATen Input Variations                                                | Status   | Isolated   | PCC   |
|---:|:---------------------------------------------------------------------|:---------|:-----------|:------|
...
|  2 | Tensor<[1, 12, 1500, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Fallback | Done       | True  |
...
|  4 | Tensor<[1, 768, 3000]> self = ?  | Fallback | Done       | True  |
### aten.mm.default
|    | ATen Input Variations                                        | Status   | Isolated   | PCC   |
|---:|:-------------------------------------------------------------|:---------|:-----------|:------|
...
|  1 | Tensor<[1, 1]> self = ?,<br>Tensor other = 50259 | Fallback | Done       | True  |
|  2 | Tensor<[1, 1]> self = ?,<br>Tensor other = 50359 | Fallback | Done       | True  |
|  3 | Tensor<[1, 1]> self = ?,<br>Tensor other = 50363 | Fallback | Done       | True  |
...
|  1 | Tensor<[1, 1500, 768]> input = ?,<br>List[int] normalized_shape = [768],<br>Optional[Tensor]<[768]> weight = ?,<br>Optional[Tensor]<[768]> bias = ?,<br>float eps = 1e-05 | Fallback | Done       | N/A   |
...
|  4 | Tensor<[448, 768]> self = ?,<br>int dim = 0,<br>Optional[int] start = 0,<br>Optional[int] end = 4                      | Fallback | Done       | True  |
|  5 | Tensor<[448, 768]> self = ?,<br>int dim = 0,<br>Optional[int] start = 4,<br>Optional[int] end = 5                      | Fallback | Done       | True  |
...
| 18 | Tensor<[1, 51865]> self = ?,<br>List[int] size = [1, 1, 51865]         | Fallback | Done       | True  |
