...
|  5 | aten.clone.default                               |                  8 |           4 |         0 |          0 | 🚧          |    0.5  |
...
| 17 | aten.transpose.int                               |                  6 |           3 |         0 |          0 | 🚧          |    0.5  |
...
|  2 | Tensor<[1, 12, 1500, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Unknown  | Done       | True  |
