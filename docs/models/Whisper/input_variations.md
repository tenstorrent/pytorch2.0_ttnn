...
|  8 | aten.gelu.default                                |                  5 |           3 |         0 |          0 | 🚧          |    0.6  |
...
| 17 | aten.transpose.int                               |                  6 |           2 |         0 |          0 | 🚧          |    0.33 |
...
|  2 | Tensor<[1, 12, 1500, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Unknown  | Fallback   | True  |
|  3 | Tensor<[1, 12, 4, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format    | Unknown  | Fallback   | True  |
|  4 | Tensor<[1, 1500, 3072]> self = ?                                                             | Unknown  | Fallback   | True  |
|  5 | Tensor<[1, 1500, 768]> self = ?                                                              | Unknown  | Fallback   | True  |
|  6 | Tensor<[1, 4, 3072]> self = ?                                                                | Unknown  | Fallback   | True  |
|  7 | Tensor<[1, 4, 768]> self = ?                                                                 | Unknown  | Fallback   | True  |
...
|  4 | Tensor<[1, 768, 3000]> self = ?  | Unknown  | Done       | True  |
### aten.mm.default
|    | ATen Input Variations                                        | Status   | Isolated   | PCC   |
|---:|:-------------------------------------------------------------|:---------|:-----------|:------|
...
|  2 | Tensor<[1, 1]> self = ?,<br>Tensor other = 50359 | Unknown  | Done       | True  |
|  3 | Tensor<[1, 1]> self = ?,<br>Tensor other = 50363 | Unknown  | Done       | True  |
...
|    | ATen Input Variations                                             | Status   | Isolated   | PCC   |
|---:|:------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1, 51865]> self = ?,<br>int dim = 1,<br>int index = -1 | Unknown  | Done       | True  |
...
|  4 | Tensor<[1, 1500, 12, 64]> self = ?,<br>int dim0 = 1,<br>int dim1 = 2 | Unknown  | Done       | True  |
