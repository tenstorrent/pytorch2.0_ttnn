...
|  9 | aten.clamp.default                                |                  6 |           0 |         0 |          1 | ✘           |    0    |
...
| 20 | aten.mul.Tensor                                   |                 17 |           5 |         0 |          7 | 🚧          |    0.29 |
...
|  5 | Tensor<[6, 2]> self = ?,<br>Optional[number] min = 0,<br>Optional[number] max = 1                    | Fallback | Done       | True  |
### aten.clone.default
|    | ATen Input Variations                                                                         | Status   | Isolated   | PCC   |
|---:|:----------------------------------------------------------------------------------------------|:---------|:-----------|:------|
...
| 13 | Tensor<[3234, 2]> self = ?,<br>Tensor other = ?                        | Fallback | Unknown    | N/A   |
...
|  1 | Tensor<[3, 480, 640]> self = ?,<br>int dim = 0 | Fallback | Done       | True  |
