...
| 19 | aten.mul.Tensor         |                 28 |           9 |         0 |          0 | 🚧          |    0.32 |
...
| 33 | aten.unsqueeze.default  |                 30 |           7 |         0 |          0 | 🚧          |    0.23 |
...
|    | ATen Input Variations     | Status   | Isolated   | PCC   |
|---:|:--------------------------|:---------|:-----------|:------|
|  0 | Tensor<[15, 15]> self = ? | Unknown  | Done       | True  |
### aten.add.Tensor
|    | ATen Input Variations                                                      | Status   | Isolated   | PCC   |
|---:|:---------------------------------------------------------------------------|:---------|:-----------|:------|
...
| 23 | Tensor<[15, 15]> self = ?,<br>Tensor other = 8                             | Unknown  | Done       | True  |
...
|  1 | Tensor<[1, 1, 512]> self = ?                                                              | Unknown  | Fallback   | True  |
|  2 | Tensor<[1, 15, 1024]> self = ?                                                            | Unknown  | Fallback   | True  |
|  3 | Tensor<[1, 15, 512]> self = ?                                                             | Unknown  | Fallback   | True  |
|  4 | Tensor<[1, 15, 6, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Unknown  | Fallback   | True  |
|  5 | Tensor<[1, 6, 1, 15]> self = ?                                                            | Unknown  | Fallback   | True  |
|  6 | Tensor<[1, 6, 1, 17]> self = ?                                                            | Unknown  | Fallback   | True  |
|  7 | Tensor<[1, 6, 1, 1]> self = ?                                                             | Unknown  | Fallback   | True  |
|  8 | Tensor<[1, 6, 1, 2]> self = ?                                                             | Unknown  | Fallback   | True  |
|  9 | Tensor<[1, 6, 1, s0 + 1]> self = ?                                                        | Unknown  | Unknown    | N/A   |
| 10 | Tensor<[1, 6, 15, 15]> self = ?                                                           | Unknown  | Fallback   | True  |
### aten.div.Tensor
|    | ATen Input Variations                                                   | Status   | Isolated   | PCC   |
|---:|:------------------------------------------------------------------------|:---------|:-----------|:------|
...
| 19 | Tensor<[1, 1]> self = ?,<br>Tensor other = 0                                  | Unknown  | Unknown    | N/A   |
| 20 | Tensor<[1, 1]> self = ?,<br>Tensor other = 16                                 | Unknown  | Unknown    | N/A   |
| 21 | Tensor<[15, 15]> self = ?,<br>Tensor other = 16                               | Done     | Done       | True  |
| 22 | Tensor<[15, 15]> self = ?,<br>Tensor other = 8                                | Unknown  | Done       | True  |
...
|  2 | Tensor<[1, 1, 1, 1]> self = ?,<br>number other = 1.0      | Done     | Done       | True  |
...
|    | ATen Input Variations                                | Status   | Isolated   | PCC   |
|---:|:-----------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1, 15]> self = ?,<br>int dim = 2          | Unknown  | Done       | True  |
...
| 15 | Tensor<[15]> self = ?,<br>int dim = 0                | Unknown  | Done       | True  |
| 16 | Tensor<[15]> self = ?,<br>int dim = 1                | Unknown  | Done       | True  |
