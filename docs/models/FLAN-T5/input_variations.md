...
|---:|:------------------------|-------------------:|------------:|
|  0 | aten._softmax.default   |                  6 |           0 |
|  1 | aten._to_copy.default   |                 12 |           0 |
|  2 | aten.abs.default        |                  1 |           0 |
|  3 | aten.add.Tensor         |                 31 |           0 |
|  4 | aten.arange.default     |                  6 |           0 |
|  5 | aten.bmm.default        |                 12 |           0 |
|  6 | aten.cat.default        |                  7 |           0 |
|  7 | aten.clone.default      |                 11 |           0 |
|  8 | aten.div.Tensor         |                 10 |           0 |
|  9 | aten.embedding.default  |                  7 |           0 |
| 10 | aten.expand.default     |                 16 |           0 |
| 11 | aten.full_like.default  |                  5 |           0 |
| 12 | aten.gt.Scalar          |                  1 |           0 |
| 13 | aten.le.Tensor          |                  1 |           0 |
| 14 | aten.log.default        |                  5 |           0 |
| 15 | aten.lt.Scalar          |                  5 |           0 |
| 16 | aten.mean.dim           |                  2 |           0 |
| 17 | aten.minimum.default    |                  5 |           0 |
| 18 | aten.mm.default         |                  9 |           0 |
| 19 | aten.mul.Tensor         |                 30 |           0 |
| 20 | aten.neg.default        |                  4 |           0 |
| 21 | aten.ones.default       |                  8 |           0 |
| 22 | aten.permute.default    |                  5 |           0 |
| 23 | aten.pow.Tensor_Scalar  |                  4 |           0 |
| 24 | aten.repeat.default     |                  1 |           0 |
| 25 | aten.rsqrt.default      |                  2 |           0 |
| 26 | aten.rsub.Scalar        |                  6 |           0 |
| 27 | aten.slice.Tensor       |                 55 |           0 |
| 28 | aten.sub.Tensor         |                  5 |           0 |
| 29 | aten.sym_size.int       |                  1 |           0 |
| 30 | aten.t.default          |                  5 |           0 |
| 31 | aten.tanh.default       |                  2 |           0 |
| 32 | aten.transpose.int      |                  9 |           0 |
| 33 | aten.unsqueeze.default  |                 33 |           0 |
| 34 | aten.view.default       |                 43 |           0 |
| 35 | aten.where.self         |                  5 |           0 |
| 36 | aten.zeros.default      |                  4 |           0 |
| 37 | aten.zeros_like.default |                  4 |           0 |
***
...
|  5 | Tensor<[1, 6, 15, 15]> self = ?,<br>int<> dim = -1,<br>bool<> half_to_float = False    | Unknown  |
...
|  4 | Tensor<[1, 15, 1024]> self = ?,<br>Tensor<> other = 1.0                    | Unknown  |
|  5 | Tensor<[1, 15, 1024]> self = ?,<br>Tensor<[1, 15, 1024]> other = ?         | Unknown  |
|  6 | Tensor<[1, 15, 1]> self = ?,<br>Tensor<> other = 1e-06                     | Unknown  |
|  7 | Tensor<[1, 15, 512]> self = ?,<br>Tensor<[1, 15, 512]> other = ?           | Unknown  |
...
| 20 | Tensor<[1, 6, 15, 15]> self = ?,<br>Tensor<[1, 1, 1, 15]> other = ?        | Unknown  |
| 21 | Tensor<[1, 6, 15, 15]> self = ?,<br>Tensor<[1, 6, 15, 15]> other = ?       | Unknown  |
| 22 | Tensor<[15, 15]> self = ?,<br>Tensor<> other = 0                           | Unknown  |
| 23 | Tensor<[15, 15]> self = ?,<br>Tensor<> other = 8                           | Unknown  |
| 24 | Tensor<[15, 15]> self = ?,<br>Tensor<[15, 15]> other = ?                   | Unknown  |
...
|  2 | number<> end = 15,<br>Optional[int]<> dtype = torch.int64,<br>Optional[Device]<> device = cpu,<br>Optional[bool]<> pin_memory = False      | Unknown  |
...
| 10 | Tensor<[6, 15, 15]> self = ?,<br>Tensor<[6, 15, 64]> mat2 = ?        | Unknown  |
| 11 | Tensor<[6, 15, 64]> self = ?,<br>Tensor<[6, 64, 15]> mat2 = ?        | Unknown  |
### aten.cat.default
|    | ATen Input Variations                                                                                  | Status   |
|---:|:-------------------------------------------------------------------------------------------------------|:---------|
|  0 | List[Tensor]<> tensors = ['torch.Size([1, 1, 16])', 'torch.Size([1, 1, 1])'],<br>int<> dim = -1        | Unknown  |
|  1 | List[Tensor]<> tensors = ['torch.Size([1, 1, 1])', 'torch.Size([1, 1, 1])'],<br>int<> dim = -1         | Unknown  |
|  2 | List[Tensor]<> tensors = ['torch.Size([1, 1, s0 - 1])', 'torch.Size([1, 1, 1])'],<br>int<> dim = -1    | Unknown  |
|  3 | List[Tensor]<> tensors = ['torch.Size([1, 1, s0])', 'torch.Size([1, 1, 1])'],<br>int<> dim = -1        | Unknown  |
|  4 | List[Tensor]<> tensors = ['torch.Size([1, 6, 1, 64])', 'torch.Size([1, 6, 1, 64])'],<br>int<> dim = 2  | Unknown  |
|  5 | List[Tensor]<> tensors = ['torch.Size([1, 6, 16, 64])', 'torch.Size([1, 6, 1, 64])'],<br>int<> dim = 2 | Unknown  |
|  6 | List[Tensor]<> tensors = ['torch.Size([1, 6, s0, 64])', 'torch.Size([1, 6, 1, 64])'],<br>int<> dim = 2 | Unknown  |
### aten.clone.default
|    | ATen Input Variations                                                                       | Status   |
|---:|:--------------------------------------------------------------------------------------------|:---------|
...
|  3 | Tensor<[1, 15, 512]> self = ?                                                               | Unknown  |
|  4 | Tensor<[1, 15, 6, 64]> self = ?,<br>Optional[int]<> memory_format = torch.contiguous_format | Unknown  |
...
| 10 | Tensor<[1, 6, 15, 15]> self = ?                                                             | Unknown  |
### aten.div.Tensor
|    | ATen Input Variations                                                     | Status   |
|---:|:--------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 1]> self = ?,<br>Tensor<> other = 16                           | Unknown  |
|  1 | Tensor<[1, 1]> self = ?,<br>Tensor<> other = 2.0794415416798357           | Unknown  |
|  2 | Tensor<[15, 15]> self = ?,<br>Tensor<> other = 2.772588722239781          | Unknown  |
|  3 | Tensor<[15, 15]> self = ?,<br>Tensor<> other = 8                          | Unknown  |
...
|  1 | Tensor<[32, 6]> weight = ?,<br>Tensor<[15, 15]> indices = ?         | Unknown  |
...
|  5 | Tensor<[32128, 512]> weight = ?,<br>Tensor<[1, 15]> indices = ?     | Unknown  |
...
|  5 | Tensor<[1, 6, 1, s0 + 1]> self = ?,<br>List[int]<> size = [1, 6, 1, 'torch.Size(s0 + 1)']   | Unknown  |
...
| 14 | Tensor<[1, 6, 64, s0 + 1]> self = ?,<br>List[int]<> size = [1, 6, 64, 'torch.Size(s0 + 1)'] | Unknown  |
| 15 | Tensor<[1, 6, s0 + 1, 64]> self = ?,<br>List[int]<> size = [1, 6, 'torch.Size(s0 + 1)', 64] | Unknown  |
...
|  1 | Tensor<[1, 15, 512]> self = ?,<br>Optional[List[int]]<> dim = [-1],<br>bool<> keepdim = True | Unknown  |
...
|  5 | Tensor<[15, 1024]> self = ?,<br>Tensor<[1024, 512]> mat2 = ? | Unknown  |
|  6 | Tensor<[15, 384]> self = ?,<br>Tensor<[384, 512]> mat2 = ?   | Unknown  |
|  7 | Tensor<[15, 512]> self = ?,<br>Tensor<[512, 1024]> mat2 = ?  | Unknown  |
|  8 | Tensor<[15, 512]> self = ?,<br>Tensor<[512, 384]> mat2 = ?   | Unknown  |
### aten.mul.Tensor
|    | ATen Input Variations                                                           | Status   |
|---:|:--------------------------------------------------------------------------------|:---------|
...
| 16 | Tensor<[1, 15, 1024]> self = ?,<br>Tensor<> other = 0.044715                    | Unknown  |
| 17 | Tensor<[1, 15, 1024]> self = ?,<br>Tensor<> other = 0.5                         | Unknown  |
| 18 | Tensor<[1, 15, 1024]> self = ?,<br>Tensor<> other = 0.7978845608028654          | Unknown  |
| 19 | Tensor<[1, 15, 1024]> self = ?,<br>Tensor<[1, 15, 1024]> other = ?              | Unknown  |
| 20 | Tensor<[1, 15, 512]> self = ?,<br>Tensor<[1, 15, 1]> other = ?                  | Unknown  |
| 21 | Tensor<[1, 1]> self = ?,<br>Tensor<> other = 0                                  | Unknown  |
| 22 | Tensor<[1, 1]> self = ?,<br>Tensor<> other = 16                                 | Unknown  |
| 23 | Tensor<[15, 15]> self = ?,<br>Tensor<> other = 16                               | Unknown  |
| 24 | Tensor<[15, 15]> self = ?,<br>Tensor<> other = 8                                | Unknown  |
...
| 28 | Tensor<[512]> self = ?,<br>Tensor<[1, 15, 512]> other = ?                       | Unknown  |
...
|  1 | Tensor<[15, 15, 6]> self = ?,<br>List[int]<> dims = [2, 0, 1]         | Unknown  |
...
|  2 | Tensor<[1, 15, 1024]> self = ?,<br>number<> exponent = 3.0 | Unknown  |
|  3 | Tensor<[1, 15, 512]> self = ?,<br>number<> exponent = 2    | Unknown  |
### aten.repeat.default
|    | ATen Input Variations                                          | Status   |
|---:|:---------------------------------------------------------------|:---------|
...
|  1 | Tensor<[1, 1, 1, 17]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1           | Unknown  |
|  2 | Tensor<[1, 1, 1, 17]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1           | Unknown  |
|  3 | Tensor<[1, 1, 1, 1]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1            | Unknown  |
|  4 | Tensor<[1, 1, 1, 1]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1            | Unknown  |
|  5 | Tensor<[1, 1, 1, 2]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1            | Unknown  |
|  6 | Tensor<[1, 1, 1, 2]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1            | Unknown  |
|  7 | Tensor<[1, 1, 1, s0 + 1]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1       | Unknown  |
|  8 | Tensor<[1, 1, 1, s0 + 1]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1       | Unknown  |
|  9 | Tensor<[1, 1, 1, s0]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1           | Unknown  |
| 10 | Tensor<[1, 1, 1, s0]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1           | Unknown  |
| 11 | Tensor<[1, 1, 17]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1              | Unknown  |
| 12 | Tensor<[1, 1, 1]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1               | Unknown  |
| 13 | Tensor<[1, 1, 1]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1               | Unknown  |
| 14 | Tensor<[1, 1, 2]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1               | Unknown  |
| 15 | Tensor<[1, 1, s0 + 1]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1          | Unknown  |
| 16 | Tensor<[1, 1, s0]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1              | Unknown  |
| 17 | Tensor<[1, 15]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                 | Unknown  |
| 18 | Tensor<[1, 15]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                 | Unknown  |
| 19 | Tensor<[1, 17]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                 | Unknown  |
| 20 | Tensor<[1, 17]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                 | Unknown  |
| 21 | Tensor<[1, 1]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                  | Unknown  |
| 22 | Tensor<[1, 1]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                  | Unknown  |
| 23 | Tensor<[1, 2]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                  | Unknown  |
| 24 | Tensor<[1, 2]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                  | Unknown  |
| 25 | Tensor<[1, 6, 1, 15]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1           | Unknown  |
| 26 | Tensor<[1, 6, 1, 17]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1           | Unknown  |
| 27 | Tensor<[1, 6, 1, 2]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1            | Unknown  |
| 28 | Tensor<[1, 6, 1, s0 + 1]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1       | Unknown  |
| 29 | Tensor<[1, 6, 17, 17]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1          | Unknown  |
| 30 | Tensor<[1, 6, 17, 17]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1          | Unknown  |
| 31 | Tensor<[1, 6, 17, 17]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = -1,<br>Optional[int]<> end = -1         | Unknown  |
| 32 | Tensor<[1, 6, 18, 15]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1          | Unknown  |
| 33 | Tensor<[1, 6, 18, 15]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1          | Unknown  |
| 34 | Tensor<[1, 6, 18, 15]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = -1,<br>Optional[int]<> end = -1         | Unknown  |
| 35 | Tensor<[1, 6, 2, 2]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1            | Unknown  |
| 36 | Tensor<[1, 6, 2, 2]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1            | Unknown  |
| 37 | Tensor<[1, 6, 2, 2]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = -1,<br>Optional[int]<> end = -1           | Unknown  |
| 38 | Tensor<[1, 6, 3, 15]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1           | Unknown  |
| 39 | Tensor<[1, 6, 3, 15]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1           | Unknown  |
| 40 | Tensor<[1, 6, 3, 15]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = -1,<br>Optional[int]<> end = -1          | Unknown  |
| 41 | Tensor<[1, 6, s0 + 1, s0 + 1]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1  | Unknown  |
| 42 | Tensor<[1, 6, s0 + 1, s0 + 1]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1  | Unknown  |
| 43 | Tensor<[1, 6, s0 + 1, s0 + 1]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = -1,<br>Optional[int]<> end = -1 | Unknown  |
| 44 | Tensor<[1, 6, s0 + 2, 15]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1      | Unknown  |
| 45 | Tensor<[1, 6, s0 + 2, 15]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1      | Unknown  |
| 46 | Tensor<[1, 6, s0 + 2, 15]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = -1,<br>Optional[int]<> end = -1     | Unknown  |
| 47 | Tensor<[1, s0 + 1]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1             | Unknown  |
| 48 | Tensor<[1, s0 + 1]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1             | Unknown  |
| 49 | Tensor<[1, s0]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                 | Unknown  |
| 50 | Tensor<[15]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                    | Unknown  |
| 51 | Tensor<[17]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                    | Unknown  |
| 52 | Tensor<[1]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                     | Unknown  |
| 53 | Tensor<[2]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                     | Unknown  |
| 54 | Tensor<[s0 + 1]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                | Unknown  |
### aten.sub.Tensor
|    | ATen Input Variations                                          | Status   |
|---:|:---------------------------------------------------------------|:---------|
...
|    | ATen Input Variations         | Status   |
|---:|:------------------------------|:---------|
|  0 | Tensor<[1024, 512]> self = ?  | Unknown  |
|  1 | Tensor<[32128, 512]> self = ? | Unknown  |
|  2 | Tensor<[384, 512]> self = ?   | Unknown  |
|  3 | Tensor<[512, 1024]> self = ?  | Unknown  |
|  4 | Tensor<[512, 384]> self = ?   | Unknown  |
### aten.tanh.default
|    | ATen Input Variations          | Status   |
|---:|:-------------------------------|:---------|
|  0 | Tensor<[1, 1, 1024]> self = ?  | Unknown  |
|  1 | Tensor<[1, 15, 1024]> self = ? | Unknown  |
### aten.transpose.int
|    | ATen Input Variations                                                     | Status   |
|---:|:--------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 1, 6, 64]> self = ?,<br>int<> dim0 = 1,<br>int<> dim1 = 2      | Unknown  |
|  1 | Tensor<[1, 15, 6, 64]> self = ?,<br>int<> dim0 = 1,<br>int<> dim1 = 2     | Unknown  |
|  2 | Tensor<[1, 6, 1, 64]> self = ?,<br>int<> dim0 = 1,<br>int<> dim1 = 2      | Unknown  |
|  3 | Tensor<[1, 6, 1, 64]> self = ?,<br>int<> dim0 = 3,<br>int<> dim1 = 2      | Unknown  |
|  4 | Tensor<[1, 6, 15, 64]> self = ?,<br>int<> dim0 = 1,<br>int<> dim1 = 2     | Unknown  |
|  5 | Tensor<[1, 6, 15, 64]> self = ?,<br>int<> dim0 = 3,<br>int<> dim1 = 2     | Unknown  |
...
| 11 | Tensor<[1, 15]> self = ?,<br>int<> dim = 1             | Unknown  |
...
| 18 | Tensor<[15]> self = ?,<br>int<> dim = 0                | Unknown  |
| 19 | Tensor<[15]> self = ?,<br>int<> dim = 1                | Unknown  |
...
| 27 | Tensor<[6, 15, 15]> self = ?,<br>int<> dim = 0         | Unknown  |
...
|  6 | Tensor<[1, 15, 1024]> self = ?,<br>List[int]<> size = [15, 1024]                         | Unknown  |
|  7 | Tensor<[1, 15, 384]> self = ?,<br>List[int]<> size = [1, -1, 6, 64]                      | Unknown  |
|  8 | Tensor<[1, 15, 384]> self = ?,<br>List[int]<> size = [15, 384]                           | Unknown  |
|  9 | Tensor<[1, 15, 512]> self = ?,<br>List[int]<> size = [15, 512]                           | Unknown  |
| 10 | Tensor<[1, 15, 6, 64]> self = ?,<br>List[int]<> size = [1, -1, 384]                      | Unknown  |
| 11 | Tensor<[1, 15]> self = ?,<br>List[int]<> size = [-1, 15]                                 | Unknown  |
...
| 21 | Tensor<[1, 6, 1, s0 + 1]> self = ?,<br>List[int]<> size = [6, 1, 'torch.Size(s0 + 1)']   | Unknown  |
| 22 | Tensor<[1, 6, 15, 15]> self = ?,<br>List[int]<> size = [6, 15, 15]                       | Unknown  |
| 23 | Tensor<[1, 6, 15, 64]> self = ?,<br>List[int]<> size = [6, 15, 64]                       | Unknown  |
| 24 | Tensor<[1, 6, 17, 64]> self = ?,<br>List[int]<> size = [6, 17, 64]                       | Unknown  |
| 25 | Tensor<[1, 6, 2, 64]> self = ?,<br>List[int]<> size = [6, 2, 64]                         | Unknown  |
| 26 | Tensor<[1, 6, 64, 15]> self = ?,<br>List[int]<> size = [6, 64, 15]                       | Unknown  |
...
| 30 | Tensor<[1, 6, 64, s0 + 1]> self = ?,<br>List[int]<> size = [6, 64, 'torch.Size(s0 + 1)'] | Unknown  |
| 31 | Tensor<[1, 6, s0 + 1, 64]> self = ?,<br>List[int]<> size = [6, 'torch.Size(s0 + 1)', 64] | Unknown  |
| 32 | Tensor<[15, 1024]> self = ?,<br>List[int]<> size = [1, 15, 1024]                         | Unknown  |
| 33 | Tensor<[15, 384]> self = ?,<br>List[int]<> size = [1, 15, 384]                           | Unknown  |
| 34 | Tensor<[15, 512]> self = ?,<br>List[int]<> size = [1, 15, 512]                           | Unknown  |
...
| 40 | Tensor<[6, 1, s0 + 1]> self = ?,<br>List[int]<> size = [1, 6, 1, 'torch.Size(s0 + 1)']   | Unknown  |
| 41 | Tensor<[6, 15, 15]> self = ?,<br>List[int]<> size = [1, 6, 15, 15]                       | Unknown  |
| 42 | Tensor<[6, 15, 64]> self = ?,<br>List[int]<> size = [1, 6, 15, 64]                       | Unknown  |
### aten.where.self
|    | ATen Input Variations                                                                                               | Status   |
|---:|:--------------------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 1]> condition = ?,<br>Tensor<[1, 1]> self = ?,<br>Tensor<[1, 1]> other = ?                               | Unknown  |
|  1 | Tensor<[15, 15]> condition = ?,<br>Tensor<[15, 15]> self = ?,<br>Tensor<[15, 15]> other = ?                         | Unknown  |
...
|    | ATen Input Variations                                                                                                                                                     | Status   |
|---:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|
|  0 | List[int]<> size = [1, 6, 'torch.Size(s0 + 2)', 15],<br>Optional[int]<> dtype = torch.float32,<br>Optional[Device]<> device = cpu,<br>Optional[bool]<> pin_memory = False | Unknown  |
|  1 | List[int]<> size = [1, 6, 1, 15],<br>Optional[int]<> dtype = torch.float32,<br>Optional[Device]<> device = cpu,<br>Optional[bool]<> pin_memory = False                    | Unknown  |
|  2 | List[int]<> size = [1, 6, 18, 15],<br>Optional[int]<> dtype = torch.float32,<br>Optional[Device]<> device = cpu,<br>Optional[bool]<> pin_memory = False                   | Unknown  |
|  3 | List[int]<> size = [1, 6, 3, 15],<br>Optional[int]<> dtype = torch.float32,<br>Optional[Device]<> device = cpu,<br>Optional[bool]<> pin_memory = False                    | Unknown  |
