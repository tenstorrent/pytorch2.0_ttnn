...
|    | ATen Input Variations                                                                                                                                                       | Status   |
|---:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|
|  0 | List[Tensor]<> tensors = ['torch.Size([1, 192, 35, 35])', 'torch.Size([1, 192, 35, 35])'],<br>int<> dim = 1                                                                 | None     |
|  1 | List[Tensor]<> tensors = ['torch.Size([1, 192, 8, 8])', 'torch.Size([1, 320, 8, 8])', 'torch.Size([1, 1024, 8, 8])'],<br>int<> dim = 1                                      | None     |
|  2 | List[Tensor]<> tensors = ['torch.Size([1, 256, 8, 8])', 'torch.Size([1, 256, 8, 8])'],<br>int<> dim = 1                                                                     | None     |
|  3 | List[Tensor]<> tensors = ['torch.Size([1, 256, 8, 8])', 'torch.Size([1, 512, 8, 8])', 'torch.Size([1, 512, 8, 8])', 'torch.Size([1, 256, 8, 8])'],<br>int<> dim = 1         | None     |
|  4 | List[Tensor]<> tensors = ['torch.Size([1, 384, 17, 17])', 'torch.Size([1, 256, 17, 17])', 'torch.Size([1, 256, 17, 17])', 'torch.Size([1, 128, 17, 17])'],<br>int<> dim = 1 | None     |
|  5 | List[Tensor]<> tensors = ['torch.Size([1, 384, 17, 17])', 'torch.Size([1, 256, 17, 17])', 'torch.Size([1, 384, 17, 17])'],<br>int<> dim = 1                                 | None     |
|  6 | List[Tensor]<> tensors = ['torch.Size([1, 64, 73, 73])', 'torch.Size([1, 96, 73, 73])'],<br>int<> dim = 1                                                                   | None     |
|  7 | List[Tensor]<> tensors = ['torch.Size([1, 96, 35, 35])', 'torch.Size([1, 96, 35, 35])', 'torch.Size([1, 96, 35, 35])', 'torch.Size([1, 96, 35, 35])'],<br>int<> dim = 1     | None     |
|  8 | List[Tensor]<> tensors = ['torch.Size([1, 96, 71, 71])', 'torch.Size([1, 96, 71, 71])'],<br>int<> dim = 1                                                                   | None     |
### aten.clone.default
|    | ATen Input Variations      | Status   |
|---:|:---------------------------|:---------|
...
|    | ATen Input Variations                                             | Status   |
|---:|:------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 1536, 1, 1]> self = ?,<br>List[int]<> size = [1, 1536] | Fallback |
