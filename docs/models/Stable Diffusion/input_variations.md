...
| 28 | aten.view.default                                |                 39 |          20 |         0 |         19 | 🚧          |               0.51 |
***
...
|    | ATen Input Variations                                             | Status   |
|---:|:------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 1]> self = ?,<br>Optional[int]<> dtype = torch.float32 | None     |
...
|    | ATen Input Variations                                                                                                             | Status   |
|---:|:----------------------------------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 1280, 16, 16]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, 'torch.Size([32, 1])', 'torch.Size([32])'] | None     |
|  1 | Tensor<[1, 1280, 8, 8]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, 'torch.Size([16, 1])', 'torch.Size([16])']   | None     |
|  2 | Tensor<[1, 640, 32, 32]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, 'torch.Size([64, 1])', 'torch.Size([64])']  | None     |
### aten.add.Tensor
|    | ATen Input Variations                                                      | Status   |
|---:|:---------------------------------------------------------------------------|:---------|
...
|    | ATen Input Variations                                                                                         | Status   |
|---:|:--------------------------------------------------------------------------------------------------------------|:---------|
|  0 | List[Tensor]<> tensors = ['torch.Size([1, 1280, 16, 16])', 'torch.Size([1, 1280, 16, 16])'],<br>int<> dim = 1 | None     |
|  1 | List[Tensor]<> tensors = ['torch.Size([1, 1280, 16, 16])', 'torch.Size([1, 640, 16, 16])'],<br>int<> dim = 1  | None     |
|  2 | List[Tensor]<> tensors = ['torch.Size([1, 1280, 32, 32])', 'torch.Size([1, 640, 32, 32])'],<br>int<> dim = 1  | None     |
|  3 | List[Tensor]<> tensors = ['torch.Size([1, 1280, 8, 8])', 'torch.Size([1, 1280, 8, 8])'],<br>int<> dim = 1     | None     |
|  4 | List[Tensor]<> tensors = ['torch.Size([1, 160])', 'torch.Size([1, 160])'],<br>int<> dim = -1                  | None     |
|  5 | List[Tensor]<> tensors = ['torch.Size([1, 320, 64, 64])', 'torch.Size([1, 320, 64, 64])'],<br>int<> dim = 1   | None     |
|  6 | List[Tensor]<> tensors = ['torch.Size([1, 640, 32, 32])', 'torch.Size([1, 320, 32, 32])'],<br>int<> dim = 1   | None     |
|  7 | List[Tensor]<> tensors = ['torch.Size([1, 640, 32, 32])', 'torch.Size([1, 640, 32, 32])'],<br>int<> dim = 1   | None     |
|  8 | List[Tensor]<> tensors = ['torch.Size([1, 640, 64, 64])', 'torch.Size([1, 320, 64, 64])'],<br>int<> dim = 1   | None     |
### aten.clone.default
|    | ATen Input Variations                                                                          | Status   |
|---:|:-----------------------------------------------------------------------------------------------|:---------|
...
|  1 | Tensor<[1, 1024, 640]> self = ?,<br>List[int]<> size = [1, -1, 8, 80]    | Fallback |
|  2 | Tensor<[1, 1024, 640]> self = ?,<br>List[int]<> size = [1, 32, 32, 640]  | Fallback |
|  3 | Tensor<[1, 1024, 640]> self = ?,<br>List[int]<> size = [1024, 640]       | Done     |
|  4 | Tensor<[1, 1024, 8, 80]> self = ?,<br>List[int]<> size = [1, -1, 640]    | Fallback |
|  5 | Tensor<[1, 16, 16, 1280]> self = ?,<br>List[int]<> size = [1, 256, 1280] | Fallback |
|  6 | Tensor<[1, 256, 1280]> self = ?,<br>List[int]<> size = [1, -1, 8, 160]   | Fallback |
|  7 | Tensor<[1, 256, 1280]> self = ?,<br>List[int]<> size = [1, 16, 16, 1280] | Fallback |
