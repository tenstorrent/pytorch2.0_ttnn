...
|    | ATen Input Variations                                                                  | Status   | Isolated   | PCC   |
|---:|:---------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1000]> self = ?,<br>Tensor<[1, 400]> mat1 = ?,<br>Tensor<[400, 1000]> mat2 = ? | Removed  | Done       | True  |
...
|    | ATen Input Variations              | Status   | Isolated   | PCC   |
|---:|:-----------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 160, 14, 14]> self = ?  | Removed  | Done       | True  |
|  1 | Tensor<[1, 160, 28, 28]> self = ?  | Removed  | Done       | True  |
|  2 | Tensor<[1, 32, 112, 112]> self = ? | Removed  | Done       | True  |
|  3 | Tensor<[1, 32, 56, 56]> self = ?   | Removed  | Done       | True  |
|  4 | Tensor<[1, 400, 14, 14]> self = ?  | Removed  | Done       | True  |
|  5 | Tensor<[1, 400, 7, 7]> self = ?    | Done     | Done       | True  |
|  6 | Tensor<[1, 64, 28, 28]> self = ?   | Removed  | Done       | True  |
|  7 | Tensor<[1, 64, 56, 56]> self = ?   | Removed  | Done       | True  |
### aten.t.default
|    | ATen Input Variations        | Status   | Isolated   | PCC   |
|---:|:-----------------------------|:---------|:-----------|:------|
