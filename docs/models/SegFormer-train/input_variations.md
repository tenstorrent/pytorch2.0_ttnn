...
| 14 | aten.clone.default                               |                 23 |          19 |         0 |          0 | 🚧          |    0.83 |
...
| 28 | aten.permute.default                             |                 41 |          35 |         0 |          0 | 🚧          |    0.85 |
...
|  4 | Tensor<[1, 160, 32, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format  | Unknown  | Done       | True  |
...
|  9 | Tensor<[1, 256, 128, 128]> self = ?                                                          | Unknown  | Done       | True  |
...
| 16 | Tensor<[1, 32, 128, 128]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Unknown  | Done       | True  |
...
| 21 | Tensor<[1, 64, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format   | Unknown  | Done       | True  |
...
|  18 | Tensor<[1, 16, 16, 256]> self = ?,<br>List[int] size = [1, 256, 256]     | Unknown  | Done       | True  |
