...
|---:|:------------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 16, 50, 64]> query = ?,<br>Tensor<[1, 16, 50, 64]> key = ?,<br>Tensor<[1, 16, 50, 64]> value = ? | Done     |
### aten.add.Tensor
|    | ATen Input Variations                                              | Status   |
|---:|:-------------------------------------------------------------------|:---------|
...
|    | ATen Input Variations                                                                                | Status   |
|---:|:-----------------------------------------------------------------------------------------------------|:---------|
|  0 | List[Tensor]<> tensors = ['torch.Size([1, 1, 1024])', 'torch.Size([1, 49, 1024])'],<br>int<> dim = 1 | Unknown  |
...
|    | ATen Input Variations                                                                                                                                                                                                                                                                                             | Status   |
|---:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 3, 224, 224]> input = ?,<br>Tensor<[1024, 3, 32, 32]> weight = ?,<br>Optional[Tensor]<[1024]> bias = ?,<br>List[int]<> stride = [32, 32],<br>List[int]<> padding = [0, 0],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1 | Done     |
### aten.expand.default
|    | ATen Input Variations                                            | Status   |
|---:|:-----------------------------------------------------------------|:---------|
...
|    | ATen Input Variations                                                   | Status   |
|---:|:------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 50, 1024]> self = ?,<br>int<> dim = 1,<br>int<> index = 0    | Done     |
|  1 | Tensor<[3, 50, 1, 1024]> self = ?,<br>int<> dim = 0,<br>int<> index = 0 | Done     |
|  2 | Tensor<[3, 50, 1, 1024]> self = ?,<br>int<> dim = 0,<br>int<> index = 1 | Done     |
|  3 | Tensor<[3, 50, 1, 1024]> self = ?,<br>int<> dim = 0,<br>int<> index = 2 | Done     |
### aten.slice.Tensor
|    | ATen Input Variations                                                                                       | Status   |
|---:|:------------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 50, 1024]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1 | Done     |
### aten.squeeze.dim
|    | ATen Input Variations                                   | Status   |
|---:|:--------------------------------------------------------|:---------|
|  0 | Tensor<[3, 50, 1, 1, 1024]> self = ?,<br>int<> dim = -2 | Done     |
### aten.t.default
|    | ATen Input Variations         | Status   |
|---:|:------------------------------|:---------|
...
|    | ATen Input Variations                                                  | Status   |
|---:|:-----------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 1024, 7, 7]> self = ?,<br>List[int]<> size = [1, 1024, 49]  | Done     |
...
|  4 | Tensor<[50, 1, 1024]> self = ?,<br>List[int]<> size = [50, 1024]       | Done     |
|  5 | Tensor<[50, 1, 1024]> self = ?,<br>List[int]<> size = [50, 16, 64]     | Done     |
|  6 | Tensor<[50, 1, 16, 64]> self = ?,<br>List[int]<> size = [50, 1024]     | Done     |
|  7 | Tensor<[50, 1, 3072]> self = ?,<br>List[int]<> size = [50, 1, 3, 1024] | Done     |
|  8 | Tensor<[50, 1024]> self = ?,<br>List[int]<> size = [1, 50, 1024]       | Done     |
|  9 | Tensor<[50, 1024]> self = ?,<br>List[int]<> size = [50, 1, 1024]       | Done     |
| 10 | Tensor<[50, 3072]> self = ?,<br>List[int]<> size = [50, 1, 3072]       | Done     |
