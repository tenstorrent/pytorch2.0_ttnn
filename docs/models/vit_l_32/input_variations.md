...
|  2 | Tensor<[3, 50, 1, 1024]> self = ?,<br>int<> dim = 0,<br>int<> index = 1 | Unknown  |
|  3 | Tensor<[3, 50, 1, 1024]> self = ?,<br>int<> dim = 0,<br>int<> index = 2 | Unknown  |
### aten.slice.Tensor
|    | ATen Input Variations                                                                                       | Status   |
|---:|:------------------------------------------------------------------------------------------------------------|:---------|
...
|  1 | Tensor<[1, 50, 1024]> self = ?,<br>List[int]<> size = [50, 1024]       | Unknown  |
|  2 | Tensor<[1, 50, 4096]> self = ?,<br>List[int]<> size = [50, 4096]       | Unknown  |
|  3 | Tensor<[16, 50, 64]> self = ?,<br>List[int]<> size = [1, 16, 50, 64]   | Unknown  |
|  4 | Tensor<[50, 1, 1024]> self = ?,<br>List[int]<> size = [50, 1024]       | Unknown  |
|  5 | Tensor<[50, 1, 1024]> self = ?,<br>List[int]<> size = [50, 16, 64]     | Unknown  |
|  6 | Tensor<[50, 1, 16, 64]> self = ?,<br>List[int]<> size = [50, 1024]     | Unknown  |
|  7 | Tensor<[50, 1, 3072]> self = ?,<br>List[int]<> size = [50, 1, 3, 1024] | Unknown  |
|  8 | Tensor<[50, 1024]> self = ?,<br>List[int]<> size = [1, 50, 1024]       | Unknown  |
|  9 | Tensor<[50, 1024]> self = ?,<br>List[int]<> size = [50, 1, 1024]       | Unknown  |
| 10 | Tensor<[50, 3072]> self = ?,<br>List[int]<> size = [50, 1, 3072]       | Unknown  |
| 11 | Tensor<[50, 4096]> self = ?,<br>List[int]<> size = [1, 50, 4096]       | Unknown  |
