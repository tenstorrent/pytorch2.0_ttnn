...
|    | ATen Input Variations                                                                  | Status   | Isolated   | PCC   |
|---:|:---------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1000]> self = ?,<br>Tensor<[1, 440]> mat1 = ?,<br>Tensor<[440, 1000]> mat2 = ? | Fallback | Done       | True  |
...
|    | ATen Input Variations                                                                            | Status   | Isolated   | PCC   |
|---:|:-------------------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 104, 28, 28]> self = ?,<br>Optional[List[int]] dim = [-1, -2],<br>bool keepdim = True | Fallback | Done       | True  |
|  1 | Tensor<[1, 208, 14, 14]> self = ?,<br>Optional[List[int]] dim = [-1, -2],<br>bool keepdim = True | Fallback | Done       | True  |
|  2 | Tensor<[1, 440, 7, 7]> self = ?,<br>Optional[List[int]] dim = [-1, -2],<br>bool keepdim = True   | Done     | Done       | True  |
|  3 | Tensor<[1, 48, 56, 56]> self = ?,<br>Optional[List[int]] dim = [-1, -2],<br>bool keepdim = True  | Fallback | Done       | True  |
### aten.mul.Tensor
|    | ATen Input Variations                                                  | Status   | Isolated   | PCC   |
|---:|:-----------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 104, 1, 1]> self = ?,<br>Tensor<[1, 104, 28, 28]> other = ? | Fallback | Done       | True  |
|  1 | Tensor<[1, 208, 1, 1]> self = ?,<br>Tensor<[1, 208, 14, 14]> other = ? | Fallback | Done       | True  |
|  2 | Tensor<[1, 440, 1, 1]> self = ?,<br>Tensor<[1, 440, 7, 7]> other = ?   | Fallback | Done       | True  |
|  3 | Tensor<[1, 48, 1, 1]> self = ?,<br>Tensor<[1, 48, 56, 56]> other = ?   | Fallback | Done       | True  |
### aten.relu.default
|    | ATen Input Variations              | Status   | Isolated   | PCC   |
|---:|:-----------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 104, 28, 28]> self = ?  | Fallback | Done       | True  |
|  1 | Tensor<[1, 104, 56, 56]> self = ?  | Fallback | Done       | True  |
|  2 | Tensor<[1, 110, 1, 1]> self = ?    | Fallback | Done       | True  |
|  3 | Tensor<[1, 12, 1, 1]> self = ?     | Fallback | Done       | True  |
|  4 | Tensor<[1, 208, 14, 14]> self = ?  | Fallback | Done       | True  |
|  5 | Tensor<[1, 208, 28, 28]> self = ?  | Fallback | Done       | True  |
|  6 | Tensor<[1, 26, 1, 1]> self = ?     | Fallback | Done       | True  |
|  7 | Tensor<[1, 32, 112, 112]> self = ? | Fallback | Done       | True  |
|  8 | Tensor<[1, 440, 14, 14]> self = ?  | Fallback | Done       | True  |
|  9 | Tensor<[1, 440, 7, 7]> self = ?    | Done     | Done       | True  |
| 10 | Tensor<[1, 48, 112, 112]> self = ? | Fallback | Done       | True  |
| 11 | Tensor<[1, 48, 56, 56]> self = ?   | Fallback | Done       | True  |
| 12 | Tensor<[1, 52, 1, 1]> self = ?     | Fallback | Done       | True  |
| 13 | Tensor<[1, 8, 1, 1]> self = ?      | Fallback | Done       | True  |
