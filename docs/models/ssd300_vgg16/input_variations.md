...
|  3 | aten.add.Tensor                      |                 14 |           4 |         0 |          0 | 🚧          |    0.29 |
...
| 14 | aten.expand.default                  |                 12 |           1 |         0 |          0 | 🚧          |    0.08 |
...
| 19 | aten.mul.Tensor                      |                 12 |           5 |         0 |          0 | 🚧          |    0.42 |
...
| 31 | aten.view.default                    |                 36 |           6 |         0 |         15 | 🚧          |    0.17 |
***
...
|  2 | Tensor<[1, 19, 19, 6, 4]> self = ?,<br>List[int] size = [1, 2166, 4]   | Fallback | Fallback   | True  |
|  3 | Tensor<[1, 19, 19, 6, 91]> self = ?,<br>List[int] size = [1, 2166, 91] | Fallback | Fallback   | True  |
|  4 | Tensor<[1, 3, 3, 4, 4]> self = ?,<br>List[int] size = [1, 36, 4]       | Fallback | Fallback   | True  |
|  5 | Tensor<[1, 3, 3, 4, 91]> self = ?,<br>List[int] size = [1, 36, 91]     | Fallback | Fallback   | True  |
|  6 | Tensor<[1, 38, 38, 4, 4]> self = ?,<br>List[int] size = [1, 5776, 4]   | Fallback | Fallback   | True  |
|  7 | Tensor<[1, 38, 38, 4, 91]> self = ?,<br>List[int] size = [1, 5776, 91] | Fallback | Fallback   | True  |
...
| 11 | Tensor<[19, 19]> self = ?,<br>List[int] size = [361]                   | Fallback | Fallback   | True  |
| 12 | Tensor<[3, 3]> self = ?,<br>List[int] size = [9]                       | Fallback | Fallback   | True  |
| 13 | Tensor<[38, 38]> self = ?,<br>List[int] size = [1444]                  | Fallback | Fallback   | True  |
...
|  2 | Tensor<[1, 19, 19, 6, 4]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format  | Unknown  | Fallback   | True  |
|  3 | Tensor<[1, 19, 19, 6, 91]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Unknown  | Fallback   | True  |
|  4 | Tensor<[1, 3, 3, 4, 4]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format    | Unknown  | Fallback   | True  |
|  5 | Tensor<[1, 3, 3, 4, 91]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format   | Unknown  | Fallback   | True  |
|  6 | Tensor<[1, 38, 38, 4, 4]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format  | Unknown  | Fallback   | True  |
|  7 | Tensor<[1, 38, 38, 4, 91]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Unknown  | Fallback   | True  |
...
| 11 | Tensor<[19, 19]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format           | Unknown  | Fallback   | True  |
| 12 | Tensor<[3, 3]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format             | Unknown  | Fallback   | True  |
| 13 | Tensor<[38, 38]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format           | Unknown  | Fallback   | True  |
...
|  3 | Tensor<[300]> self = ?,<br>int dim = 1         | Done     | Done       | True  |
|  4 | Tensor<[3]> self = ?,<br>int dim = 1           | Done     | Done       | True  |
|  5 | Tensor<[8732]> self = ?,<br>int dim = 1        | Unknown  | Done       | True  |
### aten.view.default
|    | ATen Input Variations                                                      | Status   | Isolated   | PCC   |
|---:|:---------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1, 1, 4, 4]> self = ?,<br>List[int] size = [1, -1, 4]           | Fallback | Fallback   | True  |
|  1 | Tensor<[1, 1, 1, 4, 91]> self = ?,<br>List[int] size = [1, -1, 91]         | Fallback | Fallback   | True  |
|  2 | Tensor<[1, 16, 1, 1]> self = ?,<br>List[int] size = [1, -1, 4, 1, 1]       | Fallback | Fallback   | True  |
|  3 | Tensor<[1, 16, 3, 3]> self = ?,<br>List[int] size = [1, -1, 4, 3, 3]       | Fallback | Fallback   | True  |
|  4 | Tensor<[1, 16, 38, 38]> self = ?,<br>List[int] size = [1, -1, 4, 38, 38]   | Fallback | Fallback   | True  |
|  5 | Tensor<[1, 1]> self = ?,<br>List[int] size = [-1]                          | Fallback | Fallback   | True  |
|  6 | Tensor<[1, 24, 10, 10]> self = ?,<br>List[int] size = [1, -1, 4, 10, 10]   | Fallback | Fallback   | True  |
|  7 | Tensor<[1, 24, 19, 19]> self = ?,<br>List[int] size = [1, -1, 4, 19, 19]   | Fallback | Fallback   | True  |
|  8 | Tensor<[1, 24, 5, 5]> self = ?,<br>List[int] size = [1, -1, 4, 5, 5]       | Fallback | Fallback   | True  |
|  9 | Tensor<[1, 364, 1, 1]> self = ?,<br>List[int] size = [1, -1, 91, 1, 1]     | Fallback | Fallback   | True  |
| 10 | Tensor<[1, 364, 3, 3]> self = ?,<br>List[int] size = [1, -1, 91, 3, 3]     | Fallback | Fallback   | True  |
| 11 | Tensor<[1, 364, 38, 38]> self = ?,<br>List[int] size = [1, -1, 91, 38, 38] | Fallback | Fallback   | True  |
| 12 | Tensor<[1, 546, 10, 10]> self = ?,<br>List[int] size = [1, -1, 91, 10, 10] | Fallback | Fallback   | True  |
| 13 | Tensor<[1, 546, 19, 19]> self = ?,<br>List[int] size = [1, -1, 91, 19, 19] | Fallback | Fallback   | True  |
| 14 | Tensor<[1, 546, 5, 5]> self = ?,<br>List[int] size = [1, -1, 91, 5, 5]     | Fallback | Fallback   | True  |
