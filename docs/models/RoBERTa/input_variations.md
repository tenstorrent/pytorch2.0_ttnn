...
|  1 | aten._to_copy.default          |                  4 |           0 |         3 |          0 | 🚧          |    0.75 |
...
|    | ATen Input Variations                                                                      | Status   | Isolated   | PCC   |
|---:|:-------------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 10, 12, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Removed  | Fallback   | True  |
|  1 | Tensor<[1, 10, 768]> self = ?                                                              | Removed  | Fallback   | True  |
|  2 | Tensor<[1, 12, 10, 10]> self = ?                                                           | Removed  | Fallback   | True  |
### aten.cumsum.default
|    | ATen Input Variations                    | Status   | Isolated   | PCC   |
|---:|:-----------------------------------------|:---------|:-----------|:------|
...
|  7 | Tensor<[10, 250002]> self = ?,<br>List[int] size = [1, 10, 250002] | Removed  | Done       | True  |
