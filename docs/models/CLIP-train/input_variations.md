...
|  2 | aten._to_copy.default                   |                  4 |           1 |         0 |          0 | 🚧          |    0.25 |
|  3 | aten._unsafe_view.default               |                  4 |           2 |         0 |          0 | 🚧          |    0.5  |
|  4 | aten.add.Tensor                         |                  9 |           1 |         0 |          0 | 🚧          |    0.11 |
...
| 10 | aten.clone.default                      |                  7 |           4 |         0 |          0 | 🚧          |    0.57 |
...
| 19 | aten.expand.default                     |                  3 |           2 |         0 |          0 | 🚧          |    0.67 |
...
| 41 | aten.transpose.int                      |                 12 |           4 |         0 |          0 | 🚧          |    0.33 |
| 42 | aten.unsqueeze.default                  |                  4 |           4 |         0 |          0 | ✅          |    1    |
| 43 | aten.view.default                       |                 29 |          12 |         0 |          0 | 🚧          |    0.41 |
***
...
|  1 | Tensor<[1, 50, 768]> self = ?,<br>Tensor<[1, 50, 768]> other = ?   | Unknown  | Done       | True  |
...
|  7 | Tensor<[2, 7, 512]> self = ?,<br>Tensor<[2, 7, 512]> other = ?     | Unknown  | Done       | True  |
...
|  2 | Tensor<[12, 50, 50]> self = ?                                                              | Unknown  | Done       | True  |
|  3 | Tensor<[16, 7, 7]> self = ?                                                                | Unknown  | Done       | True  |
...
|    | ATen Input Variations                                  | Status   | Isolated   | PCC   |
|---:|:-------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 512]> self = ?,<br>Tensor<[1, 1]> other = ? | Unknown  | Done       | True  |
|  1 | Tensor<[2, 512]> self = ?,<br>Tensor<[2, 1]> other = ? | Unknown  | Done       | True  |
...
|    | ATen Input Variations                        | Status   | Isolated   | PCC   |
|---:|:---------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1]> self = ?,<br>number other = 0 | Unknown  | Fallback   | True  |
|  1 | Tensor<[2, 1]> self = ?,<br>number other = 0 | Unknown  | Fallback   | True  |
### aten.exp.default
|    | ATen Input Variations   | Status   | Isolated   | PCC   |
|---:|:------------------------|:---------|:-----------|:------|
...
|    | ATen Input Variations                                                                                      | Status   | Isolated   | PCC   |
|---:|:-----------------------------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 512]> self = ?,<br>Tensor<[1, 1]> mask = ?,<br>number value = 0                                 | Unknown  | Failed     | N/A   |
|  1 | Tensor<[2, 1, 7, 7]> self = ?,<br>Tensor<[2, 1, 7, 7]> mask = ?,<br>number value = -3.3895313892515355e+38 | None     | Fallback   | True  |
|  2 | Tensor<[2, 512]> self = ?,<br>Tensor<[2, 1]> mask = ?,<br>number value = 0                                 | Unknown  | Failed     | N/A   |
### aten.mm.default
|    | ATen Input Variations                                        | Status   | Isolated   | PCC   |
|---:|:-------------------------------------------------------------|:---------|:-----------|:------|
...
|  8 | Tensor<[2, 512]> self = ?,<br>Tensor<[512, 512]> mat2 = ?    | Unknown  | Done       | True  |
...
|  3 | Tensor<[2, 1]> self = ?      | Unknown  | Done       | True  |
|  4 | Tensor<[2, 512]> self = ?    | Unknown  | Done       | True  |
|  5 | Tensor<[2048, 512]> self = ? | Unknown  | Done       | True  |
|  6 | Tensor<[3072, 768]> self = ? | Unknown  | Done       | True  |
|  7 | Tensor<[50, 3072]> self = ?  | Unknown  | Done       | True  |
|  8 | Tensor<[50, 768]> self = ?   | Unknown  | Done       | True  |
|  9 | Tensor<[512, 1]> self = ?    | Unknown  | Done       | True  |
| 10 | Tensor<[512, 2048]> self = ? | Unknown  | Done       | True  |
| 11 | Tensor<[512, 512]> self = ?  | Unknown  | Done       | True  |
| 12 | Tensor<[512, 768]> self = ?  | Unknown  | Done       | True  |
| 13 | Tensor<[768, 3072]> self = ? | Unknown  | Done       | True  |
| 14 | Tensor<[768, 512]> self = ?  | Unknown  | Done       | True  |
| 15 | Tensor<[768, 768]> self = ?  | Unknown  | Done       | True  |
### aten.transpose.int
|    | ATen Input Variations                                              | Status   | Isolated   | PCC   |
|---:|:-------------------------------------------------------------------|:---------|:-----------|:------|
...
|  5 | Tensor<[12, 50, 64]> self = ?,<br>int dim0 = 1,<br>int dim1 = 2    | Unknown  | Done       | True  |
...
|  8 | Tensor<[16, 7, 64]> self = ?,<br>int dim0 = 1,<br>int dim1 = 2     | Unknown  | Done       | True  |
...
| 15 | Tensor<[14, 2048]> self = ?,<br>List[int] size = [2, 7, 2048]      | Unknown  | Done       | True  |
...
| 27 | Tensor<[50, 3072]> self = ?,<br>List[int] size = [1, 50, 3072]     | Unknown  | Done       | True  |
