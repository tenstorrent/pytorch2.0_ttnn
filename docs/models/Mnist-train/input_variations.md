...
|---:|:------------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 10]> self = ?,<br>int dim = 1,<br>bool half_to_float = False | Removed  | Done       | 0.999793 |     -1 |
...
|    | ATen Input Variations                                                                  | Status   | Isolated   |      PCC |   Host |
|---:|:---------------------------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[10]> self = ?,<br>Tensor<[1, 128]> mat1 = ?,<br>Tensor<[128, 10]> mat2 = ?     | Done     | Done       | 0.99997  |     -1 |
|  1 | Tensor<[128]> self = ?,<br>Tensor<[1, 9216]> mat1 = ?,<br>Tensor<[9216, 128]> mat2 = ? | Done     | Done       | 0.999893 |     -1 |
### aten.clone.default
|    | ATen Input Variations            | Status   | Isolated   |   PCC |   Host |
|---:|:---------------------------------|:---------|:-----------|------:|-------:|
|  0 | Tensor<[1, 128]> self = ?        | Removed  | Done       |     1 |     -1 |
|  1 | Tensor<[1, 64, 12, 12]> self = ? | Removed  | Done       |     1 |     -1 |
...
|    | ATen Input Variations                                      | Status   | Isolated   |      PCC |   Host |
|---:|:-----------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 10]> self = ?,<br>Tensor<[10, 128]> mat2 = ?    | Done     | Done       | 0.999991 |     -1 |
|  1 | Tensor<[1, 128]> self = ?,<br>Tensor<[128, 9216]> mat2 = ? | Done     | Done       | 0.999982 |     -1 |
|  2 | Tensor<[10, 1]> self = ?,<br>Tensor<[1, 128]> mat2 = ?     | Done     | Done       | 0.999993 |     -1 |
|  3 | Tensor<[128, 1]> self = ?,<br>Tensor<[1, 9216]> mat2 = ?   | Done     | Done       | 0.999993 |     -1 |
### aten.relu.default
|    | ATen Input Variations            | Status   | Isolated   |   PCC |   Host |
|---:|:---------------------------------|:---------|:-----------|------:|-------:|
|  0 | Tensor<[1, 128]> self = ?        | Done     | Done       |     1 |     -1 |
|  1 | Tensor<[1, 32, 26, 26]> self = ? | Done     | Done       |     1 |     -1 |
|  2 | Tensor<[1, 64, 24, 24]> self = ? | Done     | Done       |     1 |     -1 |
...
|    | ATen Input Variations        | Status   | Isolated   |   PCC |   Host |
|---:|:-----------------------------|:---------|:-----------|------:|-------:|
|  0 | Tensor<[1, 10]> self = ?     | Done     | Done       |     1 |     -1 |
|  1 | Tensor<[1, 128]> self = ?    | Done     | Done       |     1 |     -1 |
|  2 | Tensor<[10, 128]> self = ?   | Done     | Done       |     1 |     -1 |
|  3 | Tensor<[128, 10]> self = ?   | Done     | Done       |     1 |     -1 |
|  4 | Tensor<[128, 9216]> self = ? | Done     | Done       |     1 |     -1 |
|  5 | Tensor<[9216, 128]> self = ? | Done     | Done       |     1 |     -1 |
