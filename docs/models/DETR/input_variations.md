...
|  3 | aten.add.Tensor                      |                 29 |           0 |
|  4 | aten.addmm.default                   |                  9 |           0 |
|  5 | aten.arange.default                  |                  3 |           0 |
|  6 | aten.baddbmm.default                 |                  2 |           0 |
|  7 | aten.bitwise_not.default             |                  1 |           0 |
|  8 | aten.bmm.default                     |                  4 |           0 |
|  9 | aten.cat.default                     |                  1 |           0 |
| 10 | aten.clone.default                   |                  2 |           0 |
| 11 | aten.convolution.default             |                 24 |           0 |
| 12 | aten.cos.default                     |                  1 |           0 |
| 13 | aten.cumsum.default                  |                  2 |           0 |
| 14 | aten.div.Tensor                      |                  6 |           0 |
| 15 | aten.expand.default                  |                  1 |           0 |
| 16 | aten.floor_divide.default            |                  1 |           0 |
| 17 | aten.masked_fill.Scalar              |                  1 |           0 |
| 18 | aten.max_pool2d_with_indices.default |                  1 |           0 |
| 19 | aten.mm.default                      |                  1 |           0 |
| 20 | aten.mul.Tensor                      |                 22 |           0 |
| 21 | aten.native_dropout.default          |                  7 |           0 |
| 22 | aten.native_layer_norm.default       |                  2 |           0 |
| 23 | aten.ones.default                    |                  1 |           0 |
| 24 | aten.permute.default                 |                  2 |           0 |
| 25 | aten.pow.Scalar                      |                  1 |           0 |
| 26 | aten.relu.default                    |                 15 |           0 |
| 27 | aten.repeat.default                  |                  1 |           0 |
| 28 | aten.rsqrt.default                   |                  6 |           0 |
| 29 | aten.select.int                      |                  3 |           0 |
| 30 | aten.sigmoid.default                 |                  1 |           0 |
| 31 | aten.sin.default                     |                  1 |           0 |
| 32 | aten.slice.Tensor                    |                 11 |           0 |
| 33 | aten.split.Tensor                    |                  2 |           0 |
| 34 | aten.stack.default                   |                  2 |           0 |
| 35 | aten.sub.Tensor                      |                  6 |           0 |
| 36 | aten.t.default                       |                  5 |           0 |
| 37 | aten.transpose.int                   |                  7 |           0 |
| 38 | aten.unsqueeze.default               |                  4 |           0 |
| 39 | aten.view.default                    |                 27 |           0 |
| 40 | aten.zeros.default                   |                  1 |           0 |
| 41 | aten.zeros_like.default              |                  2 |           0 |
***
...
|    | ATen Input Variations                                                                                                             | Status   |
|---:|:----------------------------------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 1, 720, 1280]> self = ?,<br>List[Optional[Tensor]]<> indices = [None, None, 'torch.Size([23, 1])', 'torch.Size([40])'] | Unknown  |
### aten.add.Tensor
|    | ATen Input Variations                                                        | Status   |
|---:|:-----------------------------------------------------------------------------|:---------|
...
|    | ATen Input Variations                                                                                       | Status   |
|---:|:------------------------------------------------------------------------------------------------------------|:---------|
|  0 | List[Tensor]<> tensors = ['torch.Size([1, 23, 40, 128])', 'torch.Size([1, 23, 40, 128])'],<br>int<> dim = 3 | Unknown  |
### aten.clone.default
|    | ATen Input Variations                                                                     | Status   |
|---:|:------------------------------------------------------------------------------------------|:---------|
...
|  1 | Tensor<[1, 23, 40, 128]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                    | Unknown  |
|  2 | Tensor<[1, 23, 40, 128]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                    | Unknown  |
|  3 | Tensor<[1, 23, 40, 128]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                    | Unknown  |
|  4 | Tensor<[1, 23, 40, 128]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1,<br>int<> step = 2 | Unknown  |
|  5 | Tensor<[1, 23, 40, 128]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 1,<br>Optional[int]<> end = -1,<br>int<> step = 2 | Unknown  |
|  6 | Tensor<[1, 23, 40]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                         | Unknown  |
|  7 | Tensor<[1, 23, 40]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = -1,<br>Optional[int]<> end = -1                        | Unknown  |
|  8 | Tensor<[1, 23, 40]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                         | Unknown  |
|  9 | Tensor<[1, 23, 40]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = -1,<br>Optional[int]<> end = -1                        | Unknown  |
| 10 | Tensor<[1, 23, 40]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                         | Unknown  |
### aten.split.Tensor
|    | ATen Input Variations                                  | Status   |
|---:|:-------------------------------------------------------|:---------|
...
|    | ATen Input Variations                                                                                                                                                                                   | Status   |
|---:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|
|  0 | List[Tensor]<> tensors = ['torch.Size([1, 23, 40, 64])', 'torch.Size([1, 23, 40, 64])'],<br>int<> dim = 4                                                                                               | Unknown  |
|  1 | List[Tensor]<> tensors = ['torch.Size([100, 1, 256])', 'torch.Size([100, 1, 256])', 'torch.Size([100, 1, 256])', 'torch.Size([100, 1, 256])', 'torch.Size([100, 1, 256])', 'torch.Size([100, 1, 256])'] | Unknown  |
### aten.sub.Tensor
|    | ATen Input Variations                                                  | Status   |
|---:|:-----------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 1024, 1, 1]> self = ?,<br>Tensor<[1, 1024, 1, 1]> other = ? | Unknown  |
