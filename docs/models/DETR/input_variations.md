...
| 20 | aten.mul.Tensor                      |                 22 |          20 |         0 |          0 | 🚧          |    0.91 |
...
| 37 | aten.unsqueeze.default               |                  4 |           1 |         0 |          0 | 🚧          |    0.25 |
| 38 | aten.view.default                    |                 27 |          26 |         0 |          1 | 🚧          |    0.96 |
...
|    | ATen Input Variations                                                                   | Status   | Isolated   | PCC   |
|---:|:----------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[100, 1, 2048]> self = ?                                                         | Unknown  | Fallback   | True  |
|  1 | Tensor<[100, 1, 256]> self = ?                                                          | Unknown  | Fallback   | True  |
|  2 | Tensor<[100, 8, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Unknown  | Fallback   | True  |
|  3 | Tensor<[920, 1, 2048]> self = ?                                                         | Unknown  | Fallback   | True  |
|  4 | Tensor<[920, 1, 256]> self = ?                                                          | Unknown  | Fallback   | True  |
|  5 | Tensor<[920, 8, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Unknown  | Fallback   | True  |
...
|  3 | Tensor<[128]> self = ?,<br>Tensor other = 128                      | Unknown  | Failed     | N/A   |
...
|  1 | Tensor<[6, 1, 100, 4]> self = ?,<br>int dim = 0,<br>int index = -1  | Unknown  | Failed     | N/A   |
|  2 | Tensor<[6, 1, 100, 92]> self = ?,<br>int dim = 0,<br>int index = -1 | Unknown  | Failed     | N/A   |
...
|  1 | Tensor<[1, 720, 1280]> self = ?,<br>int dim = 0 | Unknown  | Done       | True  |
|  2 | Tensor<[100, 256]> self = ?,<br>int dim = 1     | Done     | Done       | True  |
|  3 | Tensor<[23]> self = ?,<br>int dim = -1          | Unknown  | Done       | True  |
### aten.view.default
|    | ATen Input Variations                                                     | Status   | Isolated   | PCC   |
|---:|:--------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 23, 40, 64, 2]> self = ?,<br>List[int] size = [1, 23, 40, 128] | Fallback | Fallback   | True  |
