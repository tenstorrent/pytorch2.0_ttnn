...
|    | ATen Input Variations                                                                                         | Status   |
|---:|:--------------------------------------------------------------------------------------------------------------|:---------|
|  0 | List[Tensor]<> tensors = ['torch.Size([1, 128, 64, 64])', 'torch.Size([1, 128, 64, 64])'],<br>int<> dim = 1   | None     |
|  1 | List[Tensor]<> tensors = ['torch.Size([1, 256, 32, 32])', 'torch.Size([1, 256, 32, 32])'],<br>int<> dim = 1   | None     |
|  2 | List[Tensor]<> tensors = ['torch.Size([1, 32, 256, 256])', 'torch.Size([1, 32, 256, 256])'],<br>int<> dim = 1 | None     |
|  3 | List[Tensor]<> tensors = ['torch.Size([1, 64, 128, 128])', 'torch.Size([1, 64, 128, 128])'],<br>int<> dim = 1 | None     |
