...
|    | ATen Input Variations                                | Status   | Isolated   | PCC   |
|---:|:-----------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 128]> self = ?,<br>List[int] size = [128] | Fallback | Fallback   | True  |
|  1 | Tensor<[1, 12]> self = ?,<br>List[int] size = [12]   | Fallback | Fallback   | True  |
|  2 | Tensor<[1, 3]> self = ?,<br>List[int] size = [3]     | Fallback | Fallback   | True  |
|  3 | Tensor<[1, 64]> self = ?,<br>List[int] size = [64]   | Fallback | Fallback   | True  |
|  4 | Tensor<[1, 784]> self = ?,<br>List[int] size = [784] | Fallback | Fallback   | True  |
