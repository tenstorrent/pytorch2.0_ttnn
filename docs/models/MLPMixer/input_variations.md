...
|---:|:-------------------------------|-------------------:|------------:|----------:|-----------:|:------------|--------:|
|  0 | aten._unsafe_view.default      |                  1 |           0 |         0 |          1 | ✘           |    0    |
...
| 10 | aten.view.default              |                  6 |           5 |         0 |          1 | 🚧          |    0.83 |
***
...
|  3 | Tensor<[1, 3, 256, 256]> self = ?,<br>List[int] size = [1, 3, 16, 16, 16, 16] | Fallback | Fallback   | True  |
