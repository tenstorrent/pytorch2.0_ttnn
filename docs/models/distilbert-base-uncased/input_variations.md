...
|  1 | aten.add.Tensor                |                  1 |           0 |
|  2 | aten.addmm.default             |                  3 |           0 |
|  3 | aten.bmm.default               |                  2 |           0 |
|  4 | aten.clone.default             |                  3 |           0 |
|  5 | aten.div.Tensor                |                  1 |           0 |
|  6 | aten.embedding.default         |                  2 |           0 |
|  7 | aten.eq.Scalar                 |                  1 |           0 |
|  8 | aten.expand.default            |                  4 |           0 |
|  9 | aten.gelu.default              |                  1 |           0 |
| 10 | aten.lift_fresh_copy.default   |                  1 |           0 |
| 11 | aten.masked_fill.Tensor        |                  1 |           0 |
| 12 | aten.native_layer_norm.default |                  1 |           0 |
| 13 | aten.slice.Tensor              |                  2 |           0 |
| 14 | aten.t.default                 |                  3 |           0 |
| 15 | aten.transpose.int             |                  3 |           0 |
...
|    | ATen Input Variations                                                                   | Status   |
|---:|:----------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[3072]> self = ?,<br>Tensor<[16, 768]> mat1 = ?,<br>Tensor<[768, 3072]> mat2 = ? | Unknown  |
|  1 | Tensor<[768]> self = ?,<br>Tensor<[16, 3072]> mat1 = ?,<br>Tensor<[3072, 768]> mat2 = ? | Unknown  |
|  2 | Tensor<[768]> self = ?,<br>Tensor<[16, 768]> mat1 = ?,<br>Tensor<[768, 768]> mat2 = ?   | Unknown  |
### aten.bmm.default
|    | ATen Input Variations                                           | Status   |
|---:|:----------------------------------------------------------------|:---------|
|  0 | Tensor<[12, 16, 16]> self = ?,<br>Tensor<[12, 16, 64]> mat2 = ? | Unknown  |
|  1 | Tensor<[12, 16, 64]> self = ?,<br>Tensor<[12, 64, 16]> mat2 = ? | Unknown  |
### aten.clone.default
|    | ATen Input Variations                                                                        | Status   |
|---:|:---------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 12, 16, 16]> self = ?                                                             | Unknown  |
|  1 | Tensor<[1, 16, 12, 64]> self = ?,<br>Optional[int]<> memory_format = torch.contiguous_format | Unknown  |
|  2 | Tensor<[1, 16, 768]> self = ?                                                                | Unknown  |
### aten.div.Tensor
|    | ATen Input Variations                                     | Status   |
|---:|:----------------------------------------------------------|:---------|
...
|  1 | Tensor<[1, 512]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = 16 | Unknown  |
### aten.t.default
|    | ATen Input Variations        | Status   |
|---:|:-----------------------------|:---------|
|  0 | Tensor<[3072, 768]> self = ? | Unknown  |
|  1 | Tensor<[768, 3072]> self = ? | Unknown  |
|  2 | Tensor<[768, 768]> self = ?  | Unknown  |
### aten.transpose.int
|    | ATen Input Variations                                                  | Status   |
|---:|:-----------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 12, 16, 64]> self = ?,<br>int<> dim0 = 1,<br>int<> dim1 = 2 | Unknown  |
|  1 | Tensor<[1, 12, 16, 64]> self = ?,<br>int<> dim0 = 2,<br>int<> dim1 = 3 | Unknown  |
|  2 | Tensor<[1, 16, 12, 64]> self = ?,<br>int<> dim0 = 1,<br>int<> dim1 = 2 | Unknown  |
### aten.view.default
|    | ATen Input Variations                                                | Status   |
|---:|:---------------------------------------------------------------------|:---------|
...
|  5 | Tensor<[1, 16, 768]> self = ?,<br>List[int]<> size = [1, -1, 12, 64] | Unknown  |
|  6 | Tensor<[1, 16, 768]> self = ?,<br>List[int]<> size = [16, 768]       | Unknown  |
|  7 | Tensor<[1, 16]> self = ?,<br>List[int]<> size = [1, 1, 1, 16]        | Unknown  |
|  8 | Tensor<[12, 16, 16]> self = ?,<br>List[int]<> size = [1, 12, 16, 16] | Unknown  |
|  9 | Tensor<[12, 16, 64]> self = ?,<br>List[int]<> size = [1, 12, 16, 64] | Unknown  |
| 10 | Tensor<[16, 3072]> self = ?,<br>List[int]<> size = [1, 16, 3072]     | Unknown  |
| 11 | Tensor<[16, 768]> self = ?,<br>List[int]<> size = [1, 16, 768]       | Unknown  |
