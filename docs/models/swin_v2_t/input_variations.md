...
|  1 | Tensor<[16, 6, 64, 64]> self = ?,<br>int dim = -1,<br>bool half_to_float = False | Done     | Done       | 0.999603 |      0 |
...
|    | ATen Input Variations                                                                           | Status   | Isolated   | PCC   | Host   |
|---:|:------------------------------------------------------------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 16, 16, 1536]> self = ?                                                              | Done     | Done       | 1.0   | 0      |
|  1 | Tensor<[1, 16, 16, 384]> self = ?                                                               | Done     | Done       | 1.0   | 0      |
|  2 | Tensor<[1, 2, 2, 8, 8, 384]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Done     | Done       | 1.0   | 0      |
|  3 | Tensor<[1, 2, 8, 2, 8, 384]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Done     | Done       | 1.0   | 0      |
|  4 | Tensor<[1, 24, 64, 64]> self = ?                                                                | Done     | Done       | 1.0   | 0      |
|  5 | Tensor<[1, 32, 32, 192]> self = ?                                                               | Done     | Done       | 1.0   | 0      |
...
|  9 | Tensor<[1, 64, 24, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Done     | Done       | 1.0   | 0      |
| 10 | Tensor<[1, 64, 64, 384]> self = ?                                                               | Done     | Unknown    | N/A   | N/A    |
| 11 | Tensor<[1, 64, 64, 96]> self = ?                                                                | Done     | Unknown    | N/A   | N/A    |
| 12 | Tensor<[1, 64, 768]> self = ?                                                                   | Done     | Done       | 1.0   | 0      |
| 13 | Tensor<[1, 8, 8, 3072]> self = ?                                                                | Done     | Done       | 1.0   | 0      |
| 14 | Tensor<[1, 8, 8, 768]> self = ?                                                                 | Done     | Done       | 1.0   | 0      |
| 15 | Tensor<[1, 8, 8, 8, 8, 96]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format  | Done     | Unknown    | N/A   | N/A    |
| 16 | Tensor<[12, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format         | Done     | Done       | 1.0   | 0      |
...
| 22 | Tensor<[2, 2, 8, 8]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format         | Done     | Done       | 1.0   | 0      |
| 23 | Tensor<[24, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format         | Done     | Done       | 1.0   | 0      |
| 24 | Tensor<[3, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format          | Done     | Unknown    | N/A   | N/A    |
| 25 | Tensor<[4, 12, 32, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Done     | Done       | 1.0   | 0      |
| 26 | Tensor<[4, 12, 64, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Done     | Done       | 1.0   | 0      |
| 27 | Tensor<[4, 12, 64, 64]> self = ?                                                                | Done     | Done       | 1.0   | 0      |
| 28 | Tensor<[4, 4, 8, 8]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format         | Done     | Done       | 1.0   | 0      |
| 29 | Tensor<[4, 64, 12, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Done     | Done       | 1.0   | 0      |
| 30 | Tensor<[4, 64, 384]> self = ?                                                                   | Done     | Done       | 1.0   | 0      |
...
|  1 | Tensor<[16, 6, 64, 32]> self = ?,<br>Tensor<[16, 6, 64, 32]> other = ? | Done     | Done       | 0.999991 |      0 |
...
|  2 | Tensor<[3, 1, 1]> self = ?  | Done     | Done       | 0.999607 |      0 |
|  3 | Tensor<[6, 1, 1]> self = ?  | Done     | Done       | 0.999957 |      0 |
### aten.expand.default
|    | ATen Input Variations                                                 | Status   | Isolated   |   PCC |   Host |
|---:|:----------------------------------------------------------------------|:---------|:-----------|------:|-------:|
...
|  5 | Tensor<[16, 6, 64, 64]> self = ?,<br>Tensor<[6, 1, 1]> other = ?  | Done     | Done       |  0.0698943 |      0 |
|  6 | Tensor<[4, 12, 64, 64]> self = ?,<br>Tensor<[12, 1, 1]> other = ? | Done     | Done       |  0.256098  |      0 |
|  7 | Tensor<[64, 3, 64, 64]> self = ?,<br>Tensor<[3, 1, 1]> other = ?  | Done     | Done       | -0.0342881 |      0 |
...
|    | ATen Input Variations                                          | Status   | Isolated   |      PCC |   Host |
|---:|:---------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[16, 1, 64]> self = ?,<br>Tensor<[16, 64, 1]> other = ? | Done     | Done       | 0.451712 |      0 |
|  1 | Tensor<[4, 1, 64]> self = ?,<br>Tensor<[4, 64, 1]> other = ?   | Done     | Done       | 0.503605 |      0 |
|  2 | Tensor<[64, 1, 64]> self = ?,<br>Tensor<[64, 64, 1]> other = ? | Done     | Done       | 0.356467 |      0 |
### aten.t.default
|    | ATen Input Variations        | Status   | Isolated   |   PCC |   Host |
|---:|:-----------------------------|:---------|:-----------|------:|-------:|
