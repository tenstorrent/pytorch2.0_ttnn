...
|    | ATen Input Variations                                                                                                                                                        | Status   |
|---:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|
|  0 | List[Tensor]<> tensors = ['torch.Size([1, 14, 14, 256])', 'torch.Size([1, 14, 14, 256])', 'torch.Size([1, 14, 14, 256])', 'torch.Size([1, 14, 14, 256])'],<br>int<> dim = -1 | None     |
|  1 | List[Tensor]<> tensors = ['torch.Size([1, 28, 28, 128])', 'torch.Size([1, 28, 28, 128])', 'torch.Size([1, 28, 28, 128])', 'torch.Size([1, 28, 28, 128])'],<br>int<> dim = -1 | None     |
|  2 | List[Tensor]<> tensors = ['torch.Size([1, 7, 7, 512])', 'torch.Size([1, 7, 7, 512])', 'torch.Size([1, 7, 7, 512])', 'torch.Size([1, 7, 7, 512])'],<br>int<> dim = -1         | None     |
### aten.clone.default
|    | ATen Input Variations                                                                             | Status   |
|---:|:--------------------------------------------------------------------------------------------------|:---------|
...
|    | ATen Input Variations                                                                    | Status   |
|---:|:-----------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[169, 16]> self = ?,<br>List[Optional[Tensor]]<> indices = ['torch.Size([2401])'] | None     |
|  1 | Tensor<[169, 32]> self = ?,<br>List[Optional[Tensor]]<> indices = ['torch.Size([2401])'] | None     |
|  2 | Tensor<[169, 4]> self = ?,<br>List[Optional[Tensor]]<> indices = ['torch.Size([2401])']  | None     |
|  3 | Tensor<[169, 8]> self = ?,<br>List[Optional[Tensor]]<> indices = ['torch.Size([2401])']  | None     |
