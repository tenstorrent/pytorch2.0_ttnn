...
|---:|:--------------------------------------------------|-------------------:|------------:|
|  0 | aten._native_batch_norm_legit_no_training.default |                 12 |           1 |
|  1 | aten.add.Tensor                                   |                  7 |           0 |
|  2 | aten.cat.default                                  |                 10 |           0 |
|  3 | aten.clone.default                                |                  3 |           0 |
|  4 | aten.convolution.default                          |                 28 |           1 |
...
|  5 | Tensor<[1, 32, 256, 256]> input = ?,<br>Optional[Tensor]<[32]> weight = ?,<br>Optional[Tensor]<[32]> bias = ?,<br>Tensor<[32]> running_mean = ?,<br>Tensor<[32]> running_var = ?,<br>float<> momentum = 0.03,<br>float<> eps = 0.001                                  | Done     |
...
|    | ATen Input Variations                                                                                                                           | Status   |
|---:|:------------------------------------------------------------------------------------------------------------------------------------------------|:---------|
|  0 | List[Tensor]<> tensors = ['torch.Size([1, 12288, 85])', 'torch.Size([1, 3072, 85])', 'torch.Size([1, 768, 85])'],<br>int<> dim = 1              | Unknown  |
|  1 | List[Tensor]<> tensors = ['torch.Size([1, 128, s1, s2])', 'torch.Size([1, 128, s1, s2])'],<br>int<> dim = 1                                     | Unknown  |
|  2 | List[Tensor]<> tensors = ['torch.Size([1, 256, 32, 32])', 'torch.Size([1, 256, 32, 32])'],<br>int<> dim = 1                                     | Unknown  |
|  3 | List[Tensor]<> tensors = ['torch.Size([1, 256, s1, s2])', 'torch.Size([1, 256, s1, s2])'],<br>int<> dim = 1                                     | Unknown  |
|  4 | List[Tensor]<> tensors = ['torch.Size([1, 3, 16, 16, 2])', 'torch.Size([1, 3, 16, 16, 2])', 'torch.Size([1, 3, 16, 16, 81])'],<br>int<> dim = 4 | Unknown  |
|  5 | List[Tensor]<> tensors = ['torch.Size([1, 3, 32, 32, 2])', 'torch.Size([1, 3, 32, 32, 2])', 'torch.Size([1, 3, 32, 32, 81])'],<br>int<> dim = 4 | Unknown  |
|  6 | List[Tensor]<> tensors = ['torch.Size([1, 3, 64, 64, 2])', 'torch.Size([1, 3, 64, 64, 2])', 'torch.Size([1, 3, 64, 64, 81])'],<br>int<> dim = 4 | Unknown  |
|  7 | List[Tensor]<> tensors = ['torch.Size([1, 32, s0, s1])', 'torch.Size([1, 32, s0, s1])'],<br>int<> dim = 1                                       | Unknown  |
|  8 | List[Tensor]<> tensors = ['torch.Size([1, 64, s1, s2])', 'torch.Size([1, 64, s1, s2])'],<br>int<> dim = 1                                       | Unknown  |
|  9 | List[Tensor]<> tensors = ['torch.Size([1, s0, s1, s2])', 'torch.Size([1, s3, s1, s2])'],<br>int<> dim = 1                                       | Unknown  |
### aten.clone.default
|    | ATen Input Variations                                                                           | Status   |
|---:|:------------------------------------------------------------------------------------------------|:---------|
...
| 14 | Tensor<[1, 3, 512, 512]> input = ?,<br>Tensor<[32, 3, 6, 6]> weight = ?,<br>Optional[Tensor]<> bias = ?,<br>List[int]<> stride = [2, 2],<br>List[int]<> padding = [2, 2],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1         | Done     |
