...
| 11 | aten.convolution.default                          |                  8 |
| 12 | aten.div.Tensor                                   |                  2 |
| 13 | aten.empty.memory_format                          |                  1 |
| 14 | aten.exp.default                                  |                  1 |
| 15 | aten.expand.default                               |                  5 |
| 16 | aten.fill.Scalar                                  |                  1 |
| 17 | aten.lift_fresh_copy.default                      |                  1 |
| 18 | aten.max_pool2d_with_indices.default              |                  1 |
| 19 | aten.mul.Tensor                                   |                  4 |
| 20 | aten.native_group_norm.default                    |                  5 |
| 21 | aten.new_full.default                             |                  1 |
| 22 | aten.permute.default                              |                  1 |
| 23 | aten.relu.default                                 |                  1 |
| 24 | aten.rsub.Scalar                                  |                  1 |
| 25 | aten.select.int                                   |                  2 |
| 26 | aten.slice.Tensor                                 |                  2 |
| 27 | aten.split_with_sizes.default                     |                  2 |
| 28 | aten.stack.default                                |                  1 |
| 29 | aten.sub.Tensor                                   |                  2 |
| 30 | aten.unbind.int                                   |                  1 |
| 31 | aten.unsqueeze.default                            |                  4 |
| 32 | aten.view.default                                 |                 16 |
***
### aten._native_batch_norm_legit_no_training.default
|    | ATen Input Variations                                                                                                                                                                                                           | Status   |
|---:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 64, 400, 544]> input = ?,<br>Optional[Tensor]<[64]> weight = ?,<br>Optional[Tensor]<[64]> bias = ?,<br>Tensor<[64]> running_mean = ?,<br>Tensor<[64]> running_var = ?,<br>float momentum = 0.1,<br>float eps = 1e-05 | Unknown  |
...
|  1 | Tensor<[50]> self = ?,<br>Tensor other = 0.0                               | Unknown  |
...
|  1 | List[Tensor] tensors = [view_14, view_19, view_24, view_29, view_34]                                                  | Unknown  |
### aten.ceil.default
|    | ATen Input Variations   | Status   |
|---:|:------------------------|:---------|
...
|  2 | Tensor<[1, 2048, 25, 34]> input = ?,<br>Tensor<[256, 2048, 3, 3]> weight = ?,<br>Optional[Tensor]<[256]> bias = ?,<br>List[int] stride = [2, 2],<br>List[int] padding = [1, 1],<br>List[int] dilation = [1, 1],<br>bool transposed = False,<br>List[int] output_padding = [0, 0],<br>int groups = 1 | Unknown  |
...
| 15 | Tensor<[9, 4]> self = ?,<br>List[int] size = [1, -1, 4]                        | Unknown  |
