...
|    | ATen Input Variations                                                    | Status   | Isolated   | PCC   | Host   |
|---:|:-------------------------------------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 144, 28, 28]> self = ?,<br>Tensor<[1, 144, 28, 28]> other = ? | Done     | Unknown    | N/A   | N/A    |
|  1 | Tensor<[1, 320, 14, 14]> self = ?,<br>Tensor<[1, 320, 14, 14]> other = ? | Done     | Unknown    | N/A   | N/A    |
|  2 | Tensor<[1, 64, 56, 56]> self = ?,<br>Tensor<[1, 64, 56, 56]> other = ?   | Done     | Unknown    | N/A   | N/A    |
|  3 | Tensor<[1, 784, 7, 7]> self = ?,<br>Tensor<[1, 784, 7, 7]> other = ?     | Done     | Unknown    | N/A   | N/A    |
### aten.addmm.default
|    | ATen Input Variations                                                                  | Status   | Isolated   | PCC   | Host   |
|---:|:---------------------------------------------------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1000]> self = ?,<br>Tensor<[1, 784]> mat1 = ?,<br>Tensor<[784, 1000]> mat2 = ? | Done     | Unknown    | N/A   | N/A    |
...
|    | ATen Input Variations                                                                            | Status   | Isolated   | PCC   | Host   |
|---:|:-------------------------------------------------------------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 144, 28, 28]> self = ?,<br>Optional[List[int]] dim = [-1, -2],<br>bool keepdim = True | Done     | Unknown    | N/A   | N/A    |
|  1 | Tensor<[1, 320, 14, 14]> self = ?,<br>Optional[List[int]] dim = [-1, -2],<br>bool keepdim = True | Done     | Unknown    | N/A   | N/A    |
|  2 | Tensor<[1, 64, 56, 56]> self = ?,<br>Optional[List[int]] dim = [-1, -2],<br>bool keepdim = True  | Done     | Unknown    | N/A   | N/A    |
|  3 | Tensor<[1, 784, 7, 7]> self = ?,<br>Optional[List[int]] dim = [-1, -2],<br>bool keepdim = True   | Done     | Unknown    | N/A   | N/A    |
### aten.mul.Tensor
|    | ATen Input Variations                                                  | Status   | Isolated   | PCC   | Host   |
|---:|:-----------------------------------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 144, 1, 1]> self = ?,<br>Tensor<[1, 144, 28, 28]> other = ? | Done     | Unknown    | N/A   | N/A    |
|  1 | Tensor<[1, 320, 1, 1]> self = ?,<br>Tensor<[1, 320, 14, 14]> other = ? | Done     | Unknown    | N/A   | N/A    |
|  2 | Tensor<[1, 64, 1, 1]> self = ?,<br>Tensor<[1, 64, 56, 56]> other = ?   | Done     | Unknown    | N/A   | N/A    |
|  3 | Tensor<[1, 784, 1, 1]> self = ?,<br>Tensor<[1, 784, 7, 7]> other = ?   | Done     | Unknown    | N/A   | N/A    |
### aten.relu.default
|    | ATen Input Variations              | Status   | Isolated   | PCC   | Host   |
|---:|:-----------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 144, 28, 28]> self = ?  | Done     | Unknown    | N/A   | N/A    |
|  1 | Tensor<[1, 144, 56, 56]> self = ?  | Done     | Unknown    | N/A   | N/A    |
|  2 | Tensor<[1, 16, 1, 1]> self = ?     | Done     | Unknown    | N/A   | N/A    |
|  3 | Tensor<[1, 196, 1, 1]> self = ?    | Done     | Unknown    | N/A   | N/A    |
|  4 | Tensor<[1, 32, 112, 112]> self = ? | Done     | Unknown    | N/A   | N/A    |
|  5 | Tensor<[1, 320, 14, 14]> self = ?  | Done     | Unknown    | N/A   | N/A    |
|  6 | Tensor<[1, 320, 28, 28]> self = ?  | Done     | Unknown    | N/A   | N/A    |
|  7 | Tensor<[1, 36, 1, 1]> self = ?     | Done     | Unknown    | N/A   | N/A    |
|  8 | Tensor<[1, 64, 112, 112]> self = ? | Done     | Unknown    | N/A   | N/A    |
|  9 | Tensor<[1, 64, 56, 56]> self = ?   | Done     | Unknown    | N/A   | N/A    |
| 10 | Tensor<[1, 784, 14, 14]> self = ?  | Done     | Unknown    | N/A   | N/A    |
| 11 | Tensor<[1, 784, 7, 7]> self = ?    | Done     | Unknown    | N/A   | N/A    |
| 12 | Tensor<[1, 8, 1, 1]> self = ?      | Done     | Unknown    | N/A   | N/A    |
| 13 | Tensor<[1, 80, 1, 1]> self = ?     | Done     | Unknown    | N/A   | N/A    |
### aten.sigmoid.default
|    | ATen Input Variations           | Status   | Isolated   | PCC   | Host   |
|---:|:--------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 144, 1, 1]> self = ? | Done     | Unknown    | N/A   | N/A    |
|  1 | Tensor<[1, 320, 1, 1]> self = ? | Done     | Unknown    | N/A   | N/A    |
|  2 | Tensor<[1, 64, 1, 1]> self = ?  | Done     | Unknown    | N/A   | N/A    |
|  3 | Tensor<[1, 784, 1, 1]> self = ? | Done     | Unknown    | N/A   | N/A    |
### aten.t.default
|    | ATen Input Variations        | Status   | Isolated   | PCC   | Host   |
|---:|:-----------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1000, 784]> self = ? | Done     | Unknown    | N/A   | N/A    |
### aten.view.default
|    | ATen Input Variations                                         | Status   | Isolated   | PCC   | Host   |
|---:|:--------------------------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 784, 1, 1]> self = ?,<br>List[int] size = [1, 784] | Done     | Unknown    | N/A   | N/A    |
