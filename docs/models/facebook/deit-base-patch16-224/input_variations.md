...
| 15 | aten.transpose.int             |                  2 |           1 |         1 |          0 | ✅          |       1 |
...
| 10 | Tensor<[197, 3072]> self = ?,<br>List[int] size = [1, 197, 3072]       | Done     | Done       | True  |
| 11 | Tensor<[197, 768]> self = ?,<br>List[int] size = [1, 197, 768]         | Done     | Done       | True  |
