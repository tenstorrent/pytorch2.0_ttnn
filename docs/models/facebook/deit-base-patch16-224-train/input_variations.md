...
| 27 | aten.view.default                       |                 17 |           5 |         0 |          0 | 🚧          |    0.29 |
***
...
|  1 | Tensor<[1, 197, 768]> self = ?,<br>int dim = 1,<br>Optional[int] start = 0,<br>Optional[int] end = 1                   | Done     | Done       | True  |
...
|  8 | Tensor<[1, 3072]> self = ?,<br>List[int] size = [3072]                 | Done     | Done       | True  |
|  9 | Tensor<[1, 768, 14, 14]> self = ?,<br>List[int] size = [1, 768, 196]   | None     | Fallback   | True  |
| 10 | Tensor<[1, 768, 196]> self = ?,<br>List[int] size = [1, 768, 14, 14]   | Done     | Done       | True  |
| 11 | Tensor<[1, 768]> self = ?,<br>List[int] size = [768]                   | Done     | Done       | True  |
...
| 14 | Tensor<[12, 64, 197]> self = ?,<br>List[int] size = [1, 12, 64, 197]   | Done     | Done       | True  |
