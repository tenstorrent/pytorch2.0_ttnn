...
| 26 | aten.view.default                       |                 17 |           8 |         6 |          3 | 🚧          |    0.82 |
***
...
|  8 | Tensor<[1, 3072]> self = ?,<br>List[int] size = [3072]                 | Fallback | Fallback   | True  |
...
| 11 | Tensor<[1, 768]> self = ?,<br>List[int] size = [768]                   | Fallback | Fallback   | True  |
