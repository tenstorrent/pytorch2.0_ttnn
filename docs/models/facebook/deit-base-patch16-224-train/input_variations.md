...
|---:|:------------------------------------------------------------------|-------------------:|------------:|----------:|-----------:|:------------|--------:|
|  0 | aten._scaled_dot_product_flash_attention_for_cpu.default          |                  1 |           0 |         0 |          0 | ✘           |       0 |
|  1 | aten._scaled_dot_product_flash_attention_for_cpu_backward.default |                  1 |           0 |         0 |          0 | ✘           |       0 |
...
|  7 | aten.convolution_backward.default                                 |                  1 |           0 |         0 |          0 | ✘           |       0 |
|  8 | aten.detach.default                                               |                  1 |           0 |         1 |          0 | ✅          |       1 |
|  9 | aten.expand.default                                               |                  1 |           0 |         1 |          0 | ✅          |       1 |
| 10 | aten.gelu.default                                                 |                  1 |           1 |         0 |          0 | ✅          |       1 |
| 11 | aten.gelu_backward.default                                        |                  1 |           0 |         0 |          0 | ✘           |       0 |
| 12 | aten.mm.default                                                   |                  8 |           8 |         0 |          0 | ✅          |       1 |
| 13 | aten.native_layer_norm.default                                    |                  1 |           1 |         0 |          0 | ✅          |       1 |
| 14 | aten.native_layer_norm_backward.default                           |                  1 |           0 |         0 |          0 | ✘           |       0 |
| 15 | aten.permute.default                                              |                  2 |           2 |         0 |          0 | ✅          |       1 |
| 16 | aten.select.int                                                   |                  1 |           1 |         0 |          0 | ✅          |       1 |
| 17 | aten.select_backward.default                                      |                  1 |           0 |         0 |          0 | ✘           |       0 |
| 18 | aten.slice.Tensor                                                 |                  4 |           2 |         2 |          0 | ✅          |       1 |
| 19 | aten.slice_backward.default                                       |                  2 |           0 |         0 |          0 | ✘           |       0 |
| 20 | aten.sum.dim_IntList                                              |                  3 |           0 |         0 |          0 | ✘           |       0 |
| 21 | aten.t.default                                                    |                  8 |           8 |         0 |          0 | ✅          |       1 |
| 22 | aten.transpose.int                                                |                  4 |           4 |         0 |          0 | ✅          |       1 |
| 23 | aten.view.default                                                 |                 11 |          11 |         0 |          0 | ✅          |       1 |
***
### aten._scaled_dot_product_flash_attention_for_cpu.default
|    | ATen Input Variations                                                                                                                            | Status   | Isolated   | PCC   | Host   |
|---:|:-------------------------------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 12, 197, 64]> query = ?,<br>Tensor<[1, 12, 197, 64]> key = ?,<br>Tensor<[1, 12, 197, 64]> value = ?,<br>Optional[float] scale = 0.125 | None     | Unknown    | N/A   | N/A    |
...
|    | ATen Input Variations                                                                       | Status   | Isolated   | PCC   | Host   |
|---:|:--------------------------------------------------------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 12, 197, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Removed  | Unknown    | N/A   | N/A    |
|  1 | Tensor<[1, 197, 12, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Removed  | Done       | 1.0   | 0      |
|  2 | Tensor<[1, 197, 768]> self = ?                                                              | Removed  | Done       | 1.0   | 0      |
...
|    | ATen Input Variations             | Status   | Isolated   | PCC   | Host   |
|---:|:----------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 12, 197, 64]> self = ? | Removed  | Unknown    | N/A   | N/A    |
### aten.expand.default
|    | ATen Input Variations                                         | Status   | Isolated   |   PCC |   Host |
|---:|:--------------------------------------------------------------|:---------|:-----------|------:|-------:|
...
|    | ATen Input Variations                                                                                                                                                    | Status   | Isolated   |     PCC |   Host |
|---:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|--------:|-------:|
|  0 | Tensor<[1, 197, 768]> input = ?,<br>List[int] normalized_shape = [768],<br>Optional[Tensor]<[768]> weight = ?,<br>Optional[Tensor]<[768]> bias = ?,<br>float eps = 1e-12 | Done     | Done       | 0.99778 |      3 |
...
|  1 | Tensor<[1, 196, 768]> self = ?,<br>int dim0 = 1,<br>int dim1 = 2    | Done     | Done       | 1.0   | 0      |
|  2 | Tensor<[1, 197, 12, 64]> self = ?,<br>int dim0 = 1,<br>int dim1 = 2 | Done     | Unknown    | N/A   | N/A    |
|  3 | Tensor<[1, 768, 196]> self = ?,<br>int dim0 = 1,<br>int dim1 = 2    | Done     | Done       | 1.0   | 0      |
### aten.view.default
|    | ATen Input Variations                                                | Status   | Isolated   |   PCC |   Host |
|---:|:---------------------------------------------------------------------|:---------|:-----------|------:|-------:|
|  0 | Tensor<[1, 1000]> self = ?,<br>List[int] size = [1000]               | Done     | Done       |     1 |      0 |
|  1 | Tensor<[1, 197, 12, 64]> self = ?,<br>List[int] size = [1, 197, 768] | Done     | Done       |     1 |      0 |
|  2 | Tensor<[1, 197, 3072]> self = ?,<br>List[int] size = [197, 3072]     | Done     | Done       |     1 |      0 |
|  3 | Tensor<[1, 197, 768]> self = ?,<br>List[int] size = [1, 197, 12, 64] | Done     | Done       |     1 |      0 |
|  4 | Tensor<[1, 197, 768]> self = ?,<br>List[int] size = [197, 768]       | Done     | Done       |     1 |      0 |
...
|  8 | Tensor<[1, 768]> self = ?,<br>List[int] size = [768]                 | Done     | Done       |     1 |      0 |
