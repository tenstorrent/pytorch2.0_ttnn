...
|    | ATen Input Variations                                          | Status   | Isolated   |      PCC |   Host |
|---:|:---------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[16, 1, 49]> self = ?,<br>Tensor<[16, 49, 1]> other = ? | Done     | Done       | 0.466642 |      0 |
|  1 | Tensor<[4, 1, 49]> self = ?,<br>Tensor<[4, 49, 1]> other = ?   | Done     | Done       | 0.407807 |      0 |
|  2 | Tensor<[64, 1, 49]> self = ?,<br>Tensor<[64, 49, 1]> other = ? | Done     | Done       | 0.350469 |      0 |
### aten.t.default
|    | ATen Input Variations        | Status   | Isolated   | PCC   | Host   |
|---:|:-----------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1000, 768]> self = ? | Done     | Done       | 1.0   | 0      |
...
|  6 | Tensor<[2304, 768]> self = ? | Done     | Done       | 1.0   | 0      |
|  7 | Tensor<[288, 96]> self = ?   | Done     | Unknown    | N/A   | N/A    |
|  8 | Tensor<[3072, 768]> self = ? | Done     | Done       | 1.0   | 0      |
...
| 14 | Tensor<[768, 1536]> self = ? | Done     | Done       | 1.0   | 0      |
| 15 | Tensor<[768, 192]> self = ?  | Done     | Unknown    | N/A   | N/A    |
| 16 | Tensor<[768, 3072]> self = ? | Done     | Done       | 1.0   | 0      |
| 17 | Tensor<[768, 768]> self = ?  | Done     | Done       | 1.0   | 0      |
