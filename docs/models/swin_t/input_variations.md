...
|    | ATen Input Variations                                                         | Status   |
|---:|:------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[169, 12]> self = ?,<br>List[Optional[Tensor]] indices = [primals_178] | Unknown  |
|  1 | Tensor<[169, 24]> self = ?,<br>List[Optional[Tensor]] indices = [primals_184] | Unknown  |
|  2 | Tensor<[169, 3]> self = ?,<br>List[Optional[Tensor]] indices = [primals_174]  | Unknown  |
|  3 | Tensor<[169, 6]> self = ?,<br>List[Optional[Tensor]] indices = [primals_176]  | Unknown  |
