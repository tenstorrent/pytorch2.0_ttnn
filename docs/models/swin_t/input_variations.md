...
|  4 | List[Tensor]<> tensors = [Proxy(slice_tensor_46), Proxy(slice_tensor_49), Proxy(slice_tensor_52), Proxy(slice_tensor_55)],<br>int<> dim = -1                                 | Done     |
|  5 | List[Tensor]<> tensors = [Proxy(slice_tensor_6), Proxy(slice_tensor_9), Proxy(slice_tensor_12), Proxy(slice_tensor_15)],<br>int<> dim = -1                                   | Done     |
### aten.clone.default
|    | ATen Input Variations                                                                             | Status   |
|---:|:--------------------------------------------------------------------------------------------------|:---------|
...
|  1 | Tensor<[169, 12]> self = ?,<br>List[Optional[Tensor]]<> indices = [Proxy(primals_178)]   | Done     |
|  2 | Tensor<[169, 12]> self = ?,<br>List[Optional[Tensor]]<> indices = [Proxy(primals_179)]   | Done     |
|  3 | Tensor<[169, 12]> self = ?,<br>List[Optional[Tensor]]<> indices = [Proxy(primals_180)]   | Done     |
|  4 | Tensor<[169, 12]> self = ?,<br>List[Optional[Tensor]]<> indices = [Proxy(primals_181)]   | Done     |
|  5 | Tensor<[169, 12]> self = ?,<br>List[Optional[Tensor]]<> indices = [Proxy(primals_182)]   | Done     |
|  6 | Tensor<[169, 12]> self = ?,<br>List[Optional[Tensor]]<> indices = [Proxy(primals_183)]   | Done     |
|  7 | Tensor<[169, 24]> self = ?,<br>List[Optional[Tensor]]<> indices = ['torch.Size([2401])'] | Unknown  |
|  8 | Tensor<[169, 24]> self = ?,<br>List[Optional[Tensor]]<> indices = [Proxy(primals_184)]   | Done     |
|  9 | Tensor<[169, 24]> self = ?,<br>List[Optional[Tensor]]<> indices = [Proxy(primals_185)]   | Done     |
| 10 | Tensor<[169, 3]> self = ?,<br>List[Optional[Tensor]]<> indices = ['torch.Size([2401])']  | Unknown  |
| 11 | Tensor<[169, 3]> self = ?,<br>List[Optional[Tensor]]<> indices = [Proxy(primals_174)]    | Done     |
| 12 | Tensor<[169, 3]> self = ?,<br>List[Optional[Tensor]]<> indices = [Proxy(primals_175)]    | Done     |
| 13 | Tensor<[169, 6]> self = ?,<br>List[Optional[Tensor]]<> indices = ['torch.Size([2401])']  | Unknown  |
| 14 | Tensor<[169, 6]> self = ?,<br>List[Optional[Tensor]]<> indices = [Proxy(primals_176)]    | Done     |
| 15 | Tensor<[169, 6]> self = ?,<br>List[Optional[Tensor]]<> indices = [Proxy(primals_177)]    | Done     |
