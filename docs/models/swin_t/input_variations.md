...
|    | ATen Input Variations                                                                                                                                                        | Status   |
|---:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|
|  0 | List[Tensor]<> tensors = ['torch.Size([1, 14, 14, 192])', 'torch.Size([1, 14, 14, 192])', 'torch.Size([1, 14, 14, 192])', 'torch.Size([1, 14, 14, 192])'],<br>int<> dim = -1 | None     |
|  1 | List[Tensor]<> tensors = ['torch.Size([1, 28, 28, 96])', 'torch.Size([1, 28, 28, 96])', 'torch.Size([1, 28, 28, 96])', 'torch.Size([1, 28, 28, 96])'],<br>int<> dim = -1     | None     |
|  2 | List[Tensor]<> tensors = ['torch.Size([1, 7, 7, 384])', 'torch.Size([1, 7, 7, 384])', 'torch.Size([1, 7, 7, 384])', 'torch.Size([1, 7, 7, 384])'],<br>int<> dim = -1         | None     |
### aten.clone.default
|    | ATen Input Variations                                                                             | Status   |
|---:|:--------------------------------------------------------------------------------------------------|:---------|
...
|    | ATen Input Variations                                                                    | Status   |
|---:|:-----------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[169, 12]> self = ?,<br>List[Optional[Tensor]]<> indices = ['torch.Size([2401])'] | None     |
|  1 | Tensor<[169, 24]> self = ?,<br>List[Optional[Tensor]]<> indices = ['torch.Size([2401])'] | None     |
|  2 | Tensor<[169, 3]> self = ?,<br>List[Optional[Tensor]]<> indices = ['torch.Size([2401])']  | None     |
|  3 | Tensor<[169, 6]> self = ?,<br>List[Optional[Tensor]]<> indices = ['torch.Size([2401])']  | None     |
