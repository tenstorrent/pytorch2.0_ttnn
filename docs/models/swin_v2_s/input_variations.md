...
|    | ATen Input Variations                                                                                                                                                        | Status   |
|---:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|
|  0 | List[Tensor]<> tensors = ['torch.Size([1, 16, 16, 192])', 'torch.Size([1, 16, 16, 192])', 'torch.Size([1, 16, 16, 192])', 'torch.Size([1, 16, 16, 192])'],<br>int<> dim = -1 | None     |
|  1 | List[Tensor]<> tensors = ['torch.Size([1, 32, 32, 96])', 'torch.Size([1, 32, 32, 96])', 'torch.Size([1, 32, 32, 96])', 'torch.Size([1, 32, 32, 96])'],<br>int<> dim = -1     | None     |
|  2 | List[Tensor]<> tensors = ['torch.Size([1, 8, 8, 384])', 'torch.Size([1, 8, 8, 384])', 'torch.Size([1, 8, 8, 384])', 'torch.Size([1, 8, 8, 384])'],<br>int<> dim = -1         | None     |
### aten.clamp.default
|    | ATen Input Variations                                                                                     | Status   |
|---:|:----------------------------------------------------------------------------------------------------------|:---------|
...
|    | ATen Input Variations                                                                    | Status   |
|---:|:-----------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[225, 12]> self = ?,<br>List[Optional[Tensor]]<> indices = ['torch.Size([4096])'] | None     |
|  1 | Tensor<[225, 24]> self = ?,<br>List[Optional[Tensor]]<> indices = ['torch.Size([4096])'] | None     |
|  2 | Tensor<[225, 3]> self = ?,<br>List[Optional[Tensor]]<> indices = ['torch.Size([4096])']  | None     |
|  3 | Tensor<[225, 6]> self = ?,<br>List[Optional[Tensor]]<> indices = ['torch.Size([4096])']  | None     |
