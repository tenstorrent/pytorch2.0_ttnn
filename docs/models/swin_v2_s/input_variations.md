...
|  1 | aten._unsafe_view.default       |                 19 |          13 |         0 |          6 | 🚧          |    0.68 |
|  2 | aten.add.Tensor                 |                 11 |           8 |         3 |          0 | ✅          |    1    |
|  3 | aten.addmm.default              |                 18 |          17 |         1 |          0 | ✅          |    1    |
...
|  9 | aten.clone.default              |                 42 |           0 |        42 |          0 | ✅          |    1    |
| 10 | aten.constant_pad_nd.default    |                  4 |           0 |         4 |          0 | ✅          |    1    |
| 11 | aten.convolution.default        |                  1 |           0 |         0 |          0 | ✘           |    0    |
| 12 | aten.div.Tensor                 |                  4 |           4 |         0 |          0 | ✅          |    1    |
| 13 | aten.eq.Scalar                  |                  3 |           3 |         0 |          0 | ✅          |    1    |
| 14 | aten.exp.default                |                  4 |           1 |         3 |          0 | ✅          |    1    |
...
| 29 | aten.select.int                 |                 12 |           0 |        12 |          0 | ✅          |    1    |
...
| 35 | aten.unsqueeze.default          |                 16 |           4 |         9 |          0 | 🚧          |    0.81 |
| 36 | aten.view.default               |                 84 |          49 |        15 |         20 | 🚧          |    0.76 |
***
...
|    | ATen Input Variations                                                       | Status   | Isolated   | PCC   |
|---:|:----------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 2, 2, 8, 8, 384]> self = ?,<br>List[int] size = [4, 64, 384]     | Fallback | Fallback   | True  |
|  1 | Tensor<[1, 2, 8, 2, 8, 384]> self = ?,<br>List[int] size = [1, 16, 16, 384] | Fallback | Fallback   | True  |
|  2 | Tensor<[1, 4, 4, 8, 8, 192]> self = ?,<br>List[int] size = [16, 64, 192]    | Fallback | Fallback   | True  |
|  3 | Tensor<[1, 4, 8, 4, 8, 192]> self = ?,<br>List[int] size = [1, 32, 32, 192] | Fallback | Fallback   | True  |
|  4 | Tensor<[1, 64, 24, 32]> self = ?,<br>List[int] size = [1, 64, 768]          | Done     | Done       | True  |
|  5 | Tensor<[1, 8, 8, 8, 8, 96]> self = ?,<br>List[int] size = [1, 64, 64, 96]   | Fallback | Fallback   | True  |
|  6 | Tensor<[1, 8, 8, 8, 8, 96]> self = ?,<br>List[int] size = [64, 64, 96]      | Fallback | Fallback   | True  |
...
| 18 | Tensor<[8, 8, 8, 8]> self = ?,<br>List[int] size = [64, 64]                 | Done     | Done       | True  |
### aten.add.Tensor
|    | ATen Input Variations                                                        | Status   | Isolated   | PCC   |
|---:|:-----------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 16, 16, 384]> self = ?,<br>Tensor<[1, 16, 16, 384]> other = ?     | Done     | Done       | True  |
|  1 | Tensor<[1, 16, 6, 64, 64]> self = ?,<br>Tensor<[1, 16, 1, 64, 64]> other = ? | Removed  | Done       | True  |
...
|  4 | Tensor<[1, 4, 12, 64, 64]> self = ?,<br>Tensor<[1, 4, 1, 64, 64]> other = ?  | Removed  | Done       | True  |
|  5 | Tensor<[1, 64, 3, 64, 64]> self = ?,<br>Tensor<[1, 64, 1, 64, 64]> other = ? | Removed  | Done       | True  |
...
|    | ATen Input Variations                                                                           | Status   | Isolated   | PCC   |
|---:|:------------------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 16, 16, 1536]> self = ?                                                              | Removed  | Fallback   | True  |
|  1 | Tensor<[1, 16, 16, 384]> self = ?                                                               | Removed  | Fallback   | True  |
|  2 | Tensor<[1, 2, 2, 8, 8, 384]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Removed  | Fallback   | True  |
|  3 | Tensor<[1, 2, 8, 2, 8, 384]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Removed  | Fallback   | True  |
|  4 | Tensor<[1, 24, 64, 64]> self = ?                                                                | Removed  | Fallback   | True  |
|  5 | Tensor<[1, 32, 32, 192]> self = ?                                                               | Removed  | Fallback   | True  |
|  6 | Tensor<[1, 32, 32, 768]> self = ?                                                               | Removed  | Fallback   | True  |
|  7 | Tensor<[1, 4, 4, 8, 8, 192]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Removed  | Fallback   | True  |
|  8 | Tensor<[1, 4, 8, 4, 8, 192]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Removed  | Fallback   | True  |
|  9 | Tensor<[1, 64, 24, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Removed  | Fallback   | True  |
| 10 | Tensor<[1, 64, 64, 384]> self = ?                                                               | Removed  | Fallback   | True  |
| 11 | Tensor<[1, 64, 64, 96]> self = ?                                                                | Removed  | Fallback   | True  |
| 12 | Tensor<[1, 64, 768]> self = ?                                                                   | Removed  | Fallback   | True  |
| 13 | Tensor<[1, 8, 8, 3072]> self = ?                                                                | Removed  | Fallback   | True  |
| 14 | Tensor<[1, 8, 8, 768]> self = ?                                                                 | Removed  | Fallback   | True  |
| 15 | Tensor<[1, 8, 8, 8, 8, 96]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format  | Removed  | Fallback   | True  |
| 16 | Tensor<[1152]> self = ?                                                                         | Removed  | Unknown    | N/A   |
| 17 | Tensor<[12, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format         | Removed  | Fallback   | True  |
| 18 | Tensor<[16, 6, 32, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Removed  | Fallback   | True  |
| 19 | Tensor<[16, 6, 64, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Removed  | Fallback   | True  |
| 20 | Tensor<[16, 6, 64, 64]> self = ?                                                                | Removed  | Fallback   | True  |
| 21 | Tensor<[16, 64, 192]> self = ?                                                                  | Removed  | Fallback   | True  |
| 22 | Tensor<[16, 64, 6, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Removed  | Fallback   | True  |
| 23 | Tensor<[2, 2, 8, 8]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format         | Removed  | Fallback   | True  |
| 24 | Tensor<[2304]> self = ?                                                                         | Removed  | Unknown    | N/A   |
| 25 | Tensor<[24, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format         | Removed  | Fallback   | True  |
| 26 | Tensor<[288]> self = ?                                                                          | Removed  | Unknown    | N/A   |
| 27 | Tensor<[3, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format          | Removed  | Fallback   | True  |
| 28 | Tensor<[4, 12, 32, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Removed  | Fallback   | True  |
| 29 | Tensor<[4, 12, 64, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Removed  | Fallback   | True  |
| 30 | Tensor<[4, 12, 64, 64]> self = ?                                                                | Removed  | Fallback   | True  |
| 31 | Tensor<[4, 4, 8, 8]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format         | Removed  | Fallback   | True  |
| 32 | Tensor<[4, 64, 12, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Removed  | Fallback   | True  |
| 33 | Tensor<[4, 64, 384]> self = ?                                                                   | Removed  | Fallback   | True  |
| 34 | Tensor<[576]> self = ?                                                                          | Removed  | Unknown    | N/A   |
| 35 | Tensor<[6, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format          | Removed  | Fallback   | True  |
| 36 | Tensor<[64, 3, 32, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Removed  | Fallback   | True  |
| 37 | Tensor<[64, 3, 64, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Removed  | Fallback   | True  |
| 38 | Tensor<[64, 3, 64, 64]> self = ?                                                                | Removed  | Fallback   | True  |
| 39 | Tensor<[64, 64, 3, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Removed  | Fallback   | True  |
| 40 | Tensor<[64, 64, 96]> self = ?                                                                   | Removed  | Fallback   | True  |
| 41 | Tensor<[8, 8, 8, 8]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format         | Removed  | Fallback   | True  |
### aten.constant_pad_nd.default
|    | ATen Input Variations                                                                           | Status   | Isolated   | PCC   |
|---:|:------------------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 16, 16, 384]> self = ?,<br>List[int] pad = [0, 0, 0, 0, 0, 0],<br>number value = 0.0 | Removed  | Done       | True  |
|  1 | Tensor<[1, 32, 32, 192]> self = ?,<br>List[int] pad = [0, 0, 0, 0, 0, 0],<br>number value = 0.0 | Removed  | Done       | True  |
|  2 | Tensor<[1, 64, 64, 96]> self = ?,<br>List[int] pad = [0, 0, 0, 0, 0, 0],<br>number value = 0.0  | Removed  | Done       | True  |
|  3 | Tensor<[1, 8, 8, 768]> self = ?,<br>List[int] pad = [0, 0, 0, 0, 0, 0],<br>number value = 0.0   | Removed  | Done       | True  |
...
|    | ATen Input Variations       | Status   | Isolated   | PCC   |
|---:|:----------------------------|:---------|:-----------|:------|
|  0 | Tensor<[12, 1, 1]> self = ? | Removed  | Done       | True  |
|  1 | Tensor<[24, 1, 1]> self = ? | Done     | Done       | True  |
|  2 | Tensor<[3, 1, 1]> self = ?  | Removed  | Done       | True  |
|  3 | Tensor<[6, 1, 1]> self = ?  | Removed  | Done       | True  |
### aten.expand.default
|    | ATen Input Variations                                                 | Status   | Isolated   | PCC   |
|---:|:----------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 24, 32, 64]> self = ?,<br>List[int] size = [1, 24, 32, 64] | Removed  | Fallback   | True  |
|  1 | Tensor<[1, 24, 64, 1]> self = ?,<br>List[int] size = [1, 24, 64, 32]  | None     | Fallback   | True  |
|  2 | Tensor<[1, 24, 64, 32]> self = ?,<br>List[int] size = [1, 24, 64, 32] | Removed  | Fallback   | True  |
|  3 | Tensor<[1, 24, 64, 64]> self = ?,<br>List[int] size = [1, 24, 64, 64] | Removed  | Fallback   | True  |
|  4 | Tensor<[16, 6, 32, 64]> self = ?,<br>List[int] size = [16, 6, 32, 64] | Removed  | Fallback   | True  |
|  5 | Tensor<[16, 6, 64, 1]> self = ?,<br>List[int] size = [16, 6, 64, 32]  | None     | Fallback   | True  |
|  6 | Tensor<[16, 6, 64, 32]> self = ?,<br>List[int] size = [16, 6, 64, 32] | Removed  | Fallback   | True  |
|  7 | Tensor<[16, 6, 64, 64]> self = ?,<br>List[int] size = [16, 6, 64, 64] | Removed  | Fallback   | True  |
|  8 | Tensor<[4, 12, 32, 64]> self = ?,<br>List[int] size = [4, 12, 32, 64] | Removed  | Fallback   | True  |
|  9 | Tensor<[4, 12, 64, 1]> self = ?,<br>List[int] size = [4, 12, 64, 32]  | None     | Fallback   | True  |
| 10 | Tensor<[4, 12, 64, 32]> self = ?,<br>List[int] size = [4, 12, 64, 32] | Removed  | Fallback   | True  |
| 11 | Tensor<[4, 12, 64, 64]> self = ?,<br>List[int] size = [4, 12, 64, 64] | Removed  | Fallback   | True  |
| 12 | Tensor<[64, 3, 32, 64]> self = ?,<br>List[int] size = [64, 3, 32, 64] | Removed  | Fallback   | True  |
| 13 | Tensor<[64, 3, 64, 1]> self = ?,<br>List[int] size = [64, 3, 64, 32]  | None     | Fallback   | True  |
| 14 | Tensor<[64, 3, 64, 32]> self = ?,<br>List[int] size = [64, 3, 64, 32] | Removed  | Fallback   | True  |
| 15 | Tensor<[64, 3, 64, 64]> self = ?,<br>List[int] size = [64, 3, 64, 64] | Removed  | Fallback   | True  |
### aten.gelu.default
|    | ATen Input Variations              | Status   | Isolated   | PCC   |
|---:|:-----------------------------------|:---------|:-----------|:------|
...
|    | ATen Input Variations                                                                          | Status   | Isolated   | PCC   |
|---:|:-----------------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 768, 8, 8]> self = ?,<br>Optional[List[int]] dim = [-1, -2],<br>bool keepdim = True | Removed  | Done       | True  |
### aten.mm.default
|    | ATen Input Variations                                        | Status   | Isolated   | PCC   |
|---:|:-------------------------------------------------------------|:---------|:-----------|:------|
...
| 17 | Tensor<[64, 64, 3]> self = ?,<br>List[int] dims = [2, 0, 1]                   | Done     | Done       | True  |
...
|    | ATen Input Variations                                                 | Status   | Isolated   | PCC   |
|---:|:----------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[3, 1, 24, 64, 32]> self = ?,<br>int dim = 0,<br>int index = 0 | Removed  | Done       | True  |
|  1 | Tensor<[3, 1, 24, 64, 32]> self = ?,<br>int dim = 0,<br>int index = 1 | Removed  | Done       | True  |
|  2 | Tensor<[3, 1, 24, 64, 32]> self = ?,<br>int dim = 0,<br>int index = 2 | Removed  | Done       | True  |
|  3 | Tensor<[3, 16, 6, 64, 32]> self = ?,<br>int dim = 0,<br>int index = 0 | Removed  | Done       | True  |
|  4 | Tensor<[3, 16, 6, 64, 32]> self = ?,<br>int dim = 0,<br>int index = 1 | Removed  | Done       | True  |
|  5 | Tensor<[3, 16, 6, 64, 32]> self = ?,<br>int dim = 0,<br>int index = 2 | Removed  | Done       | True  |
|  6 | Tensor<[3, 4, 12, 64, 32]> self = ?,<br>int dim = 0,<br>int index = 0 | Removed  | Done       | True  |
|  7 | Tensor<[3, 4, 12, 64, 32]> self = ?,<br>int dim = 0,<br>int index = 1 | Removed  | Done       | True  |
|  8 | Tensor<[3, 4, 12, 64, 32]> self = ?,<br>int dim = 0,<br>int index = 2 | Removed  | Done       | True  |
|  9 | Tensor<[3, 64, 3, 64, 32]> self = ?,<br>int dim = 0,<br>int index = 0 | Removed  | Done       | True  |
| 10 | Tensor<[3, 64, 3, 64, 32]> self = ?,<br>int dim = 0,<br>int index = 1 | Removed  | Done       | True  |
| 11 | Tensor<[3, 64, 3, 64, 32]> self = ?,<br>int dim = 0,<br>int index = 2 | Removed  | Done       | True  |
...
|    | ATen Input Variations                                                                                                                      | Status   | Isolated   | PCC   |
|---:|:-------------------------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 16, 16, 192]> self = ?,<br>int dim = 3,<br>Optional[int] start = 0,<br>Optional[int] end = 9223372036854775807                  | Removed  | Fallback   | True  |
|  1 | Tensor<[1, 16, 16, 384]> self = ?,<br>int dim = 0,<br>Optional[int] start = 0,<br>Optional[int] end = 9223372036854775807                  | Removed  | Fallback   | True  |
...
|  4 | Tensor<[1, 16, 16, 384]> self = ?,<br>int dim = 3,<br>Optional[int] start = 0,<br>Optional[int] end = 9223372036854775807                  | Removed  | Fallback   | True  |
...
|  7 | Tensor<[1, 32, 32, 192]> self = ?,<br>int dim = 0,<br>Optional[int] start = 0,<br>Optional[int] end = 9223372036854775807                  | Removed  | Fallback   | True  |
...
| 10 | Tensor<[1, 32, 32, 192]> self = ?,<br>int dim = 3,<br>Optional[int] start = 0,<br>Optional[int] end = 9223372036854775807                  | Removed  | Fallback   | True  |
| 11 | Tensor<[1, 32, 32, 96]> self = ?,<br>int dim = 3,<br>Optional[int] start = 0,<br>Optional[int] end = 9223372036854775807                   | Removed  | Fallback   | True  |
...
| 14 | Tensor<[1, 64, 64, 96]> self = ?,<br>int dim = 0,<br>Optional[int] start = 0,<br>Optional[int] end = 9223372036854775807                   | Removed  | Fallback   | True  |
...
| 17 | Tensor<[1, 64, 64, 96]> self = ?,<br>int dim = 3,<br>Optional[int] start = 0,<br>Optional[int] end = 9223372036854775807                   | Removed  | Fallback   | True  |
...
| 20 | Tensor<[1, 8, 8, 384]> self = ?,<br>int dim = 3,<br>Optional[int] start = 0,<br>Optional[int] end = 9223372036854775807                    | Removed  | Fallback   | True  |
| 21 | Tensor<[1, 8, 8, 768]> self = ?,<br>int dim = 0,<br>Optional[int] start = 0,<br>Optional[int] end = 9223372036854775807                    | Removed  | Fallback   | True  |
| 22 | Tensor<[1, 8, 8, 768]> self = ?,<br>int dim = 3,<br>Optional[int] start = 0,<br>Optional[int] end = 9223372036854775807                    | Removed  | Fallback   | True  |
### aten.sub.Tensor
|    | ATen Input Variations                                          | Status   | Isolated   | PCC   |
|---:|:---------------------------------------------------------------|:---------|:-----------|:------|
...
|  1 | Tensor<[16, 1, 64, 64]> self = ?,<br>int dim = 0 | None     | Fallback   | True  |
|  2 | Tensor<[16, 64, 64]> self = ?,<br>int dim = 1    | Removed  | Done       | True  |
|  3 | Tensor<[16, 64]> self = ?,<br>int dim = 1        | Removed  | Done       | True  |
|  4 | Tensor<[16, 64]> self = ?,<br>int dim = 2        | Removed  | Done       | True  |
|  5 | Tensor<[24, 64, 64]> self = ?,<br>int dim = 0    | Done     | Done       | True  |
|  6 | Tensor<[3, 64, 64]> self = ?,<br>int dim = 0     | Done     | Done       | True  |
|  7 | Tensor<[4, 1, 64, 64]> self = ?,<br>int dim = 0  | None     | Fallback   | True  |
|  8 | Tensor<[4, 64, 64]> self = ?,<br>int dim = 1     | Removed  | Done       | True  |
|  9 | Tensor<[4, 64]> self = ?,<br>int dim = 1         | Removed  | Done       | True  |
| 10 | Tensor<[4, 64]> self = ?,<br>int dim = 2         | Removed  | Done       | True  |
| 11 | Tensor<[6, 64, 64]> self = ?,<br>int dim = 0     | Done     | Done       | True  |
| 12 | Tensor<[64, 1, 64, 64]> self = ?,<br>int dim = 0 | None     | Fallback   | True  |
| 13 | Tensor<[64, 64, 64]> self = ?,<br>int dim = 1    | Removed  | Done       | True  |
| 14 | Tensor<[64, 64]> self = ?,<br>int dim = 1        | Removed  | Done       | True  |
| 15 | Tensor<[64, 64]> self = ?,<br>int dim = 2        | Removed  | Done       | True  |
### aten.view.default
|    | ATen Input Variations                                                       | Status   | Isolated   | PCC   |
|---:|:----------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1, 1, 8, 8, 768]> self = ?,<br>List[int] size = [1, 64, 768]     | Fallback | Fallback   | True  |
|  1 | Tensor<[1, 1, 8, 1, 8, 768]> self = ?,<br>List[int] size = [1, 8, 8, 768]   | Fallback | Fallback   | True  |
|  2 | Tensor<[1, 15, 15, 12]> self = ?,<br>List[int] size = [-1, 12]              | Removed  | Done       | True  |
|  3 | Tensor<[1, 15, 15, 24]> self = ?,<br>List[int] size = [-1, 24]              | Removed  | Done       | True  |
|  4 | Tensor<[1, 15, 15, 2]> self = ?,<br>List[int] size = [225, 2]               | Done     | Unknown    | N/A   |
|  5 | Tensor<[1, 15, 15, 3]> self = ?,<br>List[int] size = [-1, 3]                | Removed  | Unknown    | N/A   |
|  6 | Tensor<[1, 15, 15, 512]> self = ?,<br>List[int] size = [225, 512]           | Done     | Unknown    | N/A   |
|  7 | Tensor<[1, 15, 15, 6]> self = ?,<br>List[int] size = [-1, 6]                | Removed  | Unknown    | N/A   |
|  8 | Tensor<[1, 16, 16, 1536]> self = ?,<br>List[int] size = [256, 1536]         | Done     | Done       | False |
|  9 | Tensor<[1, 16, 16, 384]> self = ?,<br>List[int] size = [1, 2, 8, 2, 8, 384] | Fallback | Fallback   | True  |
| 10 | Tensor<[1, 16, 16, 384]> self = ?,<br>List[int] size = [256, 384]           | Done     | Done       | False |
| 11 | Tensor<[1, 16, 16, 768]> self = ?,<br>List[int] size = [256, 768]           | Done     | Done       | False |
| 12 | Tensor<[1, 16, 6, 64, 64]> self = ?,<br>List[int] size = [-1, 6, 64, 64]    | Fallback | Fallback   | True  |
...
| 20 | Tensor<[1, 4, 12, 64, 64]> self = ?,<br>List[int] size = [-1, 12, 64, 64]   | Fallback | Fallback   | True  |
| 21 | Tensor<[1, 64, 2304]> self = ?,<br>List[int] size = [1, 64, 3, 24, 32]      | Fallback | Fallback   | True  |
| 22 | Tensor<[1, 64, 3, 64, 64]> self = ?,<br>List[int] size = [-1, 3, 64, 64]    | Fallback | Unknown    | N/A   |
...
| 26 | Tensor<[1, 64, 768]> self = ?,<br>List[int] size = [1, 1, 1, 8, 8, 768]     | Fallback | Fallback   | True  |
...
| 29 | Tensor<[1, 8, 8, 1536]> self = ?,<br>List[int] size = [64, 1536]            | Done     | Done       | False |
| 30 | Tensor<[1, 8, 8, 3072]> self = ?,<br>List[int] size = [64, 3072]            | Done     | Done       | False |
| 31 | Tensor<[1, 8, 8, 768]> self = ?,<br>List[int] size = [1, 1, 8, 1, 8, 768]   | Fallback | Fallback   | True  |
| 32 | Tensor<[1, 8, 8, 768]> self = ?,<br>List[int] size = [64, 768]              | Done     | Done       | False |
| 33 | Tensor<[1024, 192]> self = ?,<br>List[int] size = [1, 32, 32, 192]          | Done     | Unknown    | N/A   |
| 34 | Tensor<[1024, 192]> self = ?,<br>List[int] size = [16, 64, 192]             | Removed  | Unknown    | N/A   |
| 35 | Tensor<[1024, 576]> self = ?,<br>List[int] size = [16, 64, 576]             | Removed  | Unknown    | N/A   |
...
| 38 | Tensor<[16, 6, 64, 64]> self = ?,<br>List[int] size = [1, 16, 6, 64, 64]    | Fallback | Fallback   | True  |
...
| 42 | Tensor<[16, 64, 576]> self = ?,<br>List[int] size = [16, 64, 3, 6, 32]      | Fallback | Unknown    | N/A   |
| 43 | Tensor<[192, 64, 32]> self = ?,<br>List[int] size = [64, 3, 64, 32]         | Done     | Unknown    | N/A   |
| 44 | Tensor<[192, 64, 64]> self = ?,<br>List[int] size = [64, 3, 64, 64]         | Removed  | Unknown    | N/A   |
...
| 52 | Tensor<[256, 1152]> self = ?,<br>List[int] size = [4, 64, 1152]             | Removed  | Done       | True  |
...
| 55 | Tensor<[256, 384]> self = ?,<br>List[int] size = [4, 64, 384]               | Removed  | Done       | True  |
| 56 | Tensor<[32, 32]> self = ?,<br>List[int] size = [4, 8, 4, 8]                 | Done     | Done       | True  |
| 57 | Tensor<[4, 12, 64, 64]> self = ?,<br>List[int] size = [1, 4, 12, 64, 64]    | Fallback | Fallback   | True  |
| 58 | Tensor<[4, 12, 64, 64]> self = ?,<br>List[int] size = [48, 64, 64]          | Done     | Done       | True  |
| 59 | Tensor<[4, 64, 1152]> self = ?,<br>List[int] size = [4, 64, 3, 12, 32]      | Fallback | Fallback   | True  |
| 60 | Tensor<[4, 64, 384]> self = ?,<br>List[int] size = [1, 2, 2, 8, 8, 384]     | Fallback | Fallback   | True  |
...
| 64 | Tensor<[4096, 288]> self = ?,<br>List[int] size = [64, 64, 288]             | Removed  | Unknown    | N/A   |
| 65 | Tensor<[4096, 384]> self = ?,<br>List[int] size = [1, 64, 64, 384]          | Done     | Unknown    | N/A   |
| 66 | Tensor<[4096, 3]> self = ?,<br>List[int] size = [64, 64, -1]                | Done     | Unknown    | N/A   |
...
| 69 | Tensor<[4096, 96]> self = ?,<br>List[int] size = [64, 64, 96]               | Removed  | Unknown    | N/A   |
| 70 | Tensor<[48, 64, 32]> self = ?,<br>List[int] size = [4, 12, 64, 32]          | Done     | Done       | True  |
| 71 | Tensor<[48, 64, 64]> self = ?,<br>List[int] size = [4, 12, 64, 64]          | Removed  | Done       | True  |
| 72 | Tensor<[64, 2304]> self = ?,<br>List[int] size = [1, 64, 2304]              | Removed  | Done       | True  |
| 73 | Tensor<[64, 3, 64, 64]> self = ?,<br>List[int] size = [1, 64, 3, 64, 64]    | Fallback | Unknown    | N/A   |
...
| 76 | Tensor<[64, 64, 288]> self = ?,<br>List[int] size = [64, 64, 3, 3, 32]      | Fallback | Unknown    | N/A   |
...
| 80 | Tensor<[64, 768]> self = ?,<br>List[int] size = [1, 64, 768]                | Removed  | Done       | True  |
...
| 83 | Tensor<[96, 64, 64]> self = ?,<br>List[int] size = [16, 6, 64, 64]          | Removed  | Unknown    | N/A   |
