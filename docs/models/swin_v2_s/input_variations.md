...
|    | ATen Input Variations                                                         | Status   |
|---:|:------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[225, 12]> self = ?,<br>List[Optional[Tensor]] indices = [primals_411] | Unknown  |
|  1 | Tensor<[225, 24]> self = ?,<br>List[Optional[Tensor]] indices = [primals_447] | Unknown  |
|  2 | Tensor<[225, 3]> self = ?,<br>List[Optional[Tensor]] indices = [primals_403]  | Unknown  |
|  3 | Tensor<[225, 6]> self = ?,<br>List[Optional[Tensor]] indices = [primals_407]  | Unknown  |
