...
|  4 | Tensor<[1, 16, 10, 10]> self = ?,<br>int<> dim = -1,<br>bool<> half_to_float = False    | Unknown  |
...
|  2 | Tensor<[1, 10, 1024]> self = ?,<br>Tensor<[1, 10, 1024]> other = ?           | Unknown  |
|  3 | Tensor<[1, 10, 1]> self = ?,<br>Tensor<> other = 1e-06                       | Unknown  |
...
| 12 | Tensor<[1, 16, 10, 10]> self = ?,<br>Tensor<[1, 1, 1, 10]> other = ?         | Unknown  |
| 13 | Tensor<[1, 16, 10, 10]> self = ?,<br>Tensor<[1, 16, 10, 10]> other = ?       | Unknown  |
...
|  8 | Tensor<[16, 10, 10]> self = ?,<br>Tensor<[16, 10, 64]> mat2 = ?        | Unknown  |
|  9 | Tensor<[16, 10, 64]> self = ?,<br>Tensor<[16, 64, 10]> mat2 = ?        | Unknown  |
### aten.cat.default
|    | ATen Input Variations                                                                                    | Status   |
|---:|:---------------------------------------------------------------------------------------------------------|:---------|
...
|  3 | Tensor<[1, 10, 16, 64]> self = ?,<br>Optional[int]<> memory_format = torch.contiguous_format | Unknown  |
|  4 | Tensor<[1, 10, 4096]> self = ?                                                               | Unknown  |
...
|  9 | Tensor<[1, 16, 10, 10]> self = ?                                                             | Unknown  |
### aten.div.Tensor
|    | ATen Input Variations                                                     | Status   |
|---:|:--------------------------------------------------------------------------|:---------|
...
|  1 | Tensor<[32, 16]> weight = ?,<br>Tensor<[10, 10]> indices = ?         | Unknown  |
|  2 | Tensor<[32, 16]> weight = ?,<br>Tensor<[2, 2]> indices = ?           | Unknown  |
|  3 | Tensor<[32, 16]> weight = ?,<br>Tensor<[s0 + 1, s0 + 1]> indices = ? | Unknown  |
|  4 | Tensor<[32128, 1024]> weight = ?,<br>Tensor<[1, 10]> indices = ?     | Unknown  |
...
|  1 | Tensor<[1, 10, 1024]> self = ?,<br>Optional[List[int]]<> dim = [-1],<br>bool<> keepdim = True | Unknown  |
...
|  4 | Tensor<[10, 1024]> self = ?,<br>Tensor<[1024, 1024]> mat2 = ? | Unknown  |
|  5 | Tensor<[10, 1024]> self = ?,<br>Tensor<[1024, 4096]> mat2 = ? | Unknown  |
|  6 | Tensor<[10, 4096]> self = ?,<br>Tensor<[4096, 1024]> mat2 = ? | Unknown  |
### aten.mul.Tensor
|    | ATen Input Variations                                                           | Status   |
|---:|:--------------------------------------------------------------------------------|:---------|
...
|  9 | Tensor<[1, 10, 1024]> self = ?,<br>Tensor<[1, 10, 1]> other = ?                 | Unknown  |
...
| 15 | Tensor<[1024]> self = ?,<br>Tensor<[1, 10, 1024]> other = ?                     | Unknown  |
...
|  1 | Tensor<[10, 10, 16]> self = ?,<br>List[int]<> dims = [2, 0, 1]         | Unknown  |
...
|  1 | Tensor<[1, 10, 1024]> self = ?,<br>number<> exponent = 2 | Unknown  |
### aten.relu.default
|    | ATen Input Variations          | Status   |
|---:|:-------------------------------|:---------|
|  0 | Tensor<[1, 1, 4096]> self = ?  | Unknown  |
|  1 | Tensor<[1, 10, 4096]> self = ? | Unknown  |
### aten.repeat.default
|    | ATen Input Variations                                          | Status   |
|---:|:---------------------------------------------------------------|:---------|
...
| 13 | Tensor<[1, 16, 1, 10]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1           | Unknown  |
| 14 | Tensor<[1, 16, 1, 2]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1            | Unknown  |
| 15 | Tensor<[1, 16, 1, s0 + 1]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1       | Unknown  |
| 16 | Tensor<[1, 16, 2, 2]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1            | Unknown  |
| 17 | Tensor<[1, 16, 2, 2]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1            | Unknown  |
| 18 | Tensor<[1, 16, 2, 2]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = -1,<br>Optional[int]<> end = -1           | Unknown  |
| 19 | Tensor<[1, 16, 3, 10]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1           | Unknown  |
| 20 | Tensor<[1, 16, 3, 10]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1           | Unknown  |
| 21 | Tensor<[1, 16, 3, 10]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = -1,<br>Optional[int]<> end = -1          | Unknown  |
| 22 | Tensor<[1, 16, s0 + 1, s0 + 1]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1  | Unknown  |
| 23 | Tensor<[1, 16, s0 + 1, s0 + 1]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1  | Unknown  |
| 24 | Tensor<[1, 16, s0 + 1, s0 + 1]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = -1,<br>Optional[int]<> end = -1 | Unknown  |
| 25 | Tensor<[1, 16, s0 + 2, 10]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1      | Unknown  |
| 26 | Tensor<[1, 16, s0 + 2, 10]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1      | Unknown  |
| 27 | Tensor<[1, 16, s0 + 2, 10]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = -1,<br>Optional[int]<> end = -1     | Unknown  |
| 28 | Tensor<[1, 1]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                   | Unknown  |
| 29 | Tensor<[1, 1]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                   | Unknown  |
| 30 | Tensor<[1, 2]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                   | Unknown  |
| 31 | Tensor<[1, 2]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1                   | Unknown  |
...
|  1 | Tensor<[1, 10, 16, 64]> self = ?,<br>int<> dim0 = 1,<br>int<> dim1 = 2     | Unknown  |
|  2 | Tensor<[1, 16, 1, 64]> self = ?,<br>int<> dim0 = 1,<br>int<> dim1 = 2      | Unknown  |
|  3 | Tensor<[1, 16, 1, 64]> self = ?,<br>int<> dim0 = 3,<br>int<> dim1 = 2      | Unknown  |
|  4 | Tensor<[1, 16, 10, 64]> self = ?,<br>int<> dim0 = 1,<br>int<> dim1 = 2     | Unknown  |
|  5 | Tensor<[1, 16, 10, 64]> self = ?,<br>int<> dim0 = 3,<br>int<> dim1 = 2     | Unknown  |
...
| 15 | Tensor<[16, 10, 10]> self = ?,<br>int<> dim = 0         | Unknown  |
...
|  4 | Tensor<[1, 10, 1024]> self = ?,<br>List[int]<> size = [1, -1, 16, 64]                      | Unknown  |
|  5 | Tensor<[1, 10, 1024]> self = ?,<br>List[int]<> size = [10, 1024]                           | Unknown  |
|  6 | Tensor<[1, 10, 16, 64]> self = ?,<br>List[int]<> size = [1, -1, 1024]                      | Unknown  |
|  7 | Tensor<[1, 10, 4096]> self = ?,<br>List[int]<> size = [10, 4096]                           | Unknown  |
|  8 | Tensor<[1, 1024]> self = ?,<br>List[int]<> size = [1, 1, 1024]                             | Unknown  |
|  9 | Tensor<[1, 10]> self = ?,<br>List[int]<> size = [-1, 10]                                   | Unknown  |
...
| 15 | Tensor<[1, 16, 10, 10]> self = ?,<br>List[int]<> size = [16, 10, 10]                       | Unknown  |
| 16 | Tensor<[1, 16, 10, 64]> self = ?,<br>List[int]<> size = [16, 10, 64]                       | Unknown  |
| 17 | Tensor<[1, 16, 2, 64]> self = ?,<br>List[int]<> size = [16, 2, 64]                         | Unknown  |
| 18 | Tensor<[1, 16, 64, 10]> self = ?,<br>List[int]<> size = [16, 64, 10]                       | Unknown  |
...
| 26 | Tensor<[10, 1024]> self = ?,<br>List[int]<> size = [1, 10, 1024]                           | Unknown  |
| 27 | Tensor<[10, 4096]> self = ?,<br>List[int]<> size = [1, 10, 4096]                           | Unknown  |
...
| 33 | Tensor<[16, 10, 10]> self = ?,<br>List[int]<> size = [1, 16, 10, 10]                       | Unknown  |
| 34 | Tensor<[16, 10, 64]> self = ?,<br>List[int]<> size = [1, 16, 10, 64]                       | Unknown  |
### aten.where.self
|    | ATen Input Variations                                                                                               | Status   |
|---:|:--------------------------------------------------------------------------------------------------------------------|:---------|
