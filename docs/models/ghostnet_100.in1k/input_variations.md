...
|  7 | aten.mean.dim                                     |                  7 |           0 |         7 |          0 | ✅          |       1 |
|  8 | aten.mul.Tensor                                   |                  6 |           0 |         6 |          0 | ✅          |       1 |
|  9 | aten.relu.default                                 |                 18 |           2 |        16 |          0 | ✅          |       1 |
...
|  1 | Tensor<[1, 480, 14, 14]> self = ?,<br>Tensor<[1, 480, 1, 1]> other = ? | Removed  | Done       | True  |
|  2 | Tensor<[1, 672, 14, 14]> self = ?,<br>Tensor<[1, 672, 1, 1]> other = ? | Removed  | Done       | True  |
|  3 | Tensor<[1, 672, 7, 7]> self = ?,<br>Tensor<[1, 672, 1, 1]> other = ?   | Removed  | Done       | True  |
|  4 | Tensor<[1, 72, 28, 28]> self = ?,<br>Tensor<[1, 72, 1, 1]> other = ?   | Removed  | Done       | True  |
|  5 | Tensor<[1, 960, 7, 7]> self = ?,<br>Tensor<[1, 960, 1, 1]> other = ?   | Removed  | Done       | True  |
### aten.relu.default
|    | ATen Input Variations              | Status   | Isolated   | PCC   |
|---:|:-----------------------------------|:---------|:-----------|:------|
...
|  4 | Tensor<[1, 16, 112, 112]> self = ? | Removed  | Unknown    | N/A   |
|  5 | Tensor<[1, 168, 1, 1]> self = ?    | Removed  | Done       | True  |
|  6 | Tensor<[1, 20, 1, 1]> self = ?     | Removed  | Done       | True  |
|  7 | Tensor<[1, 24, 112, 112]> self = ? | Removed  | Unknown    | N/A   |
...
| 12 | Tensor<[1, 36, 56, 56]> self = ?   | Removed  | Unknown    | N/A   |
| 13 | Tensor<[1, 480, 7, 7]> self = ?    | Removed  | Done       | True  |
| 14 | Tensor<[1, 60, 28, 28]> self = ?   | Removed  | Done       | True  |
| 15 | Tensor<[1, 8, 112, 112]> self = ?  | Removed  | Unknown    | N/A   |
