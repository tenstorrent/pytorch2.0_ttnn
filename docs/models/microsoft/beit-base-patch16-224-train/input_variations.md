...
|  2 | Tensor<[1, 197, 768]> self = ?                                                              | Removed  | Done       | True  |
...
|    | ATen Input Variations                                                  | Status   | Isolated   | PCC   |
|---:|:-----------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1, 768]> self = ?,<br>List[int] size = [768]                | Removed  | Done       | True  |
...
|  9 | Tensor<[1, 3072]> self = ?,<br>List[int] size = [3072]                 | Removed  | Done       | True  |
...
| 12 | Tensor<[1, 768]> self = ?,<br>List[int] size = [768]                   | Removed  | Done       | True  |
| 13 | Tensor<[12, 197, 197]> self = ?,<br>List[int] size = [1, 12, 197, 197] | Removed  | Done       | True  |
