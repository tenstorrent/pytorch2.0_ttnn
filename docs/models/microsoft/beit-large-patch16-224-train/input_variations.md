...
| 13 | aten.expand.default                     |                  5 |           0 |         5 |          0 | ✅          |    1    |
...
| 18 | aten.mean.dim                           |                  1 |           0 |         1 |          0 | ✅          |    1    |
| 19 | aten.mm.default                         |                  8 |           7 |         1 |          0 | ✅          |    1    |
| 20 | aten.mul.Tensor                         |                  4 |           3 |         1 |          0 | ✅          |    1    |
| 21 | aten.native_layer_norm.default          |                  2 |           0 |         2 |          0 | ✅          |    1    |
...
| 26 | aten.slice.Tensor                       |                  5 |           2 |         3 |          0 | ✅          |    1    |
...
| 31 | aten.transpose.int                      |                  7 |           3 |         1 |          0 | 🚧          |    0.57 |
| 32 | aten.unsqueeze.default                  |                  2 |           2 |         0 |          0 | ✅          |    1    |
| 33 | aten.view.default                       |                 21 |          10 |         6 |          5 | 🚧          |    0.76 |
***
### aten._softmax.default
|    | ATen Input Variations                                                              | Status   | Isolated   | PCC   |
|---:|:-----------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 16, 197, 197]> self = ?,<br>int dim = -1,<br>bool half_to_float = False | Removed  | Done       | True  |
...
|    | ATen Input Variations                                                      | Status   | Isolated   | PCC   |
|---:|:---------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.8999999985098839           | Removed  | Done       | True  |
|  1 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.9043478220701218           | Removed  | Done       | True  |
|  2 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.9086956530809402           | Removed  | Done       | True  |
|  3 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.9130434766411781           | Removed  | Done       | True  |
|  4 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.917391300201416            | Removed  | Done       | True  |
|  5 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.9217391312122345           | Removed  | Done       | True  |
|  6 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.9260869547724724           | Removed  | Done       | True  |
|  7 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.9304347857832909           | Removed  | Done       | True  |
|  8 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.9347826093435287           | Removed  | Done       | True  |
|  9 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.9391304366290569           | Removed  | Done       | True  |
| 10 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.9434782639145851           | Removed  | Done       | True  |
| 11 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.947826087474823            | Removed  | Done       | True  |
| 12 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.9521739110350609           | Removed  | Done       | True  |
| 13 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.9565217345952988           | Removed  | Done       | True  |
| 14 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.960869561880827            | Removed  | Done       | True  |
| 15 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.9652173891663551           | Removed  | Done       | True  |
| 16 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.9695652164518833           | Removed  | Done       | True  |
| 17 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.9739130418747663           | Removed  | Done       | True  |
| 18 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.9782608672976494           | Removed  | Done       | True  |
| 19 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.9826086945831776           | Removed  | Done       | True  |
| 20 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.9869565209373832           | Removed  | Done       | True  |
| 21 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.9913043472915888           | Removed  | Done       | True  |
| 22 | Tensor<[1, 1, 1]> self = ?,<br>Tensor other = 0.9956521736457944           | Removed  | Done       | True  |
...
|    | ATen Input Variations                                                                       | Status   | Isolated   | PCC   |
|---:|:--------------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 16, 197, 197]> self = ?                                                          | Removed  | Fallback   | True  |
|  1 | Tensor<[1, 197, 1024]> self = ?                                                             | Removed  | Fallback   | True  |
|  2 | Tensor<[1, 197, 16, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Removed  | Fallback   | True  |
|  3 | Tensor<[16, 197, 197]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format   | Removed  | Fallback   | True  |
...
|  1 | Tensor<[1, 1, 1024]> self = ?,<br>List[int] size = [1, 196, 1024]         | Removed  | Done       | True  |
...
|    | ATen Input Variations                                             | Status   | Isolated   | PCC   |
|---:|:------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 196, 1024]> self = ?,<br>Optional[List[int]] dim = [1] | Removed  | Done       | True  |
### aten.mm.default
|    | ATen Input Variations                                          | Status   | Isolated   | PCC   |
|---:|:---------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1000]> self = ?,<br>Tensor<[1000, 1024]> mat2 = ?   | Removed  | Done       | True  |
...
|  1 | Tensor<[1, 197, 1024]> self = ?,<br>Tensor<[1, 197, 1024]> other = ? | Removed  | Done       | True  |
...
|    | ATen Input Variations                                                                                                                                                        | Status   | Isolated   | PCC   |
|---:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1024]> input = ?,<br>List[int] normalized_shape = [1024],<br>Optional[Tensor]<[1024]> weight = ?,<br>Optional[Tensor]<[1024]> bias = ?,<br>float eps = 1e-12      | Removed  | Done       | N/A   |
|  1 | Tensor<[1, 197, 1024]> input = ?,<br>List[int] normalized_shape = [1024],<br>Optional[Tensor]<[1024]> weight = ?,<br>Optional[Tensor]<[1024]> bias = ?,<br>float eps = 1e-12 | Removed  | Done       | N/A   |
...
|  2 | Tensor<[1, 197, 1024]> self = ?,<br>int dim = 1,<br>Optional[int] start = 0,<br>Optional[int] end = 1                   | Removed  | Done       | True  |
...
|    | ATen Input Variations                                                 | Status   | Isolated   | PCC   |
|---:|:----------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1024, 196]> self = ?,<br>int dim0 = 1,<br>int dim1 = 2     | Removed  | Done       | True  |
...
|    | ATen Input Variations                                                  | Status   | Isolated   | PCC   |
|---:|:-----------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1, 1024]> self = ?,<br>List[int] size = [1024]              | Fallback | Fallback   | True  |
|  1 | Tensor<[1, 1000]> self = ?,<br>List[int] size = [1000]                 | Fallback | Fallback   | True  |
|  2 | Tensor<[1, 1024, 14, 14]> self = ?,<br>List[int] size = [1, 1024, 196] | Done     | Done       | True  |
|  3 | Tensor<[1, 1024, 196]> self = ?,<br>List[int] size = [1, 1024, 14, 14] | Removed  | Done       | True  |
|  4 | Tensor<[1, 1024]> self = ?,<br>List[int] size = [1024]                 | Fallback | Fallback   | True  |
...
|  7 | Tensor<[1, 16, 64, 197]> self = ?,<br>List[int] size = [16, 64, 197]   | Removed  | Done       | True  |
...
| 11 | Tensor<[1, 197, 4096]> self = ?,<br>List[int] size = [197, 4096]       | Removed  | Done       | True  |
| 12 | Tensor<[1, 4096]> self = ?,<br>List[int] size = [4096]                 | Fallback | Fallback   | True  |
...
| 15 | Tensor<[16, 64, 197]> self = ?,<br>List[int] size = [1, 16, 64, 197]   | Removed  | Done       | True  |
| 16 | Tensor<[197, 1024]> self = ?,<br>List[int] size = [1, 197, 1024]       | Done     | Done       | True  |
| 17 | Tensor<[197, 197, 16]> self = ?,<br>List[int] size = [38809, 16]       | Removed  | Done       | True  |
| 18 | Tensor<[197, 197]> self = ?,<br>List[int] size = [-1]                  | Fallback | Fallback   | True  |
| 19 | Tensor<[197, 4096]> self = ?,<br>List[int] size = [1, 197, 4096]       | Removed  | Done       | True  |
