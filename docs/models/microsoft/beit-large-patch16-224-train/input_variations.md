...
|  7 | aten.clone.default                      |                  4 |           3 |         1 |          0 | ✅          |    1    |
...
| 33 | aten.view.default                       |                 21 |           9 |        11 |          0 | 🚧          |    0.95 |
***
...
|  1 | Tensor<[1, 197, 1024]> self = ?                                                             | Removed  | Done       | True  |
...
|    | ATen Input Variations                                                  | Status   | Isolated   | PCC   |
|---:|:-----------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1, 1024]> self = ?,<br>List[int] size = [1024]              | Removed  | Done       | True  |
|  1 | Tensor<[1, 1000]> self = ?,<br>List[int] size = [1000]                 | Removed  | Done       | True  |
...
|  4 | Tensor<[1, 1024]> self = ?,<br>List[int] size = [1024]                 | Removed  | Done       | True  |
...
| 12 | Tensor<[1, 4096]> self = ?,<br>List[int] size = [4096]                 | Removed  | Done       | True  |
| 13 | Tensor<[16, 197, 197]> self = ?,<br>List[int] size = [1, 16, 197, 197] | Removed  | Done       | True  |
