...
| 20 | aten.view.default              |                 14 |          12 |         1 |          0 | 🚧          |    0.93 |
***
...
|  8 | Tensor<[16, 197, 197]> self = ?,<br>List[int] size = [1, 16, 197, 197] | Removed  | Done       | True  |
...
| 11 | Tensor<[197, 197]> self = ?,<br>List[int] size = [-1]                  | None     | Fallback   | True  |
