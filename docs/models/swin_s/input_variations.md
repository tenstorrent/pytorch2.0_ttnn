...
|    | ATen Input Variations                                                                               | Status   |
|---:|:----------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 14, 14, 384]> self = ?,<br>List[int]<> pad = [0, 0, 0, 0, 0, 0],<br>number<> value = 0.0 | Unknown  |
|  1 | Tensor<[1, 28, 28, 192]> self = ?,<br>List[int]<> pad = [0, 0, 0, 0, 0, 0],<br>number<> value = 0.0 | Unknown  |
|  2 | Tensor<[1, 56, 56, 96]> self = ?,<br>List[int]<> pad = [0, 0, 0, 0, 0, 0],<br>number<> value = 0.0  | Unknown  |
|  3 | Tensor<[1, 7, 7, 768]> self = ?,<br>List[int]<> pad = [0, 0, 0, 0, 0, 0],<br>number<> value = 0.0   | Unknown  |
...
|  8 | Tensor<[1, 24, 49, 32]> self = ?,<br>List[int]<> size = [24, 49, 32]          | Unknown  |
...
| 17 | Tensor<[1, 49, 768]> self = ?,<br>List[int]<> size = [49, 768]                | Unknown  |
...
| 39 | Tensor<[24, 49, 32]> self = ?,<br>List[int]<> size = [1, 24, 49, 32]          | Unknown  |
...
| 57 | Tensor<[49, 2304]> self = ?,<br>List[int]<> size = [1, 49, 2304]              | Unknown  |
| 58 | Tensor<[49, 3072]> self = ?,<br>List[int]<> size = [1, 7, 7, 3072]            | Unknown  |
| 59 | Tensor<[49, 768]> self = ?,<br>List[int]<> size = [1, 49, 768]                | Unknown  |
