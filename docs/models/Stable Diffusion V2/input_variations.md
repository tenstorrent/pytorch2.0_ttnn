...
|---:|:---------------------------------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 8, 1024, 80]> query = ?,<br>Tensor<[1, 8, 1024, 80]> key = ?,<br>Tensor<[1, 8, 1024, 80]> value = ? | Unknown  | Fallback   | False |
|  1 | Tensor<[1, 8, 1024, 80]> query = ?,<br>Tensor<[1, 8, 9, 80]> key = ?,<br>Tensor<[1, 8, 9, 80]> value = ?       | Unknown  | Fallback   | True  |
...
|    | ATen Input Variations                                                             | Status   | Isolated   | PCC   |
|---:|:----------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | List[Tensor] tensors = [<[1, 1280, 16, 16]>, <[1, 1280, 16, 16]>],<br>int dim = 1 | Unknown  | Fallback   | True  |
|  1 | List[Tensor] tensors = [<[1, 1280, 16, 16]>, <[1, 640, 16, 16]>],<br>int dim = 1  | Unknown  | Fallback   | True  |
|  2 | List[Tensor] tensors = [<[1, 1280, 32, 32]>, <[1, 640, 32, 32]>],<br>int dim = 1  | Unknown  | Fallback   | True  |
|  3 | List[Tensor] tensors = [<[1, 1280, 8, 8]>, <[1, 1280, 8, 8]>],<br>int dim = 1     | Unknown  | Fallback   | True  |
|  4 | List[Tensor] tensors = [<[1, 160]>, <[1, 160]>],<br>int dim = -1                  | Unknown  | Fallback   | True  |
|  5 | List[Tensor] tensors = [<[1, 320, 64, 64]>, <[1, 320, 64, 64]>],<br>int dim = 1   | Unknown  | Fallback   | True  |
|  6 | List[Tensor] tensors = [<[1, 640, 32, 32]>, <[1, 320, 32, 32]>],<br>int dim = 1   | Unknown  | Fallback   | True  |
|  7 | List[Tensor] tensors = [<[1, 640, 32, 32]>, <[1, 640, 32, 32]>],<br>int dim = 1   | Unknown  | Fallback   | True  |
|  8 | List[Tensor] tensors = [<[1, 640, 64, 64]>, <[1, 320, 64, 64]>],<br>int dim = 1   | Unknown  | Fallback   | True  |
### aten.clone.default
|    | ATen Input Variations                                                                        | Status   | Isolated   | PCC   |
|---:|:---------------------------------------------------------------------------------------------|:---------|:-----------|:------|
...
|  9 | Tensor<[160]> self = ?,<br>Tensor other = 160             | Unknown  | Fallback   | True  |
### aten.exp.default
|    | ATen Input Variations   | Status   | Isolated   | PCC   |
|---:|:------------------------|:---------|:-----------|:------|
...
|  9 | Tensor<[32]> self = ?,<br>int dim = -1        | Unknown  | Fallback   | True  |
| 10 | Tensor<[64]> self = ?,<br>int dim = -1        | Unknown  | Fallback   | True  |
### aten.view.default
|    | ATen Input Variations                                                  | Status   | Isolated   | PCC   |
|---:|:-----------------------------------------------------------------------|:---------|:-----------|:------|
