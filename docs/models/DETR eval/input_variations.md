...
|    | ATen Input Variations                                                                   | Status   |
|---:|:----------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[100, 1, 2048]> self = ?                                                         | Unknown  |
|  1 | Tensor<[100, 1, 256]> self = ?                                                          | Unknown  |
|  2 | Tensor<[100, 8, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Unknown  |
|  3 | Tensor<[920, 1, 2048]> self = ?                                                         | Unknown  |
|  4 | Tensor<[920, 1, 256]> self = ?                                                          | Unknown  |
|  5 | Tensor<[920, 8, 32]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Unknown  |
