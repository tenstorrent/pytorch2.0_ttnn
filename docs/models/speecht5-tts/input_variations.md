...
|  9 | Tensor<[12, 24, 24]> self = ?,<br>int dim = -1,<br>bool half_to_float = False     | Unknown  | Done       | 0.9996263517947904 | 0      |
...
|  2 | Tensor<[1, 12, 24, 24]> self = ?,<br>Tensor<[1, 1, 24, 24]> other = ? | Unknown  | Done       | 0.999997902338367  | 0      |
|  3 | Tensor<[1, 128, 1536]> self = ?,<br>Tensor<[1, 128, 1536]> other = ?  | Unknown  | Unknown    | N/A                | N/A    |
|  4 | Tensor<[1, 24, 768]> self = ?,<br>Tensor<[1, 24, 768]> other = ?      | Unknown  | Done       | 0.9999979940275655 | 0      |
...
| 10 | Tensor<[12, 24, 24]> self = ?,<br>Tensor<[12, 24, 24]> other = ?      | Unknown  | Done       | 0.9999979766298892 | 0      |
| 11 | Tensor<[24, 24]> self = ?,<br>Tensor other = 160                      | Unknown  | Done       | 0.9758362550956688 | 0      |
### aten.addmm.default
|    | ATen Input Variations                                                                   | Status   | Isolated   | PCC                | Host   |
|---:|:----------------------------------------------------------------------------------------|:---------|:-----------|:-------------------|:-------|
...
|  5 | Tensor<[3072]> self = ?,<br>Tensor<[24, 768]> mat1 = ?,<br>Tensor<[768, 3072]> mat2 = ? | Unknown  | Done       | 0.9999670916333978 | 0      |
...
| 10 | Tensor<[768]> self = ?,<br>Tensor<[24, 3072]> mat1 = ?,<br>Tensor<[3072, 768]> mat2 = ? | Unknown  | Done       | 0.9999425993797116 | 0      |
| 11 | Tensor<[768]> self = ?,<br>Tensor<[24, 768]> mat1 = ?,<br>Tensor<[768, 768]> mat2 = ?   | Unknown  | Done       | 0.9999672002868023 | 0      |
...
| 18 | Tensor<[12, 24, 24]> self = ?,<br>Tensor<[12, 24, 64]> mat2 = ?          | Unknown  | Done       | 0.9999890476573082 | 0      |
| 19 | Tensor<[12, 24, 64]> self = ?,<br>Tensor<[12, 64, 24]> mat2 = ?          | Unknown  | Done       | 0.9999862629066099 | 0      |
| 20 | Tensor<[24, 12, 64]> self = ?,<br>Tensor<[24, 64, 24]> mat2 = ?          | Unknown  | Done       | 0.9999862571108484 | 0      |
### aten.cat.default
|    | ATen Input Variations                                                         | Status   | Isolated   | PCC   | Host   |
|---:|:------------------------------------------------------------------------------|:---------|:-----------|:------|:-------|
...
|---:|:-------------------------------|:---------|:-----------|:-------------------|:-------|
|  0 | Tensor<[1, 1, 3072]> self = ?  | Unknown  | Unknown    | N/A                | N/A    |
|  1 | Tensor<[1, 24, 3072]> self = ? | Unknown  | Done       | 0.9999914535633865 | 0      |
...
|  5 | Tensor<[]> self = ?,<br>Tensor<[1, 24, 768]> other = ? | Unknown  | Done       | 0.9999977007830533 | 0      |
...
|  1 | Tensor<[1, 24, 768]> input = ?,<br>List[int] normalized_shape = [768],<br>Optional[Tensor]<[768]> weight = ?,<br>Optional[Tensor]<[768]> bias = ?,<br>float eps = 1e-05 | Unknown  | Done       | 0.9964383378097271 | 3      |
### aten.relu.default
|    | ATen Input Variations         | Status   | Isolated   | PCC   | Host   |
|---:|:------------------------------|:---------|:-----------|:------|:-------|
...
|    | ATen Input Variations                                  | Status   | Isolated   | PCC                | Host   |
|---:|:-------------------------------------------------------|:---------|:-----------|:-------------------|:-------|
|  0 | Tensor<[24, 1]> self = ?,<br>Tensor<[1, 24]> other = ? | Unknown  | Done       | 0.9999983279788232 | 0      |
