...
|    | ATen Input Variations                                              | Status   | Isolated   | PCC   | Host   |
|---:|:-------------------------------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[16, 384, 384]> self = ?,<br>Tensor<[16, 384, 64]> mat2 = ? | Removed  | Unknown    | N/A   | N/A    |
|  1 | Tensor<[16, 384, 64]> self = ?,<br>Tensor<[16, 64, 384]> mat2 = ?  | Removed  | Unknown    | N/A   | N/A    |
### aten.clone.default
|    | ATen Input Variations                                                                       | Status   | Isolated   | PCC   | Host   |
|---:|:--------------------------------------------------------------------------------------------|:---------|:-----------|:------|:-------|
...
|    | ATen Input Variations                                               | Status   | Isolated   | PCC   | Host   |
|---:|:--------------------------------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 16, 384, 64]> self = ?,<br>List[int] dims = [0, 2, 1, 3] | Removed  | Unknown    | N/A   | N/A    |
|  1 | Tensor<[1, 384, 16, 64]> self = ?,<br>List[int] dims = [0, 2, 1, 3] | Removed  | Unknown    | N/A   | N/A    |
### aten.rsub.Scalar
|    | ATen Input Variations                                  | Status   | Isolated   | PCC   | Host   |
|---:|:-------------------------------------------------------|:---------|:-----------|:------|:-------|
...
|    | ATen Input Variations                                                 | Status   | Isolated   | PCC   | Host   |
|---:|:----------------------------------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 16, 384, 64]> self = ?,<br>int dim0 = -1,<br>int dim1 = -2 | Removed  | Unknown    | N/A   | N/A    |
...
|    | ATen Input Variations                                                  | Status   | Isolated   | PCC   | Host   |
|---:|:-----------------------------------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 16, 384, 384]> self = ?,<br>List[int] size = [16, 384, 384] | Removed  | Unknown    | N/A   | N/A    |
|  1 | Tensor<[1, 16, 384, 64]> self = ?,<br>List[int] size = [16, 384, 64]   | Removed  | Unknown    | N/A   | N/A    |
|  2 | Tensor<[1, 16, 64, 384]> self = ?,<br>List[int] size = [16, 64, 384]   | Removed  | Unknown    | N/A   | N/A    |
|  3 | Tensor<[1, 384, 1024]> self = ?,<br>List[int] size = [1, 384, 16, 64]  | Removed  | Unknown    | N/A   | N/A    |
|  4 | Tensor<[1, 384, 1024]> self = ?,<br>List[int] size = [384, 1024]       | Done     | Unknown    | N/A   | N/A    |
|  5 | Tensor<[1, 384, 16, 64]> self = ?,<br>List[int] size = [1, 384, 1024]  | Removed  | Unknown    | N/A   | N/A    |
|  6 | Tensor<[1, 384, 4096]> self = ?,<br>List[int] size = [384, 4096]       | Done     | Unknown    | N/A   | N/A    |
|  7 | Tensor<[16, 384, 384]> self = ?,<br>List[int] size = [1, 16, 384, 384] | Removed  | Unknown    | N/A   | N/A    |
|  8 | Tensor<[16, 384, 64]> self = ?,<br>List[int] size = [1, 16, 384, 64]   | Removed  | Unknown    | N/A   | N/A    |
