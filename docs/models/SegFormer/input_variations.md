...
|  3 | Tensor<[1, 1024, 640]> self = ?                                                                | Unknown  |
...
|  7 | Tensor<[1, 2, 4096, 256]> self = ?                                                             | Unknown  |
|  8 | Tensor<[1, 256, 1024]> self = ?                                                                | Unknown  |
