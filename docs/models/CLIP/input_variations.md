...
|  1 | aten._to_copy.default           |                  5 |           3 |
|  2 | aten._unsafe_view.default       |                  2 |           2 |
|  3 | aten.add.Tensor                 |                  4 |           4 |
|  4 | aten.addmm.default              |                  6 |           6 |
|  5 | aten.arange.default             |                  1 |           1 |
|  6 | aten.argmax.default             |                  1 |           1 |
...
| 14 | aten.expand.default             |                  3 |           3 |
| 15 | aten.full.default               |                  1 |           1 |
| 16 | aten.index.Tensor               |                  2 |           1 |
| 17 | aten.linalg_vector_norm.default |                  2 |           2 |
| 18 | aten.masked_fill.Scalar         |                  1 |           1 |
...
|    | ATen Input Variations                                                                               | Status   |
|---:|:----------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 3, 224, 224]> self = ?,<br>Optional[int]<> dtype = torch.bfloat16                        | Done     |
|  1 | Tensor<[2, 1, 7, 7]> self = ?,<br>Optional[int]<> dtype = torch.bfloat16                            | Unknown  |
|  2 | Tensor<[2, 1, 7, 7]> self = ?,<br>Optional[int]<> dtype = torch.bool                                | Done     |
|  3 | Tensor<[2, 7]> self = ?,<br>Optional[int]<> dtype = torch.int32,<br>Optional[Device]<> device = cpu | Done     |
|  4 | Tensor<[7, 7]> self = ?,<br>Optional[int]<> dtype = torch.bfloat16                                  | Unknown  |
### aten._unsafe_view.default
|    | ATen Input Variations                                                | Status   |
|---:|:---------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 50, 12, 64]> self = ?,<br>List[int]<> size = [1, 50, 768] | Done     |
|  1 | Tensor<[2, 7, 8, 64]> self = ?,<br>List[int]<> size = [2, 7, 512]    | Done     |
### aten.add.Tensor
|    | ATen Input Variations                                            | Status   |
|---:|:-----------------------------------------------------------------|:---------|
...
|    | ATen Input Variations                                                                        | Status   |
|---:|:---------------------------------------------------------------------------------------------|:---------|
|  0 | number<> end = 2,<br>Optional[Device]<> device = cpu,<br>Optional[bool]<> pin_memory = False | Done     |
### aten.argmax.default
|    | ATen Input Variations                                | Status   |
|---:|:-----------------------------------------------------|:---------|
|  0 | Tensor<[2, 7]> self = ?,<br>Optional[int]<> dim = -1 | Done     |
### aten.bmm.default
|    | ATen Input Variations                                           | Status   |
|---:|:----------------------------------------------------------------|:---------|
...
|    | ATen Input Variations                                                                                                                                                                                                                                                                                      | Status   |
|---:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 3, 224, 224]> input = ?,<br>Tensor<[768, 3, 32, 32]> weight = ?,<br>Optional[Tensor]<> bias = ?,<br>List[int]<> stride = [32, 32],<br>List[int]<> padding = [0, 0],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1 | Done     |
### aten.div.Tensor
|    | ATen Input Variations                                  | Status   |
|---:|:-------------------------------------------------------|:---------|
...
|  1 | Tensor<[2, 7, 512]> self = ?,<br>List[Optional[Tensor]]<> indices = [Proxy(arange_default), Proxy(argmax_default)] | Done     |
### aten.linalg_vector_norm.default
|    | ATen Input Variations                                                                                         | Status   |
|---:|:--------------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 512]> self = ?,<br>number<> ord = 2,<br>Optional[List[int]]<> dim = [-1],<br>bool<> keepdim = True | Done     |
|  1 | Tensor<[2, 512]> self = ?,<br>number<> ord = 2,<br>Optional[List[int]]<> dim = [-1],<br>bool<> keepdim = True | Done     |
### aten.masked_fill.Scalar
|    | ATen Input Variations                                                                                        | Status   |
|---:|:-------------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[2, 1, 7, 7]> self = ?,<br>Tensor<[2, 1, 7, 7]> mask = ?,<br>number<> value = -3.3895313892515355e+38 | Done     |
### aten.mm.default
|    | ATen Input Variations                                     | Status   |
|---:|:----------------------------------------------------------|:---------|
...
|    | ATen Input Variations                                               | Status   |
|---:|:--------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 50, 768]> self = ?,<br>int<> dim = 1,<br>int<> index = 0 | Done     |
...
|    | ATen Input Variations                                                                                      | Status   |
|---:|:-----------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 1, 7, 7]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1 | Done     |
|  1 | Tensor<[1, 1, 7, 7]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1 | Done     |
|  2 | Tensor<[1, 50, 768]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1 | Done     |
|  3 | Tensor<[1, 768]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1     | Done     |
|  4 | Tensor<[1, 77]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1      | Done     |
|  5 | Tensor<[1, 77]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = 7       | Done     |
|  6 | Tensor<[2, 1, 1, 7]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1 | Done     |
|  7 | Tensor<[2, 7]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = -1       | Done     |
### aten.t.default
|    | ATen Input Variations        | Status   |
|---:|:-----------------------------|:---------|
