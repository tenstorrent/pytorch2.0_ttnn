...
| 29 | aten.view.default               |                 20 |           5 |         0 |         15 | 🚧          |               0.25 |
***
...
|    | ATen Input Variations                                                                               | Status   |
|---:|:----------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 3, 224, 224]> self = ?,<br>Optional[int]<> dtype = torch.bfloat16                        | None     |
...
|  3 | Tensor<[2, 7]> self = ?,<br>Optional[int]<> dtype = torch.int32,<br>Optional[Device]<> device = cpu | None     |
|  4 | Tensor<[7, 7]> self = ?,<br>Optional[int]<> dtype = torch.bfloat16                                  | Unknown  |
### aten._unsafe_view.default
|    | ATen Input Variations                                                | Status   |
|---:|:---------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 50, 12, 64]> self = ?,<br>List[int]<> size = [1, 50, 768] | None     |
|  1 | Tensor<[2, 7, 8, 64]> self = ?,<br>List[int]<> size = [2, 7, 512]    | None     |
### aten.add.Tensor
|    | ATen Input Variations                                            | Status   |
|---:|:-----------------------------------------------------------------|:---------|
...
|    | ATen Input Variations                                                                        | Status   |
|---:|:---------------------------------------------------------------------------------------------|:---------|
|  0 | number<> end = 2,<br>Optional[Device]<> device = cpu,<br>Optional[bool]<> pin_memory = False | None     |
### aten.argmax.default
|    | ATen Input Variations                                | Status   |
|---:|:-----------------------------------------------------|:---------|
|  0 | Tensor<[2, 7]> self = ?,<br>Optional[int]<> dim = -1 | None     |
### aten.bmm.default
|    | ATen Input Variations                                           | Status   |
|---:|:----------------------------------------------------------------|:---------|
...
|    | ATen Input Variations                                                                              | Status   |
|---:|:---------------------------------------------------------------------------------------------------|:---------|
|  0 | List[Tensor]<> tensors = ['torch.Size([1, 1, 768])', 'torch.Size([1, 49, 768])'],<br>int<> dim = 1 | None     |
### aten.clone.default
|    | ATen Input Variations                                                                        | Status   |
|---:|:---------------------------------------------------------------------------------------------|:---------|
...
|    | ATen Input Variations                                                                                                                                                                                                                                                                                      | Status   |
|---:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 3, 224, 224]> input = ?,<br>Tensor<[768, 3, 32, 32]> weight = ?,<br>Optional[Tensor]<> bias = ?,<br>List[int]<> stride = [32, 32],<br>List[int]<> padding = [0, 0],<br>List[int]<> dilation = [1, 1],<br>bool<> transposed = False,<br>List[int]<> output_padding = [0, 0],<br>int<> groups = 1 | None     |
### aten.div.Tensor
|    | ATen Input Variations                                  | Status   |
|---:|:-------------------------------------------------------|:---------|
...
|    | ATen Input Variations                                             | Status   |
|---:|:------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 1, 7, 7]> self = ?,<br>List[int]<> size = [2, 1, 7, 7] | Done     |
...
|    | ATen Input Variations                                                                                      | Status   |
|---:|:-----------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[2, 7, 512]> self = ?,<br>List[Optional[Tensor]]<> indices = ['torch.Size([2])', 'torch.Size([2])'] | None     |
### aten.linalg_vector_norm.default
|    | ATen Input Variations                                                                                         | Status   |
|---:|:--------------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 512]> self = ?,<br>number<> ord = 2,<br>Optional[List[int]]<> dim = [-1],<br>bool<> keepdim = True | None     |
|  1 | Tensor<[2, 512]> self = ?,<br>number<> ord = 2,<br>Optional[List[int]]<> dim = [-1],<br>bool<> keepdim = True | None     |
### aten.masked_fill.Scalar
|    | ATen Input Variations                                                                                        | Status   |
|---:|:-------------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[2, 1, 7, 7]> self = ?,<br>Tensor<[2, 1, 7, 7]> mask = ?,<br>number<> value = -3.3895313892515355e+38 | None     |
### aten.mm.default
|    | ATen Input Variations                                     | Status   |
|---:|:----------------------------------------------------------|:---------|
...
|    | ATen Input Variations                                               | Status   |
|---:|:--------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 50, 768]> self = ?,<br>int<> dim = 1,<br>int<> index = 0 | None     |
...
|    | ATen Input Variations                                                                                                       | Status   |
|---:|:----------------------------------------------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 1, 7, 7]> self = ?,<br>int<> dim = 2,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = 9223372036854775807 | Unknown  |
|  1 | Tensor<[1, 1, 7, 7]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = 9223372036854775807 | Unknown  |
|  2 | Tensor<[1, 50, 768]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = 9223372036854775807 | Unknown  |
|  3 | Tensor<[1, 768]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = 9223372036854775807     | Unknown  |
|  4 | Tensor<[1, 77]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = 9223372036854775807      | Unknown  |
|  5 | Tensor<[1, 77]> self = ?,<br>int<> dim = 1,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = 7                        | Done     |
|  6 | Tensor<[2, 1, 1, 7]> self = ?,<br>int<> dim = 3,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = 9223372036854775807 | Unknown  |
|  7 | Tensor<[2, 7]> self = ?,<br>int<> dim = 0,<br>Optional[int]<> start = 0,<br>Optional[int]<> end = 9223372036854775807       | Unknown  |
### aten.t.default
|    | ATen Input Variations        | Status   |
|---:|:-----------------------------|:---------|
...
|    | ATen Input Variations                                                | Status   |
|---:|:---------------------------------------------------------------------|:---------|
|  0 | Tensor<[1, 12, 50, 64]> self = ?,<br>List[int]<> size = [12, -1, 64] | Fallback |
|  1 | Tensor<[1, 50, 3072]> self = ?,<br>List[int]<> size = [50, 3072]     | Done     |
|  2 | Tensor<[1, 50, 768]> self = ?,<br>List[int]<> size = [1, -1, 12, 64] | Fallback |
|  3 | Tensor<[1, 50, 768]> self = ?,<br>List[int]<> size = [1, 50, 12, 64] | Fallback |
|  4 | Tensor<[1, 50, 768]> self = ?,<br>List[int]<> size = [50, 768]       | Done     |
|  5 | Tensor<[1, 768, 7, 7]> self = ?,<br>List[int]<> size = [1, 768, 49]  | Fallback |
|  6 | Tensor<[12, 50, 64]> self = ?,<br>List[int]<> size = [1, 12, 50, 64] | Done     |
|  7 | Tensor<[14, 2048]> self = ?,<br>List[int]<> size = [2, 7, 2048]      | Fallback |
|  8 | Tensor<[14, 512]> self = ?,<br>List[int]<> size = [2, 7, 512]        | Fallback |
|  9 | Tensor<[16, 7, 64]> self = ?,<br>List[int]<> size = [2, 8, 7, 64]    | Fallback |
| 10 | Tensor<[16, 7, 7]> self = ?,<br>List[int]<> size = [2, 8, 7, 7]      | Fallback |
| 11 | Tensor<[2, 7, 2048]> self = ?,<br>List[int]<> size = [14, 2048]      | Fallback |
| 12 | Tensor<[2, 7, 512]> self = ?,<br>List[int]<> size = [14, 512]        | Fallback |
| 13 | Tensor<[2, 7, 512]> self = ?,<br>List[int]<> size = [2, -1, 8, 64]   | Fallback |
| 14 | Tensor<[2, 7, 512]> self = ?,<br>List[int]<> size = [2, 7, 8, 64]    | Fallback |
| 15 | Tensor<[2, 7]> self = ?,<br>List[int]<> size = [-1, 7]               | Fallback |
| 16 | Tensor<[2, 8, 7, 64]> self = ?,<br>List[int]<> size = [16, -1, 64]   | Fallback |
| 17 | Tensor<[2, 8, 7, 7]> self = ?,<br>List[int]<> size = [16, 7, 7]      | Fallback |
