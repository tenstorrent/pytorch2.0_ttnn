...
|  9 | aten.clone.default              |                  6 |           0 |         6 |          0 | ✅          |    1    |
...
| 14 | aten.expand.default             |                  3 |           1 |         2 |          0 | ✅          |    1    |
...
|  3 | Tensor<[7, 7]> self = ?,<br>Optional[int] dtype = torch.bfloat16                                | Removed  | Fallback   | True  |
...
|    | ATen Input Variations                                                                      | Status   | Isolated   | PCC   |
|---:|:-------------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 12, 50, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Removed  | Fallback   | True  |
|  1 | Tensor<[1, 50, 12, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Removed  | Fallback   | True  |
|  2 | Tensor<[12, 50, 50]> self = ?                                                              | Removed  | Fallback   | True  |
|  3 | Tensor<[16, 7, 7]> self = ?                                                                | Removed  | Fallback   | True  |
|  4 | Tensor<[2, 7, 8, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format   | Removed  | Fallback   | True  |
|  5 | Tensor<[2, 8, 7, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format   | Removed  | Fallback   | True  |
...
|  1 | Tensor<[2, 1, 1, 7]> self = ?,<br>List[int] size = [2, 1, 7, 7] | Removed  | Done       | False |
