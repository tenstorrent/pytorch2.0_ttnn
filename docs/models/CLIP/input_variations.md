...
|  1 | Tensor<[2, 1]> self = ?      | Done     | Done       | True  |
...
|  5 | Tensor<[1, 768, 7, 7]> self = ?,<br>List[int] size = [1, 768, 49]  | Done     | Done       | True  |
...
| 15 | Tensor<[2, 7]> self = ?,<br>List[int] size = [-1, 7]               | Done     | Done       | True  |
