...
|  7 | aten.leaky_relu.default                           |                 13 |           5 |         8 |          0 | ✅          |    1    |
...
|  2 | Tensor<[1, 128, 32, 32]> self = ?,<br>number negative_slope = 0.1   | Removed  | Done       | True  |
|  3 | Tensor<[1, 128, 64, 64]> self = ?,<br>number negative_slope = 0.1   | Removed  | Done       | True  |
|  4 | Tensor<[1, 256, 16, 16]> self = ?,<br>number negative_slope = 0.1   | Removed  | Done       | True  |
