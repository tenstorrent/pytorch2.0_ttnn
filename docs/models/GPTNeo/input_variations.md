...
| 33 | aten.unsqueeze.default         |                  9 |           2 |         0 |          0 | 🚧          |    0.22 |
...
|    | ATen Input Variations                                                                      | Status   | Isolated   | PCC   |
|---:|:-------------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1, 45]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format      | Unknown  | Fallback   | True  |
|  1 | Tensor<[1, 1, 768]> self = ?                                                               | Unknown  | Fallback   | True  |
|  2 | Tensor<[1, 12, 1, 46]> self = ?                                                            | Unknown  | Fallback   | True  |
|  3 | Tensor<[1, 12, 1, s10 + 1]> self = ?                                                       | Unknown  | Unknown    | N/A   |
|  4 | Tensor<[1, 12, 45, 45]> self = ?                                                           | Unknown  | Fallback   | True  |
|  5 | Tensor<[1, 45, 12, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Unknown  | Fallback   | True  |
|  6 | Tensor<[1, 45, 768]> self = ?                                                              | Unknown  | Fallback   | True  |
...
|  1 | Tensor<[1, 50]> self = ?,<br>int dim = 1,<br>int index = -1 | Unknown  | Failed     | N/A   |
### aten.slice.Tensor
|    | ATen Input Variations                                                                                                       | Status   | Isolated   | PCC   |
|---:|:----------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|:------|
