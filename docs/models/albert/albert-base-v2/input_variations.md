...
|  3 | Tensor<[1, 9, 3072]> self = ?,<br>Tensor other = 1.0              | Done     |
|  4 | Tensor<[1, 9, 3072]> self = ?,<br>Tensor<[1, 9, 3072]> other = ?  | Done     |
|  5 | Tensor<[1, 9, 768]> self = ?,<br>Tensor<[1, 9, 768]> other = ?    | Done     |
### aten.addmm.default
|    | ATen Input Variations                                                                    | Status   |
|---:|:-----------------------------------------------------------------------------------------|:---------|
|  0 | Tensor<[128]> self = ?,<br>Tensor<[9, 768]> mat1 = ?,<br>Tensor<[768, 128]> mat2 = ?     | Done     |
|  1 | Tensor<[30000]> self = ?,<br>Tensor<[9, 128]> mat1 = ?,<br>Tensor<[128, 30000]> mat2 = ? | Done     |
|  2 | Tensor<[3072]> self = ?,<br>Tensor<[9, 768]> mat1 = ?,<br>Tensor<[768, 3072]> mat2 = ?   | Done     |
...
|  1 | Tensor<[1, 9, 12, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Done     |
|  2 | Tensor<[1, 9, 128]> self = ?                                                              | Done     |
|  3 | Tensor<[1, 9, 768]> self = ?                                                              | Done     |
### aten.div.Tensor
|    | ATen Input Variations                                 | Status   |
|---:|:------------------------------------------------------|:---------|
...
|  5 | Tensor<[1, 9, 3072]> self = ?,<br>Tensor other = 0.044715                | Done     |
|  6 | Tensor<[1, 9, 3072]> self = ?,<br>Tensor other = 0.5                     | Done     |
|  7 | Tensor<[1, 9, 3072]> self = ?,<br>Tensor other = 0.7978845608028654      | Done     |
|  8 | Tensor<[1, 9, 3072]> self = ?,<br>Tensor<[1, 9, 3072]> other = ?         | Done     |
...
|  1 | Tensor<[1, 9, 3072]> self = ?,<br>number exponent = 3.0 | Done     |
### aten.rsub.Scalar
|    | ATen Input Variations                                | Status   |
|---:|:-----------------------------------------------------|:---------|
...
|    | ATen Input Variations         | Status   |
|---:|:------------------------------|:---------|
|  0 | Tensor<[128, 768]> self = ?   | Done     |
|  1 | Tensor<[30000, 128]> self = ? | Done     |
|  2 | Tensor<[3072, 768]> self = ?  | Done     |
|  3 | Tensor<[768, 128]> self = ?   | Done     |
|  4 | Tensor<[768, 3072]> self = ?  | Done     |
|  5 | Tensor<[768, 768]> self = ?   | Done     |
### aten.tanh.default
|    | ATen Input Variations         | Status   |
|---:|:------------------------------|:---------|
