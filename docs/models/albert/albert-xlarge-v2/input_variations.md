...
|  5 | Tensor<[8192]> self = ?,<br>Tensor<[9, 2048]> mat1 = ?,<br>Tensor<[2048, 8192]> mat2 = ? | Removed  | Done       | True  |
### aten.bmm.default
|    | ATen Input Variations                                           | Status   | Isolated   | PCC   |
|---:|:----------------------------------------------------------------|:---------|:-----------|:------|
...
|  2 | Tensor<[1, 9, 16, 128]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Removed  | Fallback   | True  |
|  3 | Tensor<[1, 9, 2048]> self = ?                                                              | Removed  | Fallback   | True  |
### aten.div.Tensor
|    | ATen Input Variations                                                | Status   | Isolated   | PCC   |
|---:|:---------------------------------------------------------------------|:---------|:-----------|:------|
...
|  8 | Tensor<[1, 9, 8192]> self = ?,<br>Tensor<[1, 9, 8192]> other = ?         | Removed  | Done       | True  |
...
|  6 | Tensor<[1, 9, 8192]> self = ?,<br>List[int] size = [9, 8192]       | Fallback | Fallback   | True  |
...
| 12 | Tensor<[9, 8192]> self = ?,<br>List[int] size = [1, 9, 8192]       | Fallback | Fallback   | True  |
