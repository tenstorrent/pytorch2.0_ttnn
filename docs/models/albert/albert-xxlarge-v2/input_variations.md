...
|  4 | aten.addmm.default             |                  6 |           4 |         2 |          0 | ✅          |    1    |
...
| 20 | aten.view.default              |                 13 |           9 |         1 |          3 | 🚧          |    0.77 |
***
...
|  5 | Tensor<[1, 9, 4096]> self = ?,<br>Tensor<[1, 9, 4096]> other = ?   | Removed  | Done       | True  |
### aten.addmm.default
|    | ATen Input Variations                                                                      | Status   | Isolated   | PCC   |
|---:|:-------------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[128]> self = ?,<br>Tensor<[9, 4096]> mat1 = ?,<br>Tensor<[4096, 128]> mat2 = ?     | Done     | Done       | True  |
|  1 | Tensor<[16384]> self = ?,<br>Tensor<[9, 4096]> mat1 = ?,<br>Tensor<[4096, 16384]> mat2 = ? | Removed  | Done       | True  |
|  2 | Tensor<[30000]> self = ?,<br>Tensor<[9, 128]> mat1 = ?,<br>Tensor<[128, 30000]> mat2 = ?   | Removed  | Done       | True  |
...
|    | ATen Input Variations                                                                     | Status   | Isolated   | PCC   |
|---:|:------------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 64, 9, 9]> self = ?                                                            | Removed  | Fallback   | True  |
|  1 | Tensor<[1, 9, 128]> self = ?                                                              | Removed  | Fallback   | True  |
|  2 | Tensor<[1, 9, 4096]> self = ?                                                             | Removed  | Fallback   | True  |
|  3 | Tensor<[1, 9, 64, 64]> self = ?,<br>Optional[int] memory_format = torch.contiguous_format | Removed  | Fallback   | True  |
### aten.div.Tensor
|    | ATen Input Variations                                 | Status   | Isolated   | PCC   |
|---:|:------------------------------------------------------|:---------|:-----------|:------|
...
|  8 | Tensor<[1, 9, 16384]> self = ?,<br>Tensor<[1, 9, 16384]> other = ?       | Removed  | Done       | True  |
...
|  4 | Tensor<[1, 9, 16384]> self = ?,<br>List[int] size = [9, 16384]    | Fallback | Fallback   | True  |
...
|  8 | Tensor<[64, 9, 9]> self = ?,<br>List[int] size = [1, 64, 9, 9]    | Removed  | Done       | True  |
|  9 | Tensor<[9, 128]> self = ?,<br>List[int] size = [1, 9, 128]        | Done     | Done       | True  |
| 10 | Tensor<[9, 16384]> self = ?,<br>List[int] size = [1, 9, 16384]    | Fallback | Fallback   | True  |
