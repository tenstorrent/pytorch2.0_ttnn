...
|  9 | aten.native_layer_norm.default                           |                  2 |           1 |         0 |          0 | 🚧          |     0.5 |
...
|---:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[1, 64, 9, 64]> query = ?,<br>Tensor<[1, 64, 9, 64]> key = ?,<br>Tensor<[1, 64, 9, 64]> value = ?,<br>Optional[Tensor] attn_mask = Proxy(masked_fill_scalar) | Done     | Unknown    | N/A   | N/A    |
|  1 | Tensor<[1, 64, 9, 64]> query = ?,<br>Tensor<[1, 64, 9, 64]> key = ?,<br>Tensor<[1, 64, 9, 64]> value = ?,<br>Optional[Tensor]<[1, 1, 9, 9]> attn_mask = masked_fill | Removed  | Unknown    | N/A   | N/A    |
...
|  2 | Tensor<[1, 9, 16384]> self = ?,<br>Tensor other = 1.0              | Done     | Done       | 0.999995 |      0 |
|  3 | Tensor<[1, 9, 16384]> self = ?,<br>Tensor<[1, 9, 16384]> other = ? | Done     | Done       | 0.999998 |      0 |
|  4 | Tensor<[1, 9, 4096]> self = ?,<br>Tensor<[1, 9, 4096]> other = ?   | Done     | Done       | 0.999998 |      0 |
### aten.addmm.default
|    | ATen Input Variations                                                                      | Status   | Isolated   |      PCC |   Host |
|---:|:-------------------------------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[128]> self = ?,<br>Tensor<[9, 4096]> mat1 = ?,<br>Tensor<[4096, 128]> mat2 = ?     | Removed  | Done       | 0.999925 |      0 |
...
|  3 | Tensor<[4096]> self = ?,<br>Tensor<[9, 128]> mat1 = ?,<br>Tensor<[128, 4096]> mat2 = ?     | Removed  | Done       | 0.999978 |      0 |
|  4 | Tensor<[4096]> self = ?,<br>Tensor<[9, 16384]> mat1 = ?,<br>Tensor<[16384, 4096]> mat2 = ? | Removed  | Done       | 0.999801 |      0 |
|  5 | Tensor<[4096]> self = ?,<br>Tensor<[9, 4096]> mat1 = ?,<br>Tensor<[4096, 4096]> mat2 = ?   | Removed  | Done       | 0.99993  |      0 |
### aten.clone.default
|    | ATen Input Variations         | Status   | Isolated   |   PCC |   Host |
|---:|:------------------------------|:---------|:-----------|------:|-------:|
|  0 | Tensor<[1, 9, 128]> self = ?  | Removed  | Done       |     1 |      0 |
|  1 | Tensor<[1, 9, 4096]> self = ? | Removed  | Done       |     1 |      0 |
...
|  3 | Tensor<[1, 9, 128]> self = ?,<br>Tensor<[1, 9, 128]> other = ?       | Done     | Done       | 0.999997 |      0 |
|  4 | Tensor<[1, 9, 16384]> self = ?,<br>Tensor other = 0.044715           | Done     | Done       | 0.999995 |      0 |
|  5 | Tensor<[1, 9, 16384]> self = ?,<br>Tensor other = 0.5                | Done     | Done       | 1        |      0 |
|  6 | Tensor<[1, 9, 16384]> self = ?,<br>Tensor other = 0.7978845608028654 | Done     | Done       | 0.999997 |      0 |
|  7 | Tensor<[1, 9, 16384]> self = ?,<br>Tensor<[1, 9, 16384]> other = ?   | Done     | Done       | 0.999996 |      0 |
### aten.native_layer_norm.default
|    | ATen Input Variations                                                                                                                                                      | Status   | Isolated   |      PCC |   Host |
|---:|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 9, 128]> input = ?,<br>List[int] normalized_shape = [128],<br>Optional[Tensor]<[128]> weight = ?,<br>Optional[Tensor]<[128]> bias = ?,<br>float eps = 1e-12     | Done     | Done       | 0.999906 |      3 |
...
|  1 | Tensor<[1, 9, 16384]> self = ? | Done     | Done       | 0.999993 |      0 |
### aten.transpose.int
|    | ATen Input Variations                                             | Status   | Isolated   | PCC   | Host   |
|---:|:------------------------------------------------------------------|:---------|:-----------|:------|:-------|
...
|  1 | Tensor<[1, 9, 16384]> self = ?,<br>List[int] size = [9, 16384]    | Done     | Done       | 1.0   | 0      |
|  2 | Tensor<[1, 9, 4096]> self = ?,<br>List[int] size = [1, 9, 64, 64] | Done     | Done       | 1.0   | 0      |
|  3 | Tensor<[1, 9, 4096]> self = ?,<br>List[int] size = [9, 4096]      | Done     | Done       | 1.0   | 0      |
|  4 | Tensor<[1, 9, 64, 64]> self = ?,<br>List[int] size = [1, 9, 4096] | Done     | Unknown    | N/A   | N/A    |
|  5 | Tensor<[9, 128]> self = ?,<br>List[int] size = [1, 9, 128]        | Done     | Done       | 1.0   | 0      |
|  6 | Tensor<[9, 16384]> self = ?,<br>List[int] size = [1, 9, 16384]    | Done     | Done       | 1.0   | 0      |
