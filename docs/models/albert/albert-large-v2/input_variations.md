...
|---:|:-------------------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 16, 9, 9]> self = ?,<br>int dim = -1,<br>bool half_to_float = False | Done     | Done       | 0.999601 |      0 |
...
|  2 | Tensor<[1, 9, 128]> self = ?,<br>Tensor other = 1.0               | None     | Fallback   | 1        |     -1 |
|  3 | Tensor<[1, 9, 128]> self = ?,<br>Tensor<[1, 9, 128]> other = ?    | Done     | Done       | 0.999998 |      0 |
|  4 | Tensor<[1, 9, 4096]> self = ?,<br>Tensor other = 1.0              | None     | Fallback   | 1        |     -1 |
...
|  2 | Tensor<[1024]> self = ?,<br>Tensor<[9, 4096]> mat1 = ?,<br>Tensor<[4096, 1024]> mat2 = ? | Done     | Done       | 0.99993  |      0 |
|  3 | Tensor<[128]> self = ?,<br>Tensor<[9, 1024]> mat1 = ?,<br>Tensor<[1024, 128]> mat2 = ?   | Done     | Done       | 0.999838 |      0 |
...
|  5 | Tensor<[1, 9, 4096]> self = ?,<br>Tensor other = 0.044715                | None     | Fallback   | 1        |     -1 |
|  6 | Tensor<[1, 9, 4096]> self = ?,<br>Tensor other = 0.5                     | None     | Fallback   | 1        |     -1 |
|  7 | Tensor<[1, 9, 4096]> self = ?,<br>Tensor other = 0.7978845608028654      | None     | Fallback   | 1        |     -1 |
...
|    | ATen Input Variations         | Status   | Isolated   |      PCC |   Host |
|---:|:------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 9, 128]> self = ?  | Done     | Done       | 0.998449 |      0 |
|  1 | Tensor<[1, 9, 4096]> self = ? | Done     | Done       | 0.998452 |      0 |
### aten.transpose.int
|    | ATen Input Variations                                               | Status   | Isolated   |   PCC |   Host |
|---:|:--------------------------------------------------------------------|:---------|:-----------|------:|-------:|
