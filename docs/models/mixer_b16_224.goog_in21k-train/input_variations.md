...
|  2 | Tensor<[196, 384]> self = ?   | Fallback | Done       | True  |
|  3 | Tensor<[196, 768]> self = ?   | Done     | Done       | True  |
|  4 | Tensor<[21843, 768]> self = ? | Done     | Done       | True  |
|  5 | Tensor<[3072, 768]> self = ?  | Fallback | Done       | True  |
|  6 | Tensor<[384, 196]> self = ?   | Fallback | Done       | True  |
|  7 | Tensor<[768, 196]> self = ?   | Done     | Done       | True  |
|  8 | Tensor<[768, 21843]> self = ? | Fallback | Done       | True  |
|  9 | Tensor<[768, 3072]> self = ?  | Fallback | Done       | True  |
...
|    | ATen Input Variations                                                | Status   | Isolated   | PCC   |
|---:|:---------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1, 384]> self = ?,<br>List[int] size = [384]              | Fallback | Done       | True  |
|  1 | Tensor<[1, 196, 3072]> self = ?,<br>List[int] size = [196, 3072]     | Fallback | Done       | True  |
|  2 | Tensor<[1, 196, 768]> self = ?,<br>List[int] size = [196, 768]       | Fallback | Done       | True  |
|  3 | Tensor<[1, 196]> self = ?,<br>List[int] size = [196]                 | Fallback | Done       | True  |
|  4 | Tensor<[1, 21843]> self = ?,<br>List[int] size = [21843]             | Fallback | Done       | True  |
|  5 | Tensor<[1, 3072]> self = ?,<br>List[int] size = [3072]               | Fallback | Done       | True  |
|  6 | Tensor<[1, 768, 14, 14]> self = ?,<br>List[int] size = [1, 768, 196] | None     | Fallback   | True  |
|  7 | Tensor<[1, 768, 196]> self = ?,<br>List[int] size = [1, 768, 14, 14] | Fallback | Done       | True  |
|  8 | Tensor<[1, 768, 196]> self = ?,<br>List[int] size = [768, 196]       | Fallback | Done       | True  |
|  9 | Tensor<[1, 768, 384]> self = ?,<br>List[int] size = [768, 384]       | Done     | Done       | True  |
| 10 | Tensor<[1, 768]> self = ?,<br>List[int] size = [768]                 | Fallback | Done       | True  |
| 11 | Tensor<[196, 3072]> self = ?,<br>List[int] size = [1, 196, 3072]     | Fallback | Done       | True  |
| 12 | Tensor<[196, 768]> self = ?,<br>List[int] size = [1, 196, 768]       | Fallback | Done       | True  |
| 13 | Tensor<[768, 196]> self = ?,<br>List[int] size = [1, 768, 196]       | Done     | Done       | True  |
| 14 | Tensor<[768, 384]> self = ?,<br>List[int] size = [1, 768, 384]       | Fallback | Done       | True  |
