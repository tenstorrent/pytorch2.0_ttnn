...
|  2 | aten.clone.default                      |                  5 |           4 |         1 |          0 | ✅          |     1   |
...
| 17 | aten.view.default                       |                 15 |           5 |        10 |          0 | ✅          |     1   |
***
### aten.add.Tensor
...
|  4 | Tensor<[1, 768]> self = ?       | Removed  | Done       | True  |
...
|    | ATen Input Variations                                                | Status   | Isolated   | PCC   |
|---:|:---------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1, 384]> self = ?,<br>List[int] size = [384]              | Removed  | Done       | True  |
...
|  3 | Tensor<[1, 196]> self = ?,<br>List[int] size = [196]                 | Removed  | Done       | True  |
|  4 | Tensor<[1, 21843]> self = ?,<br>List[int] size = [21843]             | Removed  | Done       | True  |
|  5 | Tensor<[1, 3072]> self = ?,<br>List[int] size = [3072]               | Removed  | Done       | True  |
...
| 10 | Tensor<[1, 768]> self = ?,<br>List[int] size = [768]                 | Removed  | Done       | True  |
