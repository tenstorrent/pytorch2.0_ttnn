...
|    | ATen Input Variations           | Status   | Isolated   | PCC   |
|---:|:--------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 196, 3072]> self = ? | Removed  | Fallback   | True  |
|  1 | Tensor<[1, 196, 768]> self = ?  | Removed  | Fallback   | True  |
|  2 | Tensor<[1, 768, 196]> self = ?  | Removed  | Fallback   | True  |
|  3 | Tensor<[1, 768, 384]> self = ?  | Removed  | Fallback   | True  |
|  4 | Tensor<[1, 768]> self = ?       | Removed  | Fallback   | True  |
...
|    | ATen Input Variations                                           | Status   | Isolated   | PCC   |
|---:|:----------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1, 768]> self = ?,<br>List[int] size = [1, 196, 768] | Removed  | Done       | True  |
### aten.gelu.default
|    | ATen Input Variations           | Status   | Isolated   | PCC   |
|---:|:--------------------------------|:---------|:-----------|:------|
...
|    | ATen Input Variations                                                                                                                                                    | Status   | Isolated   | PCC   |
|---:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 196, 768]> input = ?,<br>List[int] normalized_shape = [768],<br>Optional[Tensor]<[768]> weight = ?,<br>Optional[Tensor]<[768]> bias = ?,<br>float eps = 1e-06 | Removed  | Done       | N/A   |
...
|    | ATen Input Variations         | Status   | Isolated   | PCC   |
|---:|:------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 21843]> self = ?   | Done     | Done       | True  |
...
|  8 | Tensor<[768, 21843]> self = ? | Removed  | Done       | True  |
...
|    | ATen Input Variations                                                | Status   | Isolated   | PCC   |
|---:|:---------------------------------------------------------------------|:---------|:-----------|:------|
|  0 | Tensor<[1, 1, 384]> self = ?,<br>List[int] size = [384]              | Fallback | Fallback   | True  |
|  1 | Tensor<[1, 196, 3072]> self = ?,<br>List[int] size = [196, 3072]     | Removed  | Done       | True  |
|  2 | Tensor<[1, 196, 768]> self = ?,<br>List[int] size = [196, 768]       | Removed  | Done       | True  |
|  3 | Tensor<[1, 196]> self = ?,<br>List[int] size = [196]                 | Fallback | Fallback   | True  |
|  4 | Tensor<[1, 21843]> self = ?,<br>List[int] size = [21843]             | Fallback | Fallback   | True  |
|  5 | Tensor<[1, 3072]> self = ?,<br>List[int] size = [3072]               | Fallback | Fallback   | True  |
|  6 | Tensor<[1, 768, 14, 14]> self = ?,<br>List[int] size = [1, 768, 196] | Done     | Done       | True  |
|  7 | Tensor<[1, 768, 196]> self = ?,<br>List[int] size = [1, 768, 14, 14] | Removed  | Done       | True  |
|  8 | Tensor<[1, 768, 196]> self = ?,<br>List[int] size = [768, 196]       | Removed  | Done       | True  |
|  9 | Tensor<[1, 768, 384]> self = ?,<br>List[int] size = [768, 384]       | Done     | Done       | True  |
| 10 | Tensor<[1, 768]> self = ?,<br>List[int] size = [768]                 | Fallback | Fallback   | True  |
| 11 | Tensor<[196, 3072]> self = ?,<br>List[int] size = [1, 196, 3072]     | Removed  | Done       | True  |
