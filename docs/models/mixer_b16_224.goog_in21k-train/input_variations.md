...
|  5 | aten.convolution_backward.default       |                  1 |           0 |         0 |          0 | ✘           |       0 |
...
| 11 | aten.mm.default                         |                 10 |          10 |         0 |          0 | ✅          |       1 |
| 12 | aten.native_layer_norm.default          |                  1 |           1 |         0 |          0 | ✅          |       1 |
| 13 | aten.native_layer_norm_backward.default |                  1 |           0 |         0 |          0 | ✘           |       0 |
| 14 | aten.sum.dim_IntList                    |                  5 |           0 |         0 |          0 | ✘           |       0 |
| 15 | aten.t.default                          |                 11 |          11 |         0 |          0 | ✅          |       1 |
| 16 | aten.transpose.int                      |                  2 |           2 |         0 |          0 | ✅          |       1 |
| 17 | aten.unsqueeze.default                  |                  1 |           1 |         0 |          0 | ✅          |       1 |
| 18 | aten.view.default                       |                 15 |          15 |         0 |          0 | ✅          |       1 |
***
### aten._unsafe_view.default
|    | ATen Input Variations                                          | Status   | Isolated   | PCC   | Host   |
|---:|:---------------------------------------------------------------|:---------|:-----------|:------|:-------|
|  0 | Tensor<[768, 384]> self = ?,<br>List[int] size = [1, 768, 384] | Done     | Unknown    | N/A   | N/A    |
### aten.add.Tensor
|    | ATen Input Variations                                              | Status   | Isolated   |      PCC |   Host |
|---:|:-------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
...
|    | ATen Input Variations                                         | Status   | Isolated   |      PCC |   Host |
|---:|:--------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 21843]> self = ?,<br>Tensor<[21843, 768]> mat2 = ? | Done     | Done       | 0.999493 |      0 |
...
|  7 | Tensor<[384, 768]> self = ?,<br>Tensor<[768, 196]> mat2 = ?   | Done     | Done       | 0.999964 |      0 |
...
|    | ATen Input Variations                                                                                                                                                    | Status   | Isolated   |      PCC |   Host |
|---:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------|:-----------|---------:|-------:|
|  0 | Tensor<[1, 196, 768]> input = ?,<br>List[int] normalized_shape = [768],<br>Optional[Tensor]<[768]> weight = ?,<br>Optional[Tensor]<[768]> bias = ?,<br>float eps = 1e-06 | Done     | Done       | 0.998722 |      3 |
