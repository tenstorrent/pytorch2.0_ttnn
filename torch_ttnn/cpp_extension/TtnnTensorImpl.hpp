...
struct TtnnTensorImpl : public TensorImpl {
    ...
    void set_sizes_and_strides(const IntArrayRef& int_array_ref) { sizes_and_strides_.set_sizes(int_array_ref); }
    ...
    void set_ttnn_tensor(const ttnn::Tensor& tensor) { ttnn_tensor_ = tensor; }
