...
|:-----------------------------------------------------------------------|:---------|:--------------------------------|:--------------------------------|---------------------:|-------------------------:|-------------------------------------------:|---------------:|
| [Autoencoder (linear)](<docs/models/Autoencoder (linear)>)             | ✅       | 22 (3)                          | 0 (0)                           |                    0 |                  2734.87 |                                      21.22 |            100 |
| [Autoencoder (conv)](<docs/models/Autoencoder (conv)>)                 | 🚧       | 9 (3)                           | 1 (1)                           |                    1 |                  1806.86 |                                      24.6  |            100 |
| [Autoencoder (conv)-train](<docs/models/Autoencoder (conv)-train>)     | 🚧       | 24 (7)                          | 11 (4)                          |                    0 |                  3830.7  |                                      23.04 |            100 |
| [Autoencoder (linear)-train](<docs/models/Autoencoder (linear)-train>) | 🚧       | 104 (8)                         | 14 (2)                          |                    0 |                  1646.01 |                                      58.06 |            100 |
