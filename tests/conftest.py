...
def compile_and_run(device, reset_torch_dynamo, request):
    ...
    if "torch_ttnn" in record:
        ...
        try:
            ...
            load_params_once = not native_integration # load_params_once conflicts with native integration as per 2 PRs: 
            # [Add Support for Mamba 2.8B model](https://github.com/tenstorrent/pytorch2.0_ttnn/pull/1168)
            # [Support existing Falcon 7B model running E2E](https://github.com/tenstorrent/pytorch2.0_ttnn/pull/1265)
