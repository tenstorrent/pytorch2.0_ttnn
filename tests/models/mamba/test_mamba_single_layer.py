...
class ThisTester(ModelTester):
    def _load_model(self):
        ...
        model = Mamba.from_pretrained("state-spaces/mamba-2.8b-slimpj", num_layers=1, load_weights=False)
...
def test_mamba_single_layer(record_property, mode):
    model_name = "mamba_single_layer"
