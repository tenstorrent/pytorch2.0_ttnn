...
class ThisTester(ModelTester):
    ...
    def _load_inputs(self):
        ...
        self.question = [
            ...
            "what is Rothko best known for?",
            "What symptoms a malignant narcissist might exhibit in addition to the symptoms of a NPD patient?",
            "When was the Hashemite Arab Federation formed?",
            "What allows Tasmanian devil to generate strong bites?",
        ]
