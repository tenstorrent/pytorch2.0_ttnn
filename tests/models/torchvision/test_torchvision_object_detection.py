...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(("retinanet_resnet50_fpn", "RetinaNet_ResNet50_FPN_Weights"), marks=pytest.mark.skip),
        pytest.param(("retinanet_resnet50_fpn_v2", "RetinaNet_ResNet50_FPN_V2_Weights"), marks=pytest.mark.skip),
    ],
)
