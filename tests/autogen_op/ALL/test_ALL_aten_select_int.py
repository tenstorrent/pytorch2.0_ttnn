...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["Tensor<[192, 2]> self = ?", "int dim = 1", "int index = 0"],
        ["Tensor<[1, 201, 768]> self = ?", "int dim = 1", "int index = 0"],
        ...
        ["Tensor<[1, 1, 256]> self = ?", "int dim = 0", "int index = 0"],
        ["Tensor<[1, s0, 256]> self = ?", "int dim = 0", "int index = 0"],
