...
@pytest.mark.parametrize(
    "input_strings", [
        ...
        ["Tensor<[2, 512, 12, 64]> self = ?", "List[int] dims = [0, 2, 1, 3]"],
        ["Tensor<[1, 768, 12, 64]> self = ?", "List[int] dims = [0, 2, 1, 3]"],
        ["Tensor<[4, 128, 16, 64]> self = ?", "List[int] dims = [0, 2, 1, 3]"],
        ["Tensor<[1, 12, 512, 64]> self = ?", "List[int] dims = [0, 2, 1, 3]"],
        ["Tensor<[2, 16, 256, 64]> self = ?", "List[int] dims = [0, 2, 1, 3]"],
    ]
)
