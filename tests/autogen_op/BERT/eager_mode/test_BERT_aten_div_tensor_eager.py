...
@pytest.mark.parametrize(
    "input_strings", [
        ["Tensor<[1, 16, 256, 256]> self = ?", "Tensor<[1, 16, 256, 256]> other = ?"],
        ["Tensor<[1, 768]> self = ?", "Tensor<[1, 768]> other = ?"],
        ["Tensor<[1, 512, 768]> self = ?", "Tensor<[1, 512, 768]> other = ?"],
        ["Tensor<[12, 512, 64]> self = ?", "Tensor<[12, 512, 64]> other = ?"],
        ["Tensor<[2, 1024, 512]> self = ?", "Tensor<[2, 1024, 512]> other = ?"],
        ["Tensor<[8, 128, 1024]> self = ?", "Tensor<[8, 128, 1024]> other = ?"],
    ]
)
