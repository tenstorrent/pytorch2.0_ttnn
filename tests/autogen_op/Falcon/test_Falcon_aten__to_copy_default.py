...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/Falcon", "aten._to_copy.default")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["Tensor<[1, 1, 7, 7]> self = ?", "Optional[int] dtype = torch.bfloat16"],
        ["Tensor<[1, 1, 7, 7]> self = ?", "Optional[int] dtype = torch.bool"],
    ],
)
