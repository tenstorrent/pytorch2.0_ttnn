...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/Falcon", "aten.argmax.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 7]> self = ?", "Optional[int] dim = 1", "bool keepdim = True"]])
