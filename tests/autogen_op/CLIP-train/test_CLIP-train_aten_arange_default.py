...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/CLIP-train", "aten.arange.default")


@pytest.mark.parametrize(
    "input_strings", [["number end = 2", "Optional[Device] device = cpu", "Optional[bool] pin_memory = False"]]
)
