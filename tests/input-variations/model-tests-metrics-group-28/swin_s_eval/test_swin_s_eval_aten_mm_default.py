...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-input-variations/model-tests-metrics-group-28/swin_s eval", "aten.mm.default")


@pytest.mark.parametrize("input_strings", [['Tensor<[784, 384]> self = ?', 'Tensor<[384, 192]> mat2 = ?'], ['Tensor<[196, 768]> self = ?', 'Tensor<[768, 384]> mat2 = ?'], ['Tensor<[49, 1536]> self = ?', 'Tensor<[1536, 768]> mat2 = ?']])
