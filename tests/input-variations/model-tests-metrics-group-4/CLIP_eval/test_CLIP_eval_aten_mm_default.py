...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-input-variations/model-tests-metrics-group-4/CLIP eval", "aten.mm.default")


@pytest.mark.parametrize("input_strings", [['Tensor<[1, 768]> self = ?', 'Tensor<[768, 512]> mat2 = ?'], ['Tensor<[2, 512]> self = ?', 'Tensor<[512, 512]> mat2 = ?'], ['Tensor<[2, 512]> self = ?', 'Tensor<[512, 1]> mat2 = ?']])
