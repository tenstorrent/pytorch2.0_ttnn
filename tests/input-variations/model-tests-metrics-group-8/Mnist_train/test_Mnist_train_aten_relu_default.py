...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-input-variations/model-tests-metrics-group-8/Mnist train", "aten.relu.default")


@pytest.mark.parametrize("input_strings", [['Tensor<[1, 32, 26, 26]> self = ?'], ['Tensor<[1, 64, 24, 24]> self = ?'], ['Tensor<[1, 128]> self = ?']])
