...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-input-variations/model-tests-metrics-group-11/SegFormer eval", "aten.unsqueeze.default")


@pytest.mark.parametrize("input_strings", [['Tensor<[128]> self = ?', 'int dim = 1']])
