...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-input-variations/model-tests-metrics-group-6/Falcon eval", "aten.t.default")


@pytest.mark.parametrize("input_strings", [['Tensor<[65024, 4544]> self = ?']])
