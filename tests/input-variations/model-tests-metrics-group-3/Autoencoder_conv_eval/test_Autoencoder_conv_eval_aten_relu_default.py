...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-input-variations/model-tests-metrics-group-3/Autoencoder (conv) eval", "aten.relu.default")


@pytest.mark.parametrize("input_strings", [['Tensor<[1, 16, 28, 28]> self = ?'], ['Tensor<[1, 4, 14, 14]> self = ?'], ['Tensor<[1, 16, 14, 14]> self = ?']])
