...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-input-variations/model-tests-metrics-group-30/ssdlite320_mobilenet_v3_large eval", "aten.lift_fresh_copy.default")
...
def test_aten(device, input_strings, input_var_only_native, input_var_check_accu, input_var_check_ttnn):
    ...
    m = AtenModule()
    input_args, input_kwargs = get_input_vals_from_metric_str("aten.lift_fresh_copy.default", input_strings)
