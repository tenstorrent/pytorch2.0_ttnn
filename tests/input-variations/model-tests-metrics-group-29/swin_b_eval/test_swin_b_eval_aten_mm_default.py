...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-input-variations/model-tests-metrics-group-29/swin_b eval", "aten.mm.default")


@pytest.mark.parametrize("input_strings", [['Tensor<[784, 512]> self = ?', 'Tensor<[512, 256]> mat2 = ?'], ['Tensor<[196, 1024]> self = ?', 'Tensor<[1024, 512]> mat2 = ?'], ['Tensor<[49, 2048]> self = ?', 'Tensor<[2048, 1024]> mat2 = ?']])
