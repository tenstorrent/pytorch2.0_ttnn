...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-input-variations/model-tests-metrics-group-26/regnet_x_400mf eval", "aten.relu.default")


@pytest.mark.parametrize("input_strings", [['Tensor<[1, 32, 112, 112]> self = ?'], ['Tensor<[1, 32, 56, 56]> self = ?'], ['Tensor<[1, 64, 56, 56]> self = ?'], ['Tensor<[1, 64, 28, 28]> self = ?'], ['Tensor<[1, 160, 28, 28]> self = ?'], ['Tensor<[1, 160, 14, 14]> self = ?'], ['Tensor<[1, 400, 14, 14]> self = ?'], ['Tensor<[1, 400, 7, 7]> self = ?']])
